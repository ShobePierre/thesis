...
// Get detailed dragdrop attempt information (student view)
router.get('/dragdrop/attempts/:attemptId', verifyToken, activityController.getDragdropAttemptDetails);
...
// Get all dragdrop scores for an activity (instructor view)
router.get('/:id/dragdrop/scores', verifyToken, activityController.getDragdropScores);

// Get all dragdrop submissions with performance data (instructor view)
router.get('/:id/dragdrop/submissions', verifyToken, activityController.getDragdropSubmissions);
