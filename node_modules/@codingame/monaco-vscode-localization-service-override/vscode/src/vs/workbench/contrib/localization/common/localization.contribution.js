...
class BaseLocalizationWorkbenchContribution extends Disposable {
    constructor() {
        ...
        ExtensionsRegistry.registerExtensionPoint({
            ...
            jsonSchema: {
                description: ( localize(8542, "Contributes localizations to the editor")),
                type: 'array',
                default: [],
                items: {
                    type: 'object',
                    ...
                    properties: {
                        languageId: {
                            description: ( localize(8543, 'Id of the language into which the display strings are translated.')),
                            type: 'string'
                        },
                        languageName: {
                            description: ( localize(8544, 'Name of the language in English.')),
                            type: 'string'
                        },
                        localizedLanguageName: {
                            description: ( localize(8545, 'Name of the language in contributed language.')),
                            type: 'string'
                        },
                        translations: {
                            description: ( localize(8546, 'List of translations associated to the language.')),
                            type: 'array',
...
class LocalizationsDataRenderer extends Disposable {
    ...
    render(manifest) {
        ...
        const headers = [
            ( localize(8550, "Language ID")),
            ( localize(8551, "Language Name")),
            ( localize(8552, "Language Name (Localized)")),
        ];
...
( Registry.as(Extensions.ExtensionFeaturesRegistry)).registerExtensionFeature({
    id: 'localizations',
    label: ( localize(8553, "Language Packs")),
    access: {
        canToggle: false
    },
