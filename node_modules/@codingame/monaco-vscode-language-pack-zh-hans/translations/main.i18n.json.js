var content = [
	...
	"在只读代码编辑器中。",
	"在代码编辑器中。",
	"默认情况下，activeEditorState (如修改、问题等)作为 window.title 设置的一部分包含在内。使用 accessibility.windowTitleOptimized 禁用它。",
	"默认情况下，activeEditorState (如修改的、问题等)不作为 window.title 设置的一部分包含在内。使用 accessibility.windowTitleOptimized 启用它。",
	"在工作台周围，当屏幕阅读器宣布你已登录到工具栏时，使用窄键在工具栏的作之间导航。",
	"将应用程序配置为使用屏幕阅读器 (Command+E) 进行优化。",
	"将应用程序配置为使用屏幕阅读器 (Control+E) 进行优化。",
	"对该应用程序进行配置并优化，以配合屏幕读取器的使用。",
	"对该应用程序进行配置但不优化，以配合屏幕读取器的使用。",
	"已启用屏幕阅读器优化模式。",
	"已禁用屏幕阅读器优化模式。",
	...
	"使用 Intellisense 提高编码效率并减少错误。触发建议{0}。",
	"显示或聚焦悬停{0}以读取有关当前符号的信息。",
	"转到符号 {0} 以在当前文件中的符号之间快速导航。",
	"显示辅助功能帮助",
	"运行命令: 列出信号声音以概览所有声音及其当前状态。",
	"运行命令: 列出信号公告以概览公告及其当前状态。",
	"切换快速聊天的开关{0}以打开或关闭聊天会话。",
	"开始内联聊天{0}以创建编辑器聊天会话。",
	"“调试：启动调试”命令{0}将启动调试会话。",
	"“调试: 内联断点”命令{0}将在活动编辑器中当前游标位置设置或取消设置断点。",
	"“调试：添加到监视”命令{0}会将所选文本添加到监视视图中。",
	"调试: 执行选择命令{0}将在调试控制台中执行所选文本。",
	"编辑器包含聊天所做的挂起的修改。",
	"编辑器当前正在等待聊天进行修改。",
	"在编辑器中的编辑之间导航，可导航上一个{0} 和下一个{1}、接受{2}、拒绝{3} 或查看当前更改的差异{4}。接受所有文件中的编辑{5}。",
	"开发人员: 检查令牌",
	"转到行/列...",
	"转到偏移量...",
	"显示所有快速访问提供程序",
	...
	"绘制字形",
	"这是悬停状态栏。",
	"它有一个标签为 {0} 和键绑定为 {1} 的操作。",
	"它有一个标签为 {0} 的操作。",
	"- 使用 Increase Hover Verbosity 命令可以提高聚焦悬停部分的详细程度。",
	"- 使用 Decrease Hover Verbosity 命令可以降低聚焦悬停部分的详细程度。",
	"提高悬停详细程度级别",
	"降低悬停详细程度级别",
	"显示或聚焦悬停",
	...
	"了解原因",
	"市场未启用",
	"无法安装 '{0}' 扩展，因为其被报告为存在问题。",
	"无法安装“{0}”扩展，因为它已被弃用，并且找不到替换扩展“{1}”。",
	"无法安装“{0}”扩展。{1}",
	"由于 '{0}' 扩展没有发布版本，因此无法安装。",
	"无法安装“{0}”扩展，因为它与当前 {1} 版本不兼容(版本 {2})。",
	"无法卸载扩展“{0}”。扩展“{1}”依赖于它。",
	"无法卸载扩展“{0}”。扩展“{1}”和“{2}”依赖于它。",
	...
	"它不在[允许列表]({0})中",
	"此扩展的预发布版本不在[允许列表]({0})中",
	"此扩展的版本 {0} 不在[允许列表]({1})中",
	"来自此发布者的扩展不在[允许列表]({1})中",
	"来自此发布者的预发布版本不在[允许列表]({1})中",
	"扩展",
	"首选项",
	"扩展",
	"指定允许使用的扩展列表。这有助于通过限制使用未经授权的扩展来维护安全且一致的开发环境。有关如何配置此设置的详细信息，请访问 [Configure Allowed Extensions](https://code.visualstudio.com/docs/setup/enterprise#_configure-allowed-extensions) 部分。",
	"不允许使用任何扩展。",
	"允许使用所有扩展。",
	"指定允许使用的扩展列表。这有助于通过限制使用未经授权的扩展来维护安全且一致的开发环境。详细信息: https://code.visualstudio.com/docs/setup/enterprise#_configure-allowed-extensions",
	"允许或禁止使用该扩展。",
	"允许使用扩展。",
	"不允许使用扩展。",
	"仅允许使用扩展的稳定版本。",
	"允许或禁止使用扩展的特定版本。若要指定特定于平台的版本，请使用“platform@1.2.3”格式，例如“win32-x64@1.2.3”。支持的平台包括“win32-x64”、“win32-arm64”、“linux-x64”、“linux-arm64”、“linux-armhf”、“alpine-x64”、“alpine-arm64”、“darwin-x64”、“darwin-arm64”",
	"允许或禁止使用来自该发布者的所有扩展。",
	"允许使用来自该发布者的所有扩展。",
	"不允许使用来自该发布者的所有扩展。",
	"仅允许使用来自该发布者的扩展的稳定版本。",
	...
	"扩展版本与 semver 不兼容。",
	"此扩展使用的 API 建议“{0}”与当前版本的 VS Code 不兼容。",
	"此扩展使用的 API 建议“{0}”和“{1}”与当前版本的 VS Code 不兼容。",
	...
	"目录不为空",
	"文件超出可用存储配额",
	"IndexedDB 文件系统提供程序中发生内部错误。({0})",
	"无法创建已存在但不是目录的文件夹\"{0}\"",
	"无法解析具有相对文件路径\"{0}\"的文件系统提供程序",
	"ENOPRO: 未找到资源 \"{0}\" 的文件系统提供程序",
	"无法解析不存在的文件 '{0}'",
	"如果未设置覆盖标记，则无法创建文件“{0}”，因为它已存在",
	"无法写入文件\"{0}\"({1})",
	"无法解锁文件“{0}”，因为提供程序不支持它。",
	"无法以原子方式写入文件 \"{0}\"，因为提供程序不支持它。",
	"无法以原子方式写入文件 '{0}'，因为提供程序不支持未缓冲的写入。",
	"无法解锁文件 \"{0}\"，因为已启用原子写入。",
	"无法写入实际上是一个目录的文件\"{0}\"",
	"自以下时间已修改的文件:",
	"无法读取文件'{0}' ({1})",
	...
	"在此输入可缩小结果范围。",
	"HTTP",
	"控制是否在远程扩展主机中使用本地代理配置。此设置仅在 [remote development](https://aka.ms/vscode-remote). 期间用作远程设置",
	"控制是否应启用对 Electron 而不是 Node.js 的 fetch 实现的使用。所有本地扩展都将获得用于全局提取 API 的 Electron 提取实现。",
	"要使用的代理设置。如果未设置，则将从“http_proxy”和“https_proxy”环境变量继承。在 [remote development](https://aka.ms/vscode-remote) 禁用 {0} 设置时，可在本地设置和远程设置中单独配置此设置。",
	"控制是否应根据提供的 CA 列表验证代理服务器证书。在 [remote development](https://aka.ms/vscode-remote) 禁用 {0} 设置时，可在本地设置和远程设置中单独配置此设置。",
	"使用 HTTP 代理替代 Kerberos 身份验证的主体服务名称。未设置此项时，将使用基于代理主机名的默认值。在 [remote development](https://aka.ms/vscode-remote) 禁用 {0} 设置时，可在本地设置和远程设置中单独配置此设置。",
	"指定应为其忽略 HTTP/HTTPS 请求的代理设置的域名。在 [remote development](https://aka.ms/vscode-remote) 禁用 {0} 设置时，可在本地设置和远程设置中单独配置此设置。",
	"要作为每个网络请求的 “Proxy-Authorization” 标头发送的值。在 [remote development](https://aka.ms/vscode-remote) 禁用 {0} 设置时，可在本地设置和远程设置中单独配置此设置。",
	"禁用对扩展的代理支持。",
	"为扩展启用代理支持。",
	...
	"控制是否应使用 Node.js 内置支持加载系统证书。更改此设置后请重新加载窗口。在[远程开发](https://aka.ms/vscode-remote)期间禁用 {0} 设置时，可在本地设置和远程设置中分别配置此设置。",
	...
	"控制检查网络接口更改以使代理缓存失效的时间间隔(秒)。设置为 -1 可禁用。在[远程开发](https://aka.ms/vscode-remote)期间禁用 {0} 设置时，可在本地设置和远程设置中分别配置此设置。",
	"遥测{0}",
	"控制 {0} 遥测、第一方扩展遥测和参与的第三方扩展遥测。一些第三方扩展可能不遵守此设置。请查阅特定扩展的文档以确定。遥测有助于我们更好地了解 {0} 的执行情况、需要改进的地方以及功能的使用方式。",
	"详细了解[我们收集的数据]({0})。",
	"详细了解[我们收集的数据]({0})和我们的[隐私声明]({1})。",
	"若要使崩溃报告更改生效，必须完全重新启动应用程序。",
	"崩溃报告",
	"错误遥测",
	"用法数据",
	"下表概述了每个设置所发送的数据:",
	...
	"遥测",
	"终端",
	"用于运行 shell 可执行文件的可选参数集。",
	"要与终端图标关联的 codicon ID。",
	"要与终端图标关联的主题颜色 ID。",
	...
	"禁用更新。",
	"禁用自动后台更新检查。如果手动检查更新，更新将可用。",
	"仅在启动时检查更新。禁用自动后台更新检查。",
	"启用自动更新检查。代码将定期自动检查更新。",
	"此设置已弃用，请改用“{0}”。",
	"在 Windows 上启用后台更新",
	...
	"无法分析同步数据，因为它与当前版本不兼容。",
	"无法同步键绑定，因为文件中的内容无效。请打开文件并进行更正。",
	"无法同步设置，因为设置文件中存在错误/警告。",
	"默认服务已更改，因此无法同步",
	"同步服务已更改，因此无法同步",
	"无法同步，因为同步在云中已关闭",
	"无法同步，因为当前会话已过期",
	...
	"OAuth 客户端 ID (azye39d...)",
	"客户端 ID 是必填项",
	"(可选)输入与客户端 ID \"{0}\" 关联的现有客户端密码，或将此字段留空",
	...
	"启用和重新加载",
	"无法激活“{0}”扩展，因为它依赖于被禁用的“{1}”扩展。",
	"无法激活“{0}”扩展，因为它依赖于“{2}”中的“{1}”扩展，而该扩展未安装。是否要安装扩展并重新加载窗口?",
	"安装并重新加载",
	"无法激活“{0}”扩展，因为它依赖未知的“{1}”扩展。",
	"扩展 \"{0}\" 希望通过创建此文件来进行重构更改",
	"扩展 \"{0}\" 希望通过复制此文件来进行重构更改",
	"扩展 \"{0}\" 希望通过移动此文件来进行重构更改",
	"扩展 \"{0}\" 希望通过删除此文件来进行重构更改",
	"{0} 扩展希望通过创建此文件来进行重构更改",
	"{0} 扩展希望通过复制此文件来进行重构更改",
	"{0} 扩展希望通过移动此文件来进行重构更改",
	"{0} 扩展希望通过删除此文件来进行重构更改",
	"显示预览(&&P)",
	"跳过更改",
	"确定(&&O)",
	"不再询问",
	...
	"保留 {0}",
	"使用 {0} 登录",
	"已移除 {0} 的身份验证会话，正在停止服务器",
	"MCP 服务器定义“{0}”要求向 {1} 进行身份验证。",
	"MCP 服务器定义“{0}”要求向 {1} 进行身份验证。",
	"允许(&&A)",
	"扩展",
	"管理扩展",
	"取消",
	"确定(&&O)",
	"1750ms 后中止 onWillSaveNotebookDocument-event",
	"显示输出",
	"显示 {0} 输出通道",
	"显示 {0} 输出通道",
	"管理扩展",
	"在 1750ms 后终止了 onWillSaveTextDocument 事件",
	"{0}: {1}",
	...
	"扩展“{0}”从工作区删除了 {1} 个文件夹",
	"扩展“{0}”更改了工作区中的文件夹",
	"状态栏条目的标识符。在扩展中必须具有唯一性。调用 \"vscode.window.createStatusBarItem(id, ...)\"-API 时必须使用相同的值",
	"条目名称，例如“Python 语言指示器”、“Git 状态”等。尽量使名称长度保持较短，但其描述性足以让用户了解状态栏项包含的内容。",
	"要为该条目显示的文本。可以使用 \"$(<name>)\" 语法(例如 \"Hello $(globe)!\")在文本中嵌入图标",
	"条目的工具提示文本。",
	"点击状态栏条目时要执行的命令。",
	"状态栏条目的对齐方式。",
	"状态栏条目的优先级。值越高，意味着应在左侧显示更多项。",
	...
	"在此视图中调用辅助功能帮助对话框时，此内容将作为 markdown 字符串呈现给用户。当以 <keybinding:commandId> 格式提供时，将解析键绑定。如果没有键绑定，则会指示该键绑定，并且此命令将包含在快速检查中，以便于配置。",
	"视图中的嵌套组",
	"与此视图关联的远程类型的名称",
	"向编辑器提供视图",
	"向活动栏中的“资源管理器”容器提供视图",
	...
	"向活动栏中的“源代码管理”容器提供视图",
	"向活动栏中的“测试”容器提供视图",
	"向活动栏中的 Remote 容器提供视图。要提供给此容器，必须启用 \"contribViewsRemote\" API 建议。",
	"向活动栏中的 Agent Sessions 容器提供视图。要提供给此容器，必须启用 \"chatSessionsProvider\" API 建议。",
	"向“提供的视图”容器提供视图",
	"视图容器必须为数组",
	...
	"视图容器 \"{0}\" 需要 \"enabledApiProposals: [\"chatSessionsProvider\"]\"。",
	...
	"辅助功能设置",
	"高级设置在设置编辑器中默认隐藏，除非用户选择显示高级设置。",
	"实验性设置可能会发生变更，且可能在未来版本中移除。",
	"预览设置可在新功能最终确定前用于试用这些功能。",
	"遥测设置",
	"使用联机服务的设置",
	"设置所属的标签列表。然后可以在设置编辑器中搜索到该标签。例如，指定 `experimental` 标签后，可以通过搜索 `@tag:experimental` 找到该设置。",
	...
	"URL 处理程序",
	"正在向“{0}”进行身份验证",
	"向“{0}”进行身份验证时遇到问题?是否要尝试其他方式?({1})",
	"尚未完成向“{0}”进行身份验证。是否要尝试其他方式?({1})",
	"在已打开的浏览器窗口中完成身份验证。",
	"未显示 {0} 个进一步的错误和警告。",
	"无法加载测试运行程序。",
	"路径 {0} 未指向有效的扩展测试运行程序。",
	...
	"策略诊断",
	"屏幕录制模式",
	"控制屏幕录制模式叠加的垂直偏移,从底部作为工作台高度的百分比。",
	"控制屏幕录制模式键盘的字体大小(以像素为单位)。",
	"用于在屏幕录制模式下自定义键盘覆盖的选项。",
	"显示原始键。",
	"显示键盘快捷方式。",
	"显示命令名称。",
	"显示命令时，同时也显示命令组名称。",
	"显示单个编辑器光标移动命令。",
	"控制屏幕录制模式下键盘覆盖显示的时长(以毫秒为单位)。",
	"控制屏幕录制模式下鼠标指示器的十六进制(#RGB、#RGBA、#RRGGBB 或 #RRGGBBAA)的颜色。",
	"控制屏幕录制模式下鼠标光标的大小(以像素为单位)。",
	"键盘快捷方式参考",
	"键盘快捷方式参考(&&K)",
	"视频教程",
	"视频教程(&&V)",
	...
	"配置编辑器",
	"分离已固定编辑器选项卡",
	"控制固定的编辑器选项卡是否在未固定的选项卡上方呈单独一行显示。",
	"切换禅模式",
	"禅模式",
	"切换菜单栏",
	"菜单栏(&&B)",
	...
	"切换树粘滞滚动",
	"切换树粘滞滚动(&&T)",
	"切换树结构顶部的粘滞滚动小组件，例如文件资源管理器和“调试变量”视图。",
	"导航到左侧视图",
	"导航到右侧视图",
	"导航到上方视图",
	"导航到下方视图",
	...
	"将焦点放在通知横幅上",
	"使用 {0} 检查辅助视图中的响应",
	"通过命令“打开辅助视图”在辅助视图中检查响应，该命令当前无法通过键绑定触发",
	"{0}，通知 {1}",
	"{0}，通知",
	"{0}，源: {1}，通知 {2}",
	"{0}，源: {1}，通知",
	...
	"帮助(&&H)",
	"首选项",
	"为你启用了辅助功能支持。对于最易于访问的体验，我们建议使用自定义菜单样式。",
	"打开设置",
	"聚焦应用程序菜单",
	"检查更新(&&U)...",
	"正在检查更新...",
	...
	"未选中",
	"没有可提供视图数据的已注册数据提供程序。",
	"ID 为 {0} 的树状视图是否启用全部折叠。",
	"ID 为 {0} 的树状视图是否启用刷新。",
	"刷新",
	"全部折叠",
	"ID 为 {0} 的树状视图是否切换为全部折叠。",
	"运行命令 {1} 错误: {0}。这可能是由提交 {1} 的扩展引起的。",
	"更多筛选器...",
	"已展开的视图窗格容器的图标。",
	"已折叠的视图窗格容器的图标。",
	"{0}操作",
	"使用 Alt+F1 获取辅助功能帮助 {0}",
	"视图",
	"向上移动视图",
	"向左移动视图",
	"向下移动视图",
	...
	"我们已你的计算机上启动 {0}。\r\n\r\n如果 {1} 未启动，请在下面重试。",
	"全部完成。现在可以关闭此选项卡。",
	"将浏览器配置为用于在外部打开 http 或 https 链接。这可以是浏览器的名称(“edge”、“chrome”、“firefox”)或浏览器可执行文件的绝对路径。如果未设置，则将使用系统默认值。",
	"默认大小。",
	"增加大小，以便更轻松地通过鼠标抓取。",
	...
	"水平滚动条将始终可见。",
	"水平滚动条将始终隐藏。",
	"控制编辑器标题区域中用于选项卡和面包屑的滚动条的可见性。",
	"每个编辑器在编辑器标题区域显示为选项卡。",
	"活动编辑器在编辑器标题区域显示为单个大选项卡。",
	"未显示编辑器标题区域。",
	"控制打开的编辑器是否显示为单个选项卡还是一个大选项卡，或者标题区域是否应显示。",
	"当 {0} 设置为 {1} 时，在窗口标题栏中显示编辑器操作。否则，编辑器操作将显示在编辑器选项卡栏中。",
	"在窗口标题栏中显示编辑器操作。如果 {0} 设置为 {1}，则隐藏编辑器操作。",
	"未显示编辑器操作。",
	"控制显示编辑器操作的位置。",
	"控制是否始终显示编辑器操作(即使编辑器组不处于活动状态)。",
	"控制当超出可用空间时，选项卡是否应在多行之间换行，或者是否应显示滚动条。如果未将 {0} 设置为 {1}，则会忽略此值。",
	"控制在滚动到选项卡上方时是否打开这些选项卡。默认情况下，选项卡仅在鼠标滚动时呈现，但不打开。可通过在滚动时按住 Shift 键来更改滚动期间的此行为。如果未将 {0} 设置为 {1}，则会忽略此值。",
	"控制是否在具有未保存更改的编辑器的选项卡上绘制顶部边框。如果未将 {0} 设置为 {1}，则会忽略此值。",
	"控制编辑器文件修饰是否应使用徽章。",
	"控制编辑器文件修饰是否应使用颜色。",
	"控制是否应应用自定义工作台编辑器标签。",
	"控制编辑器标签的呈现。每个 __Item__ 都是与文件路径匹配的模式。同时支持相对文件路径和绝对文件路径。相对路径必须包含 WORKSPACE_FOLDER (例如 `WORKSPACE_FOLDER/src/**.tsx` or `*/src/**.tsx`)。绝对模式必须以 `/` 开头。如果多个模式匹配，则将选取最长匹配路径。每个 __Value__ 都是 __Item__ 匹配时呈现的编辑器的模板。根据上下文替换变量:",
	"`${dirname}`: 文件所在的文件夹的名称(例如 `WORKSPACE_FOLDER/folder/file.txt -> folder`)。",
	"`${dirname(N)}`: 文件所在的第 n 个父文件夹的名称(例如 `N=2: WORKSPACE_FOLDER/static/folder/file.txt -> WORKSPACE_FOLDER`)。可以使用负数来从路径开头选取文件夹(例如 `N=-1: WORKSPACE_FOLDER/folder/file.txt -> WORKSPACE_FOLDER`)。如果 __Item__ 是绝对模式路径，则第一个文件夹(`N=-1`)将引用绝对路径中的第一个文件夹，否则它对应于工作区文件夹。",
	"`${filename}`: 没有文件扩展名的文件的名称(例如 `WORKSPACE_FOLDER/folder/file.txt -> file`)。",
	"`${extname}`: 文件扩展名(例如 `WORKSPACE_FOLDER/folder/file.txt -> txt`)。",
	"`${extname(N)}`: 由 \".\" 分隔的的第 n 个文件扩展名(例如 `N=2: WORKSPACE_FOLDER/folder/file.ext1.ext2.ext3 -> ext1`)。可以使用负数来从扩展的开头选取扩展(例如 `N=-1: WORKSPACE_FOLDER/folder/file.ext1.ext2.ext3 -> ext2`)。",
	"示例: `\"**/static/**/*.html\": \"${filename} - ${dirname} (${extname})\"` 将文件 `WORKSPACE_FOLDER/static/folder/file.html` 呈现为 `file - folder (html)`。",
	"模式匹配时应呈现的模板。可能包括变量 ${dirname}、${filename} 和 ${extname}。",
	...
	"启用后，当编辑器语言与检测到的内容语言不匹配时，显示状态栏“快速修复”。",
	"在无标题文本编辑器中显示",
	"在笔记本编辑器中显示",
	"控制编辑器选项卡操作按钮（关闭、取消固定）的位置。如果未将 {0} 设置为 {1}，则会忽略此值。",
	"控制选项卡关闭操作按钮的可见性。",
	"控制选项卡取消固定操作按钮的可见性。",
	"启用后，将显示选项卡索引。如果未将 {0} 设置为 {1}，则会忽略此值。",
	"始终将标签页保持足够大，能够完全显示编辑器标签。",
	"在不能同时显示所有选项卡时，允许选项卡缩小。",
	"使所有选项卡的大小相同，同时允许它们在可用空间不足以同时显示所有选项卡时变小。",
	"控制编辑器选项卡的大小。如果未将 {0} 设置为 {1}，则会忽略此值。",
	"控制将 {0} 大小设置为 {1} 时选项卡的最小宽度。",
	"控制将 {0} 大小设置为 {1} 时选项卡的最大宽度。",
	"控制编辑器选项卡的高度。当 {0} 未设置为 {1}时，也适用于标题控件栏。",
	"固定的选项卡会继承未固定的选项卡的外观。",
	"固定的选项卡将以紧凑形式显示，其中只包含图标或编辑器名称的第一个字母。",
	"固定的选项卡缩小至紧凑的固定大小，显示编辑器名称的各部分。",
	"控制固定的编辑器选项卡的大小。固定的选项卡排在所有打开的选项卡的开头，并且在取消固定之前，通常不会关闭。如果未将 {0} 设置为 {1}，则会忽略此值。",
	"启用后，在所有其他选项卡上方的单独行中显示固定的选项卡。如果未将 {0} 设置为 {1}，则会忽略此值。",
	"使用鼠标中间单击或键盘时，始终阻止关闭固定的编辑器。",
	"使用键盘时阻止关闭固定编辑器。",
	"使用鼠标中间单击时，防止关闭固定的编辑器。",
	"切勿阻止关闭固定编辑器。",
	"控制在使用键盘或鼠标中键单击关闭时是否关闭固定的编辑器。",
	"将活动的编辑器组拆分为若干相等的部分，除非所有编辑器组都已经等为部分。这种情况下，将所有编辑器组拆分为若干相等的部分。",
	"将所有编辑器组拆分为相等的部分。",
	"将活动编辑器组拆分为相等的部分。",
	"拆分编辑器组时控制编辑器组大小。",
	"通过将编辑器或文件放到编辑器区域的边缘，控制是否可以由拖放操作拆分编辑器组。",
	"控制是否可将编辑器拖出窗口以在新窗口中打开。长按 Alt 键，同时拖动以动态切换。",
	"控制是按最近使用的顺序还是从左到右关闭编辑器。",
	"控制是否在打开的编辑器中显示图标。这要求同时启用文件图标主题。",
	"控制在编辑器打开时是否使用预览模式。每个编辑器组最多只能有一个预览模式编辑器。此编辑器在其选项卡或标题标签和“打开编辑器”视图中以斜体显示其文件名。其内容将替换为在预览模式下打开的下一个编辑器。在预览模式编辑器中进行更改将保留它，就像双击其标签或其标签上下文菜单中的“保持打开”选项一样。通过双击从资源管理器打开文件会立即保留其编辑器。",
	"控制通过 Quick Open 打开的编辑器是否显示为预览编辑器。预览编辑器不会保持打开状态，在将其显式设置为保持打开(通过双击或编辑)前将会重用。启用后，在选择前按住 Ctrl 可在非预览模式下打开编辑器。如果未将 {0} 设置为 {1}，则会忽略此值。",
	"控制当从编辑器开始进行代码导航时，编辑器是否保持为预览状态。预览编辑器不会保持打开状态，在将其显式设置为保持打开(通过双击或编辑)前将会重用。如果未将 {0} 设置为 {1}，则会忽略此值。",
	"控制在会话期间显示已打开文件的编辑器是否应在被其他进程删除或重命名时自动关闭。禁用此功能将使编辑器在此类事件中保持打开状态。请注意，从应用程序内删除将始终关闭编辑器，且永远不会关闭具有未保存更改的编辑器以保留数据。",
	"控制编辑器打开的位置。选择 {0} 或 {1} 可分别在当前活动编辑器的左侧或右侧打开。选择 {2} 或 {3} 打开编辑器的位置与当前活动编辑器无关。",
	"控制编辑器在并排打开时(例如从资源管理器)出现的默认位置。默认在当前活动编辑器右侧打开。若更改为 \"down\"，则在当前活动编辑器下方打开。这也会影响编辑器工具栏中的拆分编辑器操作。",
	...
	"通过使用三指水平滑动来切换打开的文件。请注意，“系统首选项”>“触控板”>“更多手势”必须设置为“用两指或三指滑动”。",
	...
	"控制双击选项卡时编辑器组的大小调整方式。如果未将 {0} 设置为 {1}，则会忽略此值。",
	"所有其他编辑器组均已隐藏，当前编辑器组将最大化以占用整个编辑器区域。",
	"该编辑器组通过尽可能缩小所有其他编辑器组来占用尽可能多的空间。",
	"双击选项卡时不会调整编辑器组的大小。",
	...
	"控制面板标题中的活动项是显示为标签还是图标。",
	"控制新工作区中面板(终端、调试控制台、输出、问题)的默认位置。它可以显示在编辑器区域的底部、顶部、右侧或左侧。",
	"控制面板是否以最大化方式打开。它可以始终以最大化方式打开、永不以最大化方式打开或以关闭前的最后一个状态打开。",
	"始终以最大化方式打开面板。",
	"打开面板时，切勿将其最大化。",
	"以关闭面板前的状态打开面板。",
	"控制首次打开的工作区或空窗口中辅助边栏的默认可见性。",
	"默认情况下，辅助边栏是隐藏的。",
	"如果已打开工作区，辅助侧栏默认是可见的。",
	"默认情况下，辅助边栏是可见的。",
	...
	"在主侧栏和辅助侧栏的底部显示活动栏。",
	"在主边栏和辅助边栏中隐藏活动栏。",
	"控制在工作台中单击活动栏图标时出现的行为。如果未将 {0} 设置为 {1}，则会忽略此值。",
	"如果单击的项已可见，则隐藏主边栏。",
	"如果单击的项已可见，则将焦点放在主边栏上。",
	"控制是否显示视图头部的操作项。视图头部操作项可以一直，或是仅当聚焦到和悬停在视图上时显示。",
	"如果扩展请求显示隐藏视图，则改为显示可单击的状态栏指示器。",
	"输出视图",
	"控制在工作台中字体的渲染方式。",
	...
	"使用 json 文件编辑器。",
	"确定默认情况下要使用的“设置”编辑器。",
	"控制执行搜索后和 AI 搜索结果可用后，AI 搜索结果切换是否显示在“设置”编辑器的搜索栏中。",
	...
	"根据 OS 配置减少运动呈现。",
	"控制是否显示标题栏中的导航控件。",
	"控制导航控件是否显示在自定义标题栏中。此设置仅在 {0} 设置为 {1} 时才会生效。",
	"控制是否显示标题栏中的布局控件。",
	"控制布局控件是否显示在自定义标题栏中。仅当 {0} 设置为 {1} 时，此设置才会生效。",
	"显示包含布局选项下拉列表的单个按钮。",
	...
	"`${activeRepositoryName}`: 活动存储库的名称(例如 vscode)。",
	"`${activeRepositoryBranchName}`: 活动存储库中活动分支的名称(例如 main)。",
	"`${activeEditorState}`: 提供有关活动编辑器状态的信息(例如，已修改)。在处于启用了 {0} 的屏幕阅读器模式时，默认情况下会追加此信息。",
	...
	"菜单始终隐藏。",
	"菜单在边栏中显示为紧凑按钮。",
	"菜单在边栏中显示为紧凑按钮。当 {0} 为 {1} 且 {2} 为 {3} 或 {4} 时，将忽略此值。",
	...
	"控制在打开禅模式时是否启用居中布局。",
	"控制打开禅模式是应该显示多个编辑器选项卡、单个编辑器选项卡还是完全隐藏编辑器标题区域。",
	"每个编辑器在编辑器标题区域显示为选项卡。",
	"活动编辑器在编辑器标题区域显示为单个大选项卡。",
	"未显示编辑器标题区域。",
	...
	"活动窗口",
	"指定打开新窗口时要使用的配置文件。如果提供了配置文件名称，则新窗口将使用该配置文件。如果未提供配置文件名称，则新窗口将使用活动窗口的配置文件，如果没有活动窗口，则使用默认配置文件。",
	"窗口中打开的工作区类型:“空”(无工作区)、“文件夹”(单个文件夹)或“工作区”(多根工作区)",
	"工作区中根文件夹的数量",
	"是否有具有未保存更改的工作副本",
	"窗口连接到的远程项的名称；如果未连接到任何远程项，则为空字符串",
	"当前工作区的方案来自虚拟文件系统或空字符串。",
	"当前工作区的方案来自临时文件系统。",
	"根据产品服务的嵌入器标识符(如果已定义)",
	"VS Code 是否在自动化或烟雾测试中运行",
	"主窗口是否处于全屏模式",
	"辅助窗口是否成为焦点",
	"窗口是辅助窗口",
	"活动编辑器是否具有未保存的更改",
	...
	"悬停时状态错误项的背景色。错误项比状态栏中的其他条目更醒目以显示错误条件。状态栏显示在窗口底部。",
	...
	"启用公告，仅在屏幕阅读器优化模式下播放。",
	"禁用公告。",
	"提供有关如何在聚焦终端时访问终端辅助功能帮助菜单的信息。",
	"提供有关如何在聚焦差异编辑器时在其中导航更改的信息。",
	"提供有关如何在聚焦聊天输入时访问聊天帮助菜单的信息。",
	"提供有关如何访问内联编辑器聊天辅助功能帮助菜单的信息，并提供如何在聚焦输入时使用该功能的提示。",
	"介绍如何在辅助视图中打开聊天终端输出。",
	"提供有关如何访问内联完成悬停和辅助视图的信息。",
	"提供有关如何在聚焦行时在键绑定编辑器中更改键绑定的信息。",
	"提供有关在笔记本单元格聚焦时如何聚焦单元格容器或内部编辑器的信息。",
	"提供有关如何在辅助视图中打开悬停的信息。",
	"提供有关如何在辅助视图中打开通知的信息。",
	"在空文本编辑器中提供有关相关操作的信息。",
	"提供有关在 REPL 编辑器处于焦点状态下如何访问 REPL 编辑器辅助功能帮助菜单的信息。",
	"提供有关可在注释小组件或包含注释的文件中执行的操作的信息。",
	"指示差异编辑器何时成为活动编辑器。",
	"提供有关在聚焦调试控制台或运行和调试 viewlet 时如何访问调试控制台辅助功能帮助对话框的信息。请注意，需要重新加载窗口才能使其生效。",
	"提供有关如何在辅助视图中打开演练的信息。",
	"在 keypress 上，关闭辅助视图，将焦点放在调用它的元素上。",
	"提供有关在以输入为焦点时如何访问源代码管理辅助功能帮助菜单的信息。",
	"声音音量百分比(0-100)。",
	"是否应停用位置更改",
	"播放通知前的延迟(以毫秒为单位)。",
	"播放声音之前的延迟(以毫秒为单位)。",
	"当该位置出现警告时，播放通知之前的延迟(以毫秒为单位)。",
	"当该位置出现警告时，播放声音之前的延迟(以毫秒为单位)。",
	"当该位置出现错误时，播放通知之前的延迟(以毫秒为单位)。",
	"当该位置出现错误时，播放声音之前的延迟(以毫秒为单位)。",
	"播放信号 -声音(音频提示)和/或公告(警报) - 活动行出现断点时。",
	"当有效行具有断点时播放声音。",
	"活动行出现断点时播报通知。",
	"活动行包含内联建议时播放声音/音频提示。",
	"当有效行具有内联建议时播放声音。",
	"当有下一个编辑建议时，播放信号音/音频提示和/或公告(警报)。",
	"有下一个编辑建议时播放声音。",
	"有下一个编辑建议时播放声音。",
	"播放信号 -声音(音频提示)和/或公告(警报) - 活动行出现错误时。",
	"当有效行出现错误时播放声音。",
	"活动行出现错误时播报通知。",
	"播放信号 - 声音(音频提示)和/或公告(警报) - 活动行包含可展开的折叠区域时。",
	"当有效行具有可展开的折叠区域时播放声音。",
	"活动行出现可展开的折叠区域时播报通知。",
	"播放信号 -声音(音频提示)和/或公告(警报) - 活动行出现警告时。",
	"当有效行出现警告时播放声音。",
	"活动行出现警告时播报通知。",
	"播放信号 -声音(音频提示)和/或公告(警报) - 活动行出现警告时。",
	"当有效行出现警告时播放声音。",
	...
	"当有效行出现警告时播放声音。",
	"活动行出现警告时播报通知。",
	"播放信号 -声音(音频提示)和/或公告(警报) - 调试程序在断点处停止时。",
	"当调试程序在断点上停止时播放声音。",
	"调试程序在断点上停止时播报通知。",
	"播放信号 -声音(音频提示)和/或公告(警报) - 尝试读取带有包含无内嵌提示的内嵌提示的行时。",
	"尝试读取包含无内嵌提示的内嵌提示的行时播放声音。",
	"尝试读取带有包含无内嵌提示的内嵌提示的行时播报通知。",
	"播放信号 - 声音(音频提示)和/或公告(警报) - 完成任务时。",
	"任务完成时播放声音。",
	"任务完成时播报通知。",
	"播放信号 -声音(音频提示)和/或公告(警报) - 任务失败(非零退出代码)时。",
	"任务失败时播放声音(非零退出代码)。",
	"任务失败(非零退出代码)时播报通知。",
	"播放信号 - 终端命令失败(非零退出代码)或在可访问视图中导航到具有此类退出代码的命令时。",
	"当终端命令失败(非零退出代码)或在可访问视图中导航到具有此类退出代码的命令时，播放声音。",
	"终端命令失败(非零退出代码)或在可访问视图中导航到具有此类退出代码的命令时播报通知。",
	"当终端命令成功(零退出代码)或在可访问视图中导航到具有此类退出代码的命令时，播放信号 - 声音(音频提示)和/或公告(警报)。",
	"当终端命令成功(零退出代码)或在可访问视图中导航到具有此类退出代码的命令时，播放声音。",
	"终端命令成功(零退出代码)或在可访问视图中导航到具有此类退出代码的命令时，播放公告。",
	"播放信号 -声音(音频提示)和/或公告(警报) - 终端快速修复可用时。",
	"当终端快速修复可用时播放声音。",
	"终端快速修复可用时播报通知。",
	"播放信号 -声音(音频提示)和/或公告(警报) - 终端铃声响铃时。",
	"当终端钟响铃时播放声音。",
	"终端钟响铃时播报通知。",
	"当焦点在可访问差异查看器模式下移动到插入行或下一个/上一个更改时播放声音/音频提示。",
	"当焦点移到可访问差异查看器下的已插入行或下一/上一个更改时播放声音。",
	"当焦点在可访问差异查看器模式下移动到修改行或下一个/上一个更改时播放声音/音频提示。",
	"当焦点移到可访问差异查看器下的已修改行或下一/上一个更改时播放声音。",
	"当焦点在可访问差异查看器模式下移动到删除行或下一个/上一个更改时播放声音/音频提示。",
	"当焦点移到可访问差异查看器下的已删除行或下一/上一个更改时播放声音。",
	"在显示包含聊天编辑更改的文件时播放声音/音频提示",
	"在显示包含聊天编辑更改的文件时播放声音",
	"播放信号 -声音(音频提示)和/或公告(警报) - 成功完成笔记本单元格执行时。",
	"在成功完成笔记本单元格执行时播放声音。",
	"成功完成笔记本单元格执行时播报通知。",
	"播放信号 -声音(音频提示)和/或公告(警报) - 笔记本单元格执行失败时。",
	"在笔记本单元格执行失败时播放声音。",
	"笔记本单元格执行失败时播报通知。",
	"播放信号 -声音(音频提示)和/或公告(警报) - 进度过程中发生循环时。",
	"在进行进度时循环播放声音。",
	"在进度进行时循环发出警报。",
	"播放信号 - 声音(音频提示)和/或公告(警报) - 发出聊天请求时。",
	"发出聊天请求时播放声音。",
	"发出聊天请求时播报通知。",
	"收到响应时播放声音/音频提示。",
	"收到响应时播放声音。",
	...
	"语音录制停止时播放声音/音频提示。",
	"语音录制停止时播放声音。",
	"播放信号 - 声音(音频提示)和/或公告(警报) - 清除功能(例如，终端、调试控制台或输出通道)时。",
	"清除功能时播放声音。",
	"清除功能时播报通知。",
	"撤消编辑后播放信号 - 声音(音频提示)和/或通知(警报)。",
	"撤消编辑后播放声音。",
	"撤消编辑后发出通知。",
	"保存编辑后播放信号 - 声音(音频提示)和/或通知(警报)。",
	"保留编辑后播放声音。",
	"保留编辑后发出通知。",
	"播放信号 - 声音(音频提示)和/或公告(警报) - 保存文件时。",
	"保存文件时播放声音。",
	"当用户显式保存文件时播放声音。",
	"每次保存文件(包括自动保存)时播放声音。",
	"从不播放声音。",
	"保存文件时播报通知。",
	"当用户显式保存文件时，将报出。",
	"每当保存文件(包括自动保存)时，都会报出。",
	"从不播放公告。",
	"播放信号 -声音(音频提示)和/或公告(警报) - 设置文件或笔记本的格式时。",
	"在格式化文件或笔记本时播放声音。",
	"在用户显式保存文件时播放声音。",
	"每次格式化文件(包括将其设置为在保存、键入、粘贴或运行单元格时格式化)时播放声音。",
	"从不播放声音。",
	"格式化文件或笔记本时播报通知。",
	"用户显式格式化文件时播报通知。",
	"每次文件格式化时(包括在将文件设置为在保存、键入、粘贴或运行单元格时格式化)，发出公告。",
	"从不报出。",
	"当聊天中需要用户操作时，播放信号 - 声音(音频提示)和/或通知(警报)。",
	"在聊天中需要用户操作时播放声音。",
	"附加屏幕阅读器时，启用声音。",
	"在聊天中需要用户操作时发出通知 - 包括有关操作与如何执行操作的信息。",
	"控制是否应在工作台中向链接添加下划线。",
	"控制是否应在调试监视视图中公布变量更改。",
	"控制是否将宣布来自本机 REPL 中执行的输出。",
	"控制执行代码时是否应自动将焦点发送到 REPL。",
	"控制在屏幕阅读器模式下是否应针对屏幕阅读器优化 {0}。启用后，窗口标题会将 {1} 追加到末尾。",
	"控制在聊天代理对文件应用编辑后是否应打开文件。",
	"控制是否应在聊天请求进行过程中发出详细的进度公告，包括 <search term> 的搜索文本(具有 X 个结果)、创建的文件 <file_name> 或读取文件 <file path> 等信息。",
	"是否将未聚焦的编辑器和终端变暗，这可以更清楚地说明键入的输入将转到何处。这适用于大多数编辑器，但使用 iframe(如笔记本和扩展 Web 视图编辑器)的编辑器除外。",
	"不透明度分数 (0.2 到 1.0) 用于未聚焦的编辑器和终端。这仅在启用 {0} 时生效。",
	"控制是否隐藏辅助视图。",
	"停止说话后语音识别保持活动状态的持续时间（以毫秒为单位）。例如，在聊天会话中，超时后自动提交听录文本。设置为“0”以禁用此功能。",
	"是否忽略文本到语音转换合成中的代码片段。",
	"文本转语音和语音转文本应使用的语言。如果可能，请选择 `auto` 以使用所配置的显示语言。请注意，语音识别与合成器并不支持所有显示语言。",
	"启用该功能。启用屏幕阅读器后，请注意，这将禁用 aria 更新。",
	"禁用该功能。",
	"在将语音用作输入时，是否应自动大声朗读文本响应。例如在聊天会话中，当语音用作聊天请求时，将会自动合成响应。",
	"自动(使用显示语言)",
	"检测到屏幕阅读器使用情况。是否要启用 {0} 以针对屏幕阅读器使用情况优化编辑器？",
	"是",
	"否",
	"了解详细信息",
	"已为屏幕阅读器优化",
	...
	"({0}) {1}",
	"{0} 辅助功能详细程度现已禁用",
	"浏览禁用此提示 (Shift+Tab) 等操作，使用 Esc 退出此对话框。",
	"浏览禁用此提示 (Shift+Tab )等操作。",
	"辅助功能帮助",
	"辅助视图",
	"辅助视图。{0}",
	"辅助功能帮助，{0}",
	...
	"接受内联完成",
	"帮助: 列出信号声音",
	"列出所有辅助功能声音、噪音或音频指示并配置其设置",
	"配置声音",
	"选择要播放和配置的声音",
	"帮助: 列出信号公告",
	"列出所有辅助功能公告、警报和盲文消息并配置其设置",
	"配置公告",
	"选择要配置的公告",
	"屏幕阅读器处于非活动状态，默认禁用公告。",
	"差异编辑器",
	...
	"选择要移除的动态身份验证提供程序",
	"确定要移除动态身份验证提供程序“{0}”吗?",
	"确定要移除 {0} 动态身份验证提供程序：{1}吗?",
	"这将移除所选提供程序的所有存储的身份验证数据。如果再次使用这些提供程序，则需要重新进行身份验证。",
	"移除",
	"管理帐户的受信任扩展",
	"帐户",
	"查看扩展详细信息",
	...
	"应用",
	"放弃",
	"调用代码操作(如重命名操作)，在此处查看其更改的预览。",
	"无法应用重构，因为“{0}”在此期间进行了修改。",
	"无法应用重构，因为其他 {0} 个文件在此期间进行了修改。",
	"其他",
	"批量编辑",
	"将{0}重命名为{1}，同时进行文本编辑",
	"创建{0}，同时进行文本编辑",
	...
	"聊天界面未准备就绪。",
	"无需聊天确认",
	"快速聊天视图由输入框和请求/响应列表组成。输入框用于发出请求，列表用于显示响应。",
	...
	"若要移除附加的上下文，请聚焦附件并按 Delete 或 Backspace。",
	"在输入框中，在辅助视图 {0} 中检查最后一个响应。",
	"若要聚焦聊天请求和响应列表，请调用“聚焦聊天”命令 {0}。这会将焦点移动到最近的响应，然后就可以使用向上和向下箭头键进行浏览。",
	"若要返回到聚焦的上一个聊天响应，请调用“聚焦上个聚焦的聊天响应”命令 {0}。",
	...
	"若要导航到对话中的下一个用户提示，请调用“下一个用户提示”命令 {0}。",
	"若要导航到对话中的上一个用户提示，请调用“上一个用户提示”命令 {0}。",
	"若要聚焦待定聊天确认对话框，请调用“聚焦聊天确认状态”命令{0}。",
	"如果有任何隐藏的聊天终端，可以通过调用“查看隐藏聊天终端”命令 {0} 来查看它们。",
	"若要聚焦运行工具的上一个聊天终端，请调用“聚焦最近聊天终端”命令{0}。",
	"若要聚焦上一个聊天终端工具的输出，请调用“聚焦最近聊天终端输出”命令 {0}。",
	"若要创建新的聊天会话，请调用“新建聊天”命令{0}。",
	"聊天代理视图用于跨工作区中的文件应用编辑、在终端中启用运行命令等。",
	"聊天编辑视图用于跨文件应用编辑。",
	"它由输入框和文件工作集 (Shift+Tab) 组成。",
	"发出请求时，在应用编辑时将播放进度指示器。",
	"应用编辑后，将播放声音以指示文档已打开并且可供审阅。可以使用 accessibility.signals.chatEditModifiedFile 禁用声音。",
	"通过导航上一个{0} 和下一个{1} 在编辑器中的编辑之间导航",
	"在编辑器中，保留{0}、撤消{1}或切换当前更改的差异{2}。",
	"接受或撤消更改时，将播放声音。可以使用 accessibility.signals.editsKept 和 accessibility.signals.editsUndone 禁用声音。",
	"警报将指示何时需要用户操作。例如，如果代理想要在终端中运行某些内容，你将听到“所需操作: 在终端中运行命令”。",
	"要执行此操作，请使用 accept tool 命令{0}。",
	"要自动批准工具操作而无需手动确认，请在设置中将 {0} 设置为 {1}。",
	"要接受工具操作，请使用“接受工具确认”命令{0}。",
	"默认情况下，对文件进行编辑时，这些文件将被打开。若要更改此行为，请在设置中将 accessibility.openChatEditedFiles 设置为 false。",
	"一些有用的命令包括:",
	"- 撤消编辑{0}。",
	"- 附加文件{0}。",
	"- 从工作集{0} 中删除文件。",
	...
	"可通过代码操作激活，也可直接使用“内联聊天: 启动内联聊天”命令 ({0}) 激活。",
	"在输入框中，使用“显示上一条{0}”和“显示下一条{1}”来浏览请求历史记录。编辑输入，并使用 Enter 或“提交”按钮来运行新请求。",
	"在输入框中，在辅助视图 {0} 中检查响应。",
	"弹出菜单操作可以运行前缀为 /. Type / 的请求，以发现此类现成命令。",
	"如果调用了修复操作，则响应将指示当前代码的问题。将呈现差异编辑器，并且可以使用 Tab 键访问该编辑器。",
	"进入差异编辑器后，使用 ({0}) 进入评审模式。使用向上和向下箭头导航包含建议的更改的行。",
	"使用选项卡访问命令、状态、消息响应等条件部分。",
	"可通过带有 signals.chat 前缀的设置更改辅助功能信号。默认情况下，如果请求超过 4 秒，你将听到一个声音，指示仍在进行中。",
	"聊天",
	"打开聊天",
	"打开聊天({0})",
	"切换聊天",
	...
	"你已达到每月聊天消息配额。你仍然可以使用免费内联建议。",
	"你已达到每月内联建议配额。你仍然可以使用免费聊天消息。",
	"你已达到每月聊天消息配额和内联建议配额。",
	"限额将于 {0} 重置。",
	"升级到 GitHub Copilot Pro (前 30 天免费)以获取:\r\n- 无限制内联建议\r\n- 无限制聊天消息\r\n- 访问高级模型",
	...
	"切换智能体将结束当前编辑会话。",
	"启动新会话?",
	"更改智能体将结束当前编辑会话。是否要更改智能体?",
	"是",
	"生成代码",
	"默认显示视图",
	"管理工具审批",
	"编辑/管理 AI 聊天智能体的工具审批和确认首选项。",
	undefined,
	undefined,
	undefined,
	undefined,
	...
	"这将删除所有后续请求，并撤消对 {0} 所做的编辑。是否继续?",
	"这将删除所有后续请求，并撤消对工作集中的 {0} 文件所做的编辑。是否继续?",
	"是否要撤消上次编辑？",
	"是否要撤消 {0} 编辑？",
	"是",
	"不再询问",
	...
	"是否要重试上一个请求?",
	"这将撤消自此请求以来对 {0} 所做的编辑。",
	"这将撤消自此请求以来对工作集中的 {0} 文件所做的编辑。是否继续?",
	"是",
	"不再询问",
	"插入笔记本",
	"接受",
	...
	"仅此聊天会话配置了所选工具。",
	"为此自定义智能体选择工具",
	"所选工具由“{0}”自定义智能体配置。对工具的更改也将应用于自定义智能体文件。",
	"为此自定义智能体选择工具",
	"所选工具由“{0}”自定义智能体配置。对工具的更改将仅应用于本会话，并且不会更改 \"{0}\" 自定义智能体。",
	"选择可用于聊天的工具。",
	"所选工具将全局应用于使用默认智能体的所有聊天会话。",
	...
	"用户定义的工具集",
	"添加工具以进行聊天",
	"已启用 {0} 个工具。超过 {1} 个工具时，可能会遇到工具调用降级。",
	"添加 MCP 服务器...",
	"安装扩展...",
	"配置工具集...",
	"配置工具",
	...
	"控制命令中心是否显示用于控制聊天的操作菜单(需要 {0})。",
	"允许自动将活动编辑器用作指定聊天位置的聊天上下文。",
	"隐式上下文的值。",
	"从不启用隐式上下文。",
	"已为第一次交互启用隐式上下文。",
	"始终启用隐式上下文。",
	"控制是否显示新的隐式上下文流。在“询问和编辑”模式下，上下文将自动包含在内。使用智能体时，将以附件的形式建议上下文。选择内容始终作为上下文包含在内。",
	"自动接受聊天所做的更改之后的延迟。值以秒为单位，“0” 表示禁用，最大值为 “100” 秒。",
	"是否在删除请求及其关联的编辑之前显示确认消息。",
	"是否在重试请求及其关联的编辑之前显示确认消息。",
	"此设置已弃用。请改用“chat.detectParticipant.enabled”。",
	"为 panel 聊天启用聊天参与者自动删除功能。",
	"为 panel 聊天启用聊天参与者自动删除功能。",
	"控制是否应在聊天输入中呈现相关文件。",
	"控制在窗口未处于焦点且需要确认时，聊天会话是否应向用户呈现 OS 通知。这包括窗口徽章和通知横幅。",
	...
	"控制在聊天工具请求时哪些 URL 会得到自动批准。键是 URL 模式，值可以是 `true` 以表示批准请求和响应，可以是 `false` 以表示拒绝，还可以是包含 `approveRequest` 和 `approveResponse` 属性的对象，以用于进行细粒度控制。\r\n\r\n示例:\r\n- `\"https://example.com\": true` - 批准对 example.com 的所有请求\r\n- `\"https://*.example.com\": true` - 批准对 example.com 任意子域的所有请求\r\n- `\"https://example.com/api/*\": { \"approveRequest\": true, \"approveResponse\": false }` - 批准对 example.com/api 路径的请求，但不批准响应",
	"控制哪些工具有资格获得自动批准。设置为 `false` 的工具将始终提出确认，且从不提供自动批准选项。默认行为(或将工具设置为 `true`)可能使工具提供自动批准选项。",
	undefined,
	...
	undefined,
	undefined,
	"控制在窗口未处于焦点且接收到响应时，聊天会话是否应向用户呈现 OS 通知。这包括窗口徽章和通知横幅。",
	"在聊天中启用检查点。使用检查点可以将聊天还原到以前的状态。",
	"控制是否显示聊天检查点文件更改。",
	"控制对已安装的模型上下文协议服务器的访问。",
	"无法访问 MCP 服务器。",
	"允许访问 VS Code 连接到的注册表中安装的 MCP 服务器。",
	"允许访问任何已安装的 MCP 服务器。",
	"控制在提交聊天消息时是否应自动启动 MCP 服务器。",
	"绝不要自动启动 MCP 服务器。",
	"仅自动启动从未运行过的新 MCP 服务器。",
	"自动启动尚未运行的新的和过时的 MCP 服务器。",
	"配置向 MCP 服务器公开哪些模型以进行采样(在后台发出模型请求)。可以在“{0}”命令下以图形方式编辑此设置。",
	"列出服务器",
	...
	"应用编辑时，在代码块药丸形状中显示进度动画。如果禁用，则改为显示进度百分比。",
	undefined,
	undefined,
	undefined,
	"控制代理会话菜单的显示位置。",
	"配置从各种其他应用程序的配置中发现模型上下文协议服务器。",
	"为模型上下文协议(MCP)服务器启用默认商城。",
	...
	"此设置已弃用，将在未来的版本中移除。聊天模式现称为自定义智能体，位于 `.github/agents` 中",
	"使用 AGENTS.MD 文件",
	"控制是否将在工作区根目录中找到的 `AGENTS.MD` 文件中的指令附加到所有聊天请求。",
	"使用嵌套的 AGENTS.MD 文件",
	"控制是否在所有聊天请求中列出在工作区中找到的嵌套 `AGENTS.MD` 文件中的指令。如果 `read` 工具可用，语言模型可以按需加载这些技能。",
	"使用 Claude 技能",
	"控制是否在所有聊天请求中列出在 `.claude/skills` 下的工作区和用户主目录中找到的 Claude 技能。如果 `read` 工具可用，语言模型可以按需加载这些技能。",
	"提示文件建议",
	...
	"控制是否在聊天输入上方显示待办事项列表小组件。启用后，小组件显示智能体创建的待办事项，并随进度更新。",
	"启用后，待办事项工具在只写模式下运行，这要求代理在上下文中记住待办事项。",
	"启用后，待办事项包含实现上下文的详细描述。这会提供更多信息，但同时会使用额外的令牌，可能导致响应变慢。",
	"默认情况下，思考部分将会折叠。",
	...
	undefined,
	undefined,
	"启用后，可折叠的思考部分将根据所选模式添加工具调用。",
	"禁用和隐藏 GitHub Copilot 提供的内置 AI 功能，包括聊天和内联建议。",
	"控制会话说明是否显示在“聊天会话”视图中的第二行上。",
	"控制聊天中是否允许匿名访问。",
	undefined,
	undefined,
	"启用统一 GitHub Copilot 扩展。启用后，所有 GitHub Copilot 功能均通过 GitHub Copilot 聊天助手扩展提供。禁用时，GitHub Copilot 和 GitHub Copilot 聊天助手扩展独立运行。",
	"runSubagent 工具是否能使用自定义智能体。启用后，工具可获取自定义智能体的名称，但必须获得智能体的准确名称。",
	"聊天",
	"使用智能体时每轮次允许的最大请求数。达到限制后，将要求确认以继续。",
	"{0} - {1}",
	"启动新聊天",
	"审批工具的结果",
	...
	"聊天附件资源的完整值，包括方案和路径",
	"重新运行而不使用 {0}{1}",
	"通过登录继续对话。免费帐户每月可获得 50 次高级请求，并可访问更多模型和 AI 功能。",
	"启用更多 AI 功能",
	"查看所有文件更改",
	"查看匹配项",
	"{0}，已展开",
	...
	"(编辑)，编辑工作区中的文件。",
	"(询问)，提问或键入 / 以选择主题。",
	"聊天输入 {0}{1} 按 Enter 键发送请求。使用 {2} 以获取聊天辅助功能帮助。",
	"聊天输入 {0}{1} 按 Enter 键发送请求。有关详细信息，请使用聊天辅助功能帮助命令。",
	"聊天输入 {0}{1}。",
	"搜索要添加到请求的文件和上下文",
	"切换已更改的文件。",
	"已更改 1 个文件",
	...
	"此聊天参与者的全名，显示为来自此参与者的响应的标签。如果未提供，则使用 {0}。",
	"此聊天参与者的说明，显示在 UI 中。",
	"调用命令是否将聊天置于持久模式，其中该命令会自动添加到下一条消息的聊天输入中。",
	"当用户在 `/help` 中单击此参与者时，此文本将提交给参与者。",
	"启用此参与者时必须为 true 的条件。",
	"用于帮助自动将用户问题路由到此聊天参与者的元数据。",
	"此类别的详细名称，例如 `workspace_questions` 或 `web_questions`。",
	"适用于此聊天参与者的问题类型的详细描述。",
	"适用于此聊天参与者的代表性示例问题的列表。",
	"可用于此聊天参与者的命令，用户可使用 `/` 进行调用。",
	"在 UI 中引用此命令时使用的短名称，例如使用 `fix` 或 `explain` 引用可修复问题或解释代码的命令。名称在此参与者提供的命令中应是唯一的。",
	"此命令的说明。",
	"启用命令时必须为 true 的条件。",
	"当用户在 `/help` 中单击此命令时，此文本将提交给该参与者。",
	"用于帮助自动将用户问题路由到此聊天命令的元数据。",
	"此类别的详细名称，例如 `workspace_questions` 或 `web_questions`。",
	"适用于此聊天命令的问题类型的详细描述。",
	"适用于此聊天命令的代表性示例问题的列表。",
	"显示扩展",
	"无法加载聊天，因为安装的 Copilot 聊天扩展版本与此版本的 {0} 不兼容。请确保 Copilot 聊天扩展处于最新状态。",
	"名称",
	"全名",
	"描述",
	"命令",
	...
	"向聊天小组件提供聊天会话集成。",
	"聊天会话类型的唯一标识符。",
	"动态注册的聊天参与者名称(例如: @agent)。不得包含空格。",
	"此项的更长名称，用于在菜单中显示。",
	"用于菜单和工具提示的聊天会话的说明。",
	"此条件必须为 true 才能显示此项。",
	"聊天会话编辑器选项卡的图标标识符(codicon ID)。例如 \"$(github)\" 或 \"$(cloud)\"。",
	"使用浅色主题时的图标路径",
	"使用深色主题时的图标路径",
	"此项的显示顺序。",
	"用于向后兼容的备用标识符。",
	"要在此会话类型的聊天欢迎视图中显示的标题文本。",
	"要在此会话类型的聊天欢迎视图中显示的消息文本(支持 Markdown)。",
	"要在此会话类型的聊天欢迎视图中显示的提示文本(支持 Markdown 和主题图标)。",
	"要在此会话类型的聊天输入框中显示的占位符文本。",
	"适用于此聊天会话的可选功能。",
	"此聊天会话是否支持附加文件或文件引用。",
	"此聊天会话是否支持附加工具或工具引用。",
	"此聊天会话是否支持附加 MCP 资源。",
	...
	"@vscode 如何将主题更改为浅色模式?",
	"创建项目",
	"使用 TypeScript 创建 #new Hello World 项目",
	"生成工作区",
	"如何生成此工作区?",
	"显示配置",
	"此项目的配置是在何处定义的?",
	...
	"始终允许此工具运行而无需确认。",
	"允许此会话中来自 {0} 的工具",
	"允许此服务器中的所有工具在此会话中运行，无需确认。",
	"允许此工作区中来自 {0} 的工具",
	"允许此服务器中的所有工具在此工作区中运行，无需确认。",
	"始终允许来自 {0} 的工具",
	"始终允许此服务器中的所有工具运行，无需确认。",
	"在此会话中允许，无需审核",
	"允许在此会话中发送此工具的结果，无需确认。",
	"在此工作区中允许，无需审核",
	"允许在此工作区中发送此工具的结果，无需确认。",
	"始终允许，无需审核",
	"始终允许发送此工具的结果，无需确认。",
	"允许此会话中来自 {0} 的工具，无需审核",
	"允许在此会话中发送来自此服务器的所有工具的结果，无需确认。",
	"允许此工作区中来自 {0} 的工具，无需审核",
	"允许在此工作区中发送来自此服务器的所有工具的结果，无需确认。",
	"始终允许来自 {0} 的工具，无需审核",
	"始终允许发送来自此服务器的所有工具的结果，无需确认。",
	"继续，无需审核任何工具结果",
	"在未经批准的情况下运行任何工具",
	"仅为此工作区配置",
	"配置会话工具审批",
	...
	"选择要附加的说明文件",
	"配置指令...",
	"在智能体选取器中选择要打开并配置可见性的自定义智能体",
	"配置自定义智能体...",
	undefined,
	"配置自定义智能体...",
	"自定义智能体",
	"是否要使用“设置同步”备份和同步用户提示、指令和自定义智能体文件?",
	"启用",
	"了解详细信息",
	"新建提示文件...",
	"新建指令文件...",
	...
	"外部应用程序想要创建包含 URL 内容的自定义智能体。是否要通过选择目标文件夹和名称继续操作?",
	"是(&&Y)",
	"否",
	"在当前聊天中运行提示",
	"运行提示...",
	"选择要运行的提示文件(按住 {0} 键以在新聊天中使用）",
	"配置提示文件...",
	"提示文件",
	"选择要打开的提示文件",
	"在新聊天中运行提示",
	...
	"要用于 UI 中此工具集的图标。使用 \"\\$(name)\" 语法，如 \"\\$(zap)\"",
	"此工具集的简短说明。",
	"{1} ({0})\r\n\r\n{2}",
	"配置工具集...",
	"工具集",
	...
	"当聊天处于参与的聊天会话中且该会话有可用的“模型”显示时为 True。",
	...
	undefined,
	undefined,
	"聚焦 KaTeX 数学元素时为 true。",
	undefined,
	"聊天编辑小组件中文件的当前状态",
	"聊天编辑代理是否支持对临时) (只读引用",
	"已进行更改。",
	"已清除响应，因为可能与公共代码匹配，请使用修改后的提示重试。",
	...
	"必须为 true 才能在“管理模型”列表中显示此语言模型聊天提供程序的条件。",
	"提供特定供应商的语言模型聊天提供程序。",
	"已注册供应商“{0}”，无法为其注册两次",
	"供应商字段不能为空。",
	"供应商字段不能以空格开头或结尾。",
	"其他模型",
	"为聊天提示提供 {0}。",
	"此文件的标识符。对于此贡献点，在此扩展中必须唯一。",
	"文件相对于扩展根目录的路径。",
	"(可选)文件说明。",
	"扩展 \"{0}\" 无法注册具有无效名称 \"{2}\" 的 {1} 项。",
	"扩展 \"{0}\" 无法注册没有路径的 {1} 项 \"{2}\"。",
	"扩展 \"{0}\" 无法注册没有描述的 {1} 项 \"{2}\"。",
	"扩展 \"{0}\" 的 {1} 项 \"{2}\" 路径解析在扩展之外。",
	"未能注册 {0} 项 \"{1}\": {2}",
	"自动附加为模式为 **",
	"自动附加为模式 {0} 匹配 {1}",
	"已在启用设置 {0} 时自动附加",
	...
	undefined,
	"转接",
	"UI 中显示的指令文件的名称。如果未设置，则名称从文件名派生。",
	"指令文件的说明。它可用于提供有关指令的其他上下文或信息，并传递到语言模型作为提示的一部分。",
	"一个或多个 glob 模式(用逗号分隔)，用于描述指令应用于哪些文件。根据这些模式，当上下文包含与其中一个或多个模式匹配的文件时，该文件会自动包含在提示中。如果希望始终添加此文件，请使用 `**`。\r\n示例: `**/*.ts`、`**/*.js`、`client/**`",
	"智能体在 UI 中显示的名称。",
	"有关自定义智能体及其作用和使用时机的说明。",
	"参数提示描述自定义智能体期望或支持的输入。",
	"指定运行此自定义智能体的模型。",
	"自定义智能体可访问的工具集。",
	"标头属性(如工具)应用的目标。可能的值为 `github-copilot` 和 `vscode`。",
	undefined,
	"提示的名称。这也是将运行此提示的 / 命令的名称。",
	"有关可重用提示及其作用和使用时机的说明。",
	"参数提示描述提示期望或支持的输入。",
	"要在此提示中使用的模型。",
	"要在此提示中使用的工具。",
	"工具集: {0}\r\n\r\n",
	"注意: 当目标是 github-copilot 时，不使用此属性。",
	"- 名称: {0}",
	"- 系列: {0}",
	"- 供应商: {0}",
	"内置智能体",
	...
	"智能体完成任务后可能的转接操作。",
	"注意: 当目标是 github-copilot 时，不使用此属性。",
	"聊天模式已重命名为智能体。请将此文件移动到 {0}",
	"聊天模式已重命名为智能体。请将该文件移动到 {0}",
	"无效的文件引用“{0}”。",
	"在“{1}”中找不到文件“{0}”。",
	"工具或工具集 \"{0}\" 已重命名，请改用 \"{1}\"。",
	...
	"工具或工具集 \"{0}\" 也需要在标头中启用。",
	"提示文件中不支持属性“{0}”。受支持: {1}。",
	"自定义 GitHub Copilot 智能体文件中不支持属性 \"{0}\"。受支持: {1}。",
	"在 VS Code 本地运行时忽略属性 \"{0}\"。",
	"VS Code 智能体文件中不支持属性 \"{0}\"。受支持: {1}。",
	"指令文件中不支持属性“{0}”。受支持: {1}。",
	"\"name\" 属性必须是字符串。",
	"\"name\" 属性不得为空。",
	"\"description\" 属性必须是字符串。",
	"\"description\" 属性不得为空。",
	"\"argument-hint\" 属性必须是字符串。",
	"\"argument-hint\" 属性不得为空。",
	"\"model\" 属性必须是字符串。",
	"\"model\" 属性必须是非空字符串。",
	"未知模型 \"{0}\"。",
	"模型“{0}”不适用于代理模式。",
	"\"mode\" 属性已弃用。改用 \"agent\" 属性。",
	"\"mode\" 属性已弃用。请将其重命名为 \"agent\"。",
	"\"{0}\" 属性必须是字符串。",
	"\"{0}\" 属性必须是非空字符串。",
	"未知智能体 \"{0}\"。可用智能体: {1}。",
	"在使用智能体时仅支持 \"tools\" 属性。将忽略属性。",
	"\"tools\" 属性必须是数组。",
	"\"tools\" 属性中的每个工具名称都必须是字符串。",
	"工具或工具集 \"{0}\" 已重命名，请改用 \"{1}\"。",
	"Tool or toolset '{0}' has been renamed, use the following tools instead: {1}",
	"未知工具 \"{0}\"。",
	"\"applyTo\" 属性必须是字符串。",
	"\"applyTo\" 属性必须是有效的 glob 模式。",
	"\"excludeAgent\" 属性必须是数组。",
	"\"handoffs\" 属性必须是数组。",
	"\"handoffs\" 属性中的每个转接必须是包含 \"label\"、\"agent\"、\"prompt\" 和(可选) \"send\" 的对象。",
	"转接中的 \"label\" 属性必须是非空字符串。",
	"转接中的 \"agent\" 属性必须是非空字符串。",
	"转接中的 \"prompt\" 属性必须是字符串。",
	"转接中的 \"send\" 属性必须是布尔值。",
	undefined,
	"转接对象中的未知属性 \"{0}\"。支持的属性为 \"label\"、\"agent\"、\"prompt\" 和(可选) \"send\"。",
	"转接对象中缺少的必需属性 {0}。",
	undefined,
	"\"target\" 属性必须是字符串。",
	"\"target\" 属性必须是非空字符串。",
	...
	"此工具的易读名称，可用于在 UI 中描述此工具。",
	"可向用户显示的此工具的说明。",
	"语言模型可以使用此工具的说明来选定它。",
	"此工具所接受输入的 JSON 架构。输入必须是顶级对象。特定语言模型可能并不支持所有 JSON 架构功能。有关详细信息，请参阅你正在使用的语言模型系列对应的文档。",
	"如果为 true，则此工具将显示为用户可手动添加到其请求中的附件。聊天参与者将在{0} 中收到该工具。",
	"表示此工具的图标。文件路径、具有深色和浅色主题的文件路径的对象，或主题图标引用，如 \"\\$(zap)\"",
	"使用浅色主题时的图标路径",
	"使用深色主题时的图标路径",
	"要启用此工具时必须为 true 的条件。请注意，即使工具的 `when` 条件为 false，该工具仍可能由另一个扩展调用。",
	"一组标签，大致描述了工具的功能。工具用户可以使用它们将工具集筛选为仅与当前任务相关的工具，或者他们可能需要选择一个标记，用于仅标识此扩展提供的工具。",
	"提供一组可一起使用的语言模型工具。",
	"此工具集的名称。用作引用，不应包含空格。",
	"此工具集的说明。",
	"表示此工具集的图标，如 `$(zap)`",
	"要包含在此工具集中的工具或工具集的列表。不能为空，并且必须通过其 `toolReferenceName` 引用工具。",
	"名称",
	"显示名称",
	"描述",
	"语言模型工具",
	...
	"仅在显式保存时触发代码操作",
	"保存时从不触发代码操作",
	"仅在显式保存时触发代码操作。此值将被弃用，取而代之将使用“显式”。",
	"从不在保存时触发代码操作。此值将被弃用，取而代之将使用“从不”。",
	"仅在显式保存时触发代码操作。",
	"保存时从不触发代码操作。",
	"仅在显式保存时触发代码操作。此值将被弃用，取而代之将使用“显式”。",
	"仅在显式保存时触发代码操作。此值将被弃用，取而代之将使用“从不”。",
	"保存时为编辑器运行代码操作。必须指定代码操作，并且编辑器不能关闭。当 {0} 设置为 `afterDelay` 时，代码操作将仅在显式保存文件时运行。示例: `\"source.organizeImports\": \"explicit\" `",
	"保存时为笔记本运行一系列代码操作。必须指定代码操作，并且编辑器不能关闭。当 {0} 设置为 `afterDelay` 时，代码操作将仅在显式保存文件时运行。示例: `\"notebook.source.organizeImports\": \"explicit\"`",
	"控制是否应在文件保存时运行\"{0}\"操作。",
	"切换屏幕阅读器辅助功能模式",
	"切换优化模式以使用屏幕阅读器、盲文设备和其他辅助技术。",
	"语音",
	"在编辑器中启动听写",
	"在编辑器中停止听写",
	"停止听写({0})",
	"停止听写",
	"运行命令差异编辑器: 切换侧面{0}可在原始编辑器和修改后的编辑器之间切换。",
	"accessibility.verbosity.diffEditorActive 设置控制在差异编辑器成为活动编辑器时是否会发布差异编辑器公告。",
	"在一个差异编辑器的窗格中。",
	"在针对屏幕阅读器优化的差异审阅模式下查看下一个{0}或上一个{1}差异。",
	"若要控制应播放哪些辅助功能信号，可以配置以下设置: {0}。",
	"显示空白差异",
	"差异算法已提前停止(在 {0} ms 之后)",
	"删除限制",
	"禁用空编辑器提示",
	"[[生成代码]]({0})，或[[选择语言]]({1})。开始输入以关闭或[[不再显示]]此信息。",
	"[[选择语言]]({0})以开始使用。开始输入以关闭或[[不再显示]]此信息。",
	"执行 {0} 以提出问题，执行 {1} 以选择语言并开始使用。开始输入以关闭。",
	"执行 {0} 以选择语言并开始使用。开始输入以关闭。",
	" 在设置中切换 {0} 以禁用此提示。",
	"查找",
	"查找",
	"上一个匹配项",
	...
	"包含存在问题的元素",
	"转到行/列...",
	"键入要转到的行号和可选列(例如，42:5 表示第 42 行和第 5 列)。输入 :: 可跳转到字符偏移位置(例如，::1024 表示从文件开头起第 1024 个字符)。使用负值可向后导航。",
	"转到行/列",
	"转到偏移...",
	"转到偏移",
	"无匹配项",
	...
	"编辑器概述标尺修饰颜色，用于草稿评论的评论线程。此颜色应不透明。",
	"编辑器装订线中评论字形的装饰颜色。",
	"编辑器装订线修饰颜色，用于注释未解析注释线程的字形。",
	"编辑器装订线修饰颜色，用于草稿评论的评论线程的评论字形。",
	"切换反应",
	"切换评论反应失败: {0}。",
	"切换评论反应失败",
	"未能删除评论回应: {0}。",
	...
	"评论视图永远不会打开。",
	"评论视图将在具有评论的文件处于活动状态时打开。",
	"如果在此会话期间尚未打开评论视图，则它将在带评论文件处于活动状态的会话期间首次打开。",
	...
	"控制注释小组件是滚动还是展开。",
	"控制解析线程时注释线程是否应折叠。",
	"折叠带有未提交注释的注释线程时显示确认对话框。",
	"折叠注释线程时从不显示确认对话框。",
	"控制折叠注释线程时是否显示确认对话框。",
	"{0} 未解析的注释",
	"编辑器包含可批注的范围。一些有用的命令包括:",
	"此小组件包含一个文本区域，用于撰写新注释和操作，该文本区域可在选项卡移动焦点模式后使用“切换 Tab 键移动焦点”命令{0}启用。",
	"一些有用的注释命令包括:",
	"- 消除注释(Escape)",
	"- 转到下一个注释范围{0}。",
	"- 转到上一个注释范围{0}。",
	...
	"行 {0}",
	"第 {0} 到 {1} 行",
	"编辑器有注释范围，有关详细信息，请运行“打开辅助功能帮助”({0}) 命令。",
	"编辑器具有注释范围，有关详细信息，请运行当前无法通过键绑定触发的“打开辅助功能帮助”命令。",
	"编辑器具有注释范围。",
	"光标必须在评论范围内才能添加评论。",
	"此文件上不允许有文件注释。",
	"选择评论提供程序",
	...
	"在注释聚焦时设置",
	"是否启用批注功能",
	"无法在此窗口中打开编辑器，它包含只能保存在原始窗口中的修改。",
	"在原始窗口中打开",
	"无法移动“{0}”: 编辑器包含只能保存在其当前窗口中的更改。",
	"内置",
	...
	"当前断点堆栈帧的图标颜色。",
	"所有断点堆栈帧的图标颜色。",
	"断点命中时记录的消息。{} 内的表达式将被替换。按 \"{0}\" 键确认，\"{1}\" 键取消。",
	"在满足命中次数条件时中断。按 \"{0}\" 键确认，\"{1}\" 键取消。",
	"在表达式结果为真时中断。按 \"{0}\" 键确认，\"{1}\" 键取消。",
	"表达式",
	"命中次数",
	"日志消息",
	"等待断点",
	...
	"在表达式结果为 true 时中断",
	"类型表达式。表达式计算结果为 true 时，数据断点将中断",
	"在到达命中次数时中断",
	"类型命中次数。达到命中次数时，数据断点将中断。",
	"类型异常断点条件",
	"在表达式结果为 true 时中断",
	"断点",
	"已禁用的记录点",
	...
	"选择要监视的访问类型",
	"输入要中断的内存范围",
	"地址(0x1234 - 0x1300)后的绝对范围(0x1234 + 0xff)或字节范围",
	"地址应为数字范围，格式为“[起始] - [结束]”或“[起始] + [字节]”",
	"数字必须是以 \"0x\" 开头的十进制整数或十六进制值，已获取 {0}",
	undefined,
	"在地址处添加数据断点",
	"数据(&&D)断点...",
	"编辑地址...",
	...
	"调试会话期间在变量窗格中显示变量类型",
	"允许在任何文件中设置断点。",
	"控制要在使用鼠标中键单击编辑器装订线时执行的操作。",
	"添加记录点。",
	"添加条件断点。",
	"添加触发的断点。",
	"不要执行任何操作。",
	"在调试会话结束时自动打开资源管理器视图。",
	"调试会话结束时，与该会话关联的所有只读选项卡都将关闭",
	"当处于调试过程中时，在编辑器中内联显示变量值。",
	"在调试时，始终在编辑器中内联显示变量值。",
	"在调试时，绝不在编辑器中内联显示变量值。",
	"如果语言支持内联值位置，则在调试时在编辑器中内联显示变量值。",
	"控制调试工具栏的位置。在所有视图中“浮动”、在调试视图中“停靠”、“commandCenter”(需要 {0})或“hidden”。",
	"在所有视图中显示调试工具栏。",
	"仅在调试视图中显示调试工具栏。",
	"“(实验)”在命令中心显示调试工具栏。",
	"不显示调试工具栏。",
	...
	"{0}，运行当前无法通过键绑定触发的“打开辅助功能帮助”命令。",
	"调试会话",
	"不可省略调试器的 \"type\" 属性，且其类型必须是 \"string\" 。",
	"配置名称；显示在启动配置下拉菜单中。",
	...
	"已禁用的日志断点的图标。",
	"未验证的日志断点的图标。",
	"在编辑器字形边距中悬停时显示的断点提示的图标。",
	"不受支持的断点的图标。",
	"编辑器字形边距中显示的堆栈帧的图标。",
	"编辑器字形边距中显示的具有焦点的堆栈帧的图标。",
	"调试条控制手柄的图标。",
	"“调试重启帧”操作的图标。",
	"“调试停止”操作的图标。",
	"“调试断开”操作的图标。",
	...
	"{0}个活动会话",
	"调试会话仍在运行，该会话将终止。",
	"运行会从你的工作区执行生成任务和程序代码。",
	"调试从你的工作区执行生成任务和程序代码。",
	"复合项必须拥有 \"configurations\" 属性集，才能启动多个配置。",
	"在工作区中找不到启动配置“{0}”。",
	"工作区中存在多个启动配置“{0}”。请使用文件夹名称来限定配置。",
	"无法在复合项“{2}”中为配置“{1}”找到名为“{0}”的文件夹。",
	"\"launch.json\" 中缺少配置“{0}”。",
	"传递的工作区文件夹没有 \"launch.json\"。",
	"所选调试配置的属性“{0}”的值“{1}”不受支持。",
	"所选的调试配置缺少属性“{0}”。",
	"配置的类型“{0}”不受支持。",
	"所选的启动配置缺少属性 \"type\"。",
	"安装 {0} 扩展",
	...
	"记住我在用户设置中的选择",
	"记住我对此任务的选择",
	"无法在其他工作区文件夹的启动配置中引用任务“{0}”。",
	"找不到任务“{0}”。",
	"找不到指定的任务。",
	"任务“{0}”尚未退出，并且未定义“problemMatcher”。请确保为监视任务定义问题匹配器。",
	"正在等待 preLaunchTask“{0}”...",
	"配置任务",
	"更多...",
	"后退",
	"反向",
	...
	"复制",
	"聚焦到“调试控制台”视图",
	"调试控制台是一个 Read-Eval-Print-Loop，可用于计算表达式并运行命令，也可通过 {0} 聚焦。",
	"可以使用“焦点上一个小组件”命令 {0} 从输入字段导航到调试控制台输出。",
	"可以使用“焦点下一个小组件”命令 {0} 从输出导航到调试控制台输入。",
	"可以使用向上和向下箭头键在调试控制台输出历史记录中导航。",
	"“打开可访问视图”命令 {0} 将允许按字符导航控制台输出。",
	"“显示运行”和“调试视图”命令{0}将打开“运行和调试”视图，并提供有关调试的详细信息。",
	"“调试：清除控制台”命令{0}将清除控制台输出。",
	"设置“debug.expandLazyVariables”控制是否自动计算变量。默认情况下，在使用屏幕阅读器时启用此功能。",
	"调试控制台",
	"变量 {0}，值 {1}",
	"，发生了 {0} 次",
	"调试控制台变量 {0}，值 {1}",
	"调试控制器组 {0}",
	"“显示运行和调试”视图命令{0}将打开当前视图。",
	"“调试：启动调试”命令{0}将启动调试会话。",
	"在调试控制台中访问调试输出并计算表达式，调试控制台可以通过{0}进行聚焦。",
	"调试后，以下命令将可用：",
	"-“调试：重新启动调试”命令{0}将重新启动当前调试会话。",
	"-“调试：停止调试”命令{0}将停止当前调试会话。",
	"-“调试：继续”命令{0}将继续执行，直到下一个断点。",
	"-“调试：单步执行”命令{0}将单步执行下一个函数调用。",
	"-“调试：逐过程执行”命令{0}将逐过程执行当前函数调用。",
	"-“调试：单步跳出”命令{0}将单步跳出当前函数调用。",
	"调试 viewlet 由多个视图组成，这些视图可通过以下命令聚焦，也可以通过 tab 键和箭头键导航到：",
	"-“调试：聚焦断点视图”命令{0}会聚焦断点视图。",
	"-“调试：聚焦调用堆栈视图”命令{0}将聚焦调用堆栈视图。",
	"-“调试：聚焦变量视图”命令{0}会聚焦变量视图。",
	"-“调试：聚焦监视视图”命令{0}将聚焦监视视图。",
	"设置 {0} 控制是否公布监视变量更改。",
	...
	"当 \"CALLSTACK\" 视图聚焦时为 true，否则为 false。",
	...
	"焦点会话为“附加”时为 True。",
	"如果在不调试的情况下运行焦点会话，则为 true。",
	"焦点会话支持 \"stepBack\" 请求时为 True。",
	"焦点会话支持 \"restartFrame\" 请求时为 True。",
	"当聚焦堆栈帧支持 \"restartFrame\" 时为 true。",
	"当焦点会话支持 \"jumpToCursor\" 请求时为 True。",
	"焦点会话支持 \"stepIntoTargets\" 请求时为 True。",
	"当至少存在一个断点时为 True。",
	"如果至少有一个调试扩展处于活动状态，则为 True。",
	"如果至少安装并启用了一个调试扩展，则为 True。",
	"表示 \"VARIABLES\" 视图中调试适配器针对焦点变量设置的上下文。",
	"焦点会话支持 \"setVariable\" 请求时为 True。",
	"当重点会话支持地址上的 “getBreakpointInfo” 请求时为 True。",
	...
	"如果重点会话支持暂停调试对象功能，则为 True。",
	"当重点会话支持终止线程功能时为 true。",
	"在焦点变量设置了 “evalauteName” 字段时为 True。",
	"当焦点变量为只读时为 True。",
	"用于调试可视化子句的变量值。",
	"用于调试可视化子句的变量类型。",
	"变量满足的任何接口或协定，用于调试可视化子句。",
	"用于调试可视化子句的变量名称。",
	"变量源的语言，用于调试可视化子句。",
	"变量源的扩展 ID，用于调试可视化子句。",
	"当异常小组件可见时为 True。",
	...
	"当此条件为 true 时，此调试器类型将从调试程序列表中隐藏，但仍处于启用状态。",
	"将此调试类型标记为已弃用的可选消息。",
	"Windows 特定的设置。",
	"用于 Windows 的运行时。",
	"macOS 特定的设置。",
	...
	"安装扩展的理由。这是可用于将任何信息传递给安装处理程序的字符串或对象。即 `{原因: '此扩展要打开 URI'，操作: '打开 URI'}` 将显示一个消息框，其中包含安装时的原因和操作。",
	"启用后，如果安装了该扩展但已将其禁用，则将启用该扩展。如果已启用该扩展，则该操作不起作用。",
	...
	"安装(&&I)",
	"安装扩展 VSIX",
	"已完成安装扩展。请重新加载 Visual Studio Code 以启用它们。",
	"已完成安装扩展。请重新加载 Visual Studio Code 以启用它。",
	"立即重载",
	"已完成安装扩展。请重启扩展以启用它们。",
	"已完成安装扩展。请重启扩展以启用它。",
	"重新启动扩展",
	...
	"\"{0}\" 是来自未知源的扩展。是否确定要安装?",
	"仍然安装",
	"无法安装 \"{0}\" 扩展，因为 {1} 无法验证扩展签名",
	"了解详细信息",
	"仍然安装(不验证签名)",
	"报告问题",
	"扩展签名验证失败: {0}",
	"请在下方包含以下日志:“F1 > 打开视图... > 共享”。\r\n\r\n",
	"更新 \"{0}\" 扩展时出错。",
	"安装 \"{0}\" 扩展时出错。",
	"有关更多详细信息，请查看[日志]({0})。",
	"请尝试手动下载…",
	...
	"此扩展已禁用，因为它不支持虚拟工作区。",
	"此拓展功能受限，因为当前工作区为虚拟。",
	"所有 GitHub Copilot 功能现在均通过 GitHub Copilot 对话助手扩展提供。若要暂时选择退出统一此扩展，请切换 {0} 设置。",
	"当前工作区不受信任，因此已禁用此扩展。",
	...
	"已禁用此扩展，因为它在 {0} web 版中不受支持。",
	"管理访问权限",
	"在“{0}”上安装语言包扩展，使其还在此处启用。",
	"在本地安装语言包扩展，使其还在此处启用。",
	"此扩展在远程扩展主机中被启用，因为这是其首选运行处。",
	"此扩展在本地扩展主机中被启用，因为这是其首选运行处。",
	...
	"扩展视图中“刷新”操作的图标。",
	"扩展视图中“筛选器”操作的图标。",
	"扩展视图中“在远程安装本地扩展”操作的图标。",
	"扩展视图中“安装工作区建议的扩展”操作的图标。",
	"扩展视图中“配置建议的扩展”操作的图标。",
	"用于指示扩展已同步的图标。",
	"用于指示在同步时忽略扩展的图标。",
	"用于在扩展视图和编辑器中指示扩展是远程内容的图标。",
	"扩展视图和编辑器中随安装计数一起显示的图标。",
	"为扩展视图和编辑器中的专用扩展显示的图标。",
	"扩展视图和编辑器中随评级一起显示的图标。",
	"为具有预发布版本的扩展在扩展视图和编辑器中显示的图标。",
	"用于在扩展视图和编辑器中赞助扩展的图标。",
	"扩展编辑器中用于评级的实心星形图标。",
	"扩展编辑器中用于评级的半星图标。",
	"扩展编辑器中用于评级的中空星形图标。",
	...
	"扩展编辑器中随警告消息一同显示的图标。",
	"扩展编辑器中随信息消息一同显示的图标。",
	"扩展编辑器中随工作区信任消息一同显示的图标。",
	"在扩展编辑器中显示带有激活时间消息的图标。",
	"键入扩展名称进行安装或搜索。",
	"按 Enter 以搜索扩展\"{0}\"。",
	"按 Enter 来安装扩展“{0}”。",
	"按 Enter 来管理扩展。",
	...
	"预发布",
	"选择要下载的版本",
	"此扩展的市场元数据已更改，这可能是重新发布所致。",
	"{0} 扩展的更新引入了当前安装的版本中不存在的可执行代码。",
	"提供的对象不是扩展。",
	"报告称该扩展存在问题。",
	"不允许安装此扩展。",
	"此扩展未签名。",
	"无法安装“{0}”扩展，因为它在此安装程序中不可用。",
	"如果此问题仍然存在，请通过 {0} 报告问题",
	"无法安装扩展“{0}”，因为找不到请求的版本“{1}”。",
	"无法安装扩展“{0}”，因为找不到它。",
	"安装扩展(&&I)",
	"安装扩展和 {0}(&&I)",
	"打开扩展",
	...
	"移动到废纸篓(&&M)",
	"删除(&&D)",
	"你删除的文件中具有未保存的更改。是否继续?",
	"你正在删除文件夹 {0}，但其中 1 个文件中有未保存的更改。是否要继续?",
	"你正在删除文件夹 {0}，其中 {1} 个文件中有未保存的更改。是否要继续?",
	"你正在删除具有未保存更改的 {0}。是否要继续?",
	"如果不保存，你的更改将丢失。",
	"你正在删除配置为只读的文件。是否要继续？",
	"正在删除配置为只读的文件夹 {0}。是否要继续？",
	"你正在删除的文件 {0} 配置为只读。是否要继续？",
	"如果继续，将替代只读保护。",
	"继续",
	"此操作不可逆!",
	"可以使用“撤消”命令还原这些文件。",
	...
	"在资源管理器视图中显示并选择活动文件。",
	"在新建的空白工作区中打开活动编辑器",
	"在新窗口中打开活动编辑器，但不打开任何文件夹。",
	"活动编辑器必须包含可打开的资源。",
	"必须提供文件或文件夹名。",
	"文件或文件夹名称不能以斜杠开头。",
	"此位置已存在文件或文件夹 **{0}**。请选择其他名称。",
	"名称 **{0}** 作为文件或文件夹名无效。请选择其他名称。",
	"在文件或文件夹名称中检测到的前导或尾随空格。",
	"比较新的无标题文本文件",
	"打开包含两个未命名文件的新差异编辑器。",
	"比较活动文件与剪贴板",
	"打开新的差异编辑器，将活动文件与剪贴板的内容进行比较。",
	"剪贴板 ↔ {0}",
	"重试",
	"创建 {0}",
	"正在创建 {0}",
	...
	"将文件夹添加到工作区(&&A)",
	"是否要复制文件夹或将其添加到工作区?",
	"是否要复制“{0}”或将“{0}”作为文件夹添加工作区?",
	"确定要复制文件夹吗?",
	"确定要复制“{0}”吗?",
	"无法访问部分或所有已删除文件，以进行导入。",
	"无法访问已删除文件以进行导入。",
	"导入{0}",
	"导入 {0} 个资源",
	"正在复制 {0}",
	...
	"配置与语言的文件关联的 [glob patterns](https://aka.ms/vscode-glob-patterns)(例如“*.extension”:“html”)。如果模式包含路径分隔符，则模式将在文件的绝对路径上匹配，否则将匹配文件的名称。它们优先于安装的语言的默认关联。",
	"在读取和写入文件时使用的默认字符集编码。可以按语言对此项进行配置。",
	"启用后，编辑器将尝试在打开文件时猜测字符集编码。还可以按语言配置此设置。请注意，文本搜索不遵守此设置。仅遵守 {0}。",
	"编辑器应尝试按其列出顺序进行猜测的字符集编码的列表。如果无法确定，则遵循 {0}",
	"LF",
	"CRLF",
	"使用具体操作系统规定的行末字符。",
	"默认行尾字符。",
	...
	"启用后，将在保存文件时删除行尾的空格。",
	"启用后，将在保存时或执行 'editor.action.trimTrailingWhitespace' 时从多行字符串中移除尾随空格，并将移除正则表达式。当没有最新的标记信息时，这可能导致无法从各行中剪裁掉空格。",
	...
	"启用后，会将编辑器的 [自动保存](https://code.visualstudio.com/docs/editor/codebasics#_save-auto-save)限制为打开的工作区内的文件。仅在启用 {0} 后适用。",
	"启用后，会将编辑器的 [自动保存](https://code.visualstudio.com/docs/editor/codebasics#_save-auto-save) 限制为在触发自动保存时未报告任何错误的文件。仅在启用 {0} 后适用。",
	...
	"保存时设置文件格式。格式化程序必须可用，并且不得关闭编辑器。当 {0} 设置为 `afterDelay` 时，仅在显式保存时才会格式化文件。",
	"设置整个文件的格式。",
	"格式修改(需要源代码管理)。",
	...
	"控制资源管理器是否应在撤消时要求确认。",
	"资源管理器将在所有撤消操作之前进行提示。",
	"资源管理器将在破坏性撤消操作之前进行提示。",
	"聚焦时，资源管理器将不会在撤消操作之前进行提示。",
	"控制资源管理器是否应在初始化期间展开仅包含一个文件夹的多根工作区",
	"按名称排列文件和文件夹。文件夹显示在文件前。",
	"按名称排列文件和文件夹。两者穿插显示。",
	"按名称排列文件和文件夹。文件显示在文件夹前。",
	...
	"控制文件修饰是否应使用颜色。",
	"控制文件修饰是否应使用徽章。",
	"在重复名称的末尾附加单词“copy”，后面可能跟一个数字。",
	"在重复名称的末尾添加一个数字。如果某个号码已经是名称的一部分，请尝试增加该号码。",
	"禁用增量命名。如果存在两个具有相同名称的文件，系统将提示你覆盖现有文件。",
	"选择在粘贴同名资源管理器项时要使用的重命名方式。",
	"控制资源管理器是否应在将文件放入资源管理器时自动打开该文件",
	...
	"文件资源管理器",
	"目录包含 {0} 个匹配项",
	"输入文件名。按 \"Enter\" 键确认或按 \"Esc\" 键取消。",
	"是否确定要更改工作区中多个根文件夹的顺序?",
	"确定要将以下文件{0}移动至{1}？",
	"是否确定要更改工作区中根文件夹“{0}”的顺序?",
	"是否确定要将\"{0}\"移到\"{1}\"？",
	"不再询问",
	"移动(&&M)",
	"复制 {0}",
	...
	"1 个未保存的文件",
	"{0} 个未保存的文件",
	"当 EXPLORER Viewlet 可见时为 True。",
	"当“文件夹”视图(资源管理器视图容器内的文件树)可见时为 True。",
	"如果 EXPLORER 中的焦点项是文件夹，则为 True。",
	"当 EXPLORER 中的焦点项为只读时为 True。",
	"当资源管理器的父中的焦点项为只读时为 True。",
	"如果 EXPLORER 中的焦点项是根文件夹，则为 True。",
	"如果 EXPLORER 中的一个项已被剪切用于剪切和粘贴，则为 True。",
	"如果 EXPLORER 中的焦点项可移到垃圾桶,则为 True。",
	"当焦点位于 EXPLORER 视图内时为 True。",
	"当焦点位于 OPEN EDITORS 视图内时为 True。",
	"当焦点位于 EXPLORER Viewlet 内时为 True。",
	"当资源管理器树使用资源管理器查找提供程序时为 True。",
	...
	"无",
	"没有",
	"扩展 '{0}' 配置为格式化程序，但不能格式化 '{1}'-文件",
	"扩展“{0}”配置为格式化程序，但它只能将“{1}”文件作为一个整体进行格式化，而不能格式化选定的内容或部分文件。",
	...
	"是否要在“聊天”视图中继续操作?",
	"是否要在“聊天”视图中继续操作?",
	"内联聊天旨在进行单文件代码更改。在“聊天”视图中继续你的请求，或重新表述请求来进行内联聊天。",
	"在“聊天”视图中继续",
	"取消",
	"不再询问",
	"“将内联聊天移至面板聊天”的重置选择",
	...
	"保持内联聊天键绑定是否将自动启用语音识别。",
	"内联聊天是否还会呈现一个可访问的差异查看器以显示其更改。",
	"可访问的差异查看器基于所启用的屏幕阅读器模式。",
	"始终启用可访问的差异查看器。",
	"从未启用可访问的差异查看器。",
	"是否使用下一个版本的内联聊天。",
	"从笔记本中的内联聊天小组件启用类似智能体的行为。",
	"内联聊天提供程序是否存在以及内联聊天的编辑器是否处于打开状态",
	"交互式编辑器的提供程序是否存在",
	"是否存在适用于交互式编辑器的内联聊天智能体",
	"是否存在适用于笔记本单元格的智能体",
	"是否存在适用于笔记本单元格的智能体",
	"交互式编辑器输入是否可见",
	"是否聚焦交互式编辑器输入",
	...
	"当前更改是否显示差异",
	"内联聊天请求当前是否正在进行",
	"回复的类型：已收到、尚未收到、仅消息，或已传递消息和本地编辑",
	"交互式编辑器小组件的前景色",
	"交互式编辑器小组件的背景色",
	"交互式编辑器小组件的边框颜色",
	"交互式编辑器小组件的阴影颜色",
	...
	"关闭交互窗口时提示保存该窗口。此设置更改仅影响新的交互窗口。",
	"使用 Shift+Enter 执行交互窗口(REPL)输入框，以便使 Enter 可用于创建换行符。",
	"在交互窗口(REPL)输入框中显示提示，以指示如何执行代码。",
	"按 {0} 执行。",
	"有关辅助功能帮助，请使用 {0}。",
	...
	"包括 A/B 试验信息",
	"包括其他扩展信息",
	"我确认我的 VS Code 版本未更新，并且此问题可能会关闭。",
	...
	"输入本地历史记录条目的新名称",
	"删除",
	"是否要从 {1} 中删除 {0} 的本地历史记录条目?",
	"此操作不可逆!",
	"删除(&&D)",
	"全部删除",
	"是否要删除本地历史记录中所有文件的所有条目?",
	"此操作不可逆!",
	"全部删除(&&D)",
	"创建条目",
	"创建本地历史记录条目",
	...
	"断开帐户连接",
	"退出登录",
	"MCP 服务器 {0} 已更新，可能有可用的新工具。",
	"MCP 服务器已更新，可能有可用的新工具:\r\n\r\n{0}",
	"MCP 服务器 {0} 无法成功启动。",
	"多个 MCP 服务器无法成功启动:\r\n\r\n{0}",
	"发送聊天消息时自动启动 MCP 服务器",
	"新工具可用({0} 个)",
	...
	"清除",
	"全部清除",
	"不应再在远程用户设置中配置 MCP 服务器。请改用专用 MCP 配置。",
	"不应再在用户设置中配置 MCP 服务器。请改用专用 MCP 配置。",
	"打开远程用户 MCP 配置",
	"打开用户 MCP 配置",
	"立即更新",
	"可选",
	...
	"MCP 服务器: {0}",
	"用于 MCP 服务器的图标。",
	"指示 MCP 服务器适用于远程用户范围的图标。",
	"指示 MCP 服务器适用于工作区范围的图标。",
	"随星标状态一起显示的图标。",
	"随许可证状态一起显示的图标。",
	"发布者({0})",
	"此发布者已验证 {0} 的所有权",
	...
	"MCP 服务器",
	"打开“设置”",
	"直接从 VS Code 浏览并安装[模型上下文协议(MCP)服务器](https://code.visualstudio.com/docs/copilot/customization/mcp-servers)，以通过用于连接数据库、调用 API 和执行专门任务的额外工具扩展智能体模式。",
	"此功能目前为预览版。可以随时通过设置 {0} 将其禁用。",
	"启用 MCP 服务器商城",
	"是否启用 MCP 服务器商城?",
	"启用",
	"取消",
	...
	"光标全局配置(`~/.cursor/mcp.json`)",
	"光标工作区配置(`.cursor/mcp.json`)",
	"已为服务器启用开发模式。如果存在，服务器将立即启动，输出将包含在其输出中。“dev”对象中的属性可以配置其他行为。",
	"与工作区文件夹相关的 glob 模式或 glob 模式列表，用于监视。当这些文件发生更改时，MCP 服务器将重新启动。",
	"如果已设置，则在启动时使用给定的运行时调试 MCP 服务器。",
	"使用 Node.js 调试 MCP 服务器。",
	"使用 Python 和 debugpy 调试 MCP 服务器。",
	"可执行 debugpy 的路径。",
	"服务器的类型。",
	"用于运行服务器的命令。",
	"服务器命令的工作目录。在工作区中运行时默认为工作区文件夹。",
	"传递给服务器的参数。",
	"包含服务器环境变量的文件的路径。",
	"传递给服务器的环境变量。",
	"模型上下文协议服务器",
	...
	"名称",
	"MCP 服务器",
	"具有已注册 MCP 服务器数目的上下文键",
	"指示是否存在具有未知工具的 MCP 服务器。",
	"指示是否有任何 MCP 服务器存在错误。",
	"具有已注册 MCP 工具数目的上下文键",
	"{0}: 所有工具",
	"请注意，MCP 服务器或恶意对话内容可能会尝试通过工具滥用“{0}”。",
	"运行 {0}",
	"正在运行 {0}",
	"已运行 {0}",
	"{0} (MCP 服务器)",
	"自 {0}",
	"是否信任并运行 MCP 服务器 {0}?",
	"MCP 服务器 {0} 已更新。MCP 服务器可能会向你的聊天会话添加上下文并导致意外行为。你是否要信任并运行此服务器?",
	"信任",
	"不信任",
	"是否信任并运行 {0} MCP 服务器?",
	"已发现多个更新的 MCP 服务器:\r\n\r\n{0}\r\n\r\n MCP 服务器可能会向你的聊天会话添加上下文并导致意外行为。你是否要信任并运行这些服务器?",
	"选择受信任项",
	"启动 {0} 时出错: {1}",
	"打开配置",
	"过去 7 天内共有 {0} 个请求。",
	...
	"从不",
	"显示输出",
	"找不到命令“{0}”。可以在“dev.debug.debugpyPath”选项中指定 debugpy 的路径。",
	"查看文档",
	"安装 {0}",
	"找不到运行 {1} 所需的命令“{0}”。",
	"无法启动 MCP 服务器 {0}: {1}",
	"工具“{0}”具有无效的 JSON 参数:",
	"MCP 服务器“{0}”中有工具包含无效的参数，这些参数将被省略。",
	"显示",
	"正在启动服务器 {0}",
	"连接状态: {0}",
	"正在停止服务器 {0}",
	...
	"REPL 变量",
	"变量 {0}，值 {1}",
	"启用后，笔记本大纲将仅显示包含标头的 Markdown 单元。",
	"启用后，笔记本大纲显示代码单元格。",
	"启用后，笔记本大纲将显示代码单元符号。依赖于将启用的 `#notebook.outline.showCodeCells#`。",
	"启用后，笔记本痕迹包含代码单元格。",
	"启用后，转到符号快速检查将显示笔记本中的完整代码符号以及 Markdown 标头。",
	"筛选条目",
	"仅限 Markdown 标头",
	"代码单元",
	"代码单元符号",
	...
	"显示未更改的单元格",
	"隐藏未更改的单元格",
	"选择其他输出 MIME 类型，可用的 MIME 类型: {0}",
	"单元格没有输出",
	"找不到输出的呈现器。其具有以下 mimetype: {0}",
	"当前处于活动状态",
	...
	"启用命令以切换实验笔记本内联差异编辑器。",
	"笔记本文本差异",
	"是否折叠了笔记本差异编辑器中的所有单元格",
	"笔记本差异编辑器中是否存在未更改的单元格",
	"是否隐藏了笔记本差异编辑器中未更改的单元格",
	"笔记本差异编辑器中项的种类，单元格、元数据或输出",
	"笔记本差异编辑器中项的差异状态，删除、插入、已修改或未更改",
	"双击以显示",
	"单元格 {0}",
	"元数据",
	"输出",
	...
	"单元格状态栏始终隐藏。",
	"单元格状态栏始终可见。",
	"在单元格执行完毕之前，单元格状态栏处于隐藏状态。然后它会变为可见以显示执行状态。",
	...
	"控制是否在笔记本单元格输出中禁用文件路径链接。",
	"控制是否以最小样式呈现错误输出。",
	"控制笔记本中呈现的标记的字号(以像素为单位)。设置为 {0} 时，将使用 120% 的 {1}。",
	"控制笔记本中 Markdown 单元格的行高(以像素为单位)。设置为 {0} 时，将会使用 {1}",
	...
	"控制输出中的行是否应换行。",
	"定义优先于所有其他格式化程序设置的默认笔记本格式化程序。必须是提供格式化程序的扩展的标识符。",
	"保存时设置笔记本格式。格式化程序必须可用，并且不得关闭编辑器。当 {0} 设置为 `afterDelay` 时，仅在显式保存时才会格式化文件。",
	"启用后，保存笔记本时，将最后一个新行插入代码单元格的末尾。",
	"执行时设置笔记本单元格的格式。格式化程序必须可用。",
	"控制是否需要确认提示才能删除正在运行的单元格。",
	"自定义用于在笔记本单元格中搜索的“查找小组件”行为。启用标记源和标记预览后，“查找小组件”将根据单元格的当前状态搜索源代码或预览。",
	"支持在进程之间和跨远程连接增量保存笔记本。启用后，只有对笔记本进行的更改才会发送到扩展主机，以提高大型笔记本和慢速网络连接的性能。",
	"运行 {0} 时显示下一个单元格时滚动的距离。",
	"滚动以完全显示下一个单元格。",
	"滚动以显示下一个单元格的第一行。",
	"不滚动。",
	"启用实验性生成操作，以创建已启用内联聊天的代码单元格。",
	"在调试面板中启用实验性笔记本变量视图。",
	"控制在单元格执行后是否在笔记本代码单元格中显示内联值。值将保留，直到单元格通过“清除所有输出”工具栏按钮或“笔记本： 清除内联值”命令进行编辑、重新执行或显式清除为止。",
	"始终显示内联值，如果未注册内联值提供程序，则显示正则表达式回退。注意： 如果使用回退，则较大的单元格可能会对性能产生影响。",
	"仅在注册内联值提供程序时显示内联值。",
	"从不显示内联值。",
	"显示可用的单元故障诊断。",
	"笔记本文件将不再备份以进行热重载的笔记本输出大小限制(以 KB 为单位)。使用 0 表示无限制。",
	"实验性。在笔记本编辑器的多个单元格中启用一组有限的多光标控件。当前支持核心编辑器操作(键入/剪切/复制/粘贴/合成)和编辑器命令的有限子集。",
	"控制笔记本中呈现的标记的字体系列。留空时，这将回退到默认工作台字体系列。",
	"笔记本视图是代码单元格和 Markdown 单元格的集合。可以执行代码单元格，该单元格下方将直接生成输出。",
	"“编辑单元格”命令 {0} 将焦点放在单元格输入上。",
	"“退出编辑”命令 {0} 将焦点设置在单元格容器上。如果虚拟光标处于活动状态，则可能需要先按两次默认(Escape)键才会退出虚拟光标。",
	"“焦点输出”命令 {0} 将在单元格的输出中设置焦点。",
	"“聚焦到下一个单元格编辑器”命令 {0} 将在下一个单元格的编辑器中设置焦点。",
	"“聚焦到上一个单元格编辑器”命令 {0} 将在上一个单元格的编辑器中设置焦点。",
	"焦点位于外部单元格容器上时，向上和向下箭头也将在单元格之间移动焦点。",
	"“执行单元格”命令 {0} 执行当前具有焦点的单元格。",
	"“在上方 {0} 和下方 {1} 插入单元格”命令将创建新的空代码单元格。",
	...
	"配置用于在笔记本编辑器中选择内核的图标。",
	"笔记本编辑器中的执行图标。",
	"用于在笔记本编辑器中在单元格上方进行执行的图标。",
	"用于在笔记本编辑器中在单元格下方进行执行的图标。",
	"用于在笔记本编辑器中停止执行的图标。",
	"用于在笔记本编辑器中删除单元格的图标。",
	"用于在笔记本编辑器中执行所有单元格的图标。",
	"用于在笔记本编辑器中编辑单元格的图标。",
	"用于在笔记本编辑器中停止编辑单元格的图标。",
	"用于在笔记本编辑器中上移单元格的图标。",
	"用于在笔记本编辑器中下移单元格的图标。",
	"用于在笔记本编辑器中清除单元格输出的图标。",
	"用于在笔记本编辑器中拆分单元格的图标。",
	"用于在笔记本编辑器中指示成功状态的图标。",
	"用于在笔记本编辑器中指示错误状态的图标。",
	"用于在笔记本编辑器中指示挂起状态的图标。",
	"用于在笔记本编辑器中指示执行状态的图标。",
	"用于在笔记本编辑器中批注已折叠部分的图标。",
	"用于在笔记本编辑器中批注已展开部分的图标。",
	"用于在文本编辑器中打开笔记本的图标。",
	"笔记本编辑器中的还原图标。",
	"差异编辑器中“切换空白”操作的图标",
	"用于在差异编辑器中呈现输出的图标。",
	...
	"折叠所有项。",
	"展开所有项。",
	"显示大纲元素上的错误和警告。被关闭时由 {0} 覆盖。",
	"对大纲元素的错误和警告使用颜色。被关闭时由 {0} 覆盖。",
	"对大纲元素的错误和警告使用锁屏提醒。被关闭时由 {0} 覆盖。",
	"启用后，大纲将显示 `file` 符号。",
	"启用后，大纲将显示 `module` 符号。",
	...
	"键盘布局",
	"布局: {0}",
	"定义在浏览器环境的 VS Code 中使用的键盘布局。",
	"打开 VS Code 并从命令面板运行“开发人员: 检查密钥映射(JSON)”。",
	"更改键盘布局",
	"键盘布局({0})",
	"配置键盘布局",
	"自动检测",
	...
	"设置 UI 中“更多操作”操作的图标。",
	"键绑定 UI 中“记录密钥”操作的图标。",
	"键绑定 UI 中“按优先级排序”切换开关的图标。",
	"键绑定 UI 中“编辑”操作的图标。",
	"键绑定 UI 中“添加”操作的图标。",
	"设置 UI 中“编辑”操作的图标。",
	"设置 UI 中“删除”操作的图标。",
	"设置 UI 中“放弃”操作的图标。",
	"设置和键绑定 UI 中的“清除输入”图标。",
	"在“设置”界面中显示 AI 结果的图标。",
	"为设置 UI 建议筛选器的按钮的图标。",
	"“打开设置”命令的图标。",
	"编辑",
	"在设置中替换",
	"复制到设置",
	"无法应用此设置，因为它是在系统策略中配置的。",
	"无法应用此设置，因为它未注册为语言替代设置。",
	"非默认配置文件处于活动状态时无法应用此设置。将在默认配置文件处于活动状态时应用。",
	"无法应用此设置，因为它已配置为使用设置 {0} 在所有配置文件中应用。将改用默认配置文件中的值。",
	"此设置无法在此窗口中应用。在你打开本地窗口时将应用它。",
	"此设置无法应用于此工作区。它将在您直接打开包含的工作区文件夹时应用。",
	"此设置具有应用程序作用域，只能在“默认配置文件”的设置文件中设置。",
	"只能在本地窗口的用户设置中或者远程窗口的远程设置中应用此设置。",
	"此设置仅可应用于受信任的工作区。",
	"未知的配置设置",
	"管理工作区信任",
	"不应在远程用户设置中配置 MCP 服务器。请改用专用 MCP 配置。",
	"不应在用户设置中配置 MCP 服务器。请改用专用 MCP 配置。",
	"打开远程用户 MCP 配置",
	"打开用户 MCP 配置",
	"不支持的属性",
	"用户",
	...
	"高级设置: 此设置适用于高级场景和配置。只有在了解其作用时才修改。",
	"拆分设置编辑器",
	"控制是否在设置中启用自然语言搜索。自然语言搜索由 Microsoft 联机服务提供。",
	"在搜索时隐藏目录。",
	"筛选目录为仅显示含有匹配设置的类别。单击一个类别将仅显示该类别的结果。",
	"控制设置编辑器的目录在搜索时的行为。如果在“设置”编辑器中更改此设置，则更改后的设置将在修改搜索查询后生效。",
	"节标题或活动标题的前景颜色。",
	"节标题或悬停标题的前景色。",
	"修改后的设置指示器的颜色。",
	"标头容器边框的颜色。",
	...
	"没有转发的端口。转发端口以通过 Internet 访问本地运行的服务。\r\n[转发端口]({0})",
	"端口",
	"1 个转发的端口",
	"{0} 个转发的端口",
	"未转发端口",
	"转发的端口: {0}",
	"转发的端口",
	"已自动转发超过 20 个端口。在设置中，基于 `process` 的自动端口转发已切换为 `hybrid`。可能不再检测到某些端口。",
	"撤消",
	"显示设置",
	"在端口 {1} 上运行的应用程序 {0} 可用。  ",
	"[查看所有转发端口]({0})",
	...
	"连接: 触发器重新连接",
	"连接: 暂停套接字写入",
	"UI 扩展类型。在远程窗口中，只有在本地计算机上可用时，才会启用此类扩展。",
	"工作区扩展类型。在远程窗口中，仅在远程上可用时启用此类扩展。",
	"远程",
	"覆盖扩展的类型。\"ui\" 扩展在本地计算机上安装和运行，而 \"workspace\" 扩展则在远程计算机上运行。通过使用此设置重写扩展的默认类型，可指定是否应在本地或远程安装和启用该扩展。",
	"还原您在工作区中转发的端口。",
	"启用后，将检测到新的正在运行的进程，并自动转发其侦听的端口。禁用此设置将不会阻止转发所有端口。即使禁用，扩展将仍然能够导致端口被转发，并且打开某些 URL 仍将导致端口被转发。另请参阅 {0}。",
	"设置当 {0} 为 true 时自动从其转发端口的源。当 {0} 为 false 时，{1} 将用于查找有关已转发的端口的信息。在 Windows 和 Mac 远程设备上，“process”和“hybrid”选项不起作用，系统将使用“output”。",
	...
	"自动转发端口且 `remote.autoForwardPortsSource` 默认设置为 `process` 时将触发从 `process` 切换到 `hybrid` 的自动转发端口数。设置为 `0` 可禁用回退。如果尚未配置 `remote.autoForwardPortsFallback`，但配置了 `remote.autoForwardPortsSource`，`remote.autoForwardPortsFallback` 将被视为如同设置为 `0`。",
	...
	"指定将用于端口转发的本地主机名。",
	"连接到远程时要安装的扩展列表(已在本地安装)。",
	"扩展标识符的格式必须为 “publisher.name”。",
	"为聊天小组件提供远程编码智能体集成。",
	"此项的唯一标识符。",
	"要执行的命令的标识符。该命令必须在“命令”部分中声明。",
	"此项的用户友好名称，用于在菜单中显示。",
	"用于菜单和工具提示的远程智能体的说明。",
	"现有聊天对话中最后一次出现的模式将发送到参与扩展，以方便后续答复。",
	"此条件必须为 true 才能显示此项。",
	"焦点最近的 REPL 执行",
	"焦点输入编辑器",
	"执行 REPL 输入",
	"REPL 输入",
	"你位于 REPL 编辑器输入框中，此框将接受要在 REPL 中执行的代码。",
	"执行命令{0}将计算输入框中的表达式。",
	"设置“accessibility.replEditor.readLastExecutionOutput”控制执行完成时是否将自动读取输出。",
	"设置“accessibility.replEditor.autoFocusReplExecution”控制在执行代码后焦点是否会自动移动到 REPL。",
	"Focus Last 执行命令{0} 会将焦点移动到 REPL 历史记录中最后执行的项。",
	"从此输入框运行“打开访问性视图”命令{0} 时，上一次执行的输出将显示在辅助功能视图中。",
	"焦点输入编辑器命令{0} 会将焦点恢复到此编辑器。",
	"你位于 REPL 历史记录中，此历史记录是已在 REPL 中执行的单元格的列表。每个单元格都有一个输入、一个输出和一个单元格容器。",
	"“编辑单元格”命令{0} 会将焦点移动到单元格输入的只读编辑器。",
	"“退出编辑”命令{0} 将焦点移动到单元格容器，其中向上和向下箭头还会在历史记录中的单元格之间移动焦点。",
	"浏览项目输出的可访问视图的历史记录时，运行“打开访问性视图”命令{0}。",
	"聚焦输出命令{0}会在聚焦于以前执行的项时将焦点设在输出上。",
	"聚焦输入编辑器命令{0}会将焦点移动到 REPL 输入框。",
	"REPL 编辑器标签的图标。",
	...
	"显示源代码管理提供程序计数锁屏提醒。",
	"控制源代码管理提供程序标头上的计数锁屏提醒。当存在多个提供程序或启用 {0} 设置时，以及在“源代码管理存储库”视图中，这些标头将显示在“源代码管理”视图中。",
	"将仓库更改显示为树。",
	"将仓库更改显示为列表。",
	"控制默认的源代码管理仓库视图模式。",
	"按文件名对仓库更改进行排序。",
	...
	"可同时选择多个存储库。",
	"一次只能选择一个存储库。",
	"控制“源代码管理存储库”视图中存储库的选择模式。",
	"控制是否在“源代码管理存储库”视图中显示存储库工件。此功能是试验性的，仅当 {0} 设置为 `{1}` 时生效。",
	"控制是否可以在源代码管理视图中显示操作按钮。",
	"控制是否可以在“源代码管理”输入中显示操作按钮。",
	"控制在源代码管理历史记录项组之间切换时是否存储编辑器工作集。",
	"在切换到没有工作集的源代码管理历史记录项组时，请使用空的工作集。",
	"在切换到没有工作集的源代码管理历史记录项组时，使用当前工作集。",
	"控制切换到没有工作集的源代码管理历史记录项组时要使用的默认工作集。",
	"控制源代码管理视图是否应以紧凑形式呈现文件夹。在此形式中，单个子文件夹将被压缩在组合的树元素中。",
	"控制在滚动到列表结尾时，“源代码管理图”视图是否将加载下一页的项。",
	"“源代码管理图”视图在默认情况下以及在加载更多项时要显示的项数。",
	"在“源代码管理图”视图中显示所有历史记录项组的徽章。",
	"在“源代码管理图”视图中仅显示用作筛选器的历史记录项组的徽章。",
	"控制“源代码管理图”视图中显示的徽章。这些徽章显示在图右侧，指示历史记录项组的名称。",
	"控制是否在“源代码管理图”视图中显示传入的更改。",
	"控制是否在“源代码管理图”视图中显示传出的更改。",
	"源代码管理: 接受输入",
	"源代码管理: 查看下一个提交",
	"源代码管理: 查看上一个提交",
	"选择活动存储库，键入以筛选所有存储库",
	...
	"操作按钮： {0}、{1}",
	"资源组: {0}",
	"使用“源代码管理： 聚焦源代码管理存储库视图”命令打开源代码管理存储库视图。",
	"源代码管理存储库视图列出了工作区中的所有存储库，并且仅当工作区包含多个存储库时才会显示。",
	"打开源代码管理存储库视图后，你可以：",
	"- 使用向上/向下箭头键导航存储库列表。",
	"- 使用 Enter 或 Space 键选择存储库。",
	"- 使用 Shift + 上/下 键选择多个存储库。",
	"使用“源代码管理： 焦点位于源代码管理视图”命令打开源代码管理视图。",
	"“源代码管理”视图显示存储库的资源组和资源。如果工作区包含多个存储库，它将列出在“源代码管理存储库”视图中选择的存储库的资源组和资源。",
	"打开源代码管理视图后，你可以：",
	"- 使用向上/向下箭头键导航存储库、资源组和资源列表。",
	"- 使用空格键展开或折叠资源组。",
	"使用 “Source Control： Focus on Source Control Graph View” 命令打开源代码管理图形视图。",
	"“源代码管理图”视图显示存储库的图形历史记录项。如果工作区包含多个存储库，它将列出活动存储库的历史记录项。",
	"打开源代码管理图视图后，你可以：",
	"- 使用向上/向下箭头键导航历史记录项列表。",
	"- 使用空格键在多文件差异编辑器中打开历史记录项详细信息。",
	"历史记录项引用颜色。",
	"历史记录项远程引用颜色。",
	"历史记录项基本引用颜色。",
	"历史记录项悬停默认标签前景色。",
	...
	"源代码管理历史记录",
	"显示活动存储库的源代码管理图",
	"选择要查看的存储库，键入以筛选所有存储库",
	"当前历史记录项引用",
	"选择要查看的一个/多个历史记录项引用，键入以进行筛选",
	"请使用刷新操作($(refresh))刷新图形。",
	"源代码管理存储库",
	"源代码管理",
	"源代码管理输入",
	"源代码管理输入，使用 {0} 打开源代码管理辅助功能帮助。",
	"源代码管理输入，有关详细信息，请运行“打开辅助功能帮助”命令。",
	"查看和排序",
	"存储库",
	"以列表形式查看",
	"以树形式查看",
	...
	"搜索文本",
	"搜索",
	"配置 [glob 模式](https://code.visualstudio.com/docs/editor/codebasics#_advanced-search-options)以在 Quick Open 中的全文搜索和文件搜索中排除文件和文件夹。若要从 Quick Open 中最近打开的列表中排除文件，必须使用绝对模式(例如 `**/node_modules/**`)。从 `#files.exclude#` 设置继承所有 glob 模式。",
	"匹配文件路径所依据的 glob 模式。设置为 true 或 false 可启用或禁用该模式。",
	"对匹配文件同辈进行额外检查。将 $(basename) 用作匹配文件名的变量。",
	...
	"控制在搜索文件时是否使用全局 gitignore 文件(例如，从“$HOME/.config/git/ignore”)。需要启用 {0}。",
	"控制在搜索文件时是否在父目录中使用 “.gitignore”和“.ignore”文件。需要启用 {0}。",
	"控制 Quick Open 文件结果中是否包括全局符号搜索的结果。",
	"用于搜索的线程数。设置为 0 时，引擎将自动确定此值。",
	...
	"将搜索结果显示为列表。",
	"控制默认搜索结果视图模式。",
	"在打开快速搜索视图时，控制是否自动恢复上一次输入的值。",
	"显示已关闭笔记本的笔记本编辑器中丰富的内容结果。请在更改此设置后刷新搜索结果。",
	"控制搜索视图中显示的语义搜索结果的行为。",
	"仅手动请求语义搜索结果。",
	"仅在文本搜索结果为空时自动请求语义结果。",
	"每次搜索时都自动请求语义结果。",
	...
	"未在打开的编辑器中找到结果(“{0}”除外) - ",
	"未在打开的编辑器中找到结果。请检查配置的排除项，并查看 gitignore 文件 - ",
	"在“{0}”中找不到结果(“{1}”除外) - ",
	"“{0}”中未找到任何结果 - ",
	"除“{0}”外，未找到任何结果 - ",
	"找不到结果。请检查配置的排除项，并查看 gitignore 文件 - ",
	"再次搜索",
	"在所有文件中再次搜索",
	"打开设置",
	"搜索 {1} 文件中返回的 {0} 个结果",
	...
	"全部替换",
	"切换替换",
	"搜索: 键入搜索词，然后按 Enter 进行搜索",
	"搜索",
	"切换上下文行",
	"替换: 键入待替换词，然后按 Enter 进行预览",
	"替换",
	"没有匹配的工作区符号",
	"打开转到侧边",
	"打开转到底部",
	...
	"用户设置",
	"用户设置中只允许版本为 2.0.0 的任务。",
	"正在忽略工作区文件夹 {0} 的任务配置。多文件夹工作区任务支持要求所有文件夹都使用任务版本 2.0.0",
	...
	"运行前绝不保存编辑器。",
	"提示在运行前是否保存编辑器。",
	"控制在任务已完成且窗口未聚焦的情况下，距离显示 OS 通知的最短任务运行时间(毫秒)。设置为 -1 可禁用通知。设置为 0 则始终显示通知。这包括窗口徽章和通知横幅。",
	"为任务启用详细日志记录。",
	"重新运行任务",
	"显示所有任务...",
	"任务选择列表中的“配置”图标。",
	...
	"存在依赖项循环。请参阅任务“{0}”。",
	"无法解析在工作区文件夹“{1}”中的依赖任务“{0}”",
	"任务 {0} 是后台任务，但使用的问题匹配器没有后台模式",
	"正在文件夹 {0} 中执行任务: {1}",
	"正在执行任务: {0}",
	"正在执行任务: {0}",
	"正在执行任务: {0}",
	"无法使用 cmd.exe 在 UNC 驱动器上执行 Shell 命令。",
	"无法解析问题匹配器 {0}。将忽略此匹配程序",
	"按任意键关闭终端。",
	"终端将被任务重用，按任意键关闭。",
	undefined,
	"其他命令选项",
	...
	"如果设置为 true，则后台监视器将在活动模式下启动。这与任务启动时输出与 beginsPattern 匹配的行相同。",
	"如果在输出内匹配，则会发出后台任务开始的信号。",
	"如果在输出内匹配，则会发出后台任务结束的信号。",
	"\"watching\" 属性已被弃用，请改用 \"background\"。",
	"用于跟踪监视匹配程序开始和结束的模式。",
	"如果设置为 true，则观察程序将在活动模式下启动。这与任务启动时输出与 beginsPattern 匹配的行相同。",
	...
	"具有配置文件的拆分终端",
	"启动配置文件...",
	"无法终止侦听端口 {0} 的进程，命令退出时出现错误 {1}",
	"到 shell 进程的连接丢失，正在重启终端…",
	"选择要创建的终端配置文件",
	"选择默认的终端配置文件",
	"输入终端配置文件名称",
	"有终端配置文件已具有此名称",
	...
	"终端流程的名称。",
	"由 `OSC 9;4` 序列报告的进度状态。",
	"仅在由带有值或静态文本的变量括住时才显示的条件分隔符 {0}。",
	"进程提供给终端的名称。",
	"指示此终端与任务关联。",
	"检测到的 shell 类型。",
	"根据 shell 集成正在执行的命令。这也要求检测到的命令行具有高可信度，这在某些提示框架中可能不起作用。",
	"shell 的完整提示输入(根据 shell 集成)。",
	"控制终端标题。根据上下文替换变量:",
	...
	"控制将多行粘贴到终端时是否显示警告对话框。",
	"启用警告，但在以下情况下不显示该警告：\r\n\r\n- 已启用带括号的粘贴模式（shell 支持本机多行粘贴）\r\n- 粘贴由 shell 的读取一行数据处理（在 pwsh 的情况下）",
	"如果文本包含新行，则始终显示该警告。",
	"从不显示警告。",
	"控制终端中的加粗文本是否始终使用 \"bright\" ANSI 颜色变量。",
	"控制终端的字体系列，默认为 {0} 的值。",
	"控制是否在终端中启用字体连字。只有配置的 {0} 支持连字才能正常工作。",
	"控制启用连字时使用哪些字体功能设置，格式为 `font-feature-settings` CSS 属性。根据字体可能有效的一些示例:",
	"启用 {0} 且无法分析特定 {1} 时，这是将始终一起绘制的字符序列集。这允许使用固定的连字集，即使字体不受支持。",
	"控制终端的字号(以像素为单位)。",
	...
	"不执行任何操作并将事件传递到终端。",
	"控制终端如何回应右键单击操作。",
	"将焦点放在终端上的平台默认值。在 Linux 上，这也将粘贴所选内容。",
	"在中键单击时粘贴。",
	"控制终端如何回应中键单击操作。",
	"将在其中启动终端的显式起始路径，它用作 shell 进程的当前工作目录(cwd)。如果根目录不是方便的 cwd，此路径在工作区设置中可能十分有用。",
	"控制是否确认窗口何时关闭，如果存在活动的终端会话。某些扩展启动的后台终端等将不会触发确认。",
	"从不确认。",
	"始终确认是否存在终端。",
	"确认是否存在具有子进程的终端。",
	"控制是否在终端具有子进程时确认终止终端。当设置为编辑器时，如果编辑器区域中的终端具有子进程，则将标记为已更改。请注意，子进程检测可能不适用于 Git Bash 等 shell，后者不会将其进程作为 shell 的子进程运行。后台终端（如某些扩展程序启动的终端）不会触发确认。",
	"从不确认。",
	"确认终端是否在编辑器中。",
	"确认终端是否在面板中。",
	"确认终端是在编辑器中还是在面板中。",
	"现已弃用此项。请改用 `terminal.integrated.enableVisualBell` 和 `accessibility.signals.terminalBell` 设置。",
	"控制是否启用可视化终端铃声。此项显示在终端名称旁边。",
	...
	"一个包含所有字符的字符串，在双击选择单词和回退“word”链接检测时，会被视为单词分隔符。由于这用于链接检测，包括在检测链接时使用“:”之类的字符，将会忽略“file:10:5”等链接的行和列部分。",
	"是否在终端中启用文件链接。连接可能会很慢，特别是在网络驱动器上工作时，因为将根据文件系统验证每个文件链接。更改此项将仅在新的终端中生效。",
	"始终关闭。",
	"始终可用。",
	"仅当不在远程工作区中时启用。",
	"包含终端可打开其链接的 URI 方案的字符串数组。出于安全原因，默认情况下只允许一小部分可能的方案。",
	...
	"永远不要还原终端缓冲区或重新创建流程。",
	"是否在启动时隐藏终端视图，避免在没有持续会话时创建终端。",
	"启动时切勿隐藏终端视图。",
	"仅在未还原持久会话时隐藏终端。",
	"始终隐藏终端，即使还原持久会话也是如此。",
	"是否在最后一个终端关闭时隐藏终端视图。仅当终端是视图容器中唯一可见的视图时才会发生这种情况。",
	"是否为块元素和制表符字符绘制自定义字形(而不是使用字体)，这通常会产生更好的连续线条呈现效果。请注意，禁用 {0} 时，这不起作用。",
	"是否水平重新缩放单个单元格宽且有字形与下面的单元格重叠的字形。模糊宽度字符(例如罗马数字字符 U+2160+)通常会发生这种情况，等宽字体中不特别推荐这些字符。永远不会重新缩放表情符号字形。",
	...
	"在终端右侧显示概述标尺修饰",
	"不显示修饰",
	"配置启动后等待 shell 集成的时长(毫秒)，超过该时间则声明其不存在。设置为 {0} 以等待最短时间(500ms)，默认值 {1} 表示等待时间会根据是否启用 shell 集成注入及是否为远程窗口而变化。如果有意禁用 shell 集成，建议将其设置为较小的值；如果 shell 启动非常慢，建议将其设置为较大的值。",
	"启用 shell 集成后，会为提示符左侧显示为灯泡或闪光图标的终端命令启用快速修复。",
	...
	"在终端中启用映像支持，这仅在启用 {0} 时有效。Linux 和 macOS 上同时支持 sixel 和 iTerm 的内联映像协议。这仅适用于随 Windows 本身一起提供的 ConPTY >= v2 版本的 Windows，另请参阅 {1}。当前不会在窗口重新加载/重新连接之间还原图像。",
	"控制在运行“终端: 在活动终端中运行所选文本”后是否将焦点放在终端、可访问缓冲区或两者均不集中。",
	"始终将焦点放在终端上。",
	"始终将焦点放在可访问的缓冲区上。",
	"不执行任何操作。",
	"对 pty 主机发出的所有调用都应用了模拟延迟(毫秒)。这有助于测试终端在高延迟情况下的行为。",
	"pty 主机进程的模拟启动延迟(毫秒)。这有助于测试终端在缓慢启动情况下的初始化表现。",
	"为终端启用开发人员模式。这会显示额外的调试信息和 shell 集成序列的可视化内容。",
	"集成终端",
	"是否聚焦终端。",
	...
	"当前终端数。",
	"是否聚焦终端选项卡小组件。",
	"活动终端的 shell 类型，如果可检测到该类型，则设置该类型。",
	"终端的可选缓冲区是否处于活动状态。",
	"终端的建议小组件是否可见。",
	"终端视图是否显示",
	"是否在活动终端中选择文本。",
	...
	"滚动到底部的可访问视图",
	"滚动到顶部的可访问视图",
	"焦点可访问终端视图命令<keybinding:{0}>使屏幕阅读器能够读取终端内容。",
	"自定义使用“terminal.integrated.accessibleViewPreserveCursorPosition”在终端和可访问视图之间切换时的光标行为。",
	"打开检测到的链接命令<keybinding:{0}>使屏幕阅读器能够轻松打开在终端中找到的链接。",
	"借助创建新终端(带配置文件)命令<keybinding:{0}>，可以使用特定配置文件轻松创建终端。",
	"使用 `{0}`在终端中运行所选文本后，配置焦点。",
	"启用 `terminal.integrated.accessibleViewFocusOnCommandExecution`，以便在终端中执行命令时自动聚焦终端可访问视图。",
	"可以手动调用终端请求完成命令<键绑定：{0}>，但在键入时也会显示。",
	"当终端建议聚焦小组件时:",
	"- 接受建议<keybinding:{0}>并配置建议设置<keybinding:{1}>。",
	"- 在小组件和终端<keybinding:{0}>之间切换，然后切换详细信息焦点<keybinding:{1}>以了解有关建议的详细信息。",
	"- 详细了解建议<keybinding:{0}>。",
	"- 配置建议设置<keybinding:{0}>",
	"考虑使用 powershell (而非命令提示符)以改进体验",
	"终端具有一种称为 shell 集成的功能，可提供增强的体验并为屏幕阅读器提供有用的命令，例如:",
	"可访问视图中转到下一个命令<keybinding:{0}>",
	"可访问视图中转到上一个命令<keybinding:{0}>",
	"转到符号<keybinding:{0}>",
	"运行最近使用的命令<keybinding:{0}>",
	"转到最近使用的目录<keybinding:{0}>",
	"未启用 Shell 集成。某些辅助功能可能不可用。",
	"重新打开终端的可访问视图时保留光标位置，而不是将其设置到缓冲区的底部。",
	"执行命令时，将焦点放在终端可访问视图上。",
	...
	"输入框是用户可以键入请求，并且可以通过按 Tab 键转到“发出请求”按钮来发出请求的位置，目前无法通过键绑定触发此操作。按 Escape 键后，将会关闭小组件并放弃所有内容，然后终端将重新处于焦点模式。",
	"可以在无障碍视图({0})中检查响应。",
	"在以输入框为焦点时，通过“打开可访问视图”命令检查可访问视图中的响应，该命令当前无法通过键绑定触发。",
	"从输入框({0})访问响应。",
	"通过按 Tab 键或为命令“焦点终端响应”分配键绑定，从输入框访问响应。",
	"从响应访问输入框({0})。",
	"通过 shift+tabbing 或为命令: 焦点终端输入分配键绑定，从输入框访问响应。",
	"焦点位于输入框或命令编辑器中时，执行终端: 运行聊天命令({0})操作。",
	"通过按 Tab 键转到按钮来运行命令，因为当前无法通过键绑定触发操作。",
	"在焦点放在输入框命令编辑器中时，执行终端: 插入聊天命令({0})操作。",
	"通过按 Tab 键切换到按钮来插入命令，因为当前该操作不能通过键绑定触发。",
	"使用选项卡访问命令、状态、消息响应等条件部分。",
	"可通过带有 signals.chat 前缀的设置更改辅助功能信号。默认情况下，如果请求超过 4 秒，你将听到一个声音，指示仍在进行中。",
	"打开内联聊天",
	"终端",
	...
	"请注意，这些命令和正则表达式是针对完整_命令行_内的每个_子命令_进行计算的，因此 {0} 等需要 {1} 和 {2} 都匹配 {3} 条目，并且不得与 {4} 条目匹配才能自动批准。还应检测 {5} (进程替换)等内联命令。",
	"对象可用于与完整命令行进行匹配，而不是匹配子命令和内联命令，例如 {0}。为了实现自动批准，子命令和命令行都不能被显式拒绝，且需要批准所有子命令或命令行。",
	"请注意，系统有一组默认规则用于允许和拒绝命令。建议将 {0} 设置为 {1} ，以忽略所有默认规则，确保不会与你自己的规则发生冲突。这样做需要自行承担风险，默认的拒绝规则旨在防止你运行危险命令。",
	"示例:",
	"值",
	"描述",
	"允许所有以 {0} 开头的命令",
	"允许所有以 {0} 开头的命令",
	"允许与路径 {0} ({1}、{2} 等)匹配的所有命令",
	"允许 {0} 和所有以 {1} 开头的命令",
	"将允许 {0} 命令，而不考虑大小写",
	"允许所有命令(拒绝的命令仍需要批准)",
	"需要对以 {0} 开头的所有命令进行显式批准",
	"无论大小写如何，都需要显式批准包含 {0} 的任何命令行",
	"取消设置 {1} 的默认值 {0}",
	"与完整命令行进行匹配，例如: `foo && bar`。",
	"与子命令和内联命令匹配，例如 `foo && bar` 需要 `foo` 和 `bar` 才能匹配。",
	"是否与完整命令行匹配，而不是按子命令和内联命令拆分。",
	"忽略该模式，这对于取消设置在更高的范围设置的同一模式非常有用。",
	"是否如 {0} 中所定义，忽略终端工具中的运行使用的内置默认自动批准规则。启用此设置后，终端工具中的运行将忽略默认规则集中的所有规则，但仍会遵循用户设置、远程设置和工作区设置中定义的规则。使用此设置需要自行承担风险，默认自动批准规则旨在防止你运行危险命令。",
	"允许所有检测到的文件写入。",
	"阻止在工作区外检测到的文件写入。这依赖于 shell 集成功能正常工作，以确定终端的当前工作目录。",
	"阻止所有检测到的文件写入。",
	"控制是否在终端工具的运行过程中阻止检测到的文件写入操作。此类操作在被检测到时，无论命令是否通常会自动批准，都需要获得明确批准。请注意，这无法检测所有可能的文件写入方式，目前检测到的方式包括:\r\n\r\n- 文件重定向(通过 bash 或 PowerShell 的 tree sitter 语法检测)",
	...
	"请改用 {0}",
	"在 Linux 上的聊天智能体在终端工具中运行所使用的终端配置文件。",
	"在 macOS 上的聊天智能体在终端工具中运行所使用的终端配置文件。",
	"在 Windows 上的聊天智能体在终端工具中运行所使用的终端配置文件。",
	...
	"从命令历史记录中删除",
	"查看命令输出",
	"选择要运行的命令(按 Option-key 编辑命令)",
	"选择要运行的命令(按 Alt-key 编辑命令)",
	"打开文件",
	"{0} 历史记录",
	"选择要转到的目录(按 Option-key 编辑命令)",
	"选择要转到的目录(按 Alt-key 编辑命令)",
	"控制要保留在终端命令历史记录中的最近使用的命令数。设置为 0 可禁用终端命令历史记录。",
	"打开检测到的链接...",
	"打开最后一个 URL 链接",
	"在终端中打开最后一个检测到的 URL/URI 链接",
	"打开最后一个本地文件链接",
	"搜索工作区",
	"在编辑器中打开文件",
	"聚焦资源管理器中的文件夹",
	...
	"要匹配的命令退出结果",
	"生成的快速修复的类型。这将更改快速修复的显示方式。默认为 {0}。",
	"输入要发送到终端的序列",
	"发送序列",
	"要发送到终端的文本序列",
	"发送信号",
	"要发送到终端进程的信号(例如，'SIGTERM'、'SIGINT'、'SIGKILL')",
	"中断进程(Ctrl+C)",
	"正常终止进程",
	"强制终止进程",
	"停止进程",
	...
	"导航到命令",
	"{0} ({1})",
	"在终端顶部显示当前命令。此功能要求激活 [shell integration]({0})。请参阅 {1}。",
	...
	"为命令启用快速建议，这是命令行输入中的第一个字。",
	"为参数启用快速建议，在命令行输入中的第一个字之后的任何内容。",
	"当不清楚最佳建议是什么时启用快速建议，如果此建议位于文件上，并且文件夹将作为回退进行建议。",
	"控制在键入触发字符后是否自动显示建议。",
	"控制是否应在使用 `Enter` (而不是 `Tab`)接受结果时立即运行建议。",
	"按 `Enter` 时从不运行。",
	"完整输入建议后按 `Enter` 时运行。",
	"完整输入建议后或输入不包含扩展名的文件后，在按 `Enter` 时运行。",
	"始终在按 `Enter` 时运行。",
	"控制建议选择在集成终端中的工作方式。",
	"自动触发 IntelliSense 时部分选择建议。可以使用 `Tab` 键接受第一条建议，只有在使用向下键导航建议后，使用 `Enter` 键才会也接受活动建议。",
	"自动触发 IntelliSense 时始终选择建议。可以使用 `Enter` 或 `Tab` 键接受第一条建议。",
	"自动触发 IntelliSense 时，切勿选择建议。必须先通过向下键导航列表，然后才能使用 `Enter` 或 `Tab` 键来接受活动建议。",
	"将作为建议包括在终端中的一组 Windows 命令可执行文件扩展。\r\n\r\n默认情况下包括许多可执行文件，如下所列：\r\n\r\n{0}。\r\n\r\n若要排除扩展，请将其设置为 “false”\r\n\r\n.若要将一个不在列表中，请添加它并将其设置为 “true”。",
	"控制是否应显示终端建议状态栏。",
	"控制是否启用$CDPATH支持，无论当前工作目录是什么，都公开$CDPATH变量中文件夹的子级。$CDPATH应在 Windows 上以分号分隔，并在其他平台上以分号分隔。",
	"禁用该功能。",
	"启用该功能并使用相对路径。",
	"启用该功能并使用绝对路径。当 shell 不以本机方式支持 “$CDPATH” 时，这非常有用。",
	"控制是否应检测 shell 的内联建议以及如何对其进行评分。",
	"禁用该功能。",
	"启用该功能，对内联建议进行排序，而不强制其位于顶部。这意味着完全匹配将高于内联建议。",
	"启用此功能并始终将内联建议置于顶层。",
	"确定当焦点位于第一个建议上且尚未进行导航时，向上键是否导航命令历史记录。设置为 false 时，向上箭会改为将焦点移动到最后一个建议。",
	"控制在接受建议并重新触发建议后是否自动插入空格。文件夹和符号链接文件夹从不添加尾随空格。",
	"显示来自语言服务器的建议。",
	"显示来自 {0} 的建议。",
	"终端建议提供程序",
	"控制在键入时自动显示哪些建议。建议提供程序默认启用。",
	...
	"是否要启用语音扩展?",
	"启用扩展",
	"是否要从 \"Microsoft\" 安装 \"VS Code Speech\" 扩展?",
	"安装扩展",
	"麦克风支持需要此扩展。",
	"在终端中停止听写",
	...
	"“测试”视图中“筛选器”操作的图标。",
	"在隐藏的测试显示时其旁边出现的图标。",
	"当测试资源管理器(树形式)被禁用时显示的图标。",
	"当测试资源管理器(列表形式)被禁用时显示的图标。",
	"显示的用于更新测试配置文件的图标。",
	"用于刷新测试的按钮上的图标。",
	"用于打开连续测试运行的图标。",
	"用于关闭连续测试运行的图标。",
	...
	"正在发现测试",
	"运行所有测试",
	"未在此工作区中找到测试。可能需要安装测试提供程序扩展",
	"调试所有测试",
	"未在此工作区中找到可调试测试。可能需要安装测试提供程序扩展",
	"对所有测试运行覆盖率测试",
	"在此工作区中找不到具有覆盖率运行器的测试。可能需要安装测试提供程序扩展",
	"取消测试运行",
	"以列表形式查看",
	"以树形式查看",
	"按状态排序",
	...
	"启动测试时打开测试资源管理器",
	"控制何时打开测试视图。",
	"{0} 开启时始终显示执行的测试。如果关闭此设置，则只会显示失败的测试。",
	"是否应在“文件资源管理器”视图中降低测试覆盖。",
	"配置默认情况下针对测试覆盖率显示的具体百分比。",
	"组合语句、函数和分支覆盖率的计算。",
	"语句覆盖率。",
	"语句、函数和分支覆盖率的最小值。",
	"配置测试覆盖率栏中百分比使用的颜色。",
	"控制是否在编辑器中显示覆盖率工具栏。",
	"控制“测试结果”视图的布局。",
	"在右侧显示测试运行树，在左侧显示详细信息。",
	"在左侧显示测试运行树，在右侧显示详细信息。",
	"出错",
	"失败",
	"通过",
	"已排队",
	...
	"模型想要运行所有测试。",
	"测试运行未记录任何输出。",
	"指示任何测试控制器是否具有附加的刷新处理程序。",
	"指示当前是否有任何测试控制器正在刷新测试。",
	"指示连续测试模式是否处于打开状态。",
	"指示是否有测试控制器注册了调试配置",
	"指示是否有测试控制器注册了运行配置",
	"指示是否有测试控制器注册了覆盖率配置",
	...
	"指示当前编辑器中已报告覆盖情况。",
	"指示每测试覆盖率是否可用",
	"指示是否可以将详细的逐行覆盖率信息用于内联显示",
	"指示覆盖率是否已筛选为单个测试",
	"指示是否已启用覆盖率工具栏",
	"指示是否显示内联覆盖率",
	"控制器是否实现查找与测试相关的代码的功能",
	"控制器是否实现查找与代码相关的测试的功能",
	"速览视图中显示的消息是否具有堆栈跟踪",
	"输出速览视图中项的类型。类型为“测试”、“消息”、“任务”或“结果”。",
	"当前测试项的控制器 ID",
	"当前测试项的 ID，在创建或打开测试项的菜单时设置",
	"指示测试项是否已定义 URI 的布尔值",
	"指示测试项是否处于隐藏状态的布尔值",
	"“testMessage.contextValue”中设置的值，可在编辑器/内容和测试/消息/上下文中使用",
	"结果过时时，编辑器/内容和测试/消息/上下文中的可用值",
	"指示项状态的值可用测试/项/结果。",
	"存在配置测试配置文件子菜单的菜单类型。\"run\"、\"debug\" 或 \"coverage\"",
	"正在运行测试...",
	"正在运行测试，通过 {0}/{1} ({2}%)",
	...
	"“打开时间线”操作的图标。",
	"时间线",
	"默认情况下以及在加载更多项目时在日程表视图中显示的项目数。如果设置为 \"null\"，则将根据日程表视图的可见区域自动选择一个页面大小。",
	"控制在滚动到列表结尾时，日程表视图是否将加载下一页的项目。",
	"打开时间线",
	"筛选器时间线操作的图标。",
	"筛选器时间线",
	"正在加载…",
	...
	"活动编辑器无法提供时间线信息。",
	"已筛选掉所有时间线源。",
	"除非文件已被排除或太大，否则本地历史记录将跟踪你保存的最新更改。",
	"未提供筛选的时间线信息。",
	"未提供时间表信息。",
	"尚未配置源代码管理。",
	"{0}: {1}",
	...
	"发行说明",
	"若您正以管理员身份运行 {0} 用户范围的安装，更新功能会被禁用。",
	"了解详细信息",
	"有新的 {0} 的更新可用。",
	"正在检查 {0} 更新...",
	"正在下载 {0} 更新...",
	...
	"显示设置",
	"显示已同步的数据",
	"由于 {0} 中的冲突，无法同步。请解决它们以继续。",
	"替换远程",
	"替换本地",
	"显示冲突",
	"接受更改时出错。有关更多详细信息，请查看[日志]({0})。",
	"当前会话已过期，因此已关闭设置同步。若要启用同步，请重新登录。",
	"打开设置同步…",
	"已从另一设备禁用设置同步，请再次启用同步。",
	...
	"开发人员",
	"重置欢迎页面演练进度",
	"重置欢迎页面上所有演练步骤的进度，以将其外观设置为初次查看，从而为入门体验提供全新开端。",
	"内置",
	"欢迎页面",
	"无法打开 Markdown 预览: {0}。\r\n\r\n请确保已启用 Markdown 扩展。",
	"用于欢迎页面的设置类别的图标",
	...
	"可以使用 [Copilot]({0}) 通过自然语言执行跨多个文件生成代码、修复错误、询问代码相关问题等操作。",
	"继续使用 {0} Copilot 即表示你同意 {1} 的[条款]({2})和[隐私声明]({3})",
	"使用 AI 功能",
	"开始聊天",
	"开始使用 VS Code",
	...
	"安装程序 VS Code",
	"选择主题",
	"合适的主题有助于你专注代码、更易于识别，并且使用起来更具趣味性。\r\n{0}",
	"浏览颜色主题",
	"观看视频教程",
	...
	"浏览热门 Web 扩展",
	"对所有语言的丰富支持",
	"通过语法高亮、内联建议、lint 分析和调试，更智能地编码。虽然已内置多种语言，但可将更多语言添加为扩展。\r\n{0}",
	"浏览语言扩展",
	"跨设备同步设置",
	"保持跨所有设备备份和更新基本自定义。\r\n{0}",
	"备份和同步设置",
	"使用命令面板解锁工作效率 ",
	"在 VS Code 中运行命令，无需动用鼠标即可完成任何任务。\r\n{0}",
	"打开命令面板",
	"打开你的代码",
	...
	"快速打开一个文件",
	"辅助功能入门",
	"了解可用于访问 VS Code 的工具和快捷方式。请注意，某些操作在演练的上下文中不可操作。",
	"安装程序 VS Code 辅助功能",
	"使用辅助功能帮助对话框了解功能",
	"辅助功能帮助对话框提供有关功能内容以及用于操作功能的命令/键绑定的信息。\r\n 由于焦点位于编辑器、终端、笔记本、聊天响应、注释或调试控制台上，可使用“打开辅助功能帮助”命令打开相关对话框。\r\n{0}",
	"打开辅助功能帮助",
	"屏幕阅读器用户可以在无障碍视图中逐行、逐字检查内容。",
	"辅助视图可用于终端、悬停、通知、批注、笔记本输出、聊天响应、内联完成和调试控制台输出。\r\n 如果焦点位于这些功能上，则可以使用“打开辅助视图”命令打开它。\r\n{0}",
	"打开辅助视图",
	"控制 aria 标签的详细程度",
	"工作台周围存在功能对应的屏幕阅读器详细程度设置，以便用户熟悉某项功能后，避免听到有关如何操作该功能的提示。例如，存在辅助功能帮助对话框的功能将指示如何打开对话框，直到该功能的详细程度设置被禁用。\r\n 可通过运行“打开辅助功能设置”命令来配置这些和其他辅助功能设置。\r\n{0}",
	"打开辅助功能设置",
	"使用命令面板释放工作效率",
	"在 VS Code 中运行命令，无需动用鼠标即可完成任何任务。\r\n{0}",
	"自定义键盘快捷方式",
	...
	"键盘快捷方式",
	"微调要通过音频或盲文设备接收的辅助功能信号",
	"辅助功能声音和公告会在各种事件的工作台周围播放。\r\n 可以使用“列出信号声音和列出信号公告”命令来发现和配置这些功能。\r\n{0}\r\n{1}",
	"列出信号声音",
	"列出信号公告",
	"访问编辑器中的悬停以获取有关变量或符号的详细信息",
	"当焦点位于编辑器中的变量或符号上时，可以使用“显示或打开悬停”命令聚焦悬停。\r\n{0}",
	"显示或聚焦悬停",
	"导航到文件中的符号",
	"“转到符号”命令对于在文档中的重要地标之间导航非常有用。\r\n{0}",
	"转到“符号”",
	"使用代码折叠可折叠代码块，并关注你感兴趣的代码。",
	"使用“切换折叠”命令折叠或展开代码部分。\r\n{0}\r\n 使用“切换折叠递归”命令以递归方式折叠或展开\r\n{1}\r\n",
	"切换折叠",
	"以递归方式切换折叠",
	"使用 Intellisense 提高编码效率",
	"可以使用 Trigger Intellisense 命令打开 Intellisense 建议。\r\n{0}\r\n 可以使用触发器内联建议触发内联 Intellisense 建议\r\n{1}\r\n 有用的设置包括 editor.inlineCompletionsAccessibilityVerbose 和 editor.screenReaderAnnounceInlineSuggestion。",
	"触发器 Intellisense",
	"触发内联建议",
	"配置辅助功能设置",
	"通过运行“打开辅助功能设置”命令可配置辅助功能设置。\r\n{0}",
	"打开辅助功能设置",
	"使用听写功能在编辑器和终端中编写代码和文本",
	"听写功能允许你通过语音编写代码和文本。可使用“语音: 在编辑器中开始听写”命令来激活它。\r\n{0}\r\n 在终端中进行听写时，请使用“语音: 在终端开始听写”和“语音: 在终端停止听写”命令。\r\n{1}\r\n{2}",
	"语音: 在编辑器中开始听写",
	"终端: 在终端开始听写",
	"终端: 在终端停止听写",
	"了解基础知识",
	...
	"基本功能",
	"优化设置",
	"跨设备自定义 VS Code 的所有方面并 [同步](command:workbench.userDataSync.actions.turnOn) 自定义项。\r\n{0}",
	"打开设置",
	...
	"适用于工作区信任编辑器中复选标记的图标。",
	"工作区信任编辑器中十字形的图标。",
	"适用于工作区信任编辑器中选取文件夹图标的图标。",
	"适用于工作区信任编辑器中编辑文件夹图标的图标。",
	"适用于工作区信任编辑器中删除文件夹图标的图标。",
	"主机",
	"路径",
	"{0}，受信任",
	"{1} 上的 {0}，受信任",
	...
	"你不信任当前窗口中文件的作者。已禁用以下功能:",
	"在受信任的文件夹中",
	"你信任当前文件夹中文件的作者。已启用全部功能:",
	"你不信任当前文件夹中文件的作者。已禁用以下功能:",
	"在受信任的工作区中",
	"你信任当前工作区中文件的作者。已启用所有功能:",
	...
	"键盘快捷方式: {0}",
	"信任",
	"信任当前文件夹或其父级“{0}”中所有文件的作者。",
	"信任父级",
	"不信任",
	"此工作区通过以下受信任文件夹中的加粗条目得到信任。",
	"此文件夹通过以下受信任文件夹中的加粗条目得到信任。",
	"此窗口因已打开工作区的性质而获得信任。",
	"是否已启用工作区信任功能。",
	"用户是否已信任当前工作区。",
	...
	"要显示为子菜单的菜单的标识符。",
	"指向此子菜单的菜单项的标签。",
	"(可选)用于在 UI 中表示子菜单的图标。文件路径、具有深色和浅色主题的文件路径的对象，或主题图标引用，如 \"\\$(zap)\"",
	"使用浅色主题时的图标路径",
	"使用深色主题时的图标路径",
	"向编辑器提供菜单项",
	"建议的 API 需要 `enabledApiProposal: [“{0}”]` - {1}",
	"将子菜单项分配到编辑器",
	"应为非空值。",
	...
	"(可选)用于在 UI 中表示命令的图标。文件路径、具有深色和浅色主题的文件路径的对象，或主题图标引用，如 \"\\$(zap)\"",
	"使用浅色主题时的图标路径",
	"使用深色主题时的图标路径",
	"对命令面板提供命令。",
	"{1} 已注册命令 `{0}` ({2})",
	...
	"菜单项引用了未在“子菜单”部分定义的子菜单“{0}”。",
	"`{0}` 子菜单已提供给 `{1}` 菜单。",
	"{0} 菜单贡献必须在其 {2} 字句中检查 {1}。",
	"ID",
	"标题",
	"键盘快捷方式",
	"菜单上下文",
	...
	"响应没有内容。",
	"响应内容无效。",
	"注册 GitHub Copilot Free 计划时出错。是否要重试?",
	"重试",
	"注册 GitHub Copilot Free 计划时出错。",
	"确定",
	"了解详细信息",
	"为配置提供默认值",
	"配置要应用于所有配置文件的设置。",
	...
	"无法写入 MCP 配置文件。请打开文件并更正错误或警告，然后重试。",
	...
	"无法写入 MCP 配置文件，因为文件包含未保存的更改。请先将其保存，然后重试。",
	...
	"无法解析变量 {0}。请打开一个文件夹。",
	"未给出环境变量名称，因此无法解析变量 {0}。",
	"未能找到设置“{1}”，因此无法解析变量 {0}。",
	"\"{1}\" 为结构类型值，因此无法解析变量 {0}。",
	"未给出设置名称，因此无法解析变量 {0}。",
	"无法解析变量 {0}，因为未安装扩展 {1}。",
	"无法解析变量 {0}，因为未给出扩展名。",
	"无法解析 {0} 变量。未定义 UserHome 路径",
	"无法解析变量 {0}。请确保已在活动编辑器中选择一行内容。",
	"无法解析变量 {0}。请确保已在活动编辑器中选择一列内容。",
	...
	"所有文件",
	"无扩展",
	"无法打开文件夹，请尝试改为将文件夹添加到工作区。",
	"无法打开工作区，请尝试改为将文件夹添加到工作区。",
	"打开远程(&&O)...",
	"了解详细信息(&&L)",
	"打开文件(&&F)...",
	"不支持打开本地文件夹",
	...
	"无法更改 {0} 扩展的启用，因为它是恶意的",
	"无法更改 {0} 扩展的启用，因为它不支持虚拟工作区",
	"由于扩展类型，{0} 扩展的启用无法更改",
	"无法更改 {0} 扩展的启用，因为它是不允许的",
	"{0} 扩展的启用无法更改，因为它无效",
	...
	"是否信任发布者 \"{0}\" 和 {1} 其他人？",
	"扩展 {0} 由 {1} 发布。",
	"安装此扩展还将安装 {1} 发布的 [extensions]({0})。",
	"安装此扩展还将安装 {1} 和 {2} 发布的 [extensions]({0})。",
	"这是你第一次安装来自这些发布者的扩展。",
	"扩展 {0} 由 {1} 发布。这是你从此发布者安装的第一个扩展。",
	"这是你第一次安装来自发布者 {0} 和 {1} 的扩展。",
	"{0} 已验证 {1} 的所有权。",
	"{0} 是 [**未验证]({1})。",
	"{0} 和 {1} 已[**未**验证]({2})。",
	"所有发布者均已[**未**验证]({0})。",
	"{0} 无法控制第三方扩展的行为，包括它们如何管理你的个人数据。仅在信任发布者时继续。",
	"{0} 无法控制第三方扩展的行为，包括它们如何管理你的个人数据。仅在信任发布者时继续。",
	"信任工作区 & 安装",
	"安装",
	"了解详细信息",
	...
	"“{0}”包含在“{1}”中不支持的扩展。",
	"无法激活，因为找不到 {0}",
	"用于在扩展视图和编辑器中显示默认扩展的图标。",
	"用于扩展视图和编辑器中已验证扩展发布服务器的图标。",
	"已验证扩展的发布服务器图标颜色。",
	"从以下位置删除扩展建议",
	"将扩展建议添加到",
	"工作区文件夹",
	...
	"测量扩展主机延迟",
	"API 建议",
	"UI 扩展类型。在远程窗口中, 仅本地计算机可用时启用此类扩展。",
	"工作区扩展类型。在远程窗口中，仅远程可用时启用此类扩展。",
	"引擎兼容性。",
	...
	"扩展的定价信息。可以是免费 (默认) 或试用版。有关详细信息，请访问: https://code.visualstudio.com/api/working-with-extensions/publishing-extension#extension-pricing-label",
	"相应扩展可以自由使用的 API 建议。",
	"使用扩展程序 {1} 覆盖扩展程序 {0}。",
	"使用工作区扩展 {1} 覆盖 {0}。",
	"正在 {0} 处加载开发扩展程序",
	"编辑器是只读的，因为文件的文件系统是只读的。",
	"编辑器是只读的，因为文件在此会话中设置为只读。[单击此处](command:{0})进行配置。",
	"编辑器处于只读状态，因为该文件已通过设置设为只读。[单击此处](command:{0})以配置或 [切换此会话](command:{1})。",
	...
	"类型不正确。应为“字符串”",
	"设置的类型无效，应为 {0}。请使用 JSON 格式进行修复。",
	"分析以下正则表达式（包含和不包含 u 标志）时出错：",
	"值的长度必须小于或等于 {0} 个字符。",
	"值的长度不能少于 {0} 个字符。",
	"值必须匹配 regex “{0}”。",
	...
	"静态转发",
	"网络",
	"无法使用 Web 辅助角色文本搜索器进行搜索",
	"无法使用 Web 辅助角色文件搜索器进行搜索",
	"工作区文件夹不存在: {0}",
	"是否以任何简单建议为中心",
	"是否已向下导航简单建议小组件",
	"第一个简单建议是否为重点",
	...
	"已经开始记录。",
	"停止",
	"正在准备记录 TM 语法分析。完成后按“停止”。",
	"现在正在记录 TM 语法分析。完成后按“停止”。",
	"\"contributes.{0}.language\" 中包含未知语言。提供的值: {1}",
	...
	"字体“{0}”中的字体样式无效。将忽略设置。",
	"字体 '{0}' 中的字体源无效。忽略源。",
	"字体 '{0}' 中没有有效的字体源。忽略字体定义。",
	"字体 ID“{0}”缺失或无效。将跳过字体定义。",
	"正在跳过图标定义“{0}”。未知的字体。",
	"正在跳过图标定义 '{0}'： 需要定义",
	"无法加载 {0}: {1}",
	"提供由扩展定义的主题颜色",
	...
	"\"configuration.colors\" 必须是数组",
	"{0} 必须为十六进制颜色值 (#RRGGBB[AA] 或 #RGB[A]) 或是主题颜色标识符，其提供默认值。",
	"必须定义 \"configuration.colors.id\" 且它不可为空",
	...
	"折叠的根文件夹的文件夹图标，如果未设置 rootFolderExpanded，也指展开的根文件夹的文件夹图标。",
	"展开的根文件夹的文件夹图标。展开的根文件夹图标是可选的。如果未设置，将显示为根文件夹定义的图标。",
	"将根文件夹名称关联到图标。对象键是根文件夹名称。不允许使用模式或通配符。根文件夹名匹配不区分大小写。",
	"关联的图标定义的 ID。",
	"将根文件夹名称关联到展开的根文件夹的图标。对象键是根文件夹名称。不允许使用模式或通配符。根文件夹名匹配不区分大小写。",
	"关联的图标定义的 ID。",
	...
	"默认字体大小。强烈建议使用百分比值，例如: 125%。",
	"将文件与图标关联时可使用的所有图标的说明。",
	"图标定义。对象键是定义的 ID。",
	...
	"字体的样式。要了解有效值，请参阅 https://developer.mozilla.org/zh-cn/docs/Web/CSS/font-style。",
	"字体字符的图标名称的关联。",
	"指定未启用 {0} 时在工作台中使用颜色主题。",
	"主题未知或未安装。",
	"指定当系统颜色模式为深色并启用 {0} 时的颜色主题。",
	"指定当系统颜色模式为浅色并启用 {0} 时的颜色主题。",
	"指定在高对比度深色模式下启用 {0} 时的颜色主题。",
	"指定在高对比度浅色模式下启用 {0} 时的颜色主题。",
	"如果已启用，将根据系统颜色模式自动选择颜色主题。如果系统颜色模式为深色，则使用 {0}，否则使用 {1}。",
	"覆盖当前所选颜色主题的颜色。",
	...
	"默认",
	"产品图标主题未知或未安装。",
	"如果已启用，则在操作系统使用高对比度主题时，将自动更改为高对比度主题。要使用的高对比度主题是由“{0}”和“{1}”指定的。",
	"设置注释的颜色和样式",
	"设置字符串文本的颜色和样式",
	"设置关键字的颜色和样式。",
	"设置数字的颜色和样式。",
	...
	"必须定义 \"configuration.{0}.id\" 且它不可为空",
	...
	"当前工作区已从当前配置文件中移除。请重新加载以切换回更新后的配置文件",
	"已更新当前配置文件。请重新加载以切换回更新的配置文件",
	"无法重命名默认配置文件",
	"无法删除默认配置文件。",
	"正在切换到配置文件",
	"切换配置文件需要重新加载 VS Code。",
	"重载(&&R)",
	"默认配置文件的图标。",
	"个人资料",
	"配置文件",
	...
	"接受和本地 {0}",
	"接受本地(&&L)",
	"这将清除云中的数据，并在所有设备上停止同步。",
	"清除",
	"重置(&&R)",
	"选择要下载“设置同步”活动的文件夹",
	"保存",
	"无法登录，因为没有可用的身份验证提供程序。",
	"选择要登录的帐户",
	"已登录",
	"上次使用时同步",
	"其他",
