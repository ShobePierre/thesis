...
export declare const RunSubagentToolId = "runSubagent";
export declare class RunSubagentTool extends Disposable implements IToolImpl {
    ...
    constructor(chatAgentService: IChatAgentService, chatService: IChatService, chatModeService: IChatModeService, languageModelToolsService: ILanguageModelToolsService, languageModelsService: ILanguageModelsService, logService: ILogService, toolsService: ILanguageModelToolsService, configurationService: IConfigurationService);
