    ...
    'properties': {
                ...
                'anyOf': [
                    {
                        'type': 'boolean',
                        'enum': [true, false],
                        'enumDescriptions': [( localize(8085, "Enable the pattern.")), ( localize(8086, "Disable the pattern."))],
        ...
        'files.eol': {
            ...
            'enumDescriptions': [
                ( localize(8093, "LF")),
                ( localize(8094, "CRLF")),
                ( localize(8095, "Uses operating system specific end of line character."))
            ],
            'default': 'auto',
            'description': ( localize(8096, "The default end of line character.")),
            'scope': ConfigurationScope.LANGUAGE_OVERRIDABLE
        },
        'files.enableTrash': {
            'type': 'boolean',
        ...
        'files.trimTrailingWhitespace': {
            'type': 'boolean',
            'default': false,
            'description': ( localize(8098, "When enabled, will trim trailing whitespace when saving a file.")),
            'scope': ConfigurationScope.LANGUAGE_OVERRIDABLE
        },
        ...
        'files.autoSave': {
            ...
            'markdownEnumDescriptions': [
                ( localize(8102, "An editor with changes is never automatically saved.")),
                ( localize(
                8103,
        ...
        'files.restoreUndoStack': {
            'type': 'boolean',
            'description': ( localize(8116, "Restore the undo stack when a file is reopened.")),
            'default': true
        },
...
configurationRegistry.registerConfiguration({
    ...
    properties: {
        ...
        'editor.formatOnSaveMode': {
            ...
            'enumDescriptions': [
                ( localize(8125, "Format the whole file.")),
                ( localize(8126, "Format modifications (requires source control).")),
                ( localize(
                8127,
