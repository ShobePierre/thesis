...
const autoApproveBoolean = {
    ...
    enumDescriptions: [
        ( localize(12068, "Automatically approve the pattern.")),
        ( localize(12069, "Require explicit approval for the pattern.")),
    ],
...
const terminalChatAgentProfileSchema = {
    ...
    properties: {
        path: {
            description: ( localize(12071, "A path to a shell executable.")),
            type: 'string',
        },
...
const terminalChatAgentToolsConfiguration = {
    ...
    [TerminalChatAgentToolsSettingId.AutoApprove]: {
        markdownDescription: [
            ...
            [
                ( localize(12078, 'Examples:')),
                `|${( localize(12079, "Value"))}|${( localize(12080, "Description"))}|`,
                '|---|---|',
                '| `\"mkdir\": true` | ' + ( localize(12081, "Allow all commands starting with {0}", '`mkdir`')),
                '| `\"npm run build\": true` | ' + ( localize(12082, "Allow all commands starting with {0}", '`npm run build`')),
                ...
                '| `\"/^Get-ChildItem\\\\b/i\": true` | ' + ( localize(12085, "will allow {0} commands regardless of casing", '`Get-ChildItem`')),
                '| `\"/.*/\": true` | ' + ( localize(12086, "Allow all commands (denied commands still require approval)")),
                '| `\"rm\": false` | ' + ( localize(
                    12087,
                ...
                '| `\"rm\": null` | ' + ( localize(12089, "Unset the default {0} value for {1}", '`false`', '`rm`')),
            ].join('\n'),
        ].join('\n\n'),
        type: 'object',
                ...
                autoApproveBoolean,
                {
                    ...
                    properties: {
                        ...
                        matchCommandLine: {
                            ...
                            enumDescriptions: [
                                ( localize(12090, "Match against the full command line, eg. `foo && bar`.")),
                                ( localize(
                                12091,
    ...
    [TerminalChatAgentToolsSettingId.BlockDetectedFileWrites]: {
        ...
        enumDescriptions: [
            ( localize(12095, "Allow all detected file writes.")),
            ( localize(
            12096,
            ...
            ( localize(12097, "Block all detected file writes.")),
        ],
    ...
    [TerminalChatAgentToolsSettingId.OutputLocation]: {
        markdownDescription: ( localize(12105, "Where to show the output from the run in terminal tool session.")),
        type: 'string',
        enum: ['terminal', 'none'],
        enumDescriptions: [
            ( localize(12106, "Reveal the terminal when running the command.")),
            ( localize(12107, "Do not reveal the terminal automatically.")),
        ],
