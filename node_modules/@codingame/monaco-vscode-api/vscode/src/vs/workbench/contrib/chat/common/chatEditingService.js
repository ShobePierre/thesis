...
function editEntriesToMultiDiffData(entriesObs) {
    return {
        ...
        multiDiffData: ( entriesObs.map(entries => ({
            title: ( localize(5933, 'Changes to {0} files', entries.length)),
...
const chatEditingWidgetFileStateContextKey = ( new RawContextKey('chatEditingWidgetFileState', undefined, ( localize(5934, "The current state of the file in the chat editing widget"))));
