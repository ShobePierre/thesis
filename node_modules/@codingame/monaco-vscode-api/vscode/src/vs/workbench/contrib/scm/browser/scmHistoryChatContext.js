...
let SCMHistoryItemContext = SCMHistoryItemContext_1 = class SCMHistoryItemContext {
    ...
    constructor(_scmViewService) {
        ...
        this.label = ( localize(10555, 'Source Control...'));
    ...
    asPicker(_widget) {
        return {
            placeholder: ( localize(10556, 'Select a change')),
                    ...
                    return historyProvider.provideHistoryItems({ historyItemRefs, filterText, limit: 100 }, token)
                        ...
                        return (historyItems.map(historyItem => {
                            ...
                            if (historyItem.statistics) {
                                details.push(`${historyItem.statistics.files} ${( localize(10557, 'file(s)'))}`);
                            }
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(10558, 'Add to Chat')),
            f1: false,
            menu: {
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(10559, 'Explain Changes')),
            f1: false,
            menu: {
                id: MenuId.SCMHistoryItemContext,
                group: 'z_chat',
