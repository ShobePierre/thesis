...
KeybindingsRegistry.registerCommandAndKeybindingRule({
    ...
    handler: async (accessor, resource) => {
        ...
        if (uri && fileService.hasProvider(uri)) {
            ...
            const editorLabel = ( localize(8039, "{0} (in file) ↔ {1}", name, name));
            try {
...
KeybindingsRegistry.registerCommandAndKeybindingRule({
    ...
    win: {
        primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyMod$1.Shift | KeyCode.KeyC)
    },
...
KeybindingsRegistry.registerCommandAndKeybindingRule({
    weight: KeybindingWeight.WorkbenchContrib,
    when: EditorContextKeys.focus,
    primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyMod$1.Shift | KeyMod$1.Alt | KeyCode.KeyC),
    win: {
        primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyMod$1.Shift | KeyCode.KeyC)
    },
    id: COPY_RELATIVE_PATH_COMMAND_ID,
...
CommandsRegistry.registerCommand({
    ...
    handler: async (accessor, args) => {
        ...
        const fileService = accessor.get(IFileService);
        const createFileLocalized = ( localize(8040, "Create File"));
