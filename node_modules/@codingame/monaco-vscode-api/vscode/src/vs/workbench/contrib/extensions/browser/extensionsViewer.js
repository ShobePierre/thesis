...
function getAriaLabelForExtension(extension) {
    ...
    const publisher = extension.publisherDomain?.verified ? ( localize(7668, "Verified Publisher {0}", extension.publisherDisplayName)) : ( localize(7669, "Publisher {0}", extension.publisherDisplayName));
    const deprecated = extension?.deprecationInfo ? ( localize(7670, "Deprecated")) : '';
    ...
    constructor(parent, viewId, options, extensionsViewState, extensionsWorkbenchService, viewDescriptorService, layoutService, notificationService, contextMenuService, contextKeyService, instantiationService) {
        ...
        this.list = instantiationService.createInstance(WorkbenchPagedList, `${viewId}-Extensions`, parent, delegate, [renderer], {
            ...
            accessibilityProvider: {
                ...
                getWidgetAriaLabel() {
                    return localize(7672, "Extensions");
                }
            },
...
class UnknownExtensionRenderer {
    ...
    renderTemplate(container) {
        ...
        append(messageContainer, $('span.error-marker')).textContent = ( localize(7673, "Error"));
        append(messageContainer, $('span.message')).textContent = ( localize(7674, "Unknown Extension:"));
