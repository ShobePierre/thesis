...
let SettingsTargetsWidget = class SettingsTargetsWidget extends Widget {
    ...
    resetLabels() {
        ...
        this.userLocalSettings.label = ( localize(9934, "User"));
        this.userRemoteSettings.label = ( localize(9935, "Remote")) + (hostLabel ? ` [${hostLabel}]` : '');
        this.workspaceSettings.label = ( localize(9936, "Workspace"));
        this.folderSettingsAction.label = ( localize(9937, "Folder"));
    }
    create(parent) {
        ...
        this.settingsSwitcherBar = this._register(( new ActionBar(settingsTabsWidget, {
            ...
            ariaLabel: ( localize(9938, "Settings Switcher")),
            ariaRole: 'tablist',
        ...
        this.userLocalSettings.tooltip = ( localize(9934, "User"));
        ...
        const remoteAuthority = this.environmentService.remoteAuthority;
        const hostLabel = remoteAuthority && this.labelService.getHostLabel(Schemas.vscodeRemote, remoteAuthority);
        this.userRemoteSettings.tooltip = ( localize(9935, "Remote")) + (hostLabel ? ` [${hostLabel}]` : '');
    ...
    setResultCount(settingsTarget, count) {
        if (settingsTarget === ConfigurationTarget.WORKSPACE) {
            let label = ( localize(9936, "Workspace"));
            if (count) {
                label += ` (${count})`;
            }
    ...
    async update() {
        ...
        this.workspaceSettings.tooltip = ( localize(9936, "Workspace"));
    }
};
