...
const $ = $$1;
const debugExceptionWidgetBorder = registerColor('debugExceptionWidget.border', '#a31515', ( localize(6910, 'Exception widget border color.')));
const debugExceptionWidgetBackground = registerColor('debugExceptionWidget.background', { dark: '#420b0d', light: '#f1dfde', hcDark: '#420b0d', hcLight: '#f1dfde' }, ( localize(6911, 'Exception widget background color.')));
let ExceptionWidget = class ExceptionWidget extends ZoneWidget {
    ...
    _fillContainer(container) {
        ...
        label.textContent = this.exceptionInfo.id ? ( localize(6912, 'Exception has occurred: {0}', this.exceptionInfo.id)) : ( localize(6913, 'Exception has occurred.'));
        let ariaLabel = label.textContent;
        const actionBar = ( new ActionBar(actions));
        actionBar.push(( new Action('editor.closeExceptionWidget', ( localize(6914, "Close")), ThemeIcon.asClassName(widgetClose), true, async () => {
