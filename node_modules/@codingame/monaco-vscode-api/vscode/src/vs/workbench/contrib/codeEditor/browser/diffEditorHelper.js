        ...
        if (!isEmbeddedDiffEditor) {
            ...
            this._register(autorunWithStore((reader, store) => {
                if (onlyWhiteSpaceChange.read(reader)) {
                    const helperWidget = store.add(this._instantiationService.createInstance(FloatingEditorClickWidget, this._diffEditor.getModifiedEditor(), ( localize(6134, "Show Whitespace Differences")), null));
                ...
                if (diffComputationResult && diffComputationResult.quitEarly) {
                    this._notificationService.prompt(Severity$1.Warning, ( localize(
                        ...
                        this._diffEditor.maxComputationTime
                            ...
                            label: ( localize(6136, "Remove Limit")),
                            run: () => {
