...
import { DiffEditorPool, EditorPool } from "@codingame/monaco-vscode-katex-common/vscode/vs/workbench/contrib/chat/browser/chatContentParts/chatContentCodePools";
