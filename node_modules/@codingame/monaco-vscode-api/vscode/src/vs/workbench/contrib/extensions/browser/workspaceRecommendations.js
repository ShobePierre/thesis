    ...
    async doActivate() {
        ...
        this._register(this.fileService.onDidFilesChange(e => {
            if (( this.contextService.getWorkspace().folders.some(
                folder => e.affects(this.uriIdentityService.extUri.joinPath(folder.uri, WORKSPACE_EXTENSIONS_FOLDER), FileChangeType.ADDED, FileChangeType.DELETED)
            ))) {
                    ...
                    if (invalidRecommendations.indexOf(extensionId) === -1) {
                        this._recommendations.push({
                            ...
                            reason: {
                                ...
                                reasonText: ( localize(7834, "This extension is recommended by users of the current workspace."))
                            }
                        });
                    }
                }
