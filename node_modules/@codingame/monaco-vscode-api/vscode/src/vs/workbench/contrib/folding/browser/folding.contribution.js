...
let DefaultFoldingRangeProvider = class DefaultFoldingRangeProvider extends Disposable {
    ...
    async _updateConfigValues() {
        ...
        DefaultFoldingRangeProvider_1.extensionItemLabels.push(( localize(8245, 'All')));
        DefaultFoldingRangeProvider_1.extensionDescriptions.push(( localize(8246, "All active folding range providers")));
