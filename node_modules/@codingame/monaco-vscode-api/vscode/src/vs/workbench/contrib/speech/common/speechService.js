...
const HasSpeechProvider = ( new RawContextKey('hasSpeechProvider', false, { type: 'boolean', description: ( localize(10995, "A speech provider is registered to the speech service.")) }));
const SpeechToTextInProgress = ( new RawContextKey(
    'speechToTextInProgress',
    false,
    { type: 'boolean', description: ( localize(10996, "A speech-to-text session is in progress.")) }
));
const TextToSpeechInProgress = ( new RawContextKey(
    'textToSpeechInProgress',
    false,
    { type: 'boolean', description: ( localize(10997, "A text-to-speech session is in progress.")) }
));
...
const SPEECH_LANGUAGES = {
    ['da-DK']: {
        name: ( localize(10998, "Danish (Denmark)"))
    },
    ['de-DE']: {
        name: ( localize(10999, "German (Germany)"))
    },
    ['en-AU']: {
        name: ( localize(11000, "English (Australia)"))
    },
    ['en-CA']: {
        name: ( localize(11001, "English (Canada)"))
    },
    ['en-GB']: {
        name: ( localize(11002, "English (United Kingdom)"))
    },
    ['en-IE']: {
        name: ( localize(11003, "English (Ireland)"))
    },
    ['en-IN']: {
        name: ( localize(11004, "English (India)"))
    },
    ['en-NZ']: {
        name: ( localize(11005, "English (New Zealand)"))
    },
    ['en-US']: {
        name: ( localize(11006, "English (United States)"))
    },
    ['es-ES']: {
        name: ( localize(11007, "Spanish (Spain)"))
    },
    ['es-MX']: {
        name: ( localize(11008, "Spanish (Mexico)"))
    },
    ['fr-CA']: {
        name: ( localize(11009, "French (Canada)"))
    },
    ['fr-FR']: {
        name: ( localize(11010, "French (France)"))
    },
    ['hi-IN']: {
        name: ( localize(11011, "Hindi (India)"))
    },
    ['it-IT']: {
        name: ( localize(11012, "Italian (Italy)"))
    },
    ['ja-JP']: {
        name: ( localize(11013, "Japanese (Japan)"))
    },
    ['ko-KR']: {
        name: ( localize(11014, "Korean (South Korea)"))
    },
    ['nl-NL']: {
        name: ( localize(11015, "Dutch (Netherlands)"))
    },
    ['pt-PT']: {
        name: ( localize(11016, "Portuguese (Portugal)"))
    },
    ['pt-BR']: {
        name: ( localize(11017, "Portuguese (Brazil)"))
    },
    ['ru-RU']: {
        name: ( localize(11018, "Russian (Russia)"))
    },
    ['sv-SE']: {
        name: ( localize(11019, "Swedish (Sweden)"))
    },
    ['tr-TR']: {
        name: ( localize(11020, "Turkish (Türkiye)"))
    },
    ['zh-CN']: {
        name: ( localize(11021, "Chinese (Simplified, China)"))
    },
    ['zh-HK']: {
        name: ( localize(11022, "Chinese (Traditional, Hong Kong)"))
    },
    ['zh-TW']: {
        name: ( localize(11023, "Chinese (Traditional, Taiwan)"))
    }
};
