...
const REMOTE_CATEGORY = ( localize2(7675, "Remote"));
let ExtensionsViewletViewsContribution = class ExtensionsViewletViewsContribution extends Disposable {
    ...
    registerViews() {
        ...
        viewDescriptors.push({
            ...
            name: ( localize2(7676, "Marketplace")),
    ...
    createDefaultExtensionsViewDescriptors() {
        ...
        for (const server of servers) {
            const getInstalledViewName = () => getViewName(( localize(7679, "Installed")), server);
                ...
                this._register(registerAction2(class InstallLocalExtensionsInRemoteAction2 extends Action2 {
                    constructor() {
                        super({
                            ...
                            get title() {
                                return localize2(7680, "Install Local Extensions in '{0}'...", server.label);
                            },
            ...
            this._register(registerAction2(class InstallRemoteExtensionsInLocalAction2 extends Action2 {
                constructor() {
                    super({
                        ...
                        title: ( localize2(7681, 'Install Remote Extensions Locally...')),
                        category: REMOTE_CATEGORY,
                        f1: true
                    });
                }
        ...
        viewDescriptors.push({
            ...
            name: ( localize2(7683, "Recommended")),
    ...
    createSearchExtensionsViewDescriptors() {
        ...
        viewDescriptors.push({
            ...
            name: ( localize2(7686, "Recently Updated")),
        ...
        viewDescriptors.push({
            ...
            name: ( localize2(7691, "Workspace Unsupported")),
            ctorDescriptor: ( new SyncDescriptor(ExtensionsListView, [{}])),
    ...
    createRecommendedExtensionsViewDescriptors() {
        ...
        viewDescriptors.push({
            ...
            name: ( localize2(7692, "Workspace Recommendations")),
        ...
        viewDescriptors.push({
            ...
            name: ( localize2(7693, "Other Recommendations")),
    ...
    createBuiltinExtensionsViewDescriptors() {
        ...
        viewDescriptors.push({
            ...
            name: ( localize2(7696, "Programming Languages")),
            ctorDescriptor: ( new SyncDescriptor(
    ...
    createUnsupportedWorkspaceExtensionsViewDescriptors() {
        ...
        viewDescriptors.push({
            ...
            name: ( localize2(7697, "Disabled in Restricted Mode")),
        ...
        viewDescriptors.push({
            ...
            name: ( localize2(7698, "Limited in Restricted Mode")),
        ...
        viewDescriptors.push({
            ...
            name: ( localize2(7699, "Disabled in Virtual Workspaces")),
        ...
        viewDescriptors.push({
            ...
            name: ( localize2(7700, "Limited in Virtual Workspaces")),
    ...
    createOtherLocalFilteredExtensionsViewDescriptors() {
        ...
        viewDescriptors.push({
            ...
            name: ( localize2(7701, "Deprecated")),
...
let ExtensionsViewPaneContainer = class ExtensionsViewPaneContainer extends ViewPaneContainer {
    ...
    create(parent) {
        ...
        const placeholder = ( localize(7702, "Search Extensions in Marketplace"));
    ...
    renderNotificaiton() {
        ...
        if (status && (query === this.searchBox?.getValue() || !this.searchMarketplaceExtensionsContextKey.get())) {
            ...
            const showAction = append(messageContainer, $('span.message-text-action', {
                'tabindex': '0',
                'role': 'button',
                'aria-label': `${status.message}. ${( localize(7703, "Click to Show"))}`
            }, ( localize(7704, "Show"))));
            ...
            const dismissAction = append(this.notificationContainer, $(`span.message-action${ThemeIcon.asCSSSelector(Codicon.close)}`, {
                'tabindex': '0',
                'role': 'button',
                'aria-label': ( localize(7705, "Dismiss")),
                'title': ( localize(7705, "Dismiss"))
            }));
    ...
    alertSearchResult(count, viewId) {
        ...
        switch (count) {
            ...
            case 1:
                if (view) {
                    alert(( localize(7706, "1 extension found in the {0} section.", view.name.value)));
                }
                else {
                    alert(( localize(7707, "1 extension found.")));
                }
                break;
            default:
                if (view) {
                    alert(( localize(7708, "{0} extensions found in the {1} section.", count, view.name.value)));
                }
                else {
                    alert(( localize(7709, "{0} extensions found.", count)));
                }
                break;
        }
    }
    ...
    onError(err) {
        ...
        if (/ECONNREFUSED/.test(message)) {
            const error = createErrorWithActions(( localize(
                ...
                ( new Action('open user settings', ( localize(7711, "Open User Settings")), undefined, true, () => this.preferencesService.openUserSettings()))
            ]);
    ...
    onServiceChange() {
        ...
        if (extensionsNotification) {
            ...
            if (newBadgeNumber > 0) {
                let msg = '';
                if (outdated) {
                    msg += outdated === 1 ? ( localize(7712, '{0} requires update', outdated)) : ( localize(7713, '{0} require update', outdated));
                }
                if (outdated > 0 && actionRequired.length > 0) {
                    msg += ', ';
                }
                if (actionRequired.length) {
                    msg += actionRequired.length === 1 ? ( localize(7714, '{0} requires restart', actionRequired.length)) : ( localize(7715, '{0} require restart', actionRequired.length));
                }
            ...
            if (maliciousExtensions.length) {
                ...
                for (const [extension, link] of maliciousExtensions) {
                    ...
                    if (shouldRestartExtensions || shouldReloadWindow) {
                        buttons.push({
                            label: shouldRestartExtensions ? ( localize(7716, "Restart Extensions")) : ( localize(7717, "Reload Now")),
                            run: () => shouldRestartExtensions ? this.extensionsWorkbenchService.updateRunningExtensions() : this.hostService.reload()
                        });
                    }
                    if (link) {
                        buttons.push({
                            label: ( localize(7718, "Learn More")),
    ...
    async updateBadge() {
        ...
        switch (status) {
            case ExtensionGalleryManifestStatus.RequiresSignIn:
                badge = ( new NumberBadge(1, () => ( localize(7720, "Sign in required to access marketplace"))));
                break;
            case ExtensionGalleryManifestStatus.AccessDenied:
                badge = ( new WarningBadge(() => ( localize(7721, "Access denied to marketplace"))));
                break;
        }
        if (badge) {
            this.badgeHandle.value = this.activityService.showViewContainerActivity(VIEWLET_ID, { badge });
        ...
        if (status === ExtensionGalleryManifestStatus.RequiresSignIn) {
            const badge = ( new NumberBadge(1, () => ( localize(7722, "Sign in to access Marketplace"))));
