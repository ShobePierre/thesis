...
(function (CommentAccessibilityHelpNLS) {
    ...
    CommentAccessibilityHelpNLS.commentCommands = ( localize(6318, "Some useful comment commands include:"));
    CommentAccessibilityHelpNLS.escape = ( localize(6319, "- Dismiss Comment (Escape)"));
    ...
    CommentAccessibilityHelpNLS.submitComment = ( localize(6327, "- Submit Comment{0}.", `<keybinding:${CommentCommandId.Submit}>`));
