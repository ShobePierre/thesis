...
let OpenEditorsView = class OpenEditorsView extends ViewPane {
    ...
    static { this.NAME = ( localize2(8217, "Open Editors")); }
    ...
    updateDirtyIndicator(workingCopy) {
        ...
        if (dirty === 0) {
            ...
            this.dirtyCountElement.textContent = ( localize(8218, "{0} unsaved", dirty));
...
class OpenEditorsAccessibilityProvider {
    getWidgetAriaLabel() {
        return localize(8217, "Open Editors");
    }
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(8219, "Toggle Vertical/Horizontal Editor Layout")),
            f1: true,
            keybinding: {
...
MenuRegistry.appendMenuItem(MenuId.MenubarLayoutMenu, {
    ...
    command: {
        ...
        title: {
            ...( localize2(8220, "Flip Layout")),
            mnemonicTitle: ( localize(8221, "Flip &&Layout"))
        }
    },
    order: 1
});
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(8222, "New Untitled Text File")),
            f1: false,
