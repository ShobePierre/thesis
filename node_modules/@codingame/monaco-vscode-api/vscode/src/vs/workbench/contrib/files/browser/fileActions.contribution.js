...
const copyPathCommand = {
    ...
    title: ( localize(7903, "Copy Path"))
};
const copyRelativePathCommand = {
    id: COPY_RELATIVE_PATH_COMMAND_ID,
    title: ( localize(7904, "Copy Relative Path"))
};
const revealInSideBarCommand = {
    id: REVEAL_IN_EXPLORER_COMMAND_ID,
    title: ( localize(7905, "Reveal in Explorer View"))
};
...
appendSaveConflictEditorTitleAction('workbench.files.action.acceptLocalChanges', ( localize(7906, "Use your changes and overwrite file contents")), Codicon.check, -10, acceptLocalChangesCommand);
appendSaveConflictEditorTitleAction('workbench.files.action.revertLocalChanges', ( localize(7907, "Discard your changes and revert to file contents")), Codicon.discard, -9, revertLocalChangesCommand);
...
appendToCommandPalette({
    id: COPY_PATH_COMMAND_ID,
    title: ( localize2(7908, "Copy Path of Active File")),
    category: Categories.File
});
appendToCommandPalette({
    id: COPY_RELATIVE_PATH_COMMAND_ID,
    title: ( localize2(7909, "Copy Relative Path of Active File")),
    category: Categories.File
});
appendToCommandPalette({
...
appendToCommandPalette({
    ...
    title: ( localize2(7910, "Save All in Group")),
    category: Categories.File
});
appendToCommandPalette({
    id: SAVE_FILES_COMMAND_ID,
    title: ( localize2(7911, "Save All Files")),
    category: Categories.File
});
appendToCommandPalette({
    id: REVERT_FILE_COMMAND_ID,
    title: ( localize2(7912, "Revert File")),
    category: Categories.File
});
appendToCommandPalette({
    id: COMPARE_WITH_SAVED_COMMAND_ID,
    title: ( localize2(7913, "Compare Active File with Saved")),
    category: Categories.File,
    metadata: {
...
appendToCommandPalette({
    ...
    category: Categories.File,
    metadata: { description: ( localize2(7915, "Create a new folder or directory")) }
}, ( WorkspaceFolderCountContext.notEqualsTo('0')));
appendToCommandPalette({
...
const openToSideCommand = {
    ...
    title: ( localize(7916, "Open to the Side"))
};
...
MenuRegistry.appendMenuItem(MenuId.OpenEditorsContext, {
    ...
    command: {
        ...
        title: ( localize(7917, "Reopen Editor With..."))
    },
...
MenuRegistry.appendMenuItem(MenuId.OpenEditorsContext, {
    ...
    command: {
        id: REVERT_FILE_COMMAND_ID,
        title: ( localize(7912, "Revert File")),
        precondition: OpenEditorsDirtyEditorContext
    },
    when: ( ContextKeyExpr.and((
    OpenEditorsGroupContext.toNegated()), (
...
MenuRegistry.appendMenuItem(MenuId.OpenEditorsContext, {
    ...
    command: {
        id: COMPARE_WITH_SAVED_COMMAND_ID,
        title: ( localize(7919, "Compare with Saved")),
        precondition: OpenEditorsDirtyEditorContext
    },
...
const compareResourceCommand = {
    ...
    title: ( localize(7920, "Compare with Selected"))
};
MenuRegistry.appendMenuItem(MenuId.OpenEditorsContext, {
    group: '3_compare',
    order: 20,
...
const selectForCompareCommand = {
    ...
    title: ( localize(7921, "Select for Compare"))
};
MenuRegistry.appendMenuItem(MenuId.OpenEditorsContext, {
    group: '3_compare',
    order: 30,
...
const compareSelectedCommand = {
    ...
    title: ( localize(7922, "Compare Selected"))
};
MenuRegistry.appendMenuItem(MenuId.OpenEditorsContext, {
    group: '3_compare',
    order: 30,
...
MenuRegistry.appendMenuItem(MenuId.OpenEditorsContext, {
    ...
    command: {
        ...
        title: ( localize(7924, "Close Others"))
    },
    when: ( OpenEditorsGroupContext.toNegated())
});
MenuRegistry.appendMenuItem(MenuId.OpenEditorsContext, {
    ...
    command: {
        ...
        title: ( localize(7925, "Close Saved"))
    }
});
MenuRegistry.appendMenuItem(MenuId.OpenEditorsContext, {
    group: '4_close',
...
MenuRegistry.appendMenuItem(MenuId.ExplorerContext, {
    ...
    alt: {
        id: DELETE_FILE_ID,
        title: ( localize(7929, "Delete Permanently"))
    },
...
for (const menuId of [MenuId.EmptyEditorGroupContext, MenuId.EditorTabsBarContext]) {
    MenuRegistry.appendMenuItem(menuId, { command: { id: NEW_UNTITLED_FILE_COMMAND_ID, title: ( localize(7930, "New Text File")) }, group: '1_file', order: 10 });
    MenuRegistry.appendMenuItem(menuId, { command: { id: 'workbench.action.quickOpen', title: ( localize(7931, "Open File...")) }, group: '1_file', order: 20 });
}
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    group: '1_new',
    command: {
        id: NEW_UNTITLED_FILE_COMMAND_ID,
        title: ( localize(7932, "&&New Text File"))
    },
    order: 1
});
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        ...
        title: ( localize(7936, "A&&uto Save")),
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        id: REVERT_FILE_COMMAND_ID,
        title: ( localize(7937, "Re&&vert File")),
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        id: CLOSE_EDITOR_COMMAND_ID,
        title: ( localize(7938, "&&Close Editor")),
        precondition: ( ContextKeyExpr.or(ActiveEditorContext, ( ContextKeyExpr.and(FoldersViewVisibleContext, SidebarFocusContext))))
    },
    order: 2
});
MenuRegistry.appendMenuItem(MenuId.MenubarGoMenu, {
    ...
    command: {
        ...
        title: ( localize(7939, "Go to &&File..."))
    },
    order: 1
});
