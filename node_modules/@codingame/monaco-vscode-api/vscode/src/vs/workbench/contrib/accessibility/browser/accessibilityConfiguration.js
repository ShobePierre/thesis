...
const accessibilityConfigurationNodeBase = ( Object.freeze({
    id: 'accessibility',
    title: ( localize(4190, "Accessibility")),
    type: 'object'
}));
const soundFeatureBase = {
    ...
    'default': 'auto',
    'enumDescriptions': [
        ( localize(4191, "Enable sound when a screen reader is attached.")),
        ( localize(4192, "Enable sound.")),
        ( localize(4193, "Disable sound."))
    ],
    tags: ['accessibility'],
};
...
const announcementFeatureBase = {
    ...
    'enumDescriptions': [
        ...
        ( localize(4195, "Disable announcement."))
    ],
    tags: ['accessibility'],
};
...
const configuration = {
    ...
    properties: {
        ...
        [AccessibilityVerbositySettingId.DiffEditorActive]: {
            description: ( localize(4209, 'Indicate when a diff editor becomes the active editor.')),
            ...baseVerbosityProperty
        },
        ...
        'accessibility.signalOptions.volume': {
            'description': ( localize(4214, "The volume of the sounds in percent (0-100).")),
            'type': 'number',
            'minimum': 0,
            'maximum': 100,
            'default': 70,
        ...
        'accessibility.signalOptions.debouncePositionChanges': {
            'description': ( localize(4215, "Whether or not position changes should be debounced")),
            'type': 'boolean',
            'default': false,
            'tags': ['accessibility']
        },
        'accessibility.signalOptions.experimental.delays.general': {
            ...
            'properties': {
                'announcement': {
                    'description': ( localize(4216, "The delay in milliseconds before an announcement is made.")),
                    'type': 'number',
                    'minimum': 0,
                    'default': 3000
                },
                'sound': {
                    'description': ( localize(4217, "The delay in milliseconds before a sound is played.")),
                    'type': 'number',
                    'minimum': 0,
                    'default': 400
                }
        ...
        'accessibility.signals.lineHasBreakpoint': {
            ...
            'properties': {
                'sound': {
                    'description': ( localize(4223, "Plays a sound when the active line has a breakpoint.")),
                    ...soundFeatureBase
                },
                'announcement': {
                    'description': ( localize(4224, "Announces when the active line has a breakpoint.")),
        ...
        'accessibility.signals.lineHasInlineSuggestion': {
            ...
            'properties': {
                'sound': {
                    'description': ( localize(4226, "Plays a sound when the active line has an inline suggestion.")),
                    ...soundFeatureBase,
                    'default': 'off'
                }
            }
        ...
        'accessibility.signals.nextEditSuggestion': {
            ...
            'properties': {
                'sound': {
                    'description': ( localize(4228, "Plays a sound when there is a next edit suggestion.")),
                    ...soundFeatureBase,
                },
                'announcement': {
                    'description': ( localize(4229, "Announces when there is a next edit suggestion.")),
                    ...announcementFeatureBase,
                },
            }
        },
        'accessibility.signals.lineHasError': {
            ...
            'properties': {
                'sound': {
                    'description': ( localize(4231, "Plays a sound when the active line has an error.")),
                    ...soundFeatureBase
                },
                'announcement': {
                    'description': ( localize(4232, "Announces when the active line has an error.")),
                    ...announcementFeatureBase,
                    default: 'off'
                },
            },
        ...
        'accessibility.signals.lineHasWarning': {
            ...
            'properties': {
                'sound': {
                    'description': ( localize(4237, "Plays a sound when the active line has a warning.")),
                    ...soundFeatureBase
                },
                'announcement': {
                    'description': ( localize(4238, "Announces when the active line has a warning.")),
                    ...announcementFeatureBase,
                    default: 'off'
                },
            },
        ...
        'accessibility.signals.positionHasError': {
            ...
            'properties': {
                'sound': {
                    'description': ( localize(4240, "Plays a sound when the active line has a warning.")),
                    ...soundFeatureBase
                },
                'announcement': {
                    'description': ( localize(4241, "Announces when the active line has a warning.")),
                    ...announcementFeatureBase,
                    default: 'on'
                },
            },
        ...
        'accessibility.signals.positionHasWarning': {
            ...
            'properties': {
                'sound': {
                    'description': ( localize(4243, "Plays a sound when the active line has a warning.")),
                    ...soundFeatureBase
                },
                'announcement': {
                    'description': ( localize(4244, "Announces when the active line has a warning.")),
                    ...announcementFeatureBase,
                    default: 'on'
                },
            },
        ...
        'accessibility.signals.onDebugBreak': {
            ...
            'properties': {
                'sound': {
                    'description': ( localize(4246, "Plays a sound when the debugger stopped on a breakpoint.")),
                    ...soundFeatureBase
                },
                'announcement': {
                    'description': ( localize(4247, "Announces when the debugger stopped on a breakpoint.")),
                    ...announcementFeatureBase
                },
            }
        },
        ...
        'accessibility.signals.taskCompleted': {
            ...
            'properties': {
                'sound': {
                    'description': ( localize(4252, "Plays a sound when a task is completed.")),
                    ...soundFeatureBase
                },
                'announcement': {
                    'description': ( localize(4253, "Announces when a task is completed.")),
                    ...announcementFeatureBase
                },
            }
        },
        'accessibility.signals.taskFailed': {
            ...
            'properties': {
                'sound': {
                    'description': ( localize(4255, "Plays a sound when a task fails (non-zero exit code).")),
                    ...soundFeatureBase
                },
                'announcement': {
                    'description': ( localize(4256, "Announces when a task fails (non-zero exit code).")),
                    ...announcementFeatureBase
                },
            }
        },
        ...
        'accessibility.signals.terminalQuickFix': {
            ...
            'properties': {
                'sound': {
                    'description': ( localize(4264, "Plays a sound when terminal Quick Fixes are available.")),
                    ...soundFeatureBase
                },
                'announcement': {
                    'description': ( localize(4265, "Announces when terminal Quick Fixes are available.")),
                    ...announcementFeatureBase
                },
            }
        },
        'accessibility.signals.terminalBell': {
            ...
            'properties': {
                'sound': {
                    'description': ( localize(4267, "Plays a sound when the terminal bell is ringing.")),
                    ...soundFeatureBase
                },
                'announcement': {
                    'description': ( localize(4268, "Announces when the terminal bell is ringing.")),
                    ...announcementFeatureBase
                },
            }
        },
        ...
        'accessibility.signals.chatEditModifiedFile': {
            ...
            'properties': {
                'sound': {
                    'description': ( localize(4276, "Plays a sound when revealing a file with changes from chat edits")),
                    ...soundFeatureBase
                }
            }
        },
        ...
        'accessibility.signals.notebookCellFailed': {
            ...
            'properties': {
                'sound': {
                    'description': ( localize(4281, "Plays a sound when a notebook cell execution fails.")),
                    ...soundFeatureBase
                },
                'announcement': {
                    'description': ( localize(4282, "Announces when a notebook cell execution fails.")),
                    ...announcementFeatureBase
                },
            }
        },
        'accessibility.signals.progress': {
            ...
            'properties': {
                'sound': {
                    'description': ( localize(4284, "Plays a sound on loop while progress is occurring.")),
                    ...soundFeatureBase
                },
                'announcement': {
                    'description': ( localize(4285, "Alerts on loop while progress is occurring.")),
                    ...announcementFeatureBase
                },
            },
        },
        'accessibility.signals.chatRequestSent': {
            ...
            'properties': {
                'sound': {
                    'description': ( localize(4287, "Plays a sound when a chat request is made.")),
                    ...soundFeatureBase
                },
                'announcement': {
                    'description': ( localize(4288, "Announces when a chat request is made.")),
                    ...announcementFeatureBase
                },
            }
        },
        'accessibility.signals.chatResponseReceived': {
            ...defaultNoAnnouncement,
            'description': ( localize(4289, "Plays a sound / audio cue when the response has been received.")),
            'properties': {
                'sound': {
                    'description': ( localize(4290, "Plays a sound on when the response has been received.")),
                    ...soundFeatureBase
                },
            }
        },
        'accessibility.signals.codeActionTriggered': {
            ...defaultNoAnnouncement,
            'description': ( localize(4291, "Plays a sound / audio cue - when a code action has been triggered.")),
            'properties': {
                'sound': {
                    'description': ( localize(4292, "Plays a sound when a code action has been triggered.")),
                    ...soundFeatureBase
                }
            }
        },
        'accessibility.signals.codeActionApplied': {
            ...defaultNoAnnouncement,
            'description': ( localize(4293, "Plays a sound / audio cue when the code action has been applied.")),
            'properties': {
                'sound': {
                    'description': ( localize(4294, "Plays a sound when the code action has been applied.")),
                    ...soundFeatureBase
                },
            }
        },
        'accessibility.signals.voiceRecordingStarted': {
            ...defaultNoAnnouncement,
            'description': ( localize(4295, "Plays a sound / audio cue when the voice recording has started.")),
            'properties': {
                'sound': {
                    'description': ( localize(4296, "Plays a sound when the voice recording has started.")),
                    ...soundFeatureBase,
                },
            },
            'default': {
        ...
        'accessibility.signals.voiceRecordingStopped': {
            ...defaultNoAnnouncement,
            'description': ( localize(4297, "Plays a sound / audio cue when the voice recording has stopped.")),
            'properties': {
                'sound': {
                    'description': ( localize(4298, "Plays a sound when the voice recording has stopped.")),
                    ...soundFeatureBase,
                    default: 'off'
                },
            }
        ...
        'accessibility.signals.clear': {
            ...
            'properties': {
                'sound': {
                    'description': ( localize(4300, "Plays a sound when a feature is cleared.")),
                    ...soundFeatureBase
                },
                'announcement': {
                    'description': ( localize(4301, "Announces when a feature is cleared.")),
                    ...announcementFeatureBase
                },
            },
        },
        'accessibility.signals.editsUndone': {
            ...
            'properties': {
                'sound': {
                    'description': ( localize(4303, "Plays a sound when edits have been undone.")),
                    ...soundFeatureBase
                },
                'announcement': {
                    'description': ( localize(4304, "Announces when edits have been undone.")),
                    ...announcementFeatureBase
                },
            },
        },
        'accessibility.signals.editsKept': {
            ...
            'properties': {
                'sound': {
                    'description': ( localize(4306, "Plays a sound when edits are kept.")),
                    ...soundFeatureBase
                },
                'announcement': {
                    'description': ( localize(4307, "Announces when edits are kept.")),
                    ...announcementFeatureBase
                },
            },
        },
        'accessibility.signals.save': {
            ...
            'properties': {
                'sound': {
                    'description': ( localize(4309, "Plays a sound when a file is saved.")),
                    'type': 'string',
                    'enum': ['userGesture', 'always', 'never'],
                    'default': 'never',
                    'enumDescriptions': [
                        ( localize(4310, "Plays the sound when a user explicitly saves a file.")),
                        ( localize(4311, "Plays the sound whenever a file is saved, including auto save.")),
                        ( localize(4312, "Never plays the sound."))
                    ],
                },
                'announcement': {
                    'description': ( localize(4313, "Announces when a file is saved.")),
                    'type': 'string',
                    'enum': ['userGesture', 'always', 'never'],
                    'default': 'never',
                    'enumDescriptions': [
                        ( localize(4314, "Announces when a user explicitly saves a file.")),
                        ( localize(4315, "Announces whenever a file is saved, including auto save.")),
                        ( localize(4316, "Never plays the announcement."))
                    ],
                },
            },
            default: {
        ...
        'accessibility.signals.format': {
            ...
            'properties': {
                'sound': {
                    'description': ( localize(4318, "Plays a sound when a file or notebook is formatted.")),
                    'type': 'string',
                    'enum': ['userGesture', 'always', 'never'],
                    'default': 'never',
                    'enumDescriptions': [
                        ( localize(4319, "Plays the sound when a user explicitly formats a file.")),
                        ( localize(
                        4320,
                        "Plays the sound whenever a file is formatted, including if it is set to format on save, type, or, paste, or run of a cell."
                    )),
                        ( localize(4321, "Never plays the sound."))
                    ],
                },
                'announcement': {
                    'description': ( localize(4322, "Announces when a file or notebook is formatted.")),
                    'type': 'string',
                    'enum': ['userGesture', 'always', 'never'],
                    'default': 'never',
                    'enumDescriptions': [
                        ( localize(4323, "Announces when a user explicitly formats a file.")),
                        ( localize(
                        4324,
                        "Announces whenever a file is formatted, including if it is set to format on save, type, or, paste, or run of a cell."
                    )),
                        ( localize(4325, "Never announces."))
                    ],
                },
            },
            default: {
        ...
        'accessibility.signals.chatUserActionRequired': {
            ...
            'properties': {
                'sound': {
                    'description': ( localize(4327, "Plays a sound when user action is required in the chat.")),
                    'type': 'string',
                    'enum': ['auto', 'on', 'off'],
                    'enumDescriptions': [
                        ( localize(4328, "Enable sound when a screen reader is attached.")),
                        ( localize(4192, "Enable sound.")),
                        ( localize(4193, "Disable sound."))
                    ],
                },
        ...
        'accessibility.underlineLinks': {
            'type': 'boolean',
            'description': ( localize(4330, "Controls whether links should be underlined in the workbench.")),
            'default': false,
        },
    ...
    registry.registerConfiguration({
        ...
        properties: {
            ...
            [AccessibilityWorkbenchSettingId.HideAccessibleView]: {
                description: ( localize(4339, "Controls whether the Accessible View is hidden.")),
                type: 'boolean',
                default: false,
                tags: ['accessibility']
            },
...
let DynamicSpeechAccessibilityConfiguration = class DynamicSpeechAccessibilityConfiguration extends Disposable {
        ...
        registry.registerConfiguration({
            ...
            properties: {
                ...
                [AccessibilityVoiceSettingId.IgnoreCodeBlocks]: {
                    'markdownDescription': ( localize(4341, "Whether to ignore code snippets in text-to-speech synthesis.")),
                    'type': 'boolean',
                    'default': false,
                    'tags': ['accessibility']
                },
                ...
                [AccessibilityVoiceSettingId.AutoSynthesize]: {
                    ...
                    'enumDescriptions': [
                        ...
                        ( localize(4344, "Disable the feature.")),
                    ],
                    'markdownDescription': ( localize(
                        4345,
    ...
    getLanguages() {
        return {
            ['auto']: {
                name: ( localize(4346, "Auto (Use Display Language)"))
            },
            ...SPEECH_LANGUAGES
        };
    }
