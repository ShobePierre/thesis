...
registerAction2(class RestrictSearchToFolderAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(10732, "Restrict Search to Folder")),
            category,
            keybinding: {
...
registerAction2(class ExpandSelectedTreeCommandAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(10733, "Expand Recursively")),
            category,
            menu: [{
                    id: MenuId.SearchContext,
                    when: ( ContextKeyExpr.and(
...
registerAction2(class ExcludeFolderFromSearchAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(10734, "Exclude Folder from Search")),
            category,
            menu: [
                {
                    id: MenuId.SearchContext,
...
registerAction2(class ExcludeFileTypeFromSearchAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(10735, "Exclude File Type from Search")),
            category,
            menu: [
                {
                    id: MenuId.SearchContext,
...
registerAction2(class IncludeFileTypeInSearchAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(10736, "Include File Type from Search")),
            category,
            menu: [
                {
                    id: MenuId.SearchContext,
...
registerAction2(class RevealInSideBarForSearchResultsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(10737, "Reveal in Explorer View")),
            category,
            menu: [{
                    id: MenuId.SearchContext,
                    when: ( ContextKeyExpr.and(
...
registerAction2(class FindInFilesAction extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(10738, "Find in Files")),
                mnemonicTitle: ( localize(10739, "Find &&in Files")),
            },
            metadata: {
                description: ( localize(10740, "Open a workspace search")),
                args: [
                    {
                        name: ( localize(10741, "A set of options for the search")),
                        schema: {
                            type: 'object',
                            properties: {
                                query: { 'type': 'string' },
...
registerAction2(class FindInFolderAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(10742, "Find in Folder...")),
            category,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
registerAction2(class FindInWorkspaceAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(10743, "Find in Workspace...")),
            category,
            menu: [
                {
                    id: MenuId.ExplorerContext,
