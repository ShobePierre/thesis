...
const EDITOR_WORD_WRAP = ( new RawContextKey('editorWordWrap', false, ( localize(6188, 'Whether the editor is currently using word wrapping.'))));
...
class ToggleWordWrapAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(6189, "View: Toggle Word Wrap")),
...
MenuRegistry.appendMenuItem(MenuId.EditorTitle, {
    command: {
        id: TOGGLE_WORD_WRAP_ID,
        title: ( localize(6190, "Disable wrapping for this file")),
...
MenuRegistry.appendMenuItem(MenuId.EditorTitle, {
    command: {
        id: TOGGLE_WORD_WRAP_ID,
        title: ( localize(6191, "Enable wrapping for this file")),
        icon: Codicon.wordWrap
    },
    group: 'navigation',
    order: 1,
