...
const SearchEditorIcon = registerIcon('search-editor-label-icon', Codicon.search, ( localize(10916, 'Icon of the search editor label.')));
let SearchEditorInput = class SearchEditorInput extends EditorInput {
    ...
    getName(maxLength = 12) {
        ...
        if (query) {
            return localize(10917, "Search: {0}", trimToMax(query));
        }
        return localize(10918, "Search");
    }
    setDirty(dirty) {
