    ...
    constructor(extensionService, extensionsWorkbenchService, notificationService, hostService) {
        ...
        MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
            command: {
                ...
                category: ( localize(7635, "Extensions")),
                title: ( localize(7636, "Install Missing Dependencies"))
            }
        });
    }
        ...
        if (missingDependencies.length) {
            ...
            if (extensions.length) {
                ...
                this.notificationService.notify({
                    ...
                    actions: {
                        primary: [( new Action('realod', ( localize(7638, "Reload Window")), '', true, () => this.hostService.reload()))]
                    }
                });
            }
        }
        else {
            this.notificationService.info(( localize(7639, "There are no missing dependencies to install.")));
        }
    }
};
