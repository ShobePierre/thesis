...
const DEBUG_COMMAND_CATEGORY = ( localize2(6706, 'Debug'));
const RESTART_LABEL = ( localize2(6707, "Restart"));
const STEP_OVER_LABEL = ( localize2(6708, "Step Over"));
const STEP_INTO_LABEL = ( localize2(6709, "Step Into"));
const STEP_INTO_TARGET_LABEL = ( localize2(6710, "Step Into Target"));
const STEP_OUT_LABEL = ( localize2(6711, "Step Out"));
const PAUSE_LABEL = ( localize2(6712, "Pause"));
const DISCONNECT_LABEL = ( localize2(6713, "Disconnect"));
const DISCONNECT_AND_SUSPEND_LABEL = ( localize2(6714, "Disconnect and Suspend"));
const STOP_LABEL = ( localize2(6715, "Stop"));
const CONTINUE_LABEL = ( localize2(6716, "Continue"));
const FOCUS_SESSION_LABEL = ( localize2(6717, "Focus Session"));
const SELECT_AND_START_LABEL = ( localize2(6718, "Select and Start Debugging"));
const DEBUG_CONFIGURE_LABEL = ( localize(6719, "Open '{0}'", 'launch.json'));
const DEBUG_START_LABEL = ( localize2(6720, "Start Debugging"));
const DEBUG_RUN_LABEL = ( localize2(6721, "Start Without Debugging"));
const NEXT_DEBUG_CONSOLE_LABEL = ( localize2(6722, "Focus Next Debug Console"));
const PREV_DEBUG_CONSOLE_LABEL = ( localize2(6723, "Focus Previous Debug Console"));
const OPEN_LOADED_SCRIPTS_LABEL = ( localize2(6724, "Open Loaded Script..."));
const CALLSTACK_TOP_LABEL = ( localize2(6725, "Navigate to Top of Call Stack"));
const CALLSTACK_BOTTOM_LABEL = ( localize2(6726, "Navigate to Bottom of Call Stack"));
const CALLSTACK_UP_LABEL = ( localize2(6727, "Navigate Up Call Stack"));
const CALLSTACK_DOWN_LABEL = ( localize2(6728, "Navigate Down Call Stack"));
const COPY_EVALUATE_PATH_LABEL = ( localize2(6729, "Copy as Expression"));
const COPY_VALUE_LABEL = ( localize2(6730, "Copy Value"));
const COPY_ADDRESS_LABEL = ( localize2(6731, "Copy Address"));
const ADD_TO_WATCH_LABEL = ( localize2(6732, "Add to Watch"));
const SELECT_DEBUG_CONSOLE_LABEL = ( localize2(6733, "Select Debug Console"));
const SELECT_DEBUG_SESSION_LABEL = ( localize2(6734, "Select Debug Session"));
...
CommandsRegistry.registerCommand({
    ...
    handler: async (accessor) => {
            ...
            if (source) {
                ...
                if (targets && targets.length) {
                    ...
                    if (targets.length > 1) {
                        ...
                        const pick = await quickInputService.pick(picks, { placeHolder: ( localize(6735, "Choose the specific location")) });
                        if (!pick) {
                            return;
                        }
                        id = pick._id;
        ...
        return notificationService.warn(( localize(6736, "No executable code is associated at the current cursor position.")));
    }
});
CommandsRegistry.registerCommand({
    id: CALLSTACK_TOP_ID,
...
MenuRegistry.appendMenuItem(MenuId.EditorContext, {
    command: {
        id: JUMP_TO_CURSOR_ID,
        title: ( localize(6737, "Jump to Cursor")),
    ...
    handler: async (accessor, _, context) => {
        ...
        session.stepInTargets(frame.frameId).then(targets => {
            ...
            if (targets?.length) {
                ...
                qp.placeholder = ( localize(6738, "No step targets available"));
            }
        });
    }
});
...
registerAction2(class AddConfigurationAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(6739, "Add Configuration...")),
            category: DEBUG_COMMAND_CATEGORY,
            f1: true,
            menu: {
...
MenuRegistry.appendMenuItem(MenuId.EditorContext, {
    command: {
        id: TOGGLE_INLINE_BREAKPOINT_ID,
        title: ( localize(6740, "Add Inline Breakpoint")),
        category: DEBUG_COMMAND_CATEGORY
    },
...
registerAction2(class ToggleExceptionBreakpointsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(6741, "Toggle Exception Breakpoints")),
            category: DEBUG_COMMAND_CATEGORY,
            f1: true,
    ...
    async run(accessor) {
        ...
        quickPick.placeholder = ( localize(6742, "Pick enabled exception breakpoints"));
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(6743, "Attach to Current Code Renderer")),
        });
    }
    async run(accessor) {
