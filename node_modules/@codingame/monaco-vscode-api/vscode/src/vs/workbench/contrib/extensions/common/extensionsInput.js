...
const ExtensionEditorIcon = registerIcon('extensions-editor-label-icon', Codicon.extensions, ( localize(7840, 'Icon of the extensions editor label.')));
class ExtensionsInput extends EditorInput {
    ...
    getName() {
        return localize(7841, "Extension: {0}", this._extension.displayName);
    }
    getIcon() {
