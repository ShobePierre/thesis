...
let MarkupCell = class MarkupCell extends Disposable {
    ...
    viewUpdateCollapsed() {
        ...
        if (keybinding) {
            element.title = ( localize(9687, "Double-click to expand cell input ({0})", keybinding.getLabel()));
            expandIcon.title = ( localize(9688, "Expand Cell Input ({0})", keybinding.getLabel()));
        }
