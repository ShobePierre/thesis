...
import { WebviewInput, WebviewIcons } from "./webviewEditorInput.js";
...
export interface IWebviewWorkbenchService {
    ...
    */
    openWebview(webviewInitInfo: WebviewInitInfo, viewType: string, title: string, iconPath: WebviewIcons | undefined, showOptions: IWebViewShowOptions): WebviewInput;
    /**
