...
import { picksWithPromiseFn } from '../../chat/browser/chatContextPickService.js';
import { IChatContextPickService } from '../../chat/browser/chatContextPickService.service.js';
...
let SearchViewResultChatContextPick = class SearchViewResultChatContextPick {
    constructor(_contextKeyService, _viewsService, _labelService) {
        ...
        this.type = 'valuePick';
        this.label = ( localize(10776, 'Search Results'));
...
let SymbolsContextPickerPick = class SymbolsContextPickerPick {
    constructor(_instantiationService) {
        ...
        this.label = ( localize(10777, 'Symbols...'));
    ...
    asPicker() {
        return {
            placeholder: ( localize(10778, "Select a symbol")),
...
let FilesAndFoldersPickerPick = class FilesAndFoldersPickerPick {
    constructor(_searchService, _labelService, _modelService, _languageService, _configurationService, _workspaceService, _fileService, _historyService, _instantiationService) {
        ...
        this._instantiationService = _instantiationService;
        this.type = 'pickerPick';
        this.label = ( localize(10779, 'Files & Folders...'));
        this.icon = Codicon.folder;
        this.ordinal = 600;
    }
    asPicker() {
        return {
            placeholder: ( localize(10780, "Search file or folder by name")),
...
async function searchFilesAndFolders(workspace, pattern, fuzzyMatch, token, cacheKey, configurationService, searchService) {
    const segmentMatchPattern = caseInsensitiveGlobPattern(fuzzyMatchingGlobPattern(pattern) );
