...
( Registry.as(EditorExtensions.EditorPane)).registerEditorPane(EditorPaneDescriptor.create(TextFileEditor, TextFileEditor.ID, ( localize(8129, "Text File Editor"))), [
    ( new SyncDescriptor(FileEditorInput))
]);
( Registry.as(EditorExtensions.EditorPane)).registerEditorPane(EditorPaneDescriptor.create(BinaryFileEditor, BinaryFileEditor.ID, ( localize(8130, "Binary File Editor"))), [
    ( new SyncDescriptor(FileEditorInput))
]);
