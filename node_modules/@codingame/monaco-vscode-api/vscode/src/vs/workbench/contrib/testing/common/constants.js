...
const testStateNames = {
    [TestResultState.Errored]: ( localize(12656, 'Errored')),
    [TestResultState.Failed]: ( localize(12657, 'Failed')),
    [TestResultState.Passed]: ( localize(12658, 'Passed')),
    [TestResultState.Queued]: ( localize(12659, 'Queued')),
    [TestResultState.Running]: ( localize(12660, 'Running')),
    [TestResultState.Skipped]: ( localize(12661, 'Skipped')),
    [TestResultState.Unset]: ( localize(12662, 'Not yet run')),
};
const labelForTestInState = (label, state) => ( localize(12663, '{0} ({1})', stripIcons(label), testStateNames[state]));
const testConfigurationGroupNames = {
    [TestRunProfileBitset.Debug]: ( localize(12664, 'Debug')),
    [TestRunProfileBitset.Run]: ( localize(12665, 'Run')),
    [TestRunProfileBitset.Coverage]: ( localize(12666, 'Coverage')),
};
var TestCommandId;
