...
let BackLayerWebView = class BackLayerWebView extends Themable {
    ...
    _generateStyles() {
        return {
            ...
            'notebook-cell-markup-empty-content': ( localize(9689, "Empty markdown cell, double-click or press enter to edit.")),
            'notebook-cell-renderer-not-found-error': ( localize(9690, "No renderer found for '$0'")),
            'notebook-cell-renderer-fallbacks-exhausted': ( localize(9691, "Could not render content for '$0'")),
    ...
    _createInset(webviewService, content) {
        ...
        const webview = webviewService.createWebviewElement({
            ...
            title: ( localize(9692, "Notebook webview content")),
            options: {
