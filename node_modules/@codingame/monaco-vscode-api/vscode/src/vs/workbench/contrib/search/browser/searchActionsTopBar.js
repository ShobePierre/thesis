...
registerAction2(class ClearSearchHistoryCommandAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(10767, "Clear Search History")),
            category,
            f1: true
        });
    }
...
registerAction2(class CancelSearchAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(10768, "Cancel Search")),
            icon: searchStopIcon,
            category,
            f1: true,
...
registerAction2(class CollapseDeepestExpandedLevelAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(10770, "Collapse All")),
            category,
...
registerAction2(class ExpandAllAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(10771, "Expand All")),
            category,
...
registerAction2(class ClearSearchResultsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(10772, "Clear Search Results")),
            category,
...
registerAction2(class ViewAsTreeAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(10773, "View as Tree")),
            category,
...
registerAction2(class ViewAsListAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(10774, "View as List")),
            category,
...
registerAction2(class SearchWithAIAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(10775, "Search with AI")),
            category,
            f1: true,
