...
function setupTerminalMenus() {
    MenuRegistry.appendMenuItems([
        {
            ...
            item: {
                ...
                command: {
                    ...
                    title: ( localize(11573, "&&New Terminal"))
                },
                order: 1
            }
        },
        {
            ...
            item: {
                ...
                command: {
                    ...
                    title: ( localize(11574, "New Terminal &&Window")),
        ...
        },
        {
            ...
            item: {
                ...
                command: {
                    ...
                    title: ( localize(11575, "&&Split Terminal")),
                    precondition: ( ContextKeyExpr.has(TerminalContextKeyStrings.IsOpen))
                },
                order: 2,
                when: TerminalContextKeys.processSupported
        ...
        },
        {
            ...
            item: {
                ...
                command: {
                    ...
                    title: ( localize(11576, "Run &&Active File"))
                },
                order: 3,
                when: TerminalContextKeys.processSupported
            }
        },
        {
            ...
            item: {
                ...
                command: {
                    ...
                    title: ( localize(11577, "Run &&Selected Text"))
                },
                order: 4,
                when: TerminalContextKeys.processSupported
            }
        ...
        },
        {
            ...
            item: {
                command: {
                    ...
                    title: ( localize(11579, "Copy as HTML"))
                },
                group: TerminalContextMenuGroup.Edit,
                order: 2
            }
        ...
        },
        {
            ...
            item: {
                command: {
                    ...
                    title: ( localize(11582, "Select All")),
                },
                group: TerminalContextMenuGroup.Edit,
                order: 3
            }
    ...
    MenuRegistry.appendMenuItems([
        {
            ...
            item: {
                command: {
                    ...
                    title: ( localize(11583, "New Terminal With Profile..."))
                },
                group: TerminalContextMenuGroup.Create
            }
        },
    ...
    MenuRegistry.appendMenuItems([
        {
            ...
            item: {
                command: {
                    ...
                    title: ( localize2(11584, 'Select Default Profile')),
                },
                group: '3_configure'
            }
        },
        {
            ...
            item: {
                command: {
                    ...
                    title: ( localize(11585, "Configure Terminal Settings"))
                },
                group: '3_configure'
            }
        },
        ...
        },
        {
            ...
            item: {
                command: {
                    ...
                    title: ( localize(11587, "Configure Tasks..."))
                },
                when: TaskExecutionSupportedContext,
                group: '4_tasks',
                order: 2
    ...
    MenuRegistry.appendMenuItems([
        {
            ...
            item: {
                command: {
                    ...
                    title: ( localize2(11588, 'Switch Terminal'))
                },
                group: 'navigation',
                order: 0,
        ...
        },
        {
            ...
            item: {
                ...
                group: 'navigation',
                order: 0,
                when: ( ContextKeyExpr.and(ContextKeyExpr.not('hasHiddenChatTerminals'), ( ContextKeyExpr.equals('view', TERMINAL_VIEW_ID)), ( ContextKeyExpr.has(`config.${TerminalSettingId.TabsEnabled}`)), ( ContextKeyExpr.or(( ContextKeyExpr.and(( ContextKeyExpr.equals(`config.${TerminalSettingId.TabsShowActiveTerminal}`, 'singleTerminal')), ( ContextKeyExpr.equals(TerminalContextKeyStrings.GroupCount, 1)))), ( ContextKeyExpr.and(( ContextKeyExpr.equals(
        ...
        },
        {
            ...
            item: {
                command: {
                    id: TerminalCommandId.Clear,
                    title: ( localize(11589, "Clear Terminal")),
        ...
        },
        {
            ...
            item: {
                command: {
                    id: TerminalCommandId.RunActiveFile,
                    title: ( localize(11590, "Run Active File")),
                    icon: Codicon.run
                },
                group: 'navigation',
                order: 7,
        ...
        },
        {
            ...
            item: {
                command: {
                    id: TerminalCommandId.RunSelectedText,
                    title: ( localize(11591, "Run Selected Text")),
        ...
        },
        {
            ...
            item: {
                command: {
                    ...
                    title: ( localize(11592, "Start Dictation")),
                },
                group: 'navigation',
                order: 9,
        ...
        },
        {
            ...
            item: {
                command: {
                    ...
                    title: ( localize(11593, "Stop Dictation")),
                },
                group: 'navigation',
                order: 9,
        ...
        },
        {
            ...
            item: {
                command: {
                    ...
                    title: ( localize(11595, "Change Icon..."))
                },
                group: TerminalContextMenuGroup.Edit
            }
        },
        {
            ...
            item: {
                command: {
                    ...
                    title: ( localize(11596, "Change Color..."))
                },
                group: TerminalContextMenuGroup.Edit
            }
        },
        ...
        },
        {
            ...
            item: {
                command: {
                    ...
                    title: ( localize(11597, "Join Terminals"))
                },
    ...
    for (const menuId of [MenuId.EditorTitle, MenuId.CompactWindowEditorTitle]) {
        ...
        MenuRegistry.appendMenuItem(menuId, {
            command: {
                id: TerminalCommandId.StartVoice,
                title: ( localize(11598, "Start Dictation")),
                icon: Codicon.run
            },
            group: 'navigation',
            order: 9,
        ...
        MenuRegistry.appendMenuItem(menuId, {
            command: {
                id: TerminalCommandId.StopVoice,
                title: ( localize(11599, "Stop Dictation")),
                icon: Codicon.run
            },
            group: 'navigation',
            order: 10,
...
function getTerminalActionBarArgs(location, profiles, defaultProfileName, contributedProfiles, terminalService, dropdownMenu, disposableStore) {
    ...
    for (const p of profiles) {
        ...
        dropdownActions.push(disposableStore.add(( new Action(TerminalCommandId.NewWithProfile, isDefault ? ( localize(11600, "{0} (Default)", sanitizedProfileName)) : sanitizedProfileName, undefined, true, async () => {
            await terminalService.createAndFocusTerminal(options);
        }))));
        submenuActions.push(disposableStore.add(( new Action(TerminalCommandId.Split, isDefault ? ( localize(11600, "{0} (Default)", sanitizedProfileName)) : sanitizedProfileName, undefined, true, async () => {
    ...
    for (const contributed of contributedProfiles) {
        ...
        const title = isDefault ? ( localize(11600, "{0} (Default)", contributed.title.replace(/[\n\r\t]/g, ''))) : contributed.title.replace(/[\n\r\t]/g, '');
        dropdownActions.push(disposableStore.add(( new Action(
            'contributed',
            title,
            undefined,
    ...
    if (dropdownActions.length > 0) {
        dropdownActions.push(( new SubmenuAction('split.profile', ( localize(11601, 'Split Terminal with Profile')), submenuActions)));
        dropdownActions.push(( new Separator()));
    }
    const actions = dropdownMenu.getActions();
    dropdownActions.push(...Separator.join(...( actions.map(a => a[1]))));
    const dropdownAction = disposableStore.add(( new Action('refresh profiles', ( localize(11602, 'Launch Profile...')), 'codicon-chevron-down', true)));
