...
let ExplorerView = class ExplorerView extends ViewPane {
    ...
    renderHeader(container) {
        ...
        const setHeader = () => {
            ...
            this.ariaHeaderLabel = ( localize(8194, "Explorer Section: {0}", this.name));
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(8196, "New Folder...")),
            f1: false,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(8197, "Refresh Explorer")),
            f1: true,
            ...
            metadata: {
                description: ( localize2(8198, "Forces a refresh of the Explorer."))
            },
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(8199, "Collapse Folders in Explorer")),
            f1: true,
            ...
            metadata: {
                description: ( localize2(8200, "Folds all folders in the Explorer."))
            }
        });
    }
    run(accessor) {
