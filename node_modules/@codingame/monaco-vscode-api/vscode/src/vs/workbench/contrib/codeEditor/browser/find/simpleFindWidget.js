...
const NLS_FIND_INPUT_LABEL = ( localize(6143, "Find"));
const NLS_FIND_INPUT_PLACEHOLDER = ( localize(6144, "Find"));
const NLS_PREVIOUS_MATCH_BTN_LABEL = ( localize(6145, "Previous Match"));
const NLS_NEXT_MATCH_BTN_LABEL = ( localize(6146, "Next Match"));
const NLS_CLOSE_BTN_LABEL = ( localize(6147, "Close"));
...
class SimpleFindWidget extends Widget {
    ...
    _announceSearchResults(label, searchString) {
        if (!searchString) {
            return localize(6148, "Enter search input");
        }
        if (label === NLS_NO_RESULTS) {
            return searchString === ''
                ? ( localize(6149, "{0} found", label))
                : ( localize(6150, "{0} found for '{1}'", label, searchString));
        }
        return localize(6151, "{0} found for '{1}'", label, searchString);
    }
}
const simpleFindWidgetSashBorder = registerColor('simpleFindWidget.sashBorder', { dark: '#454545', light: '#C8C8C8', hcDark: '#6FC3DF', hcLight: '#0F4A85' }, ( localize(6152, 'Border color of the sash border.')));
