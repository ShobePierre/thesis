...
( Registry.as(Extensions.Configuration)).registerConfiguration({
    ...
    'properties': {
        'notebook.lineNumbers': {
            ...
            enum: ['off', 'on'],
            default: 'off',
            markdownDescription: ( localize(9663, "Controls the display of line numbers in the cell editor."))
        }
    }
});
registerAction2(class ToggleLineNumberAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(9664, 'Toggle Notebook Line Numbers')),
            ...
            toggled: {
                ...
                title: ( localize(9665, "Notebook Line Numbers")),
            }
        });
    }
    async run(accessor) {
...
registerAction2(class ToggleActiveLineNumberAction extends NotebookMultiCellAction {
    constructor() {
        super({
            ...
            title: ( localize(9666, "Show Cell Line Numbers")),
