...
registerColor('editor.inlineValuesForeground', {
    ...
    hcDark: '#ffffff80',
    hcLight: '#00000080'
}, ( localize(6774, "Color for the debug inline value text.")));
registerColor('editor.inlineValuesBackground', '#ffc80033', ( localize(6775, "Color for the debug inline value background.")));
class InlineSegment {
