...
class InspectEditorTokens extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(6153, "Developer: Inspect Editor Tokens and Scopes")),
...
class InspectEditorTokensWidget extends Disposable {
    ...
    _beginCompute(position) {
        ...
        this._domNode.appendChild(createTextNode(( localize(6154, "Loading..."))));
    ...
    _compute(grammar, semanticTokens, tree, position) {
        ...
        reset(this._domNode, $('h2.tiw-token', undefined, tokenText, $('span.tiw-token-length', undefined, `${tokenLength} ${tokenLength === 1 ? 'char' : 'chars'}`)));
        ...
        if (treeSitterTokenInfo) {
            ...
            const table = append(this._domNode, $('table.tiw-metadata-table'));
            const tbody = append(table, $('tbody'));
            append(tbody, $('tr', undefined, $('td.tiw-metadata-key', undefined, `tree-sitter token ${lastTokenInfo.id}`), $('td.tiw-metadata-value', undefined, `${lastTokenInfo.text}`)));
            const scopes = ( new Array());
            ...
            append(tbody, $('tr', undefined, $('td.tiw-metadata-key', undefined, 'tree-sitter tree'), $('td.tiw-metadata-value.tiw-metadata-scopes', undefined, ...scopes)));
            ...
            if (captures && captures.length > 0) {
                append(tbody, $('tr', undefined, $('td.tiw-metadata-key', undefined, 'foreground'), $('td.tiw-metadata-value', undefined, ( captures.map(cap => cap.name)).join(' '))));
            }
        }
    }
