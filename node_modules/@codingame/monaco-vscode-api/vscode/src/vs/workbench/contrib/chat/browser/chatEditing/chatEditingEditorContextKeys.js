...
const ctxIsGlobalEditingSession = ( new RawContextKey('chatEdits.isGlobalEditingSession', undefined, ( localize(5239, "The current editor is part of the global edit session"))));
const ctxHasEditorModification = ( new RawContextKey('chatEdits.hasEditorModifications', undefined, ( localize(5240, "The current editor contains chat modifications"))));
const ctxIsCurrentlyBeingModified = ( new RawContextKey('chatEdits.isCurrentlyBeingModified', undefined, ( localize(5241, "The current editor is currently being modified"))));
const ctxReviewModeEnabled = ( new RawContextKey('chatEdits.isReviewModeEnabled', true, ( localize(5242, "Review mode for chat changes is enabled"))));
...
const ctxRequestCount = ( new RawContextKey('chatEdits.requestCount', 0, ( localize(5244, "The number of turns the editing session in this editor has"))));
const ctxCursorInChangeRange = ( new RawContextKey('chatEdits.cursorInChangeRange', false, ( localize(5245, "The cursor is inside a change range made by chat editing."))));
