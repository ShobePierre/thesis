...
const RuntimeExtensionsEditorIcon = registerIcon('runtime-extensions-editor-label-icon', Codicon.extensions, ( localize(7846, 'Icon of the runtime extensions editor label.')));
class RuntimeExtensionsInput extends EditorInput {
    ...
    getName() {
        return localize(7847, "Running Extensions");
    }
    getIcon() {
