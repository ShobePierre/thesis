...
const historyItemRefColor = registerColor('scmGraph.historyItemRefColor', chartsBlue, ( localize(10540, "History item reference color.")));
const historyItemRemoteRefColor = registerColor('scmGraph.historyItemRemoteRefColor', chartsPurple, ( localize(10541, "History item remote reference color.")));
const historyItemBaseRefColor = registerColor('scmGraph.historyItemBaseRefColor', '#EA5C00', ( localize(10542, "History item base reference color.")));
const historyItemHoverDefaultLabelForeground = registerColor('scmGraph.historyItemHoverDefaultLabelForeground', foreground, ( localize(10543, "History item hover default label foreground color.")));
const historyItemHoverDefaultLabelBackground = registerColor('scmGraph.historyItemHoverDefaultLabelBackground', badgeBackground, ( localize(10544, "History item hover default label background color.")));
const historyItemHoverLabelForeground = registerColor('scmGraph.historyItemHoverLabelForeground', PANEL_BACKGROUND, ( localize(10545, "History item hover label foreground color.")));
registerColor('scmGraph.historyItemHoverAdditionsForeground', { light: '#587C0C', dark: '#81B88B', hcDark: '#A1E3AD', hcLight: '#374E06' }, ( localize(10546, "History item hover additions foreground color.")));
registerColor('scmGraph.historyItemHoverDeletionsForeground', { light: '#AD0707', dark: '#C74E39', hcDark: '#C74E39', hcLight: '#AD0707' }, ( localize(10547, "History item hover deletions foreground color.")));
const colorRegistry = [
    registerColor('scmGraph.foreground1', '#FFB000', ( localize(10548, "Source control graph foreground color (1)."))),
    registerColor('scmGraph.foreground2', '#DC267F', ( localize(10549, "Source control graph foreground color (2)."))),
    registerColor('scmGraph.foreground3', '#994F00', ( localize(10550, "Source control graph foreground color (3)."))),
    registerColor('scmGraph.foreground4', '#40B0A6', ( localize(10551, "Source control graph foreground color (4)."))),
    registerColor('scmGraph.foreground5', '#B66DFF', ( localize(10552, "Source control graph foreground color (5)."))),
];
            ...
            if (beforeHistoryItemIndex !== -1 && afterHistoryItemIndex !== -1) {
                ...
                if (!incomingChangeMerged) {
                    ...
                    const incomingChangesHistoryItem = {
                        ...
                        subject: ( localize(10553, 'Incoming Changes')),
                        message: ''
                    };
        ...
        if (addOutgoingChanges && currentHistoryItemRef?.revision && currentHistoryItemRef.revision !== mergeBase) {
            ...
            if (currentHistoryItemRefIndex !== -1) {
                const outgoingChangesHistoryItem = {
                    ...
                    subject: ( localize(10554, 'Outgoing Changes')),
                    message: ''
                };
