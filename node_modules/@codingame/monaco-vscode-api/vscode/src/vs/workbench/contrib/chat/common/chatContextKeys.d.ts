...
export declare namespace ChatContextKeys {
    ...
    const isCombinedAgentSessionsViewer: RawContextKey<boolean>;
    ...
    const isActiveAgentSession: RawContextKey<boolean>;
...
export declare namespace ChatContextKeyExprs {
    ...
    const agentViewWhen: import("../../../../platform/contextkey/common/contextkey.js").ContextKeyExpression | undefined;
}
