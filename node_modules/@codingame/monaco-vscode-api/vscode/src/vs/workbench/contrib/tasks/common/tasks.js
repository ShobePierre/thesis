...
const TASK_RUNNING_STATE = ( new RawContextKey('taskRunning', false, ( localize(11455, "Whether a task is currently running."))));
const TASK_TERMINAL_ACTIVE = ( new RawContextKey('taskTerminalActive', false, ( localize(11456, "Whether the active terminal is a task terminal."))));
const TASKS_CATEGORY = ( localize2(11457, "Tasks"));
var ShellQuoting;
