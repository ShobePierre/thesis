...
const createCodeActionsAutoSave = (description) => {
    return {
        ...
        enumDescriptions: [
            ...
            ( localize(6111, 'Triggers Code Actions only when explicitly saved')),
            ( localize(6112, 'Never triggers Code Actions on save')),
            ( localize(
            6113,
...
const createNotebookCodeActionsAutoSave = (description) => {
    return {
        ...
        enumDescriptions: [
            ( localize(6115, 'Triggers Code Actions only when explicitly saved.')),
            ( localize(6116, 'Never triggers Code Actions on save.')),
            ( localize(
            6117,
            'Triggers Code Actions only when explicitly saved. This value will be deprecated in favor of "explicit".'
        )),
