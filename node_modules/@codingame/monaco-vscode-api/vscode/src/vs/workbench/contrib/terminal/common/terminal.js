...
const terminalContributionsDescriptor = {
    ...
    jsonSchema: {
        description: ( localize(11674, 'Contributes terminal functionality.')),
        type: 'object',
        properties: {
            profiles: {
                type: 'array',
                description: ( localize(11675, "Defines additional terminal profiles that the user can create.")),
                items: {
                    type: 'object',
                    required: ['id', 'title'],
                    defaultSnippets: [{
                    ...
                    properties: {
                        id: {
                            description: ( localize(11676, "The ID of the terminal profile provider.")),
                            type: 'string',
                        },
                        title: {
                            description: ( localize(11677, "Title for this terminal profile.")),
                            type: 'string',
                        },
                        icon: {
                            ...
                            anyOf: [{
                                ...
                                },
                                {
                                    ...
                                    properties: {
                                        light: {
                                            description: ( localize(11679, 'Icon path when a light theme is used')),
                                            type: 'string'
                                        },
                                        dark: {
                                            description: ( localize(11680, 'Icon path when a dark theme is used')),
                                            type: 'string'
                                        }
                                    }
                                }]
