...
import { ILanguageModelToolsService } from '../../chat/common/languageModelToolsService.service.js';
...
( Registry.as(Extensions.Quickaccess)).registerQuickAccessProvider({
    ...
    placeholder: ( localize(7329, "Press Enter to manage extensions.")),
    helpEntries: [{ description: ( localize(7330, "Manage Extensions")) }]
});
( Registry.as(EditorExtensions.EditorPane)).registerEditorPane(EditorPaneDescriptor.create(ExtensionEditor, ExtensionEditor.ID, ( localize(7331, "Extension"))), [
    ( new SyncDescriptor(ExtensionsInput))
]);
const VIEW_CONTAINER = ( Registry.as(Extensions$1.ViewContainersRegistry)).registerViewContainer({
    id: VIEWLET_ID,
    title: ( localize2(7332, "Extensions")),
    openCommandActionDescriptor: {
        id: VIEWLET_ID,
        mnemonicTitle: ( localize(7333, "E&&xtensions")),
...
( Registry.as(Extensions$2.Configuration))
    ...
    id: 'extensions',
    order: 30,
    title: ( localize(7334, "Extensions")),
    type: 'object',
    properties: {
        'extensions.autoUpdate': {
            enum: [true, 'onlyEnabledExtensions', false,],
            enumItemLabels: [
                ( localize(7335, "All Extensions")),
                ( localize(7336, "Only Enabled Extensions")),
                ( localize(7337, "None")),
            ],
            enumDescriptions: [
                ( localize(7338, 'Download and install updates automatically for all extensions.')),
                ( localize(
                7339,
                'Download and install updates automatically only for enabled extensions.'
            )),
                ( localize(7340, 'Extensions are not automatically updated.')),
            ],
        ...
        'extensions.webWorker': {
            ...
            enumDescriptions: [
                ( localize(7347, "The Web Worker Extension Host will always be launched.")),
                ( localize(7348, "The Web Worker Extension Host will never be launched.")),
                ( localize(
                7349,
                "The Web Worker Extension Host will be launched when a web extension needs it."
            )),
            ],
            description: ( localize(7350, "Enable web worker extension host.")),
            default: 'auto'
        },
        'extensions.supportVirtualWorkspaces': {
            type: 'object',
            markdownDescription: ( localize(7351, "Override the virtual workspaces support of an extension.")),
            patternProperties: {
                ...
                '([a-z0-9A-Z][a-z0-9-A-Z]*)\\.([a-z0-9A-Z][a-z0-9-A-Z]*)$': {
                    ...
                    properties: {
                        'supported': {
                            ...
                            enumDescriptions: [
                                ( localize(7354, "Extension will always be enabled.")),
                                ( localize(7355, "Extension will only be enabled only when the workspace is trusted.")),
                                ( localize(
                                7356,
                                "Extension will always be enabled, and the extension will hide functionality requiring trust."
                            )),
                            ],
                            description: ( localize(7357, "Defines the untrusted workspace support setting for the extension.")),
                        },
                        'version': {
                            type: 'string',
                            description: ( localize(
        ...
        [ExtensionGalleryServiceUrlConfigKey]: {
            type: 'string',
            description: ( localize(7363, "Configure the Marketplace service URL to connect to")),
            default: '',
            scope: ConfigurationScope.APPLICATION,
            tags: ['usesOnlineServices'],
            included: false,
            policy: {
                ...
                localization: {
                    description: {
                        ...
                        value: ( localize(7363, "Configure the Marketplace service URL to connect to")),
                    }
                }
            },
        },
...
CommandsRegistry.registerCommand('_extensions.manage', (accessor, extensionId, tab, preserveFocus, feature) => {
    ...
    if (extension) {
        ...
        throw ( new Error(( localize(7366, "Extension '{0}' not found.", extensionId))));
    }
});
...
CommandsRegistry.registerCommand({
    ...
    metadata: {
        description: ( localize(7367, "Install the given extension")),
        args: [
            {
                name: 'extensionIdOrVSIXUri',
                description: ( localize(7368, "Extension id or VSIX resource uri")),
        ...
        try {
            if (typeof arg === 'string') {
                ...
                if (extension?.enablementState === EnablementState.DisabledByExtensionKind) {
                    ...
                    if (!gallery) {
                        throw ( new Error(( localize(7366, "Extension '{0}' not found.", arg))));
                    }
...
CommandsRegistry.registerCommand({
    ...
    metadata: {
        description: ( localize(7375, "Uninstall the given extension")),
        args: [
            {
                name: ( localize(7376, "Id of the extension to uninstall")),
                schema: {
                    'type': 'string'
                }
            }
    ...
    handler: async (accessor, id) => {
        if (!id) {
            throw ( new Error(( localize(7377, "Extension id required."))));
        }
...
CommandsRegistry.registerCommand({
    ...
    metadata: {
        description: ( localize(7380, "Search for a specific extension")),
        args: [
            {
                name: ( localize(7381, "Query to use in search")),
                schema: { 'type': 'string' }
            }
        ]
    },
...
let ExtensionsContributions = class ExtensionsContributions extends Disposable {
    ...
    registerQuickAccessProvider() {
        if (this.extensionManagementServerService.localExtensionManagementServer
            ...
            ( Registry.as(Extensions.Quickaccess)).registerQuickAccessProvider({
                ...
                placeholder: ( localize(7382, "Type the name of an extension to install or search.")),
                helpEntries: [{ description: ( localize(7383, "Install or Search Extensions")) }]
            });
        }
    }
    registerGlobalActions() {
        this._register(MenuRegistry.appendMenuItem(MenuId.MenubarPreferencesMenu, {
            command: {
                id: VIEWLET_ID,
                title: ( localize(7384, "&&Extensions"))
            },
        ...
        this._register(MenuRegistry.appendMenuItem(MenuId.GlobalActivity, {
            command: {
                id: VIEWLET_ID,
                title: ( localize(7385, "Extensions"))
            },
            group: '2_configuration',
            order: 3
        }));
        this.registerExtensionAction({
            ...
            title: ( localize2(7386, 'Focus on Extensions View')),
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(7387, 'Install Extensions')),
            category: ExtensionsLocalizedLabel,
            menu: {
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(7391, 'Check for Extension Updates')),
            category: ExtensionsLocalizedLabel,
            menu: [{
                    id: MenuId.CommandPalette,
                    when: ( ContextKeyExpr.and(CONTEXT_HAS_GALLERY, ( ContextKeyExpr.or(
            ...
            run: async () => {
                ...
                if (outdated.length) {
                    ...
                    return this.dialogService.info(( localize(7392, "All extensions are up to date.")));
                }
            }
        });
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(7393, 'Enable Auto Update for All Extensions')),
            category: ExtensionsLocalizedLabel,
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(7394, 'Disable Auto Update for All Extensions')),
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(7395, 'Update All Extensions')),
            category: ExtensionsLocalizedLabel,
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(7396, 'Enable All Extensions')),
            category: ExtensionsLocalizedLabel,
            menu: [{
                    id: MenuId.CommandPalette,
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(7397, 'Enable All Extensions for this Workspace')),
            category: ExtensionsLocalizedLabel,
            menu: {
                id: MenuId.CommandPalette,
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(7398, 'Disable All Installed Extensions')),
            category: ExtensionsLocalizedLabel,
            menu: [{
                    id: MenuId.CommandPalette,
                    when: ( ContextKeyExpr.or(
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(7399, 'Disable All Installed Extensions for this Workspace')),
            category: ExtensionsLocalizedLabel,
            menu: {
                id: MenuId.CommandPalette,
                when: ( ContextKeyExpr.and(( WorkbenchStateContext.notEqualsTo('empty')), ( ContextKeyExpr.or(
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(7400, 'Install from VSIX...')),
            category: ExtensionsLocalizedLabel,
            menu: [{
                    id: MenuId.CommandPalette,
            ...
            run: async (accessor) => {
                ...
                const vsixPaths = await fileDialogService.showOpenDialog({
                    title: ( localize(7401, "Install from VSIX")),
                    filters: [{ name: 'VSIX Extensions', extensions: ['vsix'] }],
                    canSelectFiles: true,
                    canSelectMany: true,
                    openLabel: mnemonicButtonLabel(( localize(7402, "&&Install")))
                });
                if (vsixPaths) {
        ...
        this.registerExtensionAction({
            ...
            title: ( localize(7403, "Install Extension VSIX")),
            menu: [{
                ...
                if (requireReload) {
                    notificationService.prompt(Severity$1.Info, vsixs.length > 1 ? ( localize(
                        ...
                        "Completed installing extension. Please reload Visual Studio Code to enable it."
                            ...
                            label: ( localize(7406, "Reload Now")),
                    ...
                    notificationService.prompt(Severity$1.Info, vsixs.length > 1 ? ( localize(
                        ...
                        "Completed installing extension. Please restart extensions to enable it."
                            ...
                            label: ( localize(7409, "Restart Extensions")),
                            run: () => extensionsWorkbenchService.updateRunningExtensions()
                        }]);
                }
                else {
                    notificationService.prompt(Severity$1.Info, vsixs.length > 1 ? ( localize(7410, "Completed installing extensions.")) : ( localize(7411, "Completed installing extension.")), []);
                }
            }
        });
        this.registerExtensionAction({
            id: 'workbench.extensions.action.installExtensionFromLocation',
            title: ( localize2(7412, 'Install Extension from Location...')),
            ...
            run: async (accessor) => {
                ...
                if (isWeb) {
                    return (new Promise((c, e) => {
                        ...
                        quickPick.title = ( localize(7413, "Install Extension from Location"));
                        quickPick.customButton = true;
                        quickPick.customLabel = ( localize(7414, "Install"));
                        quickPick.placeholder = ( localize(7415, "Location of the web extension"));
                    ...
                    const extensionLocation = await fileDialogService.showOpenDialog({
                        ...
                        canSelectMany: false,
                        title: ( localize(7413, "Install Extension from Location")),
                    });
        ...
        MenuRegistry.appendMenuItem(extensionsSearchActionsMenu, {
            ...
            title: ( localize(7416, "Filter Extensions...")),
            group: 'navigation',
            order: 2,
            icon: filterIcon,
        });
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(7417, 'Show Featured Extensions')),
            category: ExtensionsLocalizedLabel,
            menu: [{
                    id: MenuId.CommandPalette,
        ...
        this.registerExtensionAction({
            ...
            menuTitles: {
                [extensionsFilterSubMenu.id]: ( localize(7424, "Recently Published"))
            },
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(7426, 'Show Installed Extensions')),
            category: ExtensionsLocalizedLabel,
            f1: true,
            menu: [{
                    id: extensionsFilterSubMenu,
        ...
        this.registerExtensionAction({
            ...
            menuTitles: {
                [extensionsFilterSubMenu.id]: ( localize(7431, "Updates"))
            },
            run: () => this.extensionsWorkbenchService.openSearch('@updates')
        });
        this.registerExtensionAction({
            id: LIST_WORKSPACE_UNSUPPORTED_EXTENSIONS_COMMAND_ID,
            title: ( localize2(7432, 'Show Extensions Unsupported By Workspace')),
            category: ExtensionsLocalizedLabel,
            menu: [{
                    id: MenuId.CommandPalette,
                    when: ( ContextKeyExpr.or(CONTEXT_HAS_LOCAL_SERVER, CONTEXT_HAS_REMOTE_SERVER)),
        ...
        this.registerExtensionAction({
            ...
            menuTitles: {
                [extensionsFilterSubMenu.id]: ( localize(7437, "Disabled"))
            },
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(7439, 'Clear Extensions Search Results')),
            category: ExtensionsLocalizedLabel,
        ...
        this.registerExtensionAction({
            ...
            title: ( localize(7441, "Install Workspace Recommended Extensions")),
            icon: installWorkspaceRecommendedIcon,
            menu: {
                id: MenuId.ViewTitle,
    ...
    registerContextMenuActions() {
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(7442, 'Show Pre-Release Version')),
            menu: {
                id: MenuId.ExtensionContext,
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(7443, 'Show Release Version')),
            menu: {
                id: MenuId.ExtensionContext,
                group: INSTALL_ACTIONS_GROUP,
                order: 1,
        ...
        this.registerExtensionAction({
            ...
            title: ( localize(7444, "Switch to Pre-Release Version")),
            category: ExtensionsLocalizedLabel,
            menu: {
                id: MenuId.ExtensionContext,
                group: INSTALL_ACTIONS_GROUP,
        ...
        this.registerExtensionAction({
            ...
            title: ( localize(7445, "Switch to Release Version")),
            category: ExtensionsLocalizedLabel,
            menu: {
                id: MenuId.ExtensionContext,
                group: INSTALL_ACTIONS_GROUP,
        ...
        this.registerExtensionAction({
            ...
            title: ( localize(7447, "Install (Do not Sync)")),
            menu: {
                id: MenuId.ExtensionContext,
                group: '0_install',
        ...
        this.registerExtensionAction({
            ...
            title: ( localize(7448, "Install Pre-Release (Do not Sync)")),
            menu: {
                id: MenuId.ExtensionContext,
                group: '0_install',
        ...
        this.registerExtensionAction({
            ...
            run: async (accessor, extensionId) => {
                ...
                const extension = this.extensionsWorkbenchService.local.filter(e => areSameExtensions(e.identifier, { id: extensionId }))[0]
                    || (await this.extensionsWorkbenchService.getExtensions([{ id: extensionId }], CancellationToken.None))[0];
                if (extension) {
                    const name = ( localize(7450, 'Name: {0}', extension.displayName));
                    const id = ( localize(7451, 'Id: {0}', extensionId));
                    const description = ( localize(7452, 'Description: {0}', extension.description));
                    const verision = ( localize(7453, 'Version: {0}', extension.version));
                    const publisher = ( localize(7454, 'Publisher: {0}', extension.publisherDisplayName));
                    const link = extension.url ? ( localize(7455, 'VS Marketplace Link: {0}', `${extension.url}`)) : null;
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(7456, 'Copy Extension ID')),
            menu: {
                id: MenuId.ExtensionContext,
                group: '1_copy'
            },
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(7457, 'Copy Link')),
            menu: {
                id: MenuId.ExtensionContext,
                group: '1_copy',
        ...
        this.registerExtensionAction({
            ...
            title: ( localize(7459, "Download VSIX")),
            menu: {
                id: MenuId.ExtensionContext,
        ...
        this.registerExtensionAction({
            ...
            title: ( localize(7460, "Download Pre-Release VSIX")),
            menu: {
                id: MenuId.ExtensionContext,
        ...
        this.registerExtensionAction({
            ...
            title: ( localize(7461, "Download Specific Version VSIX...")),
            menu: {
                id: MenuId.ExtensionContext,
                when: ( ContextKeyExpr.and(ContextKeyExpr.not('extensionDisallowInstall'), ( ContextKeyExpr.has('isGalleryExtension')))),
                order: 2
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(7462, "Account Preferences")),
            menu: {
                id: MenuId.ExtensionContext,
                group: '2_configure',
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(7463, 'Keyboard Shortcuts')),
            menu: {
                id: MenuId.ExtensionContext,
                group: '2_configure',
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(7464, "Apply Extension to all Profiles")),
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(7465, "Sync This Extension")),
            menu: {
                id: MenuId.ExtensionContext,
                group: '2_configure',
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(7466, "Ignore Recommendation")),
            menu: {
                id: MenuId.ExtensionContext,
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(7467, "Undo Ignored Recommendation")),
            menu: {
                id: MenuId.ExtensionContext,
                group: '3_recommendations',
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(7468, "Add to Workspace Recommendations")),
            menu: {
                id: MenuId.ExtensionContext,
                group: '3_recommendations',
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(7469, "Remove from Workspace Recommendations")),
            menu: {
                id: MenuId.ExtensionContext,
                group: '3_recommendations',
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(7470, "Add Extension to Workspace Recommendations")),
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(7471, "Add Extension to Workspace Folder Recommendations")),
            category: EXTENSIONS_CATEGORY,
            menu: {
                id: MenuId.CommandPalette,
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(7472, "Add Extension to Workspace Ignored Recommendations")),
            category: EXTENSIONS_CATEGORY,
            menu: {
                id: MenuId.CommandPalette,
                when: ( ContextKeyExpr.and(( WorkbenchStateContext.isEqualTo('workspace')), ( ContextKeyExpr.equals('resourceScheme', Schemas.extension)))),
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(7473, "Add Extension to Workspace Folder Ignored Recommendations")),
            category: EXTENSIONS_CATEGORY,
            menu: {
                id: MenuId.CommandPalette,
                when: ( ContextKeyExpr.and(( WorkbenchStateContext.isEqualTo('folder')), ( ContextKeyExpr.equals('resourceScheme', Schemas.extension)))),
        ...
        this.registerExtensionAction({
            ...
            title: ( localize2(7474, "Manage Trusted Extension Publishers")),
            category: EXTENSIONS_CATEGORY,
            f1: true,
            run: async (accessor) => {
                const quickInputService = accessor.get(IQuickInputService);
                ...
                const result = await quickInputService.pick(trustedPublisherItems, {
                    canPickMany: true,
                    title: ( localize(7475, "Manage Trusted Extension Publishers")),
                    placeHolder: ( localize(7476, "Choose which publishers to trust")),
                });
                if (result) {
...
registerAction2(class ExtensionsGallerySignInAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(7477, 'Sign in to access Extensions Marketplace')),
            menu: {
