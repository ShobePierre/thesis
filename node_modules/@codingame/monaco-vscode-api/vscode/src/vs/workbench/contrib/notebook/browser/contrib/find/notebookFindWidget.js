...
import { append, addDisposableListener, EventType, isHTMLElement, getWindow, createTextNode } from '../../../../../../base/browser/dom.js';
import { alert } from '../../../../../../base/browser/ui/aria/aria.js';
import { KeyCode, KeyMod as KeyMod$1 } from '../../../../../../base/common/keyCodes.js';
import { Lazy } from '../../../../../../base/common/lazy.js';
import { Disposable } from '../../../../../../base/common/lifecycle.js';
import { format } from '../../../../../../base/common/strings.js';
import { CONTEXT_FIND_WIDGET_VISIBLE, MATCHES_LIMIT } from '../../../../../../editor/contrib/find/browser/findModel.js';
...
let NotebookFindWidget = class NotebookFindWidget extends SimpleFindReplaceWidget {
    ...
    _getAriaLabel(label, currentMatch, searchString) {
        if (label === NLS_NO_RESULTS) {
            return searchString === ''
                ? ( localize(9265, "{0} found", label))
                : ( localize(9266, "{0} found for '{1}'", label, searchString));
        }
        return localize(9267, "{0} found for '{1}'", label, searchString);
    }
    dispose() {
        this._notebookEditor?.removeClassName(FIND_SHOW_TRANSITION);
        this._notebookEditor?.removeClassName(FIND_HIDE_TRANSITION);
