                    ...
                    async () => {
                        try {
                            ...
                            const error = e.message
                                ? ( localize(6277, "Toggling the comment reaction failed: {0}.", e.message))
                                : ( localize(6278, "Toggling the comment reaction failed"));
                ...
                async () => {
                    try {
                        ...
                        if (reaction.hasReacted) {
                            error = e.message
                                ? ( localize(6279, "Deleting the comment reaction failed: {0}.", e.message))
                                : ( localize(6280, "Deleting the comment reaction failed"));
                        }
                        else {
                            error = e.message
                                ? ( localize(6281, "Deleting the comment reaction failed: {0}.", e.message))
                                : ( localize(6282, "Deleting the comment reaction failed"));
                        }
                        this.notificationService.error(error);
                    }
                },
