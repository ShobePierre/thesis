...
const SearchExtensionsToolData = {
    ...
    displayName: ( localize(7848, 'Search Extensions')),
    ...
    userDescription: ( localize(7849, 'Search for VS Code extensions')),
    ...
    async invoke(invocation, _countTokens, _progress, token) {
        ...
        if (!params.keywords?.length && !params.category && !params.ids?.length) {
            return {
                content: [{
                        kind: 'text',
                        value: ( localize(7850, 'Please provide a category or keywords or ids to search for.'))
                    }]
            };
        }
