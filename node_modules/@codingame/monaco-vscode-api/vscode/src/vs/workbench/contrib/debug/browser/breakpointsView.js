...
import { dataBreakpoint, functionBreakpoint, logBreakpoint, breakpoint, conditionalBreakpoint, debugBreakpointUnsupported, watchExpressionsAddFuncBreakpoint, watchExpressionsAddDataBreakpoint, breakpointsActivate, breakpointsRemoveAll } from './debugIcons.js';
...
class ExceptionBreakpointsRenderer {
    ...
    renderElement(exceptionBreakpoint, index, data) {
        ...
        const exceptionBreakpointtitle = exceptionBreakpoint.verified ? (exceptionBreakpoint.description || data.name.textContent) : exceptionBreakpoint.message || ( localize(6473, "Unverified Exception Breakpoint"));
        ...
        data.elementDisposables.add(this.hoverService.setupManagedHover(getDefaultHoverDelegate('mouse'), data.condition, ( localize(6474, "Expression condition: {0}", exceptionBreakpoint.condition))));
...
let FunctionBreakpointsRenderer = class FunctionBreakpointsRenderer {
    ...
    renderElement(functionBreakpoint, _index, data) {
        ...
        if (session && !session.capabilities.supportsFunctionBreakpoints) {
            data.elementDisposables.add(this.hoverService.setupManagedHover(getDefaultHoverDelegate('mouse'), data.breakpoint, ( localize(6476, "Function breakpoints are not supported by this debug type"))));
        }
        this.breakpointSupportsCondition.set(!session || !!session.capabilities.supportsConditionalBreakpoints);
...
let DataBreakpointsRenderer = class DataBreakpointsRenderer {
    ...
    renderElement(dataBreakpoint, _index, data) {
        ...
        if (session && !session.capabilities.supportsDataBreakpoints) {
            data.elementDisposables.add(this.hoverService.setupManagedHover(getDefaultHoverDelegate('mouse'), data.breakpoint, ( localize(6477, "Data breakpoints are not supported by this debug type"))));
        }
        if (dataBreakpoint.accessType) {
            const accessType = dataBreakpoint.accessType === 'read' ? ( localize(6478, "Read")) : dataBreakpoint.accessType === 'write' ? ( localize(6479, "Write")) : ( localize(6480, "Access"));
...
let InstructionBreakpointsRenderer = class InstructionBreakpointsRenderer {
    ...
    renderElement(breakpoint, index, data) {
        ...
        data.elementDisposables.add(this.hoverService.setupManagedHover(getDefaultHoverDelegate('mouse'), data.name, ( localize(6481, "Decimal Address: {0}", (breakpoint.address.toString())))));
        data.checkbox.checked = breakpoint.enabled;
        const { message, icon } = getBreakpointMessageAndIcon(this.debugService.state, this.debugService.getModel().areBreakpointsActivated(), breakpoint, this.labelService, this.debugService.getModel());
        data.icon.className = ThemeIcon.asClassName(icon);
        data.elementDisposables.add(this.hoverService.setupManagedHover(getDefaultHoverDelegate('mouse'), data.breakpoint, breakpoint.message || message || ''));
...
class FunctionBreakpointInputRenderer {
    ...
    renderElement(functionBreakpoint, _index, data) {
        ...
        let placeholder = ( localize(6482, "Function to break on"));
        let ariaLabel = ( localize(6483, "Type function breakpoint."));
        if (data.type === 'condition') {
            data.inputBox.value = functionBreakpoint.condition || '';
            placeholder = ( localize(6484, "Break when expression evaluates to true"));
            ariaLabel = ( localize(
                6485,
            ...
            placeholder = ( localize(6486, "Break when hit count is met"));
            ariaLabel = ( localize(
                6487,
...
class DataBreakpointInputRenderer {
    ...
    renderElement(dataBreakpoint, _index, data) {
        ...
        if (data.type === 'condition') {
            ...
            placeholder = ( localize(6488, "Break when expression evaluates to true"));
            ariaLabel = ( localize(
                6489,
            ...
            placeholder = ( localize(6490, "Break when hit count is met"));
            ariaLabel = ( localize(6491, "Type hit count. Data breakpoint will break when hit count is met."));
        }
        data.inputBox.setAriaLabel(ariaLabel);
        data.inputBox.setPlaceHolder(placeholder);
        setTimeout(() => {
...
class ExceptionBreakpointInputRenderer {
    ...
    renderTemplate(container) {
        ...
        const inputBox = ( new InputBox(inputBoxContainer, this.contextViewService, {
            ariaLabel: ( localize(6492, "Type exception breakpoint condition")),
            inputBoxStyles: defaultInputBoxStyles
        }));
        toDispose.add(inputBox);
        const wrapUp = (success) => {
    ...
    renderElement(exceptionBreakpoint, _index, data) {
        const placeHolder = exceptionBreakpoint.conditionDescription || ( localize(6493, "Break when expression evaluates to true"));
        data.inputBox.setPlaceHolder(placeHolder);
...
class BreakpointsAccessibilityProvider {
    ...
    getWidgetAriaLabel() {
        return localize(6494, "Breakpoints");
    }
    getRole() {
        return 'checkbox';
    }
...
function getBreakpointMessageAndIcon(state, breakpointsActivated, breakpoint$1, labelService, debugModel) {
    ...
    if (!breakpoint$1.enabled || !breakpointsActivated) {
        return {
            ...
            message: breakpoint$1.logMessage ? ( localize(6495, "Disabled Logpoint")) : ( localize(6496, "Disabled Breakpoint")),
        };
    }
    ...
    if (debugActive && !breakpoint$1.verified) {
        return {
            ...
            message: ('message' in breakpoint$1 && breakpoint$1.message) ? breakpoint$1.message : (breakpoint$1.logMessage ? ( localize(6497, "Unverified Logpoint")) : ( localize(6498, "Unverified Breakpoint"))),
    ...
    if (breakpoint$1 instanceof DataBreakpoint) {
        if (!breakpoint$1.supported) {
            return {
                icon: breakpointIcon.unverified,
                message: ( localize(6499, "Data breakpoints not supported by this debug type")),
            };
        }
        return {
            icon: breakpointIcon.regular,
            message: breakpoint$1.message || ( localize(6500, "Data Breakpoint"))
        };
    }
    if (breakpoint$1 instanceof FunctionBreakpoint) {
        if (!breakpoint$1.supported) {
            return {
                icon: breakpointIcon.unverified,
                message: ( localize(6501, "Function breakpoints not supported by this debug type")),
            };
        }
        const messages = [];
        messages.push(breakpoint$1.message || ( localize(6502, "Function Breakpoint")));
        if (breakpoint$1.condition) {
            messages.push(( localize(6503, "Condition: {0}", breakpoint$1.condition)));
        }
        if (breakpoint$1.hitCondition) {
            messages.push(( localize(6504, "Hit Count: {0}", breakpoint$1.hitCondition)));
        }
        return {
            icon: breakpointIcon.regular,
    ...
    if (breakpoint$1 instanceof InstructionBreakpoint) {
        if (!breakpoint$1.supported) {
            return {
                icon: breakpointIcon.unverified,
                message: ( localize(6505, "Instruction breakpoints not supported by this debug type")),
            };
        }
        const messages = [];
        if (breakpoint$1.message) {
            ...
            messages.push(( localize(6507, "Instruction breakpoint")));
        }
        if (breakpoint$1.hitCondition) {
            messages.push(( localize(6504, "Hit Count: {0}", breakpoint$1.hitCondition)));
        }
    ...
    if (breakpoint$1.logMessage || breakpoint$1.condition || breakpoint$1.hitCondition || triggeringBreakpoint) {
        ...
        if (!breakpoint$1.supported) {
            ...
            messages.push(( localize(6508, "Breakpoints of this type are not supported by the debugger")));
        }
        if (breakpoint$1.logMessage) {
            messages.push(( localize(6509, "Log Message: {0}", breakpoint$1.logMessage)));
        }
        if (breakpoint$1.condition) {
            messages.push(( localize(6503, "Condition: {0}", breakpoint$1.condition)));
        }
    ...
    const message = ('message' in breakpoint$1 && breakpoint$1.message) ? breakpoint$1.message : breakpoint$1 instanceof Breakpoint && labelService ? labelService.getUriLabel(breakpoint$1.uri) : ( localize(6511, "Breakpoint"));
    return {
        icon: breakpointIcon.regular,
        message
    };
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(6512, "Add Function Breakpoint")),
                mnemonicTitle: ( localize(6513, "&&Function Breakpoint...")),
            },
            f1: true,
...
class MemoryBreakpointAction extends Action2 {
    async run(accessor, existingBreakpoint) {
        ...
        if (info.accessTypes && info.accessTypes?.length > 1) {
            ...
            const selectedAccessType = await quickInput.pick(accessTypes, { placeHolder: ( localize(6515, "Select the access type to monitor")) });
    ...
    getRange(quickInput, defaultValue) {
        return (new Promise(resolve => {
            ...
            input.prompt = ( localize(6516, "Enter a memory range in which to break"));
    ...
    parseAddress(range, isFinal) {
        ...
        if (sign === '-') {
            if (start > end) {
                return { error: ( localize(6520, 'End ({1}) should be greater than Start ({0})', startStr, endStr)) };
            }
...
registerAction2(class extends MemoryBreakpointAction {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(6521, "Add Data Breakpoint at Address")),
                mnemonicTitle: ( localize(6522, "&&Data Breakpoint...")),
            },
            f1: true,
...
registerAction2(class extends MemoryBreakpointAction {
    constructor() {
        super({
            ...
            title: ( localize2(6523, "Edit Address...")),
            menu: [{
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(6524, 'Toggle Activate Breakpoints')),
            f1: true,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(6525, "Remove Breakpoint")),
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(6526, "Remove All Breakpoints")),
                mnemonicTitle: ( localize(6527, "Remove &&All Breakpoints")),
            },
            f1: true,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(6528, "Enable All Breakpoints")),
                mnemonicTitle: ( localize(6529, "&&Enable All Breakpoints")),
            },
            f1: true,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(6530, "Disable All Breakpoints")),
                mnemonicTitle: ( localize(6531, "Disable A&&ll Breakpoints")),
            },
            f1: true,
            precondition: CONTEXT_DEBUGGERS_AVAILABLE,
            menu: [{
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(6532, 'Reapply All Breakpoints')),
            f1: true,
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            title: ( localize(6533, "Edit Condition...")),
            icon: Codicon.edit,
    ...
    async runInView(accessor, view, breakpoint) {
        ...
        if (breakpoint instanceof Breakpoint) {
            ...
            const actions = [( new Action('breakpoint.editCondition', ( localize(6533, "Edit Condition...")), undefined, true, async () => view.renderInputBox({ breakpoint, type: 'condition' }))),
                ( new Action('breakpoint.editCondition', ( localize(6534, "Edit Hit Count...")), undefined, true, async () => view.renderInputBox({ breakpoint, type: 'hitCount' })))];
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            viewId: BREAKPOINTS_VIEW_ID,
            title: ( localize(6535, "Edit Function Condition...")),
            menu: [{
                    id: MenuId.DebugBreakpointsContext,
                    group: 'navigation',
                    order: 10,
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            viewId: BREAKPOINTS_VIEW_ID,
            title: ( localize(6534, "Edit Hit Count...")),
            precondition: CONTEXT_BREAKPOINT_SUPPORTS_CONDITION,
            menu: [{
                    id: MenuId.DebugBreakpointsContext,
                    group: 'navigation',
...
registerAction2(class extends ViewAction {
    ...
    async runInView(accessor, view, breakpoint) {
        ...
        )), { placeHolder: ( localize(6537, "Select Breakpoint Mode")) });
        if (!picked) {
            return;
        }
        if (kind === 'source') {
