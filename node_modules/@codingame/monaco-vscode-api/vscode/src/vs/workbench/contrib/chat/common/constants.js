...
const LEGACY_AGENT_SESSIONS_VIEW_ID = 'workbench.view.chat.sessions';
...
export { CONTEXT_MODELS_EDITOR, CONTEXT_MODELS_SEARCH_FOCUS, ChatAgentLocation, ChatConfiguration, ChatEditorTitleMaxLength, ChatModeKind, CollapsedToolsDisplayMode, LEGACY_AGENT_SESSIONS_VIEW_ID, MANAGE_CHAT_COMMAND_ID, ThinkingDisplayMode, isSupportedChatFileScheme, validateChatMode };
