...
const breakpointHelperDecoration = {
    ...
    glyphMarginHoverMessage: ( new MarkdownString()).appendText(( localize(6423, "Click to add a breakpoint"))),
...
let BreakpointEditorContribution = class BreakpointEditorContribution {
            ...
            if (e.event.rightButton || (isMacintosh && e.event.leftButton && e.event.ctrlKey)) {
                ...
                if (breakpoints.length) {
                    ...
                    if (isShiftPressed) {
                        ...
                        const breakpointType = logPoint ? ( localize(6424, "Logpoint")) : ( localize(6425, "Breakpoint"));
                        const disabledBreakpointDialogMessage = ( localize(
                            ...
                            logPoint ? ( localize(6427, "message")) : ( localize(6428, "condition"))
                        ));
                        ...
                        await this.dialogService.prompt({
                            ...
                            buttons: [
                                {
                                    label: ( localize(6430, "&&Remove {0}", breakpointType)),
                                ...
                                },
                                {
                                    label: ( localize(
                                        6431,
                                        "{0} {1}",
                                        enabled ? ( localize(6432, "&&Disable")) : ( localize(6433, "&&Enable")),
                                        breakpointType
                                    )),
    ...
    getContextMenuActions(breakpoints, uri, lineNumber, column) {
        ...
        if (breakpoints.length === 1) {
            const breakpointType = breakpoints[0].logMessage ? ( localize(6424, "Logpoint")) : ( localize(6425, "Breakpoint"));
            actions.push(toAction({
                id: 'debug.removeBreakpoint', label: ( localize(6434, "Remove {0}", breakpointType)), enabled: true, run: async () => {
                    await this.debugService.removeBreakpoints(breakpoints[0].getId());
                }
            }));
            actions.push(toAction({
                id: 'workbench.debug.action.editBreakpointAction',
                label: ( localize(6435, "Edit {0}...", breakpointType)),
                enabled: true,
            ...
            actions.push(toAction({
                ...
                label: breakpoints[0].enabled ? ( localize(6436, "Disable {0}", breakpointType)) : ( localize(6437, "Enable {0}", breakpointType)),
                enabled: true,
            ...
            actions.push(( new SubmenuAction('debug.removeBreakpoints', ( localize(6438, "Remove Breakpoints")), ( sorted.map(bp => toAction({
                id: 'removeInlineBreakpoint',
                label: bp.column ? ( localize(6439, "Remove Inline Breakpoint on Column {0}", bp.column)) : ( localize(6440, "Remove Line Breakpoint")),
                enabled: true,
                run: () => this.debugService.removeBreakpoints(bp.getId())
            }))))));
            actions.push(( new SubmenuAction('debug.editBreakpoints', ( localize(6441, "Edit Breakpoints")), ( sorted.map(bp => toAction({
                id: 'editBreakpoint',
                label: bp.column ? ( localize(6442, "Edit Inline Breakpoint on Column {0}", bp.column)) : ( localize(6443, "Edit Line Breakpoint")),
                enabled: true,
                run: () => Promise.resolve(this.showBreakpointWidget(bp.lineNumber, bp.column))
            }))))));
            actions.push(( new SubmenuAction('debug.enableDisableBreakpoints', ( localize(6444, "Enable/Disable Breakpoints")), ( sorted.map(bp => toAction({
                id: bp.enabled ? 'disableColumnBreakpoint' : 'enableColumnBreakpoint',
                label: bp.enabled ? (bp.column ? ( localize(6445, "Disable Inline Breakpoint on Column {0}", bp.column)) : ( localize(6446, "Disable Line Breakpoint")))
                    : (bp.column ? ( localize(6447, "Enable Inline Breakpoint on Column {0}", bp.column)) : ( localize(6448, "Enable Line Breakpoint"))),
                enabled: true,
            ...
            actions.push(toAction({
                ...
                label: ( localize(6452, "Add Triggered Breakpoint...")),
                enabled: true,
        ...
        if (this.debugService.state === State.Stopped) {
            ...
            actions.push(toAction({
                id: 'runToLine',
                label: ( localize(6453, "Run to Line")),
                enabled: true,
...
const debugIconBreakpointForeground = registerColor('debugIcon.breakpointForeground', '#E51400', ( localize(6454, 'Icon color for breakpoints.')));
const debugIconBreakpointDisabledForeground = registerColor('debugIcon.breakpointDisabledForeground', '#848484', ( localize(6455, 'Icon color for disabled breakpoints.')));
const debugIconBreakpointUnverifiedForeground = registerColor('debugIcon.breakpointUnverifiedForeground', '#848484', ( localize(6456, 'Icon color for unverified breakpoints.')));
const debugIconBreakpointCurrentStackframeForeground = registerColor('debugIcon.breakpointCurrentStackframeForeground', { dark: '#FFCC00', light: '#BE8700', hcDark: '#FFCC00', hcLight: '#BE8700' }, ( localize(6457, 'Icon color for the current breakpoint stack frame.')));
const debugIconBreakpointStackframeForeground = registerColor('debugIcon.breakpointStackframeForeground', '#89D185', ( localize(6458, 'Icon color for all breakpoint stack frames.')));
