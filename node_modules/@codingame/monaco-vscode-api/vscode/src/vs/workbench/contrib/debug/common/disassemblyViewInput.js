...
const DisassemblyEditorIcon = registerIcon('disassembly-editor-label-icon', Codicon.debug, ( localize(7142, 'Icon of the disassembly editor label.')));
class DisassemblyViewInput extends EditorInput {
    ...
    getName() {
        return localize(7143, "Disassembly");
    }
    getIcon() {
