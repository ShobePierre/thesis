...
import { localChatSessionType, ChatSessionStatus } from '../../common/chatSessionsService.js';
            ...
            for (const session of providerSessions) {
                ...
                if (!state) {
                    this.mapSessionToState.set(session.resource, {
                        status,
                        inProgressTime: this.chatSessionsService.isChatSessionInProgressStatus(status) ? Date.now() : undefined,
                    });
                }
...
export { AgentSessionsModel, getAgentChangesSummary, hasValidDiff, isAgentSession, isAgentSessionsModel, isLocalAgentSessionItem };
