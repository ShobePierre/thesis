...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            title: ( localize(6373, "Focus Comments view")),
            keybinding: {
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            title: ( localize(6374, "Clear filter text")),
            keybinding: {
                when: CommentsViewFilterFocusContextKey,
                weight: KeybindingWeight.WorkbenchContrib,
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            title: ( localize(6375, "Focus comments filter")),
            keybinding: {
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            title: ( localize(6376, "Show Unresolved")),
            category: ( localize(6377, "Comments")),
            toggled: {
                condition: CONTEXT_KEY_SHOW_UNRESOLVED,
                title: ( localize(6378, "Show Unresolved")),
            },
            menu: {
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            title: ( localize(6379, "Show Resolved")),
            category: ( localize(6377, "Comments")),
            toggled: {
                condition: CONTEXT_KEY_SHOW_RESOLVED,
                title: ( localize(6380, "Show Resolved")),
            },
            menu: {
                id: viewFilterSubmenu,
                group: '1_filter',
