...
let TextFileEditor = class TextFileEditor extends AbstractTextCodeEditor {
    ...
    getTitle() {
        ...
        return localize(7862, "Text File Editor");
    }
    get input() {
        return this._input;
    }
    ...
    async handleSetInputError(error, input, options) {
        ...
        if (error.fileOperationResult === FileOperationResult.FILE_IS_DIRECTORY) {
            ...
            actions.push(toAction({
                id: 'workbench.files.action.openFolder', label: ( localize(7863, "Open Folder")), run: async () => {
            ...
            if (this.contextService.isInsideWorkspace(input.preferredResource)) {
                actions.push(toAction({
                    id: 'workbench.files.action.reveal', label: ( localize(7864, "Reveal Folder")), run: async () => {
        ...
        if (error.fileOperationResult === FileOperationResult.FILE_NOT_FOUND &&
            ...
            const fileNotFoundError = createEditorOpenError(( new FileOperationError(( localize(7868, "The editor could not be opened because the file was not found.")), FileOperationResult.FILE_NOT_FOUND)), [
                toAction({
                    id: 'workbench.files.action.createMissingFile', label: ( localize(7869, "Create File")), run: async () => {
