...
let CollapsedCellOutput = class CollapsedCellOutput extends CellContentPart {
    constructor(notebookEditor, cellOutputCollapseContainer, keybindingService) {
        ...
        placeholder.textContent = ( localize(9682, "Outputs are collapsed"));
        ...
        if (keybinding) {
            placeholder.title = ( localize(9683, "Double-click to expand cell output ({0})", keybinding.getLabel()));
            cellOutputCollapseContainer.title = ( localize(9684, "Expand Cell Output (${0})", keybinding.getLabel()));
        }
