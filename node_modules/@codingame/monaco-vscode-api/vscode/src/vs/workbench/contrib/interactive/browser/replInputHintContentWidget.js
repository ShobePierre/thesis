...
let ReplInputHintContentWidget = class ReplInputHintContentWidget extends Disposable {
    ...
    setHint() {
        ...
        if (keybinding && keybindingHintLabel) {
            const actionPart = ( localize(8380, 'Press {0} to execute. ', keybindingHintLabel));
            ...
            const helpInfo = helpKeybinding
                ? ( localize(8381, "Use {0} for accessibility help. ", helpKeybinding))
                : ( localize(8382, "Run the Open Accessibility Help command for more information. "));
