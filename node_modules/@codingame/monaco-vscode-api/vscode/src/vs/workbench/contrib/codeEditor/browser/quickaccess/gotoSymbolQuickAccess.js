        ...
        this.outlineService.createOutline(pane, OutlineTarget.QuickPick, cts.token).then(outline => {
            ...
            const updatePickerItems = () => {
                ...
                if (filteredItems.length === 0) {
                    const label = ( localize(6168, 'No matching entries'));
...
class GotoSymbolAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: {
                ...( localize2(6169, "Go to Symbol in Editor...")),
                mnemonicTitle: ( localize(6170, "Go to &&Symbol in Editor...")),
            },
            f1: true,
            keybinding: {
...
( Registry.as(Extensions.Quickaccess)).registerQuickAccessProvider({
    ...
    placeholder: ( localize(6171, "Type the name of a symbol to go to.")),
    helpEntries: [
        {
            description: ( localize(6172, "Go to Symbol in Editor")),
            prefix: AbstractGotoSymbolQuickAccessProvider.PREFIX,
            commandId: GotoSymbolAction.ID,
            commandCenterOrder: 40
        },
        {
            description: ( localize(6173, "Go to Symbol in Editor by Category")),
