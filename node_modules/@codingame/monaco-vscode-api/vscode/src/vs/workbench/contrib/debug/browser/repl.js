...
let Repl = class Repl extends FilterViewPane {
    ...
    constructor(options, debugService, instantiationService, storageService, themeService, modelService, contextKeyService, codeEditorService, viewDescriptorService, contextMenuService, configurationService, textResourcePropertiesService, editorService, keybindingService, openerService, hoverService, menuService, languageFeaturesService, logService) {
        ...
        super({
            ...options,
            filterOptions: {
                placeholder: ( localize(6933, "Filter (e.g. text, !exclude, \\escape)")),
                text: filterText,
    ...
    get refreshScheduler() {
        ...
        return (new RunOnceScheduler(async () => {
            ...
            this.filterWidget.updateBadge(total === filtered || total === 0 ? undefined : ( localize(6934, "Showing {0} of {1}", filtered, total)));
    ...
    getAriaLabel() {
        let ariaLabel = ( localize(6935, "Debug Console"));
        ...
        if (keybinding) {
            ariaLabel = ( localize(6936, "{0}, use ({1}) for accessibility help", ariaLabel, keybinding));
        }
        else {
            ariaLabel = ( localize(
                6937,
    ...
    updateInputDecoration() {
        ...
        if (this.isReadonly && this.replInput.hasTextFocus() && !this.replInput.getValue()) {
            ...
            decorations.push({
                ...
                renderOptions: {
                    after: {
                        contentText: ( localize(6938, "Please start a debug session to evaluate expressions")),
...
class AcceptReplInputAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(6939, "Debug Console: Accept Input")),
...
class FilterReplAction extends ViewAction {
    constructor() {
        super({
            ...
            title: ( localize(6940, "Debug Console: Focus Filter")),
            precondition: CONTEXT_IN_DEBUG_REPL,
            keybinding: [{
...
class FindReplAction extends ViewAction {
    constructor() {
        super({
            viewId: REPL_VIEW_ID,
            id: 'repl.action.find',
            title: ( localize(6941, "Debug Console: Focus Find")),
            precondition: CONTEXT_IN_DEBUG_REPL,
            keybinding: [{
...
class ReplCopyAllAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(6942, "Debug: Console Copy All")),
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            viewId: REPL_VIEW_ID,
            title: ( localize(6943, "Select Debug Console")),
            f1: false,
            menu: {
                id: MenuId.ViewTitle,
                group: 'navigation',
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            viewId: REPL_VIEW_ID,
            title: ( localize2(6944, 'Clear Console')),
            metadata: {
                description: ( localize2(6945, 'Clears all program output from your debug REPL'))
            },
            f1: true,
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            title: ( localize(6946, "Collapse All")),
            viewId: REPL_VIEW_ID,
            menu: {
                id: MenuId.DebugConsoleContext,
                group: 'z_commands',
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(6950, "Focus on Debug Console View")),
        });
    }
    async run(accessor) {
