...
const explorerViewIcon = registerIcon('explorer-view-icon', Codicon.files, ( localize(7890, 'View icon of the explorer view.')));
const openEditorsViewIcon = registerIcon('open-editors-view-icon', Codicon.book, ( localize(7891, 'View icon of the open editors view.')));
...
const VIEW_CONTAINER = viewContainerRegistry.registerViewContainer({
    ...
    openCommandActionDescriptor: {
        id: VIEWLET_ID,
        title: ( localize2(7893, "Explorer")),
        mnemonicTitle: ( localize(7894, "&&Explorer")),
        keybindings: { primary: KeyMod$1.CtrlCmd | KeyMod$1.Shift | KeyCode.KeyE },
        order: 0
    },
}, ViewContainerLocation.Sidebar, { isDefault: true });
const openFolder = ( localize(7895, "Open Folder"));
const addAFolder = ( localize(7896, "add a folder"));
const openRecent = ( localize(7897, "Open Recent"));
...
viewsRegistry.registerViewWelcomeContent(EmptyView.ID, {
    content: ( localize(7900, "Connected to remote.\n{0}", openFolderButton)),
    when: ( ContextKeyExpr.and((
...
viewsRegistry.registerViewWelcomeContent(EmptyView.ID, {
    content: ( localize(7902, "You have not yet opened a folder.\n{0}", openFolderButton)),
    when: ( ContextKeyExpr.and(
