...
let InlayHintsAccessibility = class InlayHintsAccessibility {
    ...
    static { this.IsReading = ( new RawContextKey(
        ...
        false,
        { type: 'boolean', description: ( localize(8272, "Whether the current line and its inlay hints are currently focused")) }
    )); }
    ...
    constructor(_editor, contextKeyService, _accessibilitySignalService, _instaService) {
        ...
        this._ariaElement.setAttribute('aria-description', ( localize(8273, "Code with Inlay Hint Information")));
...
registerAction2(class StartReadHints extends EditorAction2 {
    constructor() {
        super({
            ...
            title: ( localize2(8274, "Read Line with Inlay Hints")),
...
registerAction2(class StopReadHints extends EditorAction2 {
    constructor() {
        super({
            ...
            title: ( localize2(8275, "Stop Inlay Hints Reading")),
