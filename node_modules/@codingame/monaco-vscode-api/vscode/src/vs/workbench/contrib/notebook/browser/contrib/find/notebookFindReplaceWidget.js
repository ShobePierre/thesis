...
const NLS_FIND_INPUT_LABEL = ( localize(9248, "Find"));
const NLS_FIND_INPUT_PLACEHOLDER = ( localize(9249, "Find"));
const NLS_PREVIOUS_MATCH_BTN_LABEL = ( localize(9250, "Previous Match"));
const NLS_NEXT_MATCH_BTN_LABEL = ( localize(9251, "Next Match"));
const NLS_TOGGLE_SELECTION_FIND_TITLE = ( localize(9252, "Find in Selection"));
const NLS_CLOSE_BTN_LABEL = ( localize(9253, "Close"));
const NLS_TOGGLE_REPLACE_MODE_BTN_LABEL = ( localize(9254, "Toggle Replace"));
const NLS_REPLACE_INPUT_LABEL = ( localize(9255, "Replace"));
const NLS_REPLACE_INPUT_PLACEHOLDER = ( localize(9256, "Replace"));
const NLS_REPLACE_BTN_LABEL = ( localize(9257, "Replace"));
const NLS_REPLACE_ALL_BTN_LABEL = ( localize(9258, "Replace All"));
registerIcon('find-filter', Codicon.filter, ( localize(9259, 'Icon for Find Filter in find widget.')));
const NOTEBOOK_FIND_FILTERS = ( localize(9260, "Find Filters"));
const NOTEBOOK_FIND_IN_MARKUP_INPUT = ( localize(9261, "Markdown Source"));
const NOTEBOOK_FIND_IN_MARKUP_PREVIEW = ( localize(9262, "Rendered Markdown"));
const NOTEBOOK_FIND_IN_CODE_INPUT = ( localize(9263, "Code Cell Source"));
const NOTEBOOK_FIND_IN_CODE_OUTPUT = ( localize(9264, "Code Cell Output"));
