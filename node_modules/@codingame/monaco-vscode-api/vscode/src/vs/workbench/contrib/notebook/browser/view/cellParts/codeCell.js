...
let CodeCell = class CodeCell extends Disposable {
    ...
    registerMouseListener() {
        ...
        if (this._useNewApproachForEditorLayout) {
            ...
            this._register(addDisposableListener(win, 'mouseup', () => {
                this._pointerDownInEditor = false;
    ...
    _attachInputExpandButton(element) {
        ...
        if (keybinding) {
            element.title = ( localize(9675, "Double-click to expand cell input ({0})", keybinding.getLabel()));
            expandIcon.title = ( localize(9676, "Expand Cell Input ({0})", keybinding.getLabel()));
        }
...
class CodeCellLayout {
    ...
    layoutEditor(reason) {
        ...
        const editorContentHeight = Math.max((gotContentHeight === -1 ? editor.getLayoutInfo().height : gotContentHeight), gotContentHeight === -1 ? this._initialEditorDimension.height : gotContentHeight);
