...
import { closeIcon as closeIcon$1 } from '../panel/panelActions.js';

const maximizeIcon = registerIcon('auxiliarybar-maximize', Codicon.screenFull, ( localize(2982, 'Icon to maximize the secondary side bar.')));
const closeIcon = registerIcon('auxiliarybar-close', closeIcon$1, ( localize(2983, 'Icon to close the secondary side bar.')));
const auxiliaryBarRightIcon = registerIcon('auxiliarybar-right-layout-icon', Codicon.layoutSidebarRight, ( localize(2984, 'Icon to toggle the secondary side bar off in its right position.')));
const auxiliaryBarRightOffIcon = registerIcon('auxiliarybar-right-off-layout-icon', Codicon.layoutSidebarRightOff, ( localize(2985, 'Icon to toggle the secondary side bar on in its right position.')));
const auxiliaryBarLeftIcon = registerIcon('auxiliarybar-left-layout-icon', Codicon.layoutSidebarLeft, ( localize(2986, 'Icon to toggle the secondary side bar in its left position.')));
const auxiliaryBarLeftOffIcon = registerIcon('auxiliarybar-left-off-layout-icon', Codicon.layoutSidebarLeftOff, ( localize(2987, 'Icon to toggle the secondary side bar on in its left position.')));
class ToggleAuxiliaryBarAction extends Action2 {
    static { this.ID = 'workbench.action.toggleAuxiliaryBar'; }
    static { this.LABEL = ( localize2(2988, "Toggle Secondary Side Bar Visibility")); }
    constructor() {
        super({
            ...
            toggled: {
                ...
                title: ( localize(2989, 'Hide Secondary Side Bar')),
                icon: closeIcon,
                mnemonicTitle: ( localize(2990, "&&Secondary Side Bar")),
            },
            icon: closeIcon,
            category: Categories.View,
            metadata: {
                description: ( localize(2991, 'Open/Show and Close/Hide Secondary Side Bar')),
            },
            f1: true,
            keybinding: {
    ...
    async run(accessor) {
        ...
        const alertMessage = isCurrentlyVisible
            ? ( localize(2992, "Secondary Side Bar hidden"))
            : ( localize(2993, "Secondary Side Bar shown"));
        alert(alertMessage);
    }
}
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2989, 'Hide Secondary Side Bar')),
            category: Categories.View,
...
registerAction2(class FocusAuxiliaryBarAction extends Action2 {
    ...
    static { this.LABEL = ( localize2(2994, "Focus into Secondary Side Bar")); }
    constructor() {
        super({
...
MenuRegistry.appendMenuItems([
    {
        ...
        item: {
            ...
            command: {
                id: ToggleAuxiliaryBarAction.ID,
                title: ( localize(2995, "Toggle Secondary Side Bar")),
        ...
        item: {
            ...
            command: {
                id: ToggleAuxiliaryBarAction.ID,
                title: ( localize2(2996, 'Hide Secondary Side Bar')),
            },
...
registerAction2(class extends SwitchCompositeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(2997, 'Previous Secondary Side Bar View')),
            category: Categories.View,
            f1: true
...
registerAction2(class extends SwitchCompositeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(2998, 'Next Secondary Side Bar View')),
            category: Categories.View,
            f1: true
        }, ViewContainerLocation.AuxiliaryBar, 1);
    }
...
class MaximizeAuxiliaryBar extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(2999, 'Maximize Secondary Side Bar')),
            tooltip: ( localize(3000, "Maximize Secondary Side Bar Size")),
            category: Categories.View,
            f1: true,
...
class RestoreAuxiliaryBar extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3001, 'Restore Secondary Side Bar')),
            tooltip: ( localize(3002, "Restore Secondary Side Bar Size")),
            category: Categories.View,
            f1: true,
...
class ToggleMaximizedAuxiliaryBar extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3003, 'Toggle Maximized Secondary Side Bar')),
            f1: true,
            category: Categories.View
        });
    }
