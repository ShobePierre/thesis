...
import { IConfigurationOverrides } from "../../../../platform/configuration/common/configuration.js";
...
export declare abstract class BreadcrumbsConfig<T> {
    ...
    static readonly TitleScrollbarVisibility: {
        bindTo(service: IConfigurationService): BreadcrumbsConfig<Required<NonNullable<"hidden" | "visible" | "auto" | undefined>>>;
    };
