...
let NotificationsCenter = class NotificationsCenter extends Themable {
    ...
    updateTitle() {
        ...
        if (this.model.notifications.length === 0) {
            notificationsCenterTitle.textContent = ( localize(3519, "No new notifications"));
            clearAllAction.enabled = false;
        }
        else {
            notificationsCenterTitle.textContent = ( localize(3520, "Notifications"));
    ...
    create() {
        ...
        const notificationsToolBar = this._register(( new ActionBar(toolbarContainer, {
            ariaLabel: ( localize(3521, "Notification Center Actions")),
            actionRunner,
                    ...
                    return this._register(this.instantiationService.createInstance(DropdownMenuActionViewItem, action, {
                        getActions() {
                            const actions = [toAction({
                                    ...
                                    label: that.notificationService.getFilter() === NotificationsFilter.OFF ? ( localize(3522, "Enable Do Not Disturb Mode")) : ( localize(3523, "Disable Do Not Disturb Mode")),
                            ...
                            if (sortedFilters.length > NotificationsCenter_1.MAX_NOTIFICATION_SOURCES) {
                                actions.push(( new Separator()));
                                actions.push(that._register(that.instantiationService.createInstance(ToggleDoNotDisturbBySourceAction, ToggleDoNotDisturbBySourceAction.ID, ( localize(3524, "More…")))));
                            }
                            return actions;
                        },
        ...
        this.notificationsList = this.instantiationService.createInstance(NotificationsList, this.notificationsCenterContainer, {
            widgetAriaLabel: ( localize(3525, "Notifications Center"))
        });
