...
const maximizeIcon = registerIcon('panel-maximize', Codicon.screenFull, ( localize(3569, 'Icon to maximize a panel.')));
const closeIcon = registerIcon('panel-close', Codicon.close, ( localize(3570, 'Icon to close a panel.')));
const panelIcon = registerIcon('panel-layout-icon', Codicon.layoutPanel, ( localize(3571, 'Icon to toggle the panel off when it is on.')));
const panelOffIcon = registerIcon('panel-layout-icon-off', Codicon.layoutPanelOff, ( localize(3572, 'Icon to toggle the panel on when it is off.')));
class TogglePanelAction extends Action2 {
    static { this.ID = 'workbench.action.togglePanel'; }
    static { this.LABEL = ( localize2(3573, "Toggle Panel Visibility")); }
    constructor() {
        super({
            ...
            toggled: {
                ...
                title: ( localize(3574, 'Hide Panel')),
                icon: closeIcon,
                mnemonicTitle: ( localize(3575, "&&Panel")),
            },
            icon: closeIcon,
            f1: true,
            category: Categories.View,
            metadata: {
                description: ( localize(3576, 'Open/Show and Close/Hide Panel')),
            },
            keybinding: { primary: KeyMod$1.CtrlCmd | KeyCode.KeyJ, weight: KeybindingWeight.WorkbenchContrib },
            menu: [
                {
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3574, 'Hide Panel')),
            category: Categories.View,
...
registerAction2(class extends Action2 {
    ...
    static { this.LABEL = ( localize(3577, "Focus into Panel")); }
    constructor() {
        super({
            id: 'workbench.action.focusPanel',
            title: ( localize2(3577, "Focus into Panel")),
            category: Categories.View,
            f1: true,
        });
    }
...
const PositionPanelActionConfigs = [
    createPositionPanelActionConfig(PositionPanelActionId.TOP, ( localize2(3578, "Move Panel To Top")), ( localize(3579, "Top")), Position.TOP),
    createPositionPanelActionConfig(PositionPanelActionId.LEFT, ( localize2(3580, "Move Panel Left")), ( localize(3581, "Left")), Position.LEFT),
    createPositionPanelActionConfig(PositionPanelActionId.RIGHT, ( localize2(3582, "Move Panel Right")), ( localize(3583, "Right")), Position.RIGHT),
    createPositionPanelActionConfig(PositionPanelActionId.BOTTOM, ( localize2(3584, "Move Panel To Bottom")), ( localize(3585, "Bottom")), Position.BOTTOM),
];
const AlignPanelActionConfigs = [
    createAlignmentPanelActionConfig(AlignPanelActionId.LEFT, ( localize2(3586, "Set Panel Alignment to Left")), ( localize(3587, "Left")), 'left'),
    createAlignmentPanelActionConfig(AlignPanelActionId.RIGHT, ( localize2(3588, "Set Panel Alignment to Right")), ( localize(3589, "Right")), 'right'),
    createAlignmentPanelActionConfig(AlignPanelActionId.CENTER, ( localize2(3590, "Set Panel Alignment to Center")), ( localize(3591, "Center")), 'center'),
    createAlignmentPanelActionConfig(AlignPanelActionId.JUSTIFY, ( localize2(3592, "Set Panel Alignment to Justify")), ( localize(3593, "Justify")), 'justify'),
];
MenuRegistry.appendMenuItem(MenuId.MenubarAppearanceMenu, {
    submenu: MenuId.PanelPositionMenu,
    title: ( localize(3594, "Panel Position")),
...
MenuRegistry.appendMenuItem(MenuId.MenubarAppearanceMenu, {
    ...
    title: ( localize(3595, "Align Panel")),
    group: '3_workbench_layout_move',
    order: 5
});
...
registerAction2(class extends SwitchCompositeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(3596, "Previous Panel View")),
            category: Categories.View,
            f1: true
...
registerAction2(class extends SwitchCompositeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(3597, "Next Panel View")),
            category: Categories.View,
            f1: true
        }, ViewContainerLocation.Panel, 1);
    }
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3598, 'Toggle Maximized Panel')),
            tooltip: ( localize(3599, "Maximize Panel Size")),
            category: Categories.View,
            f1: true,
            icon: maximizeIcon,
            ...
            toggled: { condition: PanelMaximizedContext, icon: maximizeIcon, tooltip: ( localize(3600, "Restore Panel Size")) },
            menu: [{
    ...
    run(accessor) {
        ...
        if (layoutService.getPanelAlignment() !== 'center' && isHorizontal(layoutService.getPanelPosition())) {
            notificationService.warn(( localize(3601, "Maximizing the panel is only supported when it is center aligned.")));
            return;
        }
        if (!layoutService.isVisible(Parts.PANEL_PART)) {
            layoutService.setPartHidden(false, Parts.PANEL_PART);
...
MenuRegistry.appendMenuItems([
    {
        ...
        item: {
            ...
            command: {
                id: TogglePanelAction.ID,
                title: ( localize(3602, "Toggle Panel")),
                icon: panelOffIcon,
...
class MovePanelToSidePanelAction extends MoveViewsBetweenPanelsAction {
    ...
    constructor() {
        super(ViewContainerLocation.Panel, ViewContainerLocation.AuxiliaryBar, {
            ...
            title: ( localize2(3603, "Move Panel Views To Secondary Side Bar")),
            category: Categories.View,
            f1: false
        });
    }
...
class MoveSidePanelToPanelAction extends MoveViewsBetweenPanelsAction {
    ...
    constructor() {
        super(ViewContainerLocation.AuxiliaryBar, ViewContainerLocation.Panel, {
            ...
            title: ( localize2(3604, "Move Secondary Side Bar Views To Panel")),
            category: Categories.View,
            f1: false
        });
    }
