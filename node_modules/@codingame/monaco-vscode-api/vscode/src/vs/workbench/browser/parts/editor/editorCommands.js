...
function registerActiveEditorMoveCopyCommand() {
    ...
    KeybindingsRegistry.registerCommandAndKeybindingRule({
        ...
        metadata: {
            description: ( localize(3353, "Move the active editor by tabs or groups")),
            args: [
                {
                    name: ( localize(3354, "Active editor move argument")),
    ...
    KeybindingsRegistry.registerCommandAndKeybindingRule({
        ...
        metadata: {
            description: ( localize(3356, "Copy the active editor by groups")),
            args: [
                {
                    name: ( localize(3357, "Active editor copy argument")),
                    description: ( localize(
                        3358,
                    ...
                    schema: {
                        ...
                        'properties': {
                            'orientation': {
                                ...
                                'enum': [0, 1],
                                'enumDescriptions': [
                                    ( localize(3359, "Horizontal")),
                                    ( localize(3360, "Vertical"))
                                ],
                            },
                            'groups': {
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3361, 'Split Editor in Group')),
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3362, 'Join Editor in Group')),
                category: Categories.View,
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3363, 'Toggle Split Editor in Group')),
                category: Categories.View,
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3364, 'Toggle Layout of Split Editor in Group')),
                category: Categories.View,
                precondition: SideBySideEditorActiveContext,
                f1: true
            });
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3365, 'Focus First Side in Active Editor')),
                category: Categories.View,
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3366, 'Focus Second Side in Active Editor')),
                category: Categories.View,
                precondition: ( ContextKeyExpr.or(SideBySideEditorActiveContext, TextCompareEditorActiveContext)),
                f1: true
            });
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3367, 'Focus Other Side in Active Editor')),
                category: Categories.View,
                precondition: ( ContextKeyExpr.or(SideBySideEditorActiveContext, TextCompareEditorActiveContext)),
                f1: true
            });
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3368, 'Toggle Editor Group Lock')),
                category: Categories.View,
                f1: true
            });
        }
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3369, 'Lock Editor Group')),
                category: Categories.View,
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3370, 'Unlock Editor Group')),
...
export { API_OPEN_DIFF_EDITOR_COMMAND_ID, API_OPEN_EDITOR_COMMAND_ID, API_OPEN_WITH_EDITOR_COMMAND_ID, CLOSE_EDITORS_AND_GROUP_COMMAND_ID, CLOSE_EDITORS_IN_GROUP_COMMAND_ID, CLOSE_EDITORS_TO_THE_RIGHT_COMMAND_ID, CLOSE_EDITOR_COMMAND_ID, CLOSE_EDITOR_GROUP_COMMAND_ID, CLOSE_OTHER_EDITORS_IN_GROUP_COMMAND_ID, CLOSE_PINNED_EDITOR_COMMAND_ID, CLOSE_SAVED_EDITORS_COMMAND_ID, COPY_ACTIVE_EDITOR_COMMAND_ID, COPY_EDITOR_GROUP_INTO_NEW_WINDOW_COMMAND_ID, COPY_EDITOR_INTO_NEW_WINDOW_COMMAND_ID, EDITOR_CORE_NAVIGATION_COMMANDS, FOCUS_ABOVE_GROUP_WITHOUT_WRAP_COMMAND_ID, FOCUS_BELOW_GROUP_WITHOUT_WRAP_COMMAND_ID, FOCUS_FIRST_SIDE_EDITOR, FOCUS_LEFT_GROUP_WITHOUT_WRAP_COMMAND_ID, FOCUS_OTHER_SIDE_EDITOR, FOCUS_RIGHT_GROUP_WITHOUT_WRAP_COMMAND_ID, FOCUS_SECOND_SIDE_EDITOR, JOIN_EDITOR_IN_GROUP, KEEP_EDITOR_COMMAND_ID, LAYOUT_EDITOR_GROUPS_COMMAND_ID, LOCK_GROUP_COMMAND_ID, MOVE_ACTIVE_EDITOR_COMMAND_ID, MOVE_EDITOR_GROUP_INTO_NEW_WINDOW_COMMAND_ID, MOVE_EDITOR_INTO_ABOVE_GROUP, MOVE_EDITOR_INTO_BELOW_GROUP, MOVE_EDITOR_INTO_LEFT_GROUP, MOVE_EDITOR_INTO_NEW_WINDOW_COMMAND_ID, MOVE_EDITOR_INTO_RIGHT_GROUP, NEW_EMPTY_EDITOR_WINDOW_COMMAND_ID, OPEN_EDITOR_AT_INDEX_COMMAND_ID, PIN_EDITOR_COMMAND_ID, REOPEN_ACTIVE_EDITOR_WITH_COMMAND_ID, REOPEN_WITH_COMMAND_ID, SHOW_EDITORS_IN_GROUP, SPLIT_EDITOR, SPLIT_EDITOR_DOWN, SPLIT_EDITOR_IN_GROUP, SPLIT_EDITOR_LEFT, SPLIT_EDITOR_RIGHT, SPLIT_EDITOR_UP, TOGGLE_KEEP_EDITORS_COMMAND_ID, TOGGLE_LOCK_GROUP_COMMAND_ID, TOGGLE_MAXIMIZE_EDITOR_GROUP, TOGGLE_SPLIT_EDITOR_IN_GROUP, TOGGLE_SPLIT_EDITOR_IN_GROUP_LAYOUT, UNLOCK_GROUP_COMMAND_ID, UNPIN_EDITOR_COMMAND_ID, setup, splitEditor };
