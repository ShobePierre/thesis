...
import { ToggleCompositeBadgeAction, ToggleCompositePinnedAction, CompositeBarAction } from './compositeBarActions.js';
...
let PaneCompositeBar = class PaneCompositeBar extends Disposable {
    ...
    getContextMenuActionsForComposite(compositeId) {
        ...
        actions.push(( new SubmenuAction('moveToMenu', ( localize(3561, "Move To")), moveActions)));
        if (defaultLocation !== currentLocation) {
            actions.push(toAction({
                id: 'resetLocationAction', label: ( localize(3562, "Reset Location")), run: () => {
    ...
    createMoveAction(viewContainer, newLocation, defaultLocation) {
        return toAction({
            ...
            label: newLocation === ViewContainerLocation.Panel ? ( localize(3563, "Panel")) : newLocation === ViewContainerLocation.Sidebar ? ( localize(3564, "Primary Side Bar")) : ( localize(3565, "Secondary Side Bar")),
            run: () => {
                let index;
