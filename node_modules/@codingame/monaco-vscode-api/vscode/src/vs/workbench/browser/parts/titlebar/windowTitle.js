...
let WindowTitle = class WindowTitle extends Disposable {
    ...
    static { this.NLS_USER_IS_ADMIN = isWindows ? ( localize(3658, "[Administrator]")) : ( localize(3659, "[Superuser]")); }
    static { this.NLS_EXTENSION_HOST = ( localize(3660, "[Extension Development Host]")); }
