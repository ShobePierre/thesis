...
registerAction2(class MoveViewUp extends MoveViewPosition {
    constructor() {
        super({
            id: 'views.moveViewUp',
            title: ( localize(3676, "Move View Up")),
            keybinding: {
...
registerAction2(class MoveViewLeft extends MoveViewPosition {
    constructor() {
        super({
            ...
            title: ( localize(3677, "Move View Left")),
            keybinding: {
...
registerAction2(class MoveViewDown extends MoveViewPosition {
    constructor() {
        super({
            ...
            title: ( localize(3678, "Move View Down")),
            keybinding: {
...
registerAction2(class MoveViewRight extends MoveViewPosition {
    constructor() {
        super({
            ...
            title: ( localize(3679, "Move View Right")),
            keybinding: {
...
registerAction2(class MoveViews extends Action2 {
    constructor() {
        super({
            id: 'vscode.moveViews',
            title: ( localize(3680, "Move Views")),
        });
    }
