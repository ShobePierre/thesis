...
let WorkspaceTrustRequiredPlaceholderEditor = class WorkspaceTrustRequiredPlaceholderEditor extends EditorPlaceholder {
    ...
    static { this.LABEL = ( localize(3402, "Workspace Trust Required")); }
    ...
    async getContents() {
        return {
            ...
            actions: [
                {
                    label: ( localize(3405, "Manage Workspace Trust")),
...
let ErrorPlaceholderEditor = class ErrorPlaceholderEditor extends EditorPlaceholder {
    ...
    static { this.LABEL = ( localize(3406, "Error Editor")); }
    static { this.DESCRIPTOR = EditorPaneDescriptor.create(this, this.ID, this.LABEL); }
    ...
    async getContents(input, options, disposables) {
        ...
        let label;
        if (isFileNotFound) {
            label = ( localize(3407, "The editor could not be opened because the file was not found."));
        }
            ...
            label = ( localize(3409, "The editor could not be opened due to an unexpected error."));
        }
        let icon = '$(error)';
