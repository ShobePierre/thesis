...
let NotificationsToasts = class NotificationsToasts extends Themable {
    ...
    doAddToast(item, itemDisposables) {
        ...
        const notificationList = this.instantiationService.createInstance(NotificationsList, notificationToast, {
            ...
            widgetAriaLabel: (() => {
                if (!item.source) {
                    return withSeverityPrefix(( localize(3554, "{0}, notification", item.message.raw)), item.severity);
                }
                return withSeverityPrefix(( localize(3555, "{0}, source: {1}, notification", item.message.raw, item.source)), item.severity);
            })()
        });
