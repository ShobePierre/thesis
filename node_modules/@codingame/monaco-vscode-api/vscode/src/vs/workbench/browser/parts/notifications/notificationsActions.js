...
const clearIcon = registerIcon('notifications-clear', Codicon.close, ( localize(3499, 'Icon for the clear action in notifications.')));
const clearAllIcon = registerIcon('notifications-clear-all', Codicon.clearAll, ( localize(3500, 'Icon for the clear all action in notifications.')));
const hideIcon = registerIcon('notifications-hide', Codicon.chevronDown, ( localize(3501, 'Icon for the hide action in notifications.')));
const expandIcon = registerIcon('notifications-expand', Codicon.chevronUp, ( localize(3502, 'Icon for the expand action in notifications.')));
const collapseIcon = registerIcon('notifications-collapse', Codicon.chevronDown, ( localize(3503, 'Icon for the collapse action in notifications.')));
const configureIcon = registerIcon('notifications-configure', Codicon.gear, ( localize(3504, 'Icon for the configure action in notifications.')));
const doNotDisturbIcon = registerIcon('notifications-do-not-disturb', Codicon.bellSlash, ( localize(3505, 'Icon for the mute all action in notifications.')));
let ClearNotificationAction = class ClearNotificationAction extends Action {
    static { this.ID = CLEAR_NOTIFICATION; }
    static { this.LABEL = ( localize(3506, "Clear Notification")); }
...
let ClearAllNotificationsAction = class ClearAllNotificationsAction extends Action {
    ...
    static { this.LABEL = ( localize(3507, "Clear All Notifications")); }
    constructor(id, label, commandService) {
...
let ToggleDoNotDisturbAction = class ToggleDoNotDisturbAction extends Action {
    ...
    static { this.LABEL = ( localize(3508, "Toggle Do Not Disturb Mode")); }
    constructor(id, label, commandService) {
...
let ToggleDoNotDisturbBySourceAction = class ToggleDoNotDisturbBySourceAction extends Action {
    ...
    static { this.LABEL = ( localize(3509, "Toggle Do Not Disturb Mode By Source...")); }
    constructor(id, label, commandService) {
        super(id, label);
        this.commandService = commandService;
    }
...
class ConfigureDoNotDisturbAction extends Action {
    ...
    static { this.LABEL = ( localize(3510, "Configure Do Not Disturb...")); }
...
let HideNotificationsCenterAction = class HideNotificationsCenterAction extends Action {
    ...
    static { this.LABEL = ( localize(3511, "Hide Notifications")); }
    constructor(id, label, commandService) {
...
let ExpandNotificationAction = class ExpandNotificationAction extends Action {
    ...
    static { this.LABEL = ( localize(3512, "Expand Notification")); }
    constructor(id, label, commandService) {
...
let CollapseNotificationAction = class CollapseNotificationAction extends Action {
    ...
    static { this.LABEL = ( localize(3513, "Collapse Notification")); }
    constructor(id, label, commandService) {
...
class ConfigureNotificationAction extends Action {
    ...
    static { this.LABEL = ( localize(3514, "More Actions...")); }
...
let CopyNotificationMessageAction = class CopyNotificationMessageAction extends Action {
    ...
    static { this.LABEL = ( localize(3515, "Copy Text")); }
