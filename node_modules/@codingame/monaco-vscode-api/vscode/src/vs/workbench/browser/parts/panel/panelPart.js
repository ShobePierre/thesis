...
let PanelPart = class PanelPart extends AbstractPaneCompositePart {
    ...
    fillExtraContextMenuActions(actions) {
        ...
        const toggleShowLabelsAction = toAction({
            ...
            label: panelShowLabels ? ( localize(3605, "Show Icons")) : ( localize(3606, "Show Labels")),
            run: () => this.configurationService.updateValue('workbench.panel.showLabels', !panelShowLabels)
        });
        actions.push(...[
            ( new Separator()),
            ( new SubmenuAction('workbench.action.panel.position', ( localize(3607, "Panel Position")), positionActions)),
            ( new SubmenuAction('workbench.action.panel.align', ( localize(3608, "Align Panel")), alignActions)),
            toggleShowLabelsAction,
            toAction({ id: TogglePanelAction.ID, label: ( localize(3609, "Hide Panel")), run: () => this.commandService.executeCommand(TogglePanelAction.ID) }),
        ]);
    }
