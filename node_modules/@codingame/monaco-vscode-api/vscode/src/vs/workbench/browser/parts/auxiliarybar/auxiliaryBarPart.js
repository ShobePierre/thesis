...
let AuxiliaryBarPart = class AuxiliaryBarPart extends AbstractPaneCompositePart {
    ...
    fillExtraContextMenuActions(actions) {
        ...
        const toggleShowLabelsAction = toAction({
            ...
            label: this.configuration.showLabels ? ( localize(3004, "Show Icons")) : ( localize(3005, "Show Labels")),
        ...
        actions.push(...[
            ( new Separator()),
            ( new SubmenuAction('workbench.action.panel.position', ( localize(3006, "Activity Bar Position")), positionActions)),
            toAction({ id: ToggleSidebarPositionAction.ID, label: currentPositionRight ? ( localize(3007, "Move Secondary Side Bar Left")) : ( localize(3008, "Move Secondary Side Bar Right")), run: () => this.commandService.executeCommand(ToggleSidebarPositionAction.ID) }),
            toggleShowLabelsAction,
            toAction({ id: ToggleAuxiliaryBarAction.ID, label: ( localize(3009, "Hide Secondary Side Bar")), run: () => this.commandService.executeCommand(ToggleAuxiliaryBarAction.ID) })
        ]);
    }
