...
import { CloseDirection, EditorsOrder, EditorInputCapabilities, SaveReason, EditorResourceAccessor, DEFAULT_EDITOR_ASSOCIATION } from '../../../common/editor.js';
...
class SplitEditorAction extends AbstractSplitEditorAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3227, 'Split Editor')),
            f1: true,
            keybinding: {
...
class SplitEditorOrthogonalAction extends AbstractSplitEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(3228, 'Split Editor Orthogonal')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class SplitEditorLeftAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3229, 'Split Editor Left')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.Backslash)
...
class SplitEditorRightAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3230, 'Split Editor Right')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.Backslash)
...
class SplitEditorUpAction extends ExecuteCommandAction {
    static { this.LABEL = ( localize(3231, "Split Editor Up")); }
    constructor() {
        super({
            id: SPLIT_EDITOR_UP,
            title: ( localize2(3231, "Split Editor Up")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.Backslash)
...
class SplitEditorDownAction extends ExecuteCommandAction {
    static { this.LABEL = ( localize(3232, "Split Editor Down")); }
    constructor() {
        super({
            id: SPLIT_EDITOR_DOWN,
            title: ( localize2(3232, "Split Editor Down")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyChord(KeyMod$1.CtrlCmd | KeyCode.KeyK, KeyMod$1.CtrlCmd | KeyCode.Backslash)
...
class JoinTwoGroupsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3233, 'Join Editor Group with Next Group')),
            f1: true,
            category: Categories.View
        });
    }
...
class JoinAllGroupsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3234, 'Join All Editor Groups')),
            f1: true,
            category: Categories.View
        });
    }
...
class NavigateBetweenGroupsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3235, 'Navigate Between Editor Groups')),
            f1: true,
            category: Categories.View
        });
    }
...
class FocusActiveGroupAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3236, 'Focus Active Editor Group')),
            f1: true,
            category: Categories.View
        });
    }
...
class FocusFirstGroupAction extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3237, 'Focus First Editor Group')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class FocusLastGroupAction extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3238, 'Focus Last Editor Group')),
            f1: true,
            category: Categories.View
...
class FocusNextGroup extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3239, 'Focus Next Editor Group')),
            f1: true,
            category: Categories.View
...
class FocusPreviousGroup extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3240, 'Focus Previous Editor Group')),
            f1: true,
            category: Categories.View
...
class FocusLeftGroup extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3241, 'Focus Left Editor Group')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class FocusRightGroup extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3242, 'Focus Right Editor Group')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class FocusAboveGroup extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3243, 'Focus Editor Group Above')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class FocusBelowGroup extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3244, 'Focus Editor Group Below')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
let CloseEditorAction = class CloseEditorAction extends Action {
    ...
    static { this.LABEL = ( localize(3245, "Close Editor")); }
...
let UnpinEditorAction = class UnpinEditorAction extends Action {
    ...
    static { this.LABEL = ( localize(3246, "Unpin Editor")); }
    constructor(id, label, commandService) {
...
let CloseEditorTabAction = class CloseEditorTabAction extends Action {
    static { this.ID = 'workbench.action.closeActiveEditor'; }
    static { this.LABEL = ( localize(3247, "Close")); }
...
class RevertAndCloseEditorAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3248, 'Revert and Close Editor')),
            f1: true,
            category: Categories.View
        });
    }
...
class CloseLeftEditorsInGroupAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3249, 'Close Editors to the Left in Group')),
            f1: true,
            category: Categories.View
        });
    }
...
class AbstractCloseAllAction extends Action2 {
    ...
    revertEditors(editorService, logService, progressService, editors) {
        return progressService.withProgress({
            ...
            delay: 800,
            title: ( localize(3250, "Reverting Editors...")),
...
class CloseAllEditorsAction extends AbstractCloseAllAction {
    ...
    static { this.LABEL = ( localize2(3251, 'Close All Editors')); }
    constructor() {
        super({
...
class CloseAllEditorGroupsAction extends AbstractCloseAllAction {
    constructor() {
        super({
            ...
            title: ( localize2(3252, 'Close All Editor Groups')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class CloseEditorsInOtherGroupsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3253, 'Close Editors in Other Groups')),
            f1: true,
            category: Categories.View
        });
    }
...
class CloseEditorInAllGroupsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3254, 'Close Editor in All Groups')),
            f1: true,
            category: Categories.View
        });
    }
...
class MoveGroupLeftAction extends AbstractMoveGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3255, 'Move Editor Group Left')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class MoveGroupRightAction extends AbstractMoveGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3256, 'Move Editor Group Right')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class MoveGroupUpAction extends AbstractMoveGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3257, 'Move Editor Group Up')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class MoveGroupDownAction extends AbstractMoveGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3258, 'Move Editor Group Down')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class DuplicateGroupLeftAction extends AbstractDuplicateGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3259, 'Duplicate Editor Group Left')),
            f1: true,
            category: Categories.View
        }, GroupDirection.LEFT);
    }
...
class DuplicateGroupRightAction extends AbstractDuplicateGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3260, 'Duplicate Editor Group Right')),
            f1: true,
            category: Categories.View
        }, GroupDirection.RIGHT);
    }
...
class DuplicateGroupUpAction extends AbstractDuplicateGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3261, 'Duplicate Editor Group Up')),
            f1: true,
            category: Categories.View
        }, GroupDirection.UP);
    }
...
class DuplicateGroupDownAction extends AbstractDuplicateGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3262, 'Duplicate Editor Group Down')),
            f1: true,
            category: Categories.View
        }, GroupDirection.DOWN);
    }
...
class MinimizeOtherGroupsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3263, 'Expand Editor Group')),
            f1: true,
            category: Categories.View,
...
class MinimizeOtherGroupsHideSidebarAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3264, 'Expand Editor Group and Hide Side Bars')),
            f1: true,
            category: Categories.View,
...
class ResetGroupSizesAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3265, 'Reset Editor Group Sizes')),
            f1: true,
            category: Categories.View
        });
    }
...
class ToggleGroupSizesAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3266, 'Toggle Editor Group Sizes')),
            f1: true,
            category: Categories.View
        });
    }
...
class MaximizeGroupHideSidebarAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3267, 'Maximize Editor Group and Hide Side Bars')),
            f1: true,
            category: Categories.View,
...
class ToggleMaximizeEditorGroupAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3268, 'Toggle Maximize Editor Group')),
            f1: true,
            category: Categories.View,
            precondition: ( ContextKeyExpr.or(
            ...
            toggled: {
                ...
                title: ( localize(3269, "Unmaximize Group"))
            },
        });
    }
    async run(accessor, ...args) {
...
class OpenNextEditor extends AbstractNavigateEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(3270, 'Open Next Editor')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class OpenPreviousEditor extends AbstractNavigateEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(3271, 'Open Previous Editor')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class OpenNextEditorInGroup extends AbstractNavigateEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(3272, 'Open Next Editor in Group')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class OpenPreviousEditorInGroup extends AbstractNavigateEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(3273, 'Open Previous Editor in Group')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class OpenFirstEditorInGroup extends AbstractNavigateEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(3274, 'Open First Editor in Group')),
            f1: true,
            category: Categories.View
        });
    }
...
class OpenLastEditorInGroup extends AbstractNavigateEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(3275, 'Open Last Editor in Group')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class NavigateForwardAction extends Action2 {
    ...
    static { this.LABEL = ( localize(3276, "Go Forward")); }
    constructor() {
        super({
            id: NavigateForwardAction.ID,
            title: {
                ...( localize2(3276, "Go Forward")),
                mnemonicTitle: ( localize(3277, "&&Forward"))
            },
            f1: true,
            ...
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                win: { primary: KeyMod$1.Alt | KeyCode.RightArrow, secondary: [KeyCode.BrowserForward] },
                mac: { primary: KeyMod$1.WinCtrl | KeyMod$1.Shift | KeyCode.Minus, secondary: [KeyCode.BrowserForward] },
                linux: { primary: KeyMod$1.CtrlCmd | KeyMod$1.Shift | KeyCode.Minus, secondary: [KeyCode.BrowserForward] }
            },
            menu: [
...
class NavigateBackwardsAction extends Action2 {
    ...
    static { this.LABEL = ( localize(3278, "Go Back")); }
    constructor() {
        super({
            id: NavigateBackwardsAction.ID,
            title: {
                ...( localize2(3278, "Go Back")),
                mnemonicTitle: ( localize(3279, "&&Back"))
            },
            f1: true,
            ...
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                win: { primary: KeyMod$1.Alt | KeyCode.LeftArrow, secondary: [KeyCode.BrowserBack] },
                mac: { primary: KeyMod$1.WinCtrl | KeyCode.Minus, secondary: [KeyCode.BrowserBack] },
                linux: { primary: KeyMod$1.CtrlCmd | KeyMod$1.Alt | KeyCode.Minus, secondary: [KeyCode.BrowserBack] }
            },
            menu: [
...
class NavigatePreviousAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3280, 'Go Previous')),
            f1: true
        });
    }
    async run(accessor) {
...
class NavigateForwardInEditsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3281, 'Go Forward in Edit Locations')),
            f1: true
        });
    }
    async run(accessor) {
...
class NavigateBackwardsInEditsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3282, 'Go Back in Edit Locations')),
            f1: true
        });
    }
    async run(accessor) {
...
class NavigatePreviousInEditsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3283, 'Go Previous in Edit Locations')),
            f1: true
        });
    }
    async run(accessor) {
...
class NavigateToLastEditLocationAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3284, 'Go to Last Edit Location')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class NavigateForwardInNavigationsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3285, 'Go Forward in Navigation Locations')),
            f1: true
        });
    }
    async run(accessor) {
...
class NavigateBackwardsInNavigationsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3286, 'Go Back in Navigation Locations')),
            f1: true
        });
    }
    async run(accessor) {
...
class NavigatePreviousInNavigationsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3287, 'Go Previous in Navigation Locations')),
            f1: true
        });
    }
    async run(accessor) {
...
class NavigateToLastNavigationLocationAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3288, 'Go to Last Navigation Location')),
            f1: true
        });
    }
    async run(accessor) {
...
class ReopenClosedEditorAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3289, 'Reopen Closed Editor')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class ClearRecentFilesAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3290, 'Clear Recently Opened...')),
            f1: true,
    ...
    async run(accessor) {
        ...
        const { confirmed } = await dialogService.confirm({
            type: 'warning',
            message: ( localize(3291, "Do you want to clear all recently opened files and workspaces?")),
            detail: ( localize(3292, "This action is irreversible!")),
            primaryButton: ( localize(3293, "&&Clear"))
        });
        if (!confirmed) {
            return;
        }
...
class ShowEditorsInActiveGroupByMostRecentlyUsedAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3294, 'Show Editors in Active Group By Most Recently Used')),
            f1: true,
            category: Categories.View
        });
    }
...
class ShowAllEditorsByAppearanceAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3295, 'Show All Editors By Appearance')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class ShowAllEditorsByMostRecentlyUsedAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3296, 'Show All Editors By Most Recently Used')),
            f1: true,
            category: Categories.View
        });
    }
...
class QuickAccessPreviousRecentlyUsedEditorAction extends AbstractQuickAccessEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(3297, 'Quick Open Previous Recently Used Editor')),
            f1: true,
            category: Categories.View
...
class QuickAccessLeastRecentlyUsedEditorAction extends AbstractQuickAccessEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(3298, 'Quick Open Least Recently Used Editor')),
            f1: true,
            category: Categories.View
        }, AllEditorsByMostRecentlyUsedQuickAccess.PREFIX, undefined);
    }
...
class QuickAccessPreviousRecentlyUsedEditorInGroupAction extends AbstractQuickAccessEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(3299, 'Quick Open Previous Recently Used Editor in Group')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class QuickAccessLeastRecentlyUsedEditorInGroupAction extends AbstractQuickAccessEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(3300, 'Quick Open Least Recently Used Editor in Group')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class QuickAccessPreviousEditorFromHistoryAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3301, 'Quick Open Previous Editor from History')),
            f1: true
        });
    }
    async run(accessor) {
...
class OpenNextRecentlyUsedEditorAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3302, 'Open Next Recently Used Editor')),
            f1: true,
            category: Categories.View
        });
    }
...
class OpenPreviousRecentlyUsedEditorAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3303, 'Open Previous Recently Used Editor')),
            f1: true,
            category: Categories.View
        });
    }
...
class OpenNextRecentlyUsedEditorInGroupAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3304, 'Open Next Recently Used Editor In Group')),
            f1: true,
            category: Categories.View
        });
    }
...
class OpenPreviousRecentlyUsedEditorInGroupAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3305, 'Open Previous Recently Used Editor In Group')),
            f1: true,
            category: Categories.View
        });
    }
...
class ClearEditorHistoryWithoutConfirmAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3306, 'Clear Editor History without Confirmation')),
            f1: true,
...
class ClearEditorHistoryAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3307, 'Clear Editor History')),
            f1: true
        });
    }
    async run(accessor) {
        ...
        const { confirmed } = await dialogService.confirm({
            type: 'warning',
            message: ( localize(3308, "Do you want to clear the history of recently opened editors?")),
            detail: ( localize(3292, "This action is irreversible!")),
            primaryButton: ( localize(3293, "&&Clear"))
        });
        if (!confirmed) {
...
class MoveEditorLeftInGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3309, 'Move Editor Left')),
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class MoveEditorRightInGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3310, 'Move Editor Right')),
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class MoveEditorToPreviousGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3311, 'Move Editor into Previous Group')),
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyMod$1.CtrlCmd | KeyMod$1.Alt | KeyCode.LeftArrow,
                mac: {
...
class MoveEditorToNextGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3312, 'Move Editor into Next Group')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyMod$1.CtrlCmd | KeyMod$1.Alt | KeyCode.RightArrow,
...
class MoveEditorToAboveGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3313, 'Move Editor into Group Above')),
            f1: true,
            category: Categories.View
...
class MoveEditorToBelowGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3314, 'Move Editor into Group Below')),
            f1: true,
            category: Categories.View
...
class MoveEditorToLeftGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3315, 'Move Editor into Left Group')),
            f1: true,
            category: Categories.View
...
class MoveEditorToRightGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3316, 'Move Editor into Right Group')),
            f1: true,
            category: Categories.View
...
class MoveEditorToFirstGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3317, 'Move Editor into First Group')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class MoveEditorToLastGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3318, 'Move Editor into Last Group')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class SplitEditorToPreviousGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3319, 'Split Editor into Previous Group')),
            f1: true,
            category: Categories.View
...
class SplitEditorToNextGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3320, 'Split Editor into Next Group')),
            f1: true,
            category: Categories.View
...
class SplitEditorToAboveGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3321, 'Split Editor into Group Above')),
            f1: true,
            category: Categories.View
...
class SplitEditorToBelowGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3322, 'Split Editor into Group Below')),
            f1: true,
            category: Categories.View
...
class SplitEditorToLeftGroupAction extends ExecuteCommandAction {
    ...
    static { this.LABEL = ( localize(3323, "Split Editor into Left Group")); }
    constructor() {
        super({
            id: 'workbench.action.splitEditorToLeftGroup',
            title: ( localize2(3323, "Split Editor into Left Group")),
            f1: true,
            category: Categories.View
...
class SplitEditorToRightGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3324, 'Split Editor into Right Group')),
            f1: true,
            category: Categories.View
...
class SplitEditorToFirstGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3325, 'Split Editor into First Group')),
            f1: true,
            category: Categories.View
...
class SplitEditorToLastGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3326, 'Split Editor into Last Group')),
            f1: true,
            category: Categories.View
...
class EditorLayoutSingleAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3327, 'Single Column Editor Layout')),
            f1: true,
            category: Categories.View
...
class EditorLayoutTwoColumnsAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3328, 'Two Columns Editor Layout')),
            f1: true,
            category: Categories.View
        }, LAYOUT_EDITOR_GROUPS_COMMAND_ID, { groups: [{}, {}], orientation: GroupOrientation.HORIZONTAL });
    }
...
class EditorLayoutThreeColumnsAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3329, 'Three Columns Editor Layout')),
            f1: true,
            category: Categories.View
        }, LAYOUT_EDITOR_GROUPS_COMMAND_ID, { groups: [{}, {}, {}], orientation: GroupOrientation.HORIZONTAL });
    }
...
class EditorLayoutTwoRowsAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3330, 'Two Rows Editor Layout')),
            f1: true,
            category: Categories.View
...
class EditorLayoutThreeRowsAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3331, 'Three Rows Editor Layout')),
            f1: true,
            category: Categories.View
        }, LAYOUT_EDITOR_GROUPS_COMMAND_ID, { groups: [{}, {}, {}], orientation: GroupOrientation.VERTICAL });
    }
...
class EditorLayoutTwoByTwoGridAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3332, 'Grid Editor Layout (2x2)')),
            f1: true,
            category: Categories.View
...
class EditorLayoutTwoColumnsBottomAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3333, 'Two Columns Bottom Editor Layout')),
            f1: true,
            category: Categories.View
...
class EditorLayoutTwoRowsRightAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3334, 'Two Rows Right Editor Layout')),
            f1: true,
            category: Categories.View
...
class NewEditorGroupLeftAction extends AbstractCreateEditorGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3335, 'New Editor Group to the Left')),
            f1: true,
            category: Categories.View
        }, GroupDirection.LEFT);
    }
...
class NewEditorGroupRightAction extends AbstractCreateEditorGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3336, 'New Editor Group to the Right')),
            f1: true,
            category: Categories.View
        }, GroupDirection.RIGHT);
    }
...
class NewEditorGroupAboveAction extends AbstractCreateEditorGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3337, 'New Editor Group Above')),
            f1: true,
            category: Categories.View
        }, GroupDirection.UP);
    }
...
class NewEditorGroupBelowAction extends AbstractCreateEditorGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3338, 'New Editor Group Below')),
            f1: true,
            category: Categories.View
        }, GroupDirection.DOWN);
    }
...
class ToggleEditorTypeAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3339, 'Toggle Editor Type')),
            f1: true,
            category: Categories.View,
...
class ReOpenInTextEditorAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3340, 'Reopen Editor with Text Editor')),
            f1: true,
            category: Categories.View,
            precondition: ActiveEditorAvailableEditorIdsContext
        });
...
class MoveEditorToNewWindowAction extends BaseMoveCopyEditorToNewWindowAction {
    constructor() {
        super(MOVE_EDITOR_INTO_NEW_WINDOW_COMMAND_ID, {
            ...( localize2(3341, "Move Editor into New Window")),
            mnemonicTitle: ( localize(3342, "&&Move Editor into New Window")),
        }, undefined, true);
    }
}
class CopyEditorToNewindowAction extends BaseMoveCopyEditorToNewWindowAction {
    constructor() {
        super(COPY_EDITOR_INTO_NEW_WINDOW_COMMAND_ID, {
            ...( localize2(3343, "Copy Editor into New Window")),
            mnemonicTitle: ( localize(3344, "&&Copy Editor into New Window")),
...
class MoveEditorGroupToNewWindowAction extends BaseMoveCopyEditorGroupToNewWindowAction {
    constructor() {
        super(MOVE_EDITOR_GROUP_INTO_NEW_WINDOW_COMMAND_ID, {
            ...( localize2(3345, "Move Editor Group into New Window")),
            mnemonicTitle: ( localize(3346, "&&Move Editor Group into New Window")),
        }, true);
    }
}
class CopyEditorGroupToNewWindowAction extends BaseMoveCopyEditorGroupToNewWindowAction {
    constructor() {
        super(COPY_EDITOR_GROUP_INTO_NEW_WINDOW_COMMAND_ID, {
            ...( localize2(3347, "Copy Editor Group into New Window")),
            mnemonicTitle: ( localize(3348, "&&Copy Editor Group into New Window")),
        }, false);
    }
}
class RestoreEditorsToMainWindowAction extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(3349, "Restore Editors into Main Window")),
                mnemonicTitle: ( localize(3350, "&&Restore Editors into Main Window")),
            },
            f1: true,
...
class NewEmptyEditorWindowAction extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(3351, "New Empty Editor Window")),
                mnemonicTitle: ( localize(3352, "&&New Empty Editor Window")),
            },
            f1: true,
            category: Categories.View
        });
