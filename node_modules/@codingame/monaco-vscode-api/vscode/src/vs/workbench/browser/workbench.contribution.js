...
(function registerConfiguration() {
    ...
    registry.registerConfiguration({
        ...
        'properties': {
            ...
            'workbench.editor.titleScrollbarSizing': {
                ...
                enum: ['default', 'large'],
                enumDescriptions: [
                    ( localize(3701, "The default size.")),
                    ( localize(
                    3702,
            ...
            'workbench.editor.titleScrollbarVisibility': {
                ...
                enumDescriptions: [
                    ( localize(3704, "The horizontal scrollbar will be visible only when necessary.")),
                    ( localize(3705, "The horizontal scrollbar will always be visible.")),
                    ( localize(3706, "The horizontal scrollbar will always be hidden."))
                ],
                description: ( localize(
                    3707,
            ...
            [LayoutSettings.EDITOR_TABS_MODE]: {
                ...
                'enumDescriptions': [
                    ( localize(3708, "Each editor is displayed as a tab in the editor title area.")),
                    ( localize(
                    3709,
                    "The active editor is displayed as a single large tab in the editor title area."
                )),
                    ( localize(3710, "The editor title area is not displayed.")),
                ],
                'description': ( localize(
                    3711,
            ...
            [LayoutSettings.EDITOR_ACTIONS_LOCATION]: {
                ...
                'markdownEnumDescriptions': [
                    ...
                    ( localize(3714, "Editor actions are not shown.")),
                ],
                'markdownDescription': ( localize(3715, "Controls where the editor actions are shown.")),
                'default': 'default'
            },
            ...
            'workbench.editor.decorations.badges': {
                'type': 'boolean',
                'markdownDescription': ( localize(3720, "Controls whether editor file decorations should use badges.")),
                'default': true
            },
            'workbench.editor.decorations.colors': {
                'type': 'boolean',
                'markdownDescription': ( localize(3721, "Controls whether editor file decorations should use colors.")),
                'default': true
            },
            ...
            'workbench.editor.labelFormat': {
                ...
                'enumDescriptions': [
                    ...
                    ( localize(3732, "Show the name of the file followed by its directory name.")),
                    ( localize(
                    3733,
                    "Show the name of the file followed by its path relative to the workspace folder."
                )),
                    ( localize(3734, "Show the name of the file followed by its absolute path."))
                ],
                'default': 'default',
                'description': ( localize(3735, "Controls the format of the label for an editor.")),
            },
            'workbench.editor.untitled.labelFormat': {
                ...
                'default': 'content',
                'description': ( localize(3738, "Controls the format of the label for an untitled editor.")),
            },
            ...
            'workbench.editor.languageDetectionHints': {
                ...
                properties: {
                    untitledEditors: {
                        type: 'boolean',
                        description: ( localize(3744, "Show in untitled text editors")),
                    },
                    notebookEditors: {
                        type: 'boolean',
                        description: ( localize(3745, "Show in notebook editors")),
                    }
                }
            },
            ...
            'workbench.editor.tabActionCloseVisibility': {
                type: 'boolean',
                default: true,
                description: ( localize(3747, "Controls the visibility of the tab close action button."))
            },
            'workbench.editor.tabActionUnpinVisibility': {
                type: 'boolean',
                default: true,
                description: ( localize(3748, "Controls the visibility of the tab unpin action button."))
            },
            ...
            'workbench.editor.tabSizing': {
                ...
                'default': 'fit',
                'enumDescriptions': [
                    ( localize(3750, "Always keep tabs large enough to show the full editor label.")),
                    ( localize(
                    3751,
            ...
            'workbench.editor.pinnedTabSizing': {
                ...
                'default': 'normal',
                'enumDescriptions': [
                    ( localize(3757, "A pinned tab inherits the look of non pinned tabs.")),
                    ( localize(
                    3758,
            ...
            'workbench.editor.preventPinnedEditorClose': {
                ...
                'enumDescriptions': [
                    ...
                    ( localize(3763, "Prevent closing the pinned editor when using the keyboard.")),
                    ( localize(3764, "Prevent closing the pinned editor when using mouse middle click.")),
                    ( localize(3765, "Never prevent closing a pinned editor."))
                ],
                description: ( localize(
                    3766,
            ...
            'workbench.editor.splitSizing': {
                ...
                'enumDescriptions': [
                    ...
                    ( localize(3768, "Splits all the editor groups to equal parts.")),
                    ( localize(3769, "Splits the active editor group to equal parts."))
                ],
                'description': ( localize(3770, "Controls the size of editor groups when splitting them."))
            },
            ...
            'workbench.editor.navigationScope': {
                ...
                'enumDescriptions': [
                    ( localize(3786, "Navigate across all opened editors and editor groups.")),
                    ( localize(3787, "Navigate only in editors of the active editor group.")),
                    ( localize(3788, "Navigate only in the active editor."))
                ],
            },
            ...
            'workbench.editor.splitInGroupLayout': {
                ...
                'enumDescriptions': [
                    ( localize(3792, "Editors are positioned from top to bottom.")),
                    ( localize(3793, "Editors are positioned from left to right."))
                ]
            },
            ...
            'workbench.editor.doubleClickTabToToggleEditorGroupSizes': {
                ...
                'enumDescriptions': [
                    ...
                    ( localize(3799, "No editor group is resized when double clicking on a tab."))
                ]
            },
            ...
            'workbench.commandPalette.experimental.askChatLocation': {
                'type': 'string',
                tags: ['experimental'],
                'description': ( localize(3812, "Controls where the command palette should ask chat questions.")),
                'default': 'chatView',
                enum: ['chatView', 'quickChat'],
                enumDescriptions: [
                    ( localize(3813, "Ask chat questions in the Chat view.")),
                    ( localize(3814, "Ask chat questions in Quick Chat."))
                ]
            },
            ...
            'workbench.panel.opensMaximized': {
                ...
                'enumDescriptions': [
                    ( localize(3826, "Always maximize the panel when opening it.")),
                    ( localize(3827, "Never maximize the panel when opening it.")),
                    ( localize(3828, "Open the panel to the state that it was in, before it was closed."))
                ]
            },
            'workbench.secondarySideBar.defaultVisibility': {
                ...
                'enumDescriptions': [
                    ( localize(3830, "The secondary side bar is hidden by default.")),
                    ( localize(
                    3831,
                    "The secondary side bar is visible by default if a workspace is opened."
                )),
                    ( localize(3832, "The secondary side bar is visible by default.")),
                    ( localize(
                    3833,
                    "The secondary side bar is visible and maximized by default if a workspace is opened."
                )),
                    ( localize(3834, "The secondary side bar is visible and maximized by default."))
                ]
            },
            ...
            [LayoutSettings.ACTIVITY_BAR_LOCATION]: {
                ...
                'enumDescriptions': [
                    ...
                    ( localize(3841, "Hide the Activity Bar in the Primary and Secondary Side Bars."))
                ],
            },
            'workbench.activityBar.iconClickBehavior': {
                ...
                'enumDescriptions': [
                    ( localize(3843, "Hide the Primary Side Bar if the clicked item is already visible.")),
                    ( localize(3844, "Focus the Primary Side Bar if the clicked item is already visible."))
                ]
            },
            ...
            'workbench.view.showQuietly': {
                ...
                'properties': {
                    'workbench.panel.output': {
                        'type': 'boolean',
                        'description': ( localize(3847, "Output view"))
                    }
                },
                'additionalProperties': false
            },
            'workbench.fontAliasing': {
                ...
                'default': 'default',
                'description': ( localize(3848, "Controls font aliasing method in the workbench.")),
                'enumDescriptions': [
                    ( localize(
                    3849,
                    ...
                    ( localize(3851, "Disables font smoothing. Text will show with jagged sharp edges.")),
                    ( localize(
                    3852,
            ...
            'workbench.settings.editor': {
                ...
                'enum': ['ui', 'json'],
                'enumDescriptions': [
                    ( localize(3853, "Use the settings UI editor.")),
                    ( localize(3854, "Use the JSON file editor.")),
                ],
                'description': ( localize(3855, "Determines which Settings editor to use by default.")),
                'default': 'ui',
                'scope': ConfigurationScope.WINDOW
            },
            ...
            'workbench.reduceMotion': {
                ...
                'enumDescriptions': [
                    ( localize(3859, "Always render with reduced motion.")),
                    ( localize(3860, "Do not render with reduced motion")),
                    ( localize(3861, "Render with reduced motion based on OS configuration.")),
                ],
                default: 'auto',
                tags: ['accessibility'],
                enum: ['on', 'off', 'auto']
            ...
            'workbench.navigationControl.enabled': {
                ...
                'markdownDescription': isWeb ?
                    ( localize(3862, "Controls whether the navigation control in the title bar is shown.")) :
                    ( localize(
                    3863,
            ...
            [LayoutSettings.LAYOUT_ACTIONS]: {
                ...
                'default': true,
                'markdownDescription': isWeb ?
                    ( localize(3864, "Controls whether the layout control in the title bar is shown.")) :
                    ( localize(
                    3865,
            ...
            'workbench.layoutControl.type': {
                ...
                'enumDescriptions': [
                    ( localize(3866, "Shows a single button with a dropdown of layout options.")),
                    ( localize(
                    3867,
                    "Shows several buttons for toggling the visibility of the panels and side bar."
                )),
                    ( localize(3868, "Shows both the dropdown and toggle buttons.")),
                ],
                'default': 'both',
                'description': ( localize(
                    3869,
            ...
            'workbench.tips.enabled': {
                'type': 'boolean',
                'default': true,
                'description': ( localize(3870, "When enabled, will show the watermark tips when no editor is open."))
            },
        }
    });
    ...
    windowTitleDescription += '\n- ' + [
        ( localize(3872, "`${activeEditorShort}`: the file name (e.g. myFile.txt).")),
        ( localize(
        3873,
        ...
        ( localize(3884, "`${appName}`: e.g. VS Code.")),
        ( localize(3885, "`${remoteName}`: e.g. SSH")),
        ( localize(
        3886,
        "`${dirty}`: an indicator for when the active editor has unsaved changes."
    )),
        ( localize(3887, "`${focusedView}`: the name of the view that is currently focused.")),
        ( localize(
        3888,
    ...
    registry.registerConfiguration({
        ...
        'properties': {
            ...
            'window.titleSeparator': {
                ...
                'markdownDescription': ( localize(3892, "Separator used by {0}.", '`#window.title#`'))
            },
            [LayoutSettings.COMMAND_CENTER]: {
                type: 'boolean',
                default: true,
                markdownDescription: isWeb ?
                    ( localize(3893, "Show command launcher together with the window title.")) :
                    ( localize(
                    3894,
            ...
            'window.menuBarVisibility': {
                ...
                'markdownEnumDescriptions': [
                    ...
                    ( localize(3899, "Menu is always hidden.")),
                    isWeb ?
                        ( localize(3900, "Menu is displayed as a compact button in the side bar.")) :
                        ( localize(
                        3901,
            ...
            'window.openFilesInNewWindow': {
                ...
                'enum': ['on', 'off', 'default'],
                'enumDescriptions': [
                    ( localize(3906, "Files will open in a new window.")),
                    ( localize(
                    3907,
            ...
            'window.openFoldersInNewWindow': {
                ...
                'enum': ['on', 'off', 'default'],
                'enumDescriptions': [
                    ( localize(3912, "Folders will open in a new window.")),
                    ( localize(3913, "Folders will replace the last active window.")),
                    ( localize(
                    3914,
            ...
            'window.confirmBeforeClose': {
                ...
                'enumDescriptions': [
                    isWeb ?
                        ...
                        ( localize(3917, "Always ask for confirmation.")),
                    isWeb ?
                        ( localize(
                        3918,
                        ...
                        ( localize(3919, "Only ask for confirmation if a keybinding was used.")),
                    isWeb ?
                        ( localize(
                        3920,
                        "Never explicitly ask for confirmation unless data loss is imminent."
                    )) :
                        ( localize(3921, "Never explicitly ask for confirmation."))
                ],
    ...
    registry.registerConfiguration({
        ...
        'properties': {
            ...
            'zenMode.centerLayout': {
                'type': 'boolean',
                'default': true,
                'description': ( localize(3927, "Controls whether turning on Zen Mode also centers the layout."))
            },
            'zenMode.showTabs': {
                'type': 'string',
                ...
                'enumDescriptions': [
                    ( localize(3929, "Each editor is displayed as a tab in the editor title area.")),
                    ( localize(
                    3930,
                    "The active editor is displayed as a single large tab in the editor title area."
                )),
                    ( localize(3931, "The editor title area is not displayed.")),
                ],
                'default': 'multiple'
            },
