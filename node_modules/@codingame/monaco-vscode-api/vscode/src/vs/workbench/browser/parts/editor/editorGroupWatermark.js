...
const openChat = { text: ( localize(3387, "Open Chat")), id: 'workbench.action.chat.open', when: { native: showChatContextKey, web: showChatContextKey } };
const showCommands = { text: ( localize(3388, "Show All Commands")), id: 'workbench.action.showCommands' };
const gotoFile = { text: ( localize(3389, "Go to File")), id: 'workbench.action.quickOpen' };
const openFile = { text: ( localize(3390, "Open File")), id: 'workbench.action.files.openFile' };
const openFolder = { text: ( localize(3391, "Open Folder")), id: 'workbench.action.files.openFolder' };
const openFileOrFolder = { text: ( localize(3392, "Open File or Folder")), id: 'workbench.action.files.openFileFolder' };
const openRecent = { text: ( localize(3393, "Open Recent")), id: 'workbench.action.openRecent' };
const newUntitledFile = { text: ( localize(3394, "New Untitled Text File")), id: 'workbench.action.files.newUntitledFile' };
const findInFiles = { text: ( localize(3395, "Find in Files")), id: 'workbench.action.findInFiles' };
const toggleTerminal = { text: ( localize(3396, "Toggle Terminal")), id: 'workbench.action.terminal.toggleTerminal', when: { web: ( ContextKeyExpr.equals('terminalProcessSupported', true)) } };
const startDebugging = { text: ( localize(3397, "Start Debugging")), id: 'workbench.action.debug.start', when: { web: ( ContextKeyExpr.equals('terminalProcessSupported', true)) } };
const openSettings = { text: ( localize(3398, "Open Settings")), id: 'workbench.action.openSettings' };
const baseEntries = [
    openChat,
    showCommands,
];
