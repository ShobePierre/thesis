...
registerAction2(class ToggleCommandCenter extends ToggleTitleBarConfigAction {
    constructor() {
        super(LayoutSettings.COMMAND_CENTER, ( localize(3641, 'Command Center')), ( localize(3642, "Toggle visibility of the Command Center in title bar")), 1, ( IsCompactTitleBarContext.toNegated()));
    }
});
registerAction2(class ToggleNavigationControl extends ToggleTitleBarConfigAction {
    constructor() {
        super('workbench.navigationControl.enabled', ( localize(3643, 'Navigation Controls')), ( localize(3644, "Toggle visibility of the Navigation Controls in title bar")), 2, ( ContextKeyExpr.and(( IsCompactTitleBarContext.toNegated()), ( ContextKeyExpr.has('config.window.commandCenter')))));
    }
});
registerAction2(class ToggleLayoutControl extends ToggleTitleBarConfigAction {
    constructor() {
        super(LayoutSettings.LAYOUT_ACTIONS, ( localize(3645, 'Layout Controls')), ( localize(3646, "Toggle visibility of the Layout Controls in title bar")), 4);
    }
});
registerAction2(class ToggleCustomTitleBar extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(3647, 'Hide Custom Title Bar')),
            menu: [
...
registerAction2(class ToggleCustomTitleBarWindowed extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(3648, 'Hide Custom Title Bar In Full Screen')),
            menu: [
...
class ToggleCustomTitleBar extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(3649, 'Custom Title Bar')),
...
registerAction2(class ShowCustomTitleBar extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3650, "Show Custom Title Bar")),
...
registerAction2(class HideCustomTitleBar extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3651, "Hide Custom Title Bar")),
...
registerAction2(class HideCustomTitleBar extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3652, "Hide Custom Title Bar In Full Screen")),
...
registerAction2(class ToggleEditorActions extends Action2 {
    ...
    constructor() {
        ...
        super({
            ...
            title: ( localize(3653, 'Editor Actions')),
...
const ACCOUNTS_ACTIVITY_TILE_ACTION = {
    ...
    label: ( localize(3654, "Accounts")),
    tooltip: ( localize(3654, "Accounts")),
    class: undefined,
    enabled: true,
    run: function () { }
};
const GLOBAL_ACTIVITY_TITLE_ACTION = {
    ...
    label: ( localize(3655, "Manage")),
    tooltip: ( localize(3655, "Manage")),
    class: undefined,
    enabled: true,
    run: function () { }
};
