...
class BaseOpenRecentAction extends Action2 {
    ...
    async run(accessor) {
        ...
        let keyMods;
        const workspaceSeparator = { type: 'separator', label: hasWorkspaces ? ( localize(2909, "folders & workspaces")) : ( localize(2910, "folders")) };
        const fileSeparator = { type: 'separator', label: ( localize(2911, "files")) };
            ...
            onDidTriggerItemButton: async (context) => {
                if (context.button === this.removeFromRecentlyOpened || context.button === this.windowOpenedRecentlyOpenedFolder || context.button === this.windowOpenedRecentlyOpenedWorkspace) {
                    ...
                    const { confirmed } = await dialogService.confirm({
                        title: isDirtyWorkspace ? ( localize(2914, "Workspace with Unsaved Files")) : ( localize(2915, "Folder with Unsaved Files")),
                        message: isDirtyWorkspace ? ( localize(2916, "Do you want to open the workspace to review the unsaved files?")) : ( localize(2917, "Do you want to open the folder to review the unsaved files?")),
    ...
    toQuickPick(modelService, languageService, labelService, recent, kind) {
        ...
        return {
            iconClasses,
            label: name,
            ariaLabel: kind.isDirty ? isWorkspace ? ( localize(2920, "{0}, workspace with unsaved changes", name)) : ( localize(2921, "{0}, folder with unsaved changes", name)) : name,
...
class OpenRecentAction extends BaseOpenRecentAction {
    ...
    constructor() {
        super({
            ...
            title: {
                ...( localize2(2922, "Open Recent...")),
                mnemonicTitle: ( localize(2923, "&&More...")),
            },
...
class QuickPickRecentAction extends BaseOpenRecentAction {
    constructor() {
        super({
            ...
            title: ( localize2(2924, 'Quick Open Recent...')),
            category: Categories.File,
            f1: false
        });
    }
...
class ToggleFullScreenAction extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(2925, "Toggle Full Screen")),
                mnemonicTitle: ( localize(2926, "&&Full Screen")),
            },
...
class ReloadWindowAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(2927, 'Reload Window')),
...
class ShowAboutDialogAction extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(2928, "About")),
                mnemonicTitle: ( localize(2929, "&&About")),
            },
...
class NewWindowAction extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(2930, "New Window")),
                mnemonicTitle: ( localize(2931, "New &&Window")),
            },
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class BlurAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2932, 'Remove keyboard focus from focused element'))
        });
    }
    run() {
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        ...
        title: ( localize(2933, "Confirm Before Close")),
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    title: ( localize(2934, "Open &&Recent")),
