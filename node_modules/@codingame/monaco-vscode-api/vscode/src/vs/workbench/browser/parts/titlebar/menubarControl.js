...
import { MenuRegistry, MenuId, SubmenuItemAction, registerAction2, Action2, MenuItemAction } from '../../../../platform/actions/common/actions.js';
...
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        value: 'File',
        original: 'File',
        mnemonicTitle: ( localize(3623, "&&File")),
    },
    order: 1
});
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        value: 'Edit',
        original: 'Edit',
        mnemonicTitle: ( localize(3624, "&&Edit"))
    },
    order: 2
});
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        value: 'Selection',
        original: 'Selection',
        mnemonicTitle: ( localize(3625, "&&Selection"))
    },
    order: 3
});
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        value: 'View',
        original: 'View',
        mnemonicTitle: ( localize(3626, "&&View"))
    },
    order: 4
});
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        value: 'Go',
        original: 'Go',
        mnemonicTitle: ( localize(3627, "&&Go"))
    },
    order: 5
});
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        value: 'Terminal',
        original: 'Terminal',
        mnemonicTitle: ( localize(3628, "&&Terminal"))
    },
    order: 7
});
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        value: 'Help',
        original: 'Help',
        mnemonicTitle: ( localize(3629, "&&Help"))
    },
    order: 8
});
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        ...
        mnemonicTitle: ( localize(3630, "Preferences"))
    },
...
class MenubarControl extends Disposable {
    ...
    notifyUserOfCustomMenubarAccessibility() {
        ...
        this.notificationService.prompt(Severity$1.Info, message, [
            {
                label: ( localize(3632, "Open Settings")),
                run: () => {
        ...
        registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    title: ( localize2(3633, 'Focus Application Menu')),
                    keybinding: {
...
let CustomMenubarControl = class CustomMenubarControl extends MenubarControl {
    ...
    getUpdateAction() {
        ...
        switch (state.type) {
            case StateType.Idle:
                return toAction({
                    id: 'update.check', label: ( localize(3634, "Check for &&Updates...")), enabled: true, run: () => this.updateService.checkForUpdates(true)
                });
            case StateType.CheckingForUpdates:
                return toAction({ id: 'update.checking', label: ( localize(3635, "Checking for Updates...")), enabled: false, run: () => { } });
            case StateType.AvailableForDownload:
                return toAction({
                    id: 'update.downloadNow', label: ( localize(3636, "D&&ownload Update")), enabled: true, run: () => this.updateService.downloadUpdate()
                });
            case StateType.Downloading:
                return toAction({ id: 'update.downloading', label: ( localize(3637, "Downloading Update...")), enabled: false, run: () => { } });
            case StateType.Downloaded:
                return isMacintosh ? null : toAction({
                    id: 'update.install', label: ( localize(3638, "Install &&Update...")), enabled: true, run: () => this.updateService.applyUpdate()
                });
            case StateType.Updating:
                return toAction({ id: 'update.updating', label: ( localize(3639, "Installing Update...")), enabled: false, run: () => { } });
            case StateType.Ready:
                return toAction({
                    id: 'update.restart', label: ( localize(3640, "Restart to &&Update")), enabled: true, run: () => this.updateService.quitAndInstall()
                });
            default:
                return null;
        }
