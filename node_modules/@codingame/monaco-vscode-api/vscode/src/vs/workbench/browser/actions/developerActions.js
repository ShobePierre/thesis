...
class InspectContextKeysAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2698, 'Inspect Context Keys')),
...
class ToggleScreencastModeAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2699, 'Toggle Screencast Mode')),
            category: Categories.Developer,
            f1: true
        });
    }
...
class LogStorageAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2700, "Log Storage Database Contents")),
            category: Categories.Developer,
            f1: true
        });
    }
    run(accessor) {
        ...
        )), ( localize(2702, "Open developer tools from the menu and select the Console tab.")));
    }
}
class LogWorkingCopiesAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2703, "Log Working Copies")),
            category: Categories.Developer,
            f1: true
        });
    }
...
class RemoveLargeStorageEntriesAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(2704, 'Remove Large Storage Database Entries...')),
            category: Categories.Developer,
            f1: true
        });
    }
    async run(accessor) {
                    ...
                    if (value && (!environmentService.isBuilt  || value.length > RemoveLargeStorageEntriesAction.SIZE_THRESHOLD)) {
                        items.push({
                            ...
                            detail: ( localize(
                                2705,
                                "Scope: {0}, Target: {1}",
                                scope === StorageScope.APPLICATION ? ( localize(2706, "Global")) : scope === StorageScope.PROFILE ? ( localize(2707, "Profile")) : ( localize(2708, "Workspace")),
                                target === StorageTarget.MACHINE ? ( localize(2709, "Machine")) : ( localize(2710, "User"))
                            )),
                        });
                    }
                }
        ...
        const selectedItems = await ( new Promise(resolve => {
            ...
            picker.customLabel = ( localize(2711, "Remove"));
            picker.placeholder = ( localize(2712, "Select large entries to remove from storage"));
            if (items.length === 0) {
                picker.description = ( localize(2713, "There are no large storage entries to remove."));
            }
            picker.show();
        ...
        const { confirmed } = await dialogService.confirm({
            ...
            primaryButton: ( localize(2716, "&&Remove"))
        });
        if (!confirmed) {
            return;
        }
...
class StartTrackDisposables extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2717, 'Start Tracking Disposables')),
            category: Categories.Developer,
            f1: true,
...
class SnapshotTrackedDisposables extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2718, 'Snapshot Tracked Disposables')),
            category: Categories.Developer,
            f1: true,
...
class StopTrackDisposables extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2719, 'Stop Tracking Disposables')),
            category: Categories.Developer,
            f1: true,
...
class PolicyDiagnosticsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2720, 'Policy Diagnostics')),
            category: Categories.Developer,
            f1: true
        });
    }
...
configurationRegistry.registerConfiguration({
    id: 'screencastMode',
    order: 9,
    title: ( localize(2721, "Screencast Mode")),
    type: 'object',
    properties: {
        ...
        'screencastMode.keyboardOptions': {
            type: 'object',
            description: ( localize(2724, "Options for customizing the keyboard overlay in screencast mode.")),
            properties: {
                'showKeys': {
                    type: 'boolean',
                    default: true,
                    description: ( localize(2725, "Show raw keys."))
                },
                'showKeybindings': {
                    type: 'boolean',
                    default: true,
                    description: ( localize(2726, "Show keyboard shortcuts."))
                },
                'showCommands': {
                    type: 'boolean',
                    default: true,
                    description: ( localize(2727, "Show command names."))
                },
                'showCommandGroups': {
                    type: 'boolean',
                    default: false,
                    description: ( localize(2728, "Show command group names, when commands are also shown."))
                },
                'showSingleEditorCursorMoves': {
                    type: 'boolean',
                    default: true,
                    description: ( localize(2729, "Show single editor cursor move commands."))
                }
            },
            default: {
                'showKeys': true,
