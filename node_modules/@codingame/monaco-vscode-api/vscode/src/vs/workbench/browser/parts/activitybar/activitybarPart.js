...
import { Parts, Position, LayoutSettings, ActivityBarPosition } from '../../../services/layout/browser/layoutService.js';
...
let ActivityBarCompositeBar = class ActivityBarCompositeBar extends PaneCompositeBar {
    ...
    fillContextMenuActions(actions, e) {
        ...
        if (menuBarVisibility === 'compact' || menuBarVisibility === 'hidden' || menuBarVisibility === 'toggle') {
            actions.unshift(...[toAction({ id: 'toggleMenuVisibility', label: ( localize(2963, "Menu")), checked: menuBarVisibility === 'compact', run: () => this.configurationService.updateValue(MenuSettings.MenuBarVisibility, menuBarVisibility === 'compact' ? 'toggle' : 'compact') }), ( new Separator())]);
        }
        if (menuBarVisibility === 'compact' && this.menuBarContainer && e?.target) {
            if (isAncestor(e.target, this.menuBarContainer)) {
                actions.unshift(...[toAction({ id: 'hideCompactMenu', label: ( localize(2964, "Hide Menu")), run: () => this.configurationService.updateValue(MenuSettings.MenuBarVisibility, 'toggle') }), ( new Separator())]);
            }
        }
    ...
    getActivityBarContextMenuActions() {
        ...
        const actions = [
            ( new SubmenuAction('workbench.action.panel.position', ( localize(2965, "Activity Bar Position")), positionActions)),
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(2966, 'Move Activity Bar to Side')),
                mnemonicTitle: ( localize(2967, "&&Default")),
            },
            shortTitle: ( localize(2968, "Default")),
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(2969, 'Move Activity Bar to Top')),
                mnemonicTitle: ( localize(2970, "&&Top")),
            },
            shortTitle: ( localize(2971, "Top")),
            category: Categories.View,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(2972, 'Move Activity Bar to Bottom')),
                mnemonicTitle: ( localize(2973, "&&Bottom")),
            },
            shortTitle: ( localize(2974, "Bottom")),
            category: Categories.View,
            toggled: ( ContextKeyExpr.equals(
                `config.${LayoutSettings.ACTIVITY_BAR_LOCATION}`,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(2975, 'Hide Activity Bar')),
                mnemonicTitle: ( localize(2976, "&&Hidden")),
            },
            shortTitle: ( localize(2977, "Hidden")),
            category: Categories.View,
            toggled: ( ContextKeyExpr.equals(
                `config.${LayoutSettings.ACTIVITY_BAR_LOCATION}`,
...
MenuRegistry.appendMenuItem(MenuId.MenubarAppearanceMenu, {
    ...
    title: ( localize(2978, "Activity Bar Position")),
...
registerAction2(class extends SwitchCompositeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(2979, 'Previous Primary Side Bar View')),
            category: Categories.View,
            f1: true
...
registerAction2(class extends SwitchCompositeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(2980, 'Next Primary Side Bar View')),
            category: Categories.View,
            f1: true
        }, ViewContainerLocation.Sidebar, 1);
    }
...
registerAction2(class FocusActivityBarAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2981, 'Focus Activity Bar')),
            category: Categories.View,
            f1: true
        });
    }
