...
const separatorIcon = registerIcon('breadcrumb-separator', Codicon.chevronRight, ( localize(3075, 'Icon for the separator in the breadcrumbs.')));
let BreadcrumbsControl = class BreadcrumbsControl {
    ...
    static { this.CK_BreadcrumbsPossible = ( new RawContextKey('breadcrumbsPossible', false, ( localize(3076, "Whether the editor can show breadcrumbs")))); }
    static { this.CK_BreadcrumbsVisible = ( new RawContextKey('breadcrumbsVisible', false, ( localize(3077, "Whether breadcrumbs are currently visible")))); }
    static { this.CK_BreadcrumbsActive = ( new RawContextKey('breadcrumbsActive', false, ( localize(3078, "Whether breadcrumbs have focus")))); }
        ...
        const updateBreadcrumbs = () => {
            ...
            if (items.length === 0) {
                ...
                this._widget.setItems([new (class extends BreadcrumbsItem {
                        render(container) {
                            container.textContent = ( localize(3079, "no elements"));
                        }
                        equals(other) {
                            return other === this;
                        }
...
registerAction2(class ToggleBreadcrumb extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3080, "Toggle Breadcrumbs")),
            category: Categories.View,
            toggled: {
                condition: ( ContextKeyExpr.equals('config.breadcrumbs.enabled', true)),
                title: ( localize(3081, "Toggle Breadcrumbs")),
                mnemonicTitle: ( localize(3082, "&&Breadcrumbs"))
            },
            menu: [
...
registerAction2(class FocusAndSelectBreadcrumbs extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3083, "Focus and Select Breadcrumbs")),
...
registerAction2(class FocusBreadcrumbs extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3084, "Focus Breadcrumbs")),
            precondition: BreadcrumbsControl.CK_BreadcrumbsVisible,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
