...
let MultiEditorTabsControl = class MultiEditorTabsControl extends EditorTabsControl {
    ...
    handleOpenedEditors() {
        ...
        if (activeEditorChanged ||
            oldTabLabels.length !== this.tabLabels.length ||
            ( oldTabLabels.some(
    ...
    createTab(tabIndex, tabsContainer, tabsScrollbar) {
        ...
        const tabActionBar = ( new ActionBar(tabActionsContainer, { ariaLabel: ( localize(3479, "Tab actions")), actionRunner: tabActionRunner }));
