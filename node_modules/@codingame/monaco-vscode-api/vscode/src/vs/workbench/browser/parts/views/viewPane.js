...
const viewPaneContainerExpandedIcon = registerIcon('view-pane-container-expanded', Codicon.chevronDown, ( localize(3671, 'Icon for an expanded view pane container.')));
const viewPaneContainerCollapsedIcon = registerIcon('view-pane-container-collapsed', Codicon.chevronRight, ( localize(3672, 'Icon for a collapsed view pane container.')));
            ...
            for (let line of lines) {
                ...
                if (linkedText.nodes.length === 1 && typeof linkedText.nodes[0] !== 'string') {
                    ...
                    const button = ( new Button(
                        buttonContainer,
                        { title: node.title, supportIcons: true, secondary: !!(renderSecondaryButtons && buttonsCount > 0), ...defaultButtonStyles, }
                    ));
...
let ViewPane = class ViewPane extends Pane {
    ...
    renderHeader(container) {
        ...
        this.toolbar = this.instantiationService.createInstance(WorkbenchToolBar, actions, {
            ...
            ariaLabel: ( localize(3673, "{0} actions", this.title)),
    ...
    _getAriaLabel(title, description) {
        ...
        return localize(3674, 'Use Alt+F1 for accessibility help {0}', title);
    }
    updateTitle(title) {
        const calculatedTitle = this.calculateTitle(title);
