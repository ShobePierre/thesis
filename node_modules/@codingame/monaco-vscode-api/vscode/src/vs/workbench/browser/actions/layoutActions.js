...
const menubarIcon = registerIcon('menuBar', Codicon.layoutMenubar, ( localize(2752, "Represents the menu bar")));
const activityBarLeftIcon = registerIcon('activity-bar-left', Codicon.layoutActivitybarLeft, ( localize(2753, "Represents the activity bar in the left position")));
const activityBarRightIcon = registerIcon('activity-bar-right', Codicon.layoutActivitybarRight, ( localize(2754, "Represents the activity bar in the right position")));
const panelLeftIcon = registerIcon('panel-left', Codicon.layoutSidebarLeft, ( localize(2755, "Represents a side bar in the left position")));
const panelLeftOffIcon = registerIcon('panel-left-off', Codicon.layoutSidebarLeftOff, ( localize(2756, "Represents a side bar in the left position toggled off")));
const panelRightIcon = registerIcon('panel-right', Codicon.layoutSidebarRight, ( localize(2757, "Represents side bar in the right position")));
const panelRightOffIcon = registerIcon('panel-right-off', Codicon.layoutSidebarRightOff, ( localize(2758, "Represents side bar in the right position toggled off")));
const panelIcon = registerIcon('panel-bottom', Codicon.layoutPanel, ( localize(2759, "Represents the bottom panel")));
const statusBarIcon = registerIcon('statusBar', Codicon.layoutStatusbar, ( localize(2760, "Represents the status bar")));
const panelAlignmentLeftIcon = registerIcon('panel-align-left', Codicon.layoutPanelLeft, ( localize(2761, "Represents the bottom panel alignment set to the left")));
const panelAlignmentRightIcon = registerIcon('panel-align-right', Codicon.layoutPanelRight, ( localize(2762, "Represents the bottom panel alignment set to the right")));
const panelAlignmentCenterIcon = registerIcon('panel-align-center', Codicon.layoutPanelCenter, ( localize(2763, "Represents the bottom panel alignment set to the center")));
const panelAlignmentJustifyIcon = registerIcon('panel-align-justify', Codicon.layoutPanelJustify, ( localize(2764, "Represents the bottom panel alignment set to justified")));
const quickInputAlignmentTopIcon = registerIcon('quickInputAlignmentTop', Codicon.arrowUp, ( localize(2765, "Represents quick input alignment set to the top")));
const quickInputAlignmentCenterIcon = registerIcon('quickInputAlignmentCenter', Codicon.circle, ( localize(2766, "Represents quick input alignment set to the center")));
const fullscreenIcon = registerIcon('fullscreen', Codicon.screenFull, ( localize(2767, "Represents full screen")));
const centerLayoutIcon = registerIcon('centerLayoutIcon', Codicon.layoutCentered, ( localize(2768, "Represents centered layout mode")));
const zenModeIcon = registerIcon('zenMode', Codicon.target, ( localize(2769, "Represents zen mode")));
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(2770, "Toggle Centered Layout")),
                mnemonicTitle: ( localize(2771, "&&Centered Layout")),
            },
...
class MoveSidebarRightAction extends MoveSidebarPositionAction {
    ...
    constructor() {
        super(MoveSidebarRightAction.ID, ( localize2(2772, "Move Primary Side Bar Right")), Position.RIGHT);
    }
}
class MoveSidebarLeftAction extends MoveSidebarPositionAction {
    static { this.ID = 'workbench.action.moveSideBarLeft'; }
    constructor() {
        super(MoveSidebarLeftAction.ID, ( localize2(2773, "Move Primary Side Bar Left")), Position.LEFT);
    }
}
...
class ToggleSidebarPositionAction extends Action2 {
    ...
    static { this.LABEL = ( localize(2774, "Toggle Primary Side Bar Position")); }
    static getLabel(layoutService) {
        return layoutService.getSideBarPosition() === Position.LEFT ? ( localize(2772, "Move Primary Side Bar Right")) : ( localize(2773, "Move Primary Side Bar Left"));
    }
    constructor() {
        super({
            id: ToggleSidebarPositionAction.ID,
            title: ( localize2(2774, "Toggle Primary Side Bar Position")),
            category: Categories.View,
            f1: true
        });
    }
...
const configureLayoutIcon = registerIcon('configure-layout-icon', Codicon.layout, ( localize(2775, 'Icon represents workbench layout configuration.')));
MenuRegistry.appendMenuItem(MenuId.LayoutControlMenu, {
    submenu: MenuId.LayoutControlMenuSubmenu,
    title: ( localize(2776, "Configure Layout")),
...
MenuRegistry.appendMenuItems([{
        ...
        item: {
            ...
            command: {
                id: ToggleSidebarPositionAction.ID,
                title: ( localize(2777, "Move Primary Side Bar Right"))
            },
        ...
        item: {
            ...
            command: {
                id: ToggleSidebarPositionAction.ID,
                title: ( localize(2778, "Move Primary Side Bar Left"))
            },
        ...
        item: {
            ...
            command: {
                id: ToggleSidebarPositionAction.ID,
                title: ( localize(2779, "Move Secondary Side Bar Left"))
            },
            when: ( ContextKeyExpr.and(( ContextKeyExpr.notEquals('config.workbench.sideBar.location', 'right')), ( ContextKeyExpr.equals(
                'viewContainerLocation',
        ...
        item: {
            ...
            command: {
                id: ToggleSidebarPositionAction.ID,
                title: ( localize(2780, "Move Secondary Side Bar Right"))
            },
            when: ( ContextKeyExpr.and(( ContextKeyExpr.equals('config.workbench.sideBar.location', 'right')), ( ContextKeyExpr.equals(
                'viewContainerLocation',
                ViewContainerLocationToString(ViewContainerLocation.AuxiliaryBar)
...
MenuRegistry.appendMenuItem(MenuId.MenubarAppearanceMenu, {
    ...
    command: {
        id: ToggleSidebarPositionAction.ID,
        title: ( localize(2781, "&&Move Primary Side Bar Right"))
    },
...
MenuRegistry.appendMenuItem(MenuId.MenubarAppearanceMenu, {
    ...
    command: {
        id: ToggleSidebarPositionAction.ID,
        title: ( localize(2782, "&&Move Primary Side Bar Left"))
    },
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(2783, "Toggle Editor Area Visibility")),
                mnemonicTitle: ( localize(2784, "Show &&Editor Area")),
            },
            category: Categories.View,
            f1: true,
...
MenuRegistry.appendMenuItem(MenuId.MenubarViewMenu, {
    group: '2_appearance',
    title: ( localize(2785, "&&Appearance")),
    submenu: MenuId.MenubarAppearanceMenu,
    order: 1
});
class ToggleSidebarVisibilityAction extends Action2 {
    static { this.ID = 'workbench.action.toggleSidebarVisibility'; }
    static { this.LABEL = ( localize(2786, "Hide Primary Side Bar")); }
    constructor() {
        super({
            id: ToggleSidebarVisibilityAction.ID,
            title: ( localize2(2787, 'Toggle Primary Side Bar Visibility')),
            toggled: {
                condition: SideBarVisibleContext,
                title: ( localize(2788, "Primary Side Bar")),
                mnemonicTitle: ( localize(2789, "&&Primary Side Bar")),
            },
            metadata: {
                description: ( localize(2790, 'Open/Show and Close/Hide Sidebar')),
            },
            category: Categories.View,
            f1: true,
            keybinding: {
    ...
    run(accessor) {
        ...
        const alertMessage = isCurrentlyVisible
            ? ( localize(2791, "Primary Side Bar hidden"))
            : ( localize(2792, "Primary Side Bar shown"));
        alert(alertMessage);
    }
}
...
MenuRegistry.appendMenuItems([
    {
        ...
        item: {
            ...
            command: {
                id: ToggleSidebarVisibilityAction.ID,
                title: ( localize(2786, "Hide Primary Side Bar")),
            },
        ...
        item: {
            ...
            command: {
                id: ToggleSidebarVisibilityAction.ID,
                title: ( localize(2793, "Toggle Primary Side Bar")),
...
class ToggleStatusbarVisibilityAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: {
                ...( localize2(2794, "Toggle Status Bar Visibility")),
                mnemonicTitle: ( localize(2795, "S&&tatus Bar")),
            },
            category: Categories.View,
            f1: true,
...
class HideEditorTabsAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        ...
        const title = ( localize2(2796, 'Hide Editor Tabs'));
        super(LayoutSettings.EDITOR_TABS_MODE, EditorTabsMode.NONE, title, HideEditorTabsAction.ID, precondition, ( localize2(2797, "Hide Tab Bar")));
    }
}
class ZenHideEditorTabsAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        ...
        const title = ( localize2(2798, 'Hide Editor Tabs in Zen Mode'));
        super(ZenModeSettings.SHOW_TABS, EditorTabsMode.NONE, title, ZenHideEditorTabsAction.ID, precondition, ( localize2(2799, "Hide Tab Bar in Zen Mode")));
    }
}
class ShowMultipleEditorTabsAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        ...
        const title = ( localize2(2800, 'Show Multiple Editor Tabs'));
        super(LayoutSettings.EDITOR_TABS_MODE, EditorTabsMode.MULTIPLE, title, ShowMultipleEditorTabsAction.ID, precondition, ( localize2(2801, "Show Tab Bar with multiple tabs")));
    }
}
class ZenShowMultipleEditorTabsAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        ...
        const title = ( localize2(2802, 'Show Multiple Editor Tabs in Zen Mode'));
        super(ZenModeSettings.SHOW_TABS, EditorTabsMode.MULTIPLE, title, ZenShowMultipleEditorTabsAction.ID, precondition, ( localize2(2803, "Show Tab Bar in Zen Mode")));
    }
}
class ShowSingleEditorTabAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        ...
        const title = ( localize2(2804, 'Show Single Editor Tab'));
        super(LayoutSettings.EDITOR_TABS_MODE, EditorTabsMode.SINGLE, title, ShowSingleEditorTabAction.ID, precondition, ( localize2(2805, "Show Tab Bar with one Tab")));
    }
}
class ZenShowSingleEditorTabAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        ...
        const title = ( localize2(2806, 'Show Single Editor Tab in Zen Mode'));
        super(ZenModeSettings.SHOW_TABS, EditorTabsMode.SINGLE, title, ZenShowSingleEditorTabAction.ID, precondition, ( localize2(2807, "Show Tab Bar in Zen Mode with one Tab")));
    }
}
...
class EditorActionsTitleBarAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(2809, "Move Editor Actions to Title Bar")),
            category: Categories.View,
            precondition: ( ( ContextKeyExpr.equals(
                `config.${LayoutSettings.EDITOR_ACTIONS_LOCATION}`,
                EditorActionsLocation.TITLEBAR
            )).negate()),
            metadata: { description: ( localize2(2810, "Move Editor Actions from the tab bar to the title bar")) },
            f1: true
        });
    }
    run(accessor) {
...
class EditorActionsDefaultAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(2811, "Move Editor Actions to Tab Bar")),
            category: Categories.View,
            ...
            metadata: { description: ( localize2(2812, "Move Editor Actions from the title bar to the tab bar")) },
            f1: true
        });
    }
    run(accessor) {
...
class HideEditorActionsAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(2813, "Hide Editor Actions")),
            category: Categories.View,
            precondition: ( ( ContextKeyExpr.equals(
                `config.${LayoutSettings.EDITOR_ACTIONS_LOCATION}`,
                EditorActionsLocation.HIDDEN
            )).negate()),
            metadata: { description: ( localize2(2814, "Hide Editor Actions in the tab and title bar")) },
            f1: true
        });
    }
    run(accessor) {
...
class ShowEditorActionsAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(2815, "Show Editor Actions")),
            category: Categories.View,
            precondition: ( ContextKeyExpr.equals(
                `config.${LayoutSettings.EDITOR_ACTIONS_LOCATION}`,
                EditorActionsLocation.HIDDEN
            )),
            metadata: { description: ( localize2(2816, "Make Editor Actions visible.")) },
            f1: true
        });
    }
    run(accessor) {
...
MenuRegistry.appendMenuItem(MenuId.MenubarAppearanceMenu, {
    ...
    title: ( localize(2817, "Editor Actions Position")),
    group: '3_workbench_layout_move',
    order: 11
});
class ConfigureEditorTabsAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(2818, "Configure Tabs")),
            category: Categories.View,
        });
    }
    run(accessor) {
...
class ConfigureEditorAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(2819, "Configure Editors")),
            category: Categories.View,
        });
    }
    run(accessor) {
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2820, "Separate Pinned Editor Tabs")),
            category: Categories.View,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(2822, "Toggle Zen Mode")),
                mnemonicTitle: ( localize(2823, "Zen Mode")),
            },
            precondition: ( IsAuxiliaryWindowFocusedContext.toNegated()),
            category: Categories.View,
            f1: true,
    ...
    registerAction2(class ToggleMenubarAction extends Action2 {
        constructor() {
            super({
                ...
                title: {
                    ...( localize2(2824, "Toggle Menu Bar")),
                    mnemonicTitle: ( localize(2825, "Menu &&Bar")),
                },
                category: Categories.View,
                f1: true,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2827, "Reset View Locations")),
            category: Categories.View,
            f1: true
        });
    }
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2828, "Move View")),
            category: Categories.View,
            f1: true
        });
    }
            ...
            containerModel.visibleViewDescriptors.forEach(viewDescriptor => {
                if (viewDescriptor.canMoveView) {
                    if (!hasAddedView) {
                        results.push({
                            type: 'separator',
                            label: ( localize(2829, "Side Bar / {0}", containerModel.title))
                        });
                        hasAddedView = true;
                    }
                    results.push({
            ...
            containerModel.visibleViewDescriptors.forEach(viewDescriptor => {
                if (viewDescriptor.canMoveView) {
                    if (!hasAddedView) {
                        results.push({
                            type: 'separator',
                            label: ( localize(2830, "Panel / {0}", containerModel.title))
                        });
                        hasAddedView = true;
                    }
                    results.push({
            ...
            containerModel.visibleViewDescriptors.forEach(viewDescriptor => {
                if (viewDescriptor.canMoveView) {
                    if (!hasAddedView) {
                        results.push({
                            type: 'separator',
                            label: ( localize(2831, "Secondary Side Bar / {0}", containerModel.title))
                        });
                        hasAddedView = true;
                    }
                    results.push({
    ...
    async getView(quickInputService, viewDescriptorService, paneCompositePartService, viewId) {
        ...
        quickPick.placeholder = ( localize(2832, "Select a View to Move"));
...
class MoveFocusedViewAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2833, "Move Focused View")),
            category: Categories.View,
    ...
    run(accessor, viewId) {
        ...
        if (focusedViewId === undefined || focusedViewId.trim() === '') {
            dialogService.error(( localize(2834, "There is no view currently focused.")));
            return;
        }
        const viewDescriptor = viewDescriptorService.getViewDescriptorById(focusedViewId);
        if (!viewDescriptor?.canMoveView) {
            dialogService.error(( localize(2835, "The currently focused view is not movable.")));
            return;
        }
        const disposables = ( new DisposableStore());
        const quickPick = disposables.add(quickInputService.createQuickPick({ useSeparators: true }));
        quickPick.placeholder = ( localize(2836, "Select a Destination for the View"));
        quickPick.title = ( localize(2837, "View: Move {0}", viewDescriptor.name.value));
        const items = [];
        ...
        items.push({
            type: 'separator',
            label: ( localize(2843, "Secondary Side Bar"))
        });
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2844, "Reset Focused View Location")),
            category: Categories.View,
            f1: true,
            precondition: ( FocusedViewContext.notEqualsTo(''))
        });
    ...
    run(accessor) {
        ...
        if (!viewDescriptor) {
            dialogService.error(( localize(2845, "There is no view currently focused.")));
            return;
        }
...
class IncreaseViewSizeAction extends BaseResizeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(2846, 'Increase Current View Size')),
            f1: true,
            precondition: ( IsAuxiliaryWindowFocusedContext.toNegated())
        });
    }
...
class IncreaseViewWidthAction extends BaseResizeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(2847, 'Increase Editor Width')),
            f1: true,
            precondition: ( IsAuxiliaryWindowFocusedContext.toNegated())
        });
    }
...
class IncreaseViewHeightAction extends BaseResizeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(2848, 'Increase Editor Height')),
            f1: true,
            precondition: ( IsAuxiliaryWindowFocusedContext.toNegated())
        });
    }
...
class DecreaseViewSizeAction extends BaseResizeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(2849, 'Decrease Current View Size')),
            f1: true,
            precondition: ( IsAuxiliaryWindowFocusedContext.toNegated())
        });
    }
...
class DecreaseViewWidthAction extends BaseResizeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(2850, 'Decrease Editor Width')),
            f1: true,
            precondition: ( IsAuxiliaryWindowFocusedContext.toNegated())
        });
    }
...
class DecreaseViewHeightAction extends BaseResizeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(2851, 'Decrease Editor Height')),
            f1: true,
            precondition: ( IsAuxiliaryWindowFocusedContext.toNegated())
        });
    }
...
registerAction2(class AlignQuickInputTopAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2852, 'Align Quick Input Top')),
            f1: false
        });
    }
    run(accessor) {
...
registerAction2(class AlignQuickInputCenterAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2853, 'Align Quick Input Center')),
            f1: false
        });
    }
    run(accessor) {
...
const CreateToggleLayoutItem = (id, active, label, visualIcon) => {
    return {
        ...
        activeAriaLabel: ( localize(2854, "Select to Hide")),
        inactiveAriaLabel: ( localize(2855, "Select to Show")),
        useButtons: true,
    };
};
const CreateOptionLayoutItem = (id, active, label, visualIcon) => {
    return {
        ...
        activeAriaLabel: ( localize(2856, "Active")),
        useButtons: false
    };
};
...
if (!isMacintosh || !isNative) {
    ToggleVisibilityActions.push(CreateToggleLayoutItem('workbench.action.toggleMenuBar', MenuBarToggledContext, ( localize(2857, "Menu Bar")), menubarIcon));
}
ToggleVisibilityActions.push(...[
    CreateToggleLayoutItem(ToggleActivityBarVisibilityActionId, ( ContextKeyExpr.notEquals('config.workbench.activityBar.location', 'hidden')), ( localize(2858, "Activity Bar")), { whenA: ( ContextKeyExpr.equals('config.workbench.sideBar.location', 'left')), iconA: activityBarLeftIcon, iconB: activityBarRightIcon }),
    CreateToggleLayoutItem(ToggleSidebarVisibilityAction.ID, SideBarVisibleContext, ( localize(2859, "Primary Side Bar")), { whenA: ( ContextKeyExpr.equals('config.workbench.sideBar.location', 'left')), iconA: panelLeftIcon, iconB: panelRightIcon }),
    CreateToggleLayoutItem(ToggleAuxiliaryBarAction.ID, AuxiliaryBarVisibleContext, ( localize(2843, "Secondary Side Bar")), { whenA: ( ContextKeyExpr.equals('config.workbench.sideBar.location', 'left')), iconA: panelRightIcon, iconB: panelLeftIcon }),
    CreateToggleLayoutItem(TogglePanelAction.ID, PanelVisibleContext, ( localize(2842, "Panel")), panelIcon),
    CreateToggleLayoutItem(ToggleStatusbarVisibilityAction.ID, ( ContextKeyExpr.equals('config.workbench.statusBar.visible', true)), ( localize(2860, "Status Bar")), statusBarIcon),
]);
const MoveSideBarActions = [
    CreateOptionLayoutItem(MoveSidebarLeftAction.ID, ( ContextKeyExpr.equals('config.workbench.sideBar.location', 'left')), ( localize(2861, "Left")), panelLeftIcon),
    CreateOptionLayoutItem(MoveSidebarRightAction.ID, ( ContextKeyExpr.equals('config.workbench.sideBar.location', 'right')), ( localize(2862, "Right")), panelRightIcon),
];
const AlignPanelActions = [
    CreateOptionLayoutItem('workbench.action.alignPanelLeft', ( PanelAlignmentContext.isEqualTo('left')), ( localize(2863, "Left")), panelAlignmentLeftIcon),
    CreateOptionLayoutItem('workbench.action.alignPanelRight', ( PanelAlignmentContext.isEqualTo('right')), ( localize(2864, "Right")), panelAlignmentRightIcon),
    CreateOptionLayoutItem('workbench.action.alignPanelCenter', ( PanelAlignmentContext.isEqualTo('center')), ( localize(2865, "Center")), panelAlignmentCenterIcon),
    CreateOptionLayoutItem('workbench.action.alignPanelJustify', ( PanelAlignmentContext.isEqualTo('justify')), ( localize(2866, "Justify")), panelAlignmentJustifyIcon),
];
const QuickInputActions = [
    CreateOptionLayoutItem('workbench.action.alignQuickInputTop', ( QuickInputAlignmentContextKey.isEqualTo('top')), ( localize(2867, "Top")), quickInputAlignmentTopIcon),
    CreateOptionLayoutItem('workbench.action.alignQuickInputCenter', ( QuickInputAlignmentContextKey.isEqualTo('center')), ( localize(2868, "Center")), quickInputAlignmentCenterIcon),
];
const MiscLayoutOptions = [
    CreateOptionLayoutItem('workbench.action.toggleFullScreen', IsMainWindowFullscreenContext, ( localize(2869, "Full Screen")), fullscreenIcon),
    CreateOptionLayoutItem('workbench.action.toggleZenMode', InEditorZenModeContext, ( localize(2870, "Zen Mode")), zenModeIcon),
    CreateOptionLayoutItem('workbench.action.toggleCenteredLayout', IsMainEditorCenteredLayoutContext, ( localize(2871, "Centered Layout")), centerLayoutIcon),
];
...
registerAction2(class CustomizeLayoutAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2872, "Customize Layout...")),
            f1: true,
            icon: configureLayoutIcon,
            menu: [
                {
    ...
    getItems(contextKeyService, keybindingService) {
        ...
        return [
            {
                type: 'separator',
                label: ( localize(2873, "Visibility"))
            },
            ...( ToggleVisibilityActions.map(toQuickPickItem)),
            {
                type: 'separator',
                label: ( localize(2874, "Primary Side Bar Position"))
            },
            ...( MoveSideBarActions.map(toQuickPickItem)),
            {
                type: 'separator',
                label: ( localize(2875, "Panel Alignment"))
            },
            ...( AlignPanelActions.map(toQuickPickItem)),
            {
                type: 'separator',
                label: ( localize(2876, "Quick Input Position"))
            },
            ...( QuickInputActions.map(toQuickPickItem)),
            {
                type: 'separator',
                label: ( localize(2877, "Modes")),
            },
    ...
    run(accessor) {
        ...
        quickPick.title = ( localize(2878, "Customize Layout"));
        const closeButton = {
            alwaysVisible: true,
            iconClass: ThemeIcon.asClassName(Codicon.close),
            tooltip: ( localize(2879, "Close"))
        };
        const resetButton = {
            alwaysVisible: true,
            iconClass: ThemeIcon.asClassName(Codicon.discard),
            tooltip: ( localize(2880, "Restore Defaults"))
        };
        quickPick.buttons = [
            resetButton,
            closeButton
