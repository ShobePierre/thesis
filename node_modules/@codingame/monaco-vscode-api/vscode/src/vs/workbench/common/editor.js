...
const DEFAULT_EDITOR_ASSOCIATION = {
    id: 'default',
    displayName: ( localize(4019, "Text Editor")),
    providerDisplayName: ( localize(4020, "Built-in"))
};
...
function createTooLargeFileError(group, input, options, message, preferencesService) {
    return createEditorOpenError(message, [
        toAction({
            id: 'workbench.action.openLargeFile', label: ( localize(4021, "Open Anyway")), run: () => {
        ...
        toAction({
            id: 'workbench.action.configureEditorLargeFileConfirmation', label: ( localize(4022, "Configure Limit")), run: () => {
