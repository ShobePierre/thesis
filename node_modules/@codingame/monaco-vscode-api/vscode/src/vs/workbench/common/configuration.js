            ...
            'properties': {
                'security.allowedUNCHosts': {
                    ...
                    'items': {
                        'type': 'string',
                        'pattern': '^[^\\\\]+$',
                        'patternErrorMessage': ( localize(3941, 'UNC host names must not contain backslashes.'))
                    },
                    'default': [],
        ...
        const configurationNode = {
            ...
            'properties': {
                [CONFIG_NEW_WINDOW_PROFILE]: {
                    ...
                    'enumItemLabels': [...( this.userDataProfilesService.profiles.map(() => '')), ( localize(3944, "Active Window"))],
