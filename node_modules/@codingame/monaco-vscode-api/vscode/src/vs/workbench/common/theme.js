...
const OUTPUT_VIEW_BACKGROUND = registerColor('outputView.background', null, ( localize(4068, "Output view background color.")));
registerColor('outputViewStickyScroll.background', OUTPUT_VIEW_BACKGROUND, ( localize(4069, "Output view sticky scroll background color.")));
...
registerColor('activityBarTop.background', null, ( localize(4112, "Background color of the activity bar when set to top / bottom.")));
...
const PANEL_TITLE_BADGE_BACKGROUND = registerColor('panelTitleBadge.background', ACTIVITY_BAR_BADGE_BACKGROUND, ( localize(
    4119,
...
const PANEL_TITLE_BADGE_FOREGROUND = registerColor('panelTitleBadge.foreground', ACTIVITY_BAR_BADGE_FOREGROUND, ( localize(
    4120,
...
registerColor('panelInput.border', {
    ...
    hcDark: inputBorder,
    hcLight: inputBorder
}, ( localize(4121, "Input box border for inputs in the panel.")));
...
const PANEL_STICKY_SCROLL_BACKGROUND = registerColor('panelStickyScroll.background', PANEL_BACKGROUND, ( localize(4128, "Background color of sticky scroll in the panel.")));
const PANEL_STICKY_SCROLL_BORDER = registerColor('panelStickyScroll.border', null, ( localize(4129, "Border color of sticky scroll in the panel.")));
const PANEL_STICKY_SCROLL_SHADOW = registerColor('panelStickyScroll.shadow', scrollbarShadow, ( localize(4130, "Shadow color of sticky scroll in the panel.")));
...
const STATUS_BAR_REMOTE_ITEM_BACKGROUND = registerColor('statusBarItem.remoteBackground', ACTIVITY_BAR_BADGE_BACKGROUND, ( localize(4133, "Background color for the remote indicator on the status bar.")));
const STATUS_BAR_REMOTE_ITEM_FOREGROUND = registerColor('statusBarItem.remoteForeground', ACTIVITY_BAR_BADGE_FOREGROUND, ( localize(4134, "Foreground color for the remote indicator on the status bar.")));
...
registerColor('statusBarItem.offlineBackground', '#6c1717', ( localize(4137, "Status bar item background color when the workbench is offline.")));
registerColor('statusBarItem.offlineForeground', STATUS_BAR_REMOTE_ITEM_FOREGROUND, ( localize(4138, "Status bar item foreground color when the workbench is offline.")));
...
const EXTENSION_BADGE_BACKGROUND = registerColor('extensionBadge.remoteBackground', ACTIVITY_BAR_BADGE_BACKGROUND, ( localize(4141, "Background color for the remote badge in the extensions view.")));
const EXTENSION_BADGE_FOREGROUND = registerColor('extensionBadge.remoteForeground', ACTIVITY_BAR_BADGE_FOREGROUND, ( localize(4142, "Foreground color for the remote badge in the extensions view.")));
...
const SIDE_BAR_STICKY_SCROLL_BACKGROUND = registerColor('sideBarStickyScroll.background', SIDE_BAR_BACKGROUND, ( localize(4154, "Background color of sticky scroll in the side bar.")));
const SIDE_BAR_STICKY_SCROLL_BORDER = registerColor('sideBarStickyScroll.border', null, ( localize(4155, "Border color of sticky scroll in the side bar.")));
const SIDE_BAR_STICKY_SCROLL_SHADOW = registerColor('sideBarStickyScroll.shadow', scrollbarShadow, ( localize(4156, "Shadow color of sticky scroll in the side bar.")));
const TITLE_BAR_ACTIVE_FOREGROUND = registerColor('titleBar.activeForeground', {
    dark: '#CCCCCC',
    light: '#333333',
    hcDark: '#FFFFFF',
    hcLight: '#292929'
}, ( localize(4157, "Title bar foreground when the window is active.")));
const TITLE_BAR_INACTIVE_FOREGROUND = registerColor('titleBar.inactiveForeground', {
    dark: ( transparent(TITLE_BAR_ACTIVE_FOREGROUND, 0.6)),
    light: ( transparent(TITLE_BAR_ACTIVE_FOREGROUND, 0.6)),
    hcDark: null,
    hcLight: '#292929'
}, ( localize(4158, "Title bar foreground when the window is inactive.")));
const TITLE_BAR_ACTIVE_BACKGROUND = registerColor('titleBar.activeBackground', {
    dark: '#3C3C3C',
    light: '#DDDDDD',
    hcDark: '#000000',
    hcLight: '#FFFFFF'
}, ( localize(4159, "Title bar background when the window is active.")));
const TITLE_BAR_INACTIVE_BACKGROUND = registerColor('titleBar.inactiveBackground', {
    dark: ( transparent(TITLE_BAR_ACTIVE_BACKGROUND, 0.6)),
    light: ( transparent(TITLE_BAR_ACTIVE_BACKGROUND, 0.6)),
    hcDark: null,
    hcLight: null,
}, ( localize(4160, "Title bar background when the window is inactive.")));
const TITLE_BAR_BORDER = registerColor('titleBar.border', {
    dark: null,
    light: null,
    hcDark: contrastBorder,
    hcLight: contrastBorder
}, ( localize(4161, "Title bar border color.")));
const MENUBAR_SELECTION_FOREGROUND = registerColor('menubar.selectionForeground', TITLE_BAR_ACTIVE_FOREGROUND, ( localize(4162, "Foreground color of the selected menu item in the menubar.")));
const MENUBAR_SELECTION_BACKGROUND = registerColor('menubar.selectionBackground', {
    ...
    hcDark: null,
    hcLight: null,
}, ( localize(4163, "Background color of the selected menu item in the menubar.")));
registerColor('menubar.selectionBorder', {
    dark: null,
    light: null,
    hcDark: activeContrastBorder,
    hcLight: activeContrastBorder,
}, ( localize(4164, "Border color of the selected menu item in the menubar.")));
registerColor('commandCenter.foreground', TITLE_BAR_ACTIVE_FOREGROUND, ( localize(4165, "Foreground color of the command center")), false);
registerColor('commandCenter.activeForeground', MENUBAR_SELECTION_FOREGROUND, ( localize(4166, "Active foreground color of the command center")), false);
registerColor('commandCenter.inactiveForeground', TITLE_BAR_INACTIVE_FOREGROUND, ( localize(4167, "Foreground color of the command center when the window is inactive")), false);
const COMMAND_CENTER_BACKGROUND = registerColor('commandCenter.background', { dark: ( Color.white.transparent(0.05)), hcDark: null, light: ( Color.black.transparent(0.05)), hcLight: null }, ( localize(4168, "Background color of the command center")), false);
registerColor('commandCenter.activeBackground', { dark: ( Color.white.transparent(0.08)), hcDark: MENUBAR_SELECTION_BACKGROUND, light: ( Color.black.transparent(0.08)), hcLight: MENUBAR_SELECTION_BACKGROUND }, ( localize(4169, "Active background color of the command center")), false);
registerColor('commandCenter.border', { dark: ( transparent(TITLE_BAR_ACTIVE_FOREGROUND, .20)), hcDark: contrastBorder, light: ( transparent(TITLE_BAR_ACTIVE_FOREGROUND, .20)), hcLight: contrastBorder }, ( localize(4170, "Border color of the command center")), false);
registerColor('commandCenter.activeBorder', { dark: ( transparent(TITLE_BAR_ACTIVE_FOREGROUND, .30)), hcDark: TITLE_BAR_ACTIVE_FOREGROUND, light: ( transparent(TITLE_BAR_ACTIVE_FOREGROUND, .30)), hcLight: TITLE_BAR_ACTIVE_FOREGROUND }, ( localize(4171, "Active border color of the command center")), false);
registerColor('commandCenter.inactiveBorder', ( transparent(TITLE_BAR_INACTIVE_FOREGROUND, .25)), ( localize(4172, "Border color of the command center when the window is inactive")), false);
