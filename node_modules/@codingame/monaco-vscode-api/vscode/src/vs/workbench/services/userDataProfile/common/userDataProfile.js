...
const defaultUserDataProfileIcon = registerIcon('defaultProfile-icon', Codicon.settings, ( localize(14506, 'Icon for Default Profile.')));
const PROFILES_TITLE = ( localize2(14507, 'Profiles'));
const PROFILES_CATEGORY = { ...PROFILES_TITLE };
const PROFILE_EXTENSION = 'code-profile';
const PROFILE_FILTER = [{ name: ( localize(14508, "Profile")), extensions: [PROFILE_EXTENSION] }];
