...
const getStartedWalkthrough = {
    ...
    properties: {
        id: {
            description: ( localize(14191, 'The ID of a Get Started walkthrough to open.')),
            type: 'string'
        },
    }
};
const remoteHelpExtPoint = ExtensionsRegistry.registerExtensionPoint({
    ...
    jsonSchema: {
        description: ( localize(14192, 'Contributes help information for Remote')),
        type: 'object',
        properties: {
            'getStarted': {
            ...
            'feedback': {
                ...
                type: 'string',
                markdownDeprecationMessage: ( localize(14196, "Use {0} instead", '`reportIssue`'))
            },
            'reportIssue': {
                description: ( localize(
                    14197,
