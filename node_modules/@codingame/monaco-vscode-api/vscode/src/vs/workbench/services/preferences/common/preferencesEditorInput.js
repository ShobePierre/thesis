...
const SettingsEditorIcon = registerIcon('settings-editor-label-icon', Codicon.settings, ( localize(14147, 'Icon of the settings editor label.')));
let SettingsEditor2Input = class SettingsEditor2Input extends EditorInput {
    ...
    getName() {
        return localize(14148, "Settings");
    }
    getIcon() {
...
const PreferencesEditorIcon = registerIcon('preferences-editor-label-icon', Codicon.settings, ( localize(14149, 'Icon of the preferences editor label.')));
class PreferencesEditorInput extends EditorInput {
    ...
    getName() {
        return localize(14150, "Preferences");
    }
    getIcon() {
