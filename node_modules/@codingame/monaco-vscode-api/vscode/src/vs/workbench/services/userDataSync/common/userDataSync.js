...
function getSyncAreaLabel(source) {
    switch (source) {
        case SyncResource.Settings: return localize(14539, "Settings");
        case SyncResource.Keybindings: return localize(14540, "Keyboard Shortcuts");
        case SyncResource.Snippets: return localize(14541, "Snippets");
        case SyncResource.Prompts: return localize(14542, "Prompts and Instructions");
        case SyncResource.Tasks: return localize(14543, "Tasks");
        case SyncResource.Mcp: return localize(14544, "MCP Servers");
        case SyncResource.Extensions: return localize(14545, "Extensions");
        case SyncResource.GlobalState: return localize(14546, "UI State");
        case SyncResource.Profiles: return localize(14547, "Profiles");
        case SyncResource.WorkspaceState: return localize(14548, "Workspace State");
    }
}
var AccountStatus;
...
const SYNC_TITLE = ( localize2(14549, "Settings Sync"));
const SYNC_VIEW_ICON = registerIcon('settings-sync-view-icon', Codicon.sync, ( localize(14550, 'View icon of the Settings Sync view.')));
...
const DOWNLOAD_ACTIVITY_ACTION_DESCRIPTOR = {
    ...
    title: ( localize2(14551, "Download Settings Sync Activity")),
