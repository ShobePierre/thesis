...
const extensionVerifiedPublisherIconColor = registerColor('extensionIcon.verifiedForeground', textLinkForeground, ( localize(13925, "The icon color for extension verified publisher.")), false);
