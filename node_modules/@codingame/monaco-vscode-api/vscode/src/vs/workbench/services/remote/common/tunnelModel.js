...
const forwardedPortsFeaturesEnabled = ( new RawContextKey('forwardedPortsViewEnabled', false, ( localize(14199, "Whether the Ports view is enabled."))));
const forwardedPortsViewEnabled = ( new RawContextKey('forwardedPortsViewOnlyEnabled', false, ( localize(14199, "Whether the Ports view is enabled."))));
...
const UserTunnelSource = {
    ...
    description: ( localize(14200, "User Forwarded"))
};
const AutoTunnelSource = {
    source: TunnelSource.Auto,
    description: ( localize(14201, "Auto Forwarded"))
};
            ...
            for (const tunnel of tunnels) {
                ...
                this.detected.set(makeAddress(tunnel.remoteAddress.host, tunnel.remoteAddress.port), {
                    ...
                    source: {
                        ...
                        description: ( localize(14203, "Statically Forwarded"))
                    }
                });
