...
const KeybindingsEditorIcon = registerIcon('keybindings-editor-label-icon', Codicon.keyboard, ( localize(14135, 'Icon of the keybindings editor label.')));
let KeybindingsEditorInput = class KeybindingsEditorInput extends EditorInput {
    ...
    getName() {
        return localize(14136, "Keyboard Shortcuts");
    }
    getIcon() {
