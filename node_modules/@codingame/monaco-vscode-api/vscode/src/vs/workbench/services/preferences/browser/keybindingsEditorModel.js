...
const SOURCE_SYSTEM = ( localize(14137, "System"));
const SOURCE_EXTENSION = ( localize(14138, "Extension"));
const SOURCE_USER = ( localize(14139, "User"));
    ...
    static getCommandDefaultLabel(menuCommand) {
        if (!Language.isDefaultVariant()) {
            if (menuCommand && menuCommand.title && menuCommand.title.original) {
                ...
                return category ? ( localize(14140, "{0}: {1}", category, title)) : title;
            }
        }
        return null;
    }
...
class KeybindingItemMatches {
    ...
    wordMatchesAltModifier(word) {
        ...
        if (equalsIgnoreCase(( localize(14141, "option")), word)) {
            return true;
        }
        return false;
    }
    ...
    wordMatchesMetaModifier(word) {
        ...
        if (equalsIgnoreCase(( localize(14142, "meta")), word)) {
            return true;
        }
        return false;
    }
