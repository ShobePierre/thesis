...
import { PaneComposite, PaneCompositeDescriptor, Extensions } from '../../../browser/panecomposite.js';
...
let ViewsService = class ViewsService extends Disposable {
    ...
    getFocusedViewName() {
        const textEditorFocused = this.editorService.activeTextEditorControl?.hasTextFocus() ? ( localize(14557, "Text Editor")) : undefined;
                    ...
                    super({
                        ...
                        get title() {
                            ...
                            if (viewContainerLocation === ViewContainerLocation.Sidebar) {
                                return { value: ( localize(14558, "Show {0}", localizedTitle)), original: `Show ${originalTitle}` };
                            }
                            else {
                                return { value: ( localize(14559, "Toggle {0}", localizedTitle)), original: `Toggle ${originalTitle}` };
                            }
                        },
        ...
        disposables.add(registerAction2(class OpenViewAction extends Action2 {
            constructor() {
                super({
                    ...
                    metadata: {
                        description: ( localize(14560, "Opens view {0}", viewDescriptor.name.value)),
                        args: [
                            {
                                name: 'options',
                                schema: {
                                    ...
                                    properties: {
                                        'preserveFocus': {
                                            type: 'boolean',
                                            default: false,
                                            description: ( localize(14561, "Whether to preserve the existing focus when opening the view."))
                                        }
                                    },
                                }
                            }
    ...
    registerFocusViewAction(viewDescriptor, category) {
        return registerAction2(class FocusViewAction extends Action2 {
            constructor() {
                const title = ( localize2(14562, "Focus on {0} View", viewDescriptor.name.value));
                super({
        ...
        return registerAction2(class ResetViewLocationAction extends Action2 {
            constructor() {
                super({
                    ...
                    title: ( localize2(14563, "Reset Location")),
                    menu: [{
