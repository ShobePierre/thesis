...
import { ToolInvocationPresentation, ToolDataSource } from '../../contrib/chat/common/languageModelToolsService.js';
...
(function (ChatPrepareToolInvocationPart) {
    ...
    function to(part) {
        return new ChatPrepareToolInvocationPart$1(part.toolName);
    }
