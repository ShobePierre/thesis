...
const editorConfiguration = {
    ...
    properties: {
        ...
        'editor.trimAutoWhitespace': {
            ...
            description: ( localize(217, "Remove trailing auto inserted whitespace."))
        },
        ...
        'editor.wordBasedSuggestions': {
            ...
            enumDescriptions: [
                ( localize(219, 'Turn off Word Based Suggestions.')),
                ( localize(220, 'Only suggest words from the active document.')),
                ( localize(221, 'Suggest words from all open documents of the same language.')),
                ( localize(222, 'Suggest words from all open documents.'))
            ],
            description: ( localize(
                223,
        ...
        'editor.semanticHighlighting.enabled': {
            ...
            enumDescriptions: [
                ( localize(224, 'Semantic highlighting enabled for all color themes.')),
                ( localize(225, 'Semantic highlighting disabled for all color themes.')),
                ( localize(
                226,
        ...
        'editor.language.brackets': {
            ...
            items: {
                ...
                items: [
                    {
                        type: 'string',
                        description: ( localize(239, 'The opening bracket character or string sequence.'))
                    },
                    {
                        type: 'string',
                        description: ( localize(240, 'The closing bracket character or string sequence.'))
                    }
                ]
            }
        },
        ...
        'diffEditor.codeLens': {
            ...
            description: ( localize(251, "Controls whether the editor shows CodeLens."))
        },
        'diffEditor.wordWrap': {
            type: 'string',
            enum: ['off', 'on', 'inherit'],
            ...
            markdownEnumDescriptions: [
                ( localize(252, "Lines will never wrap.")),
                ( localize(253, "Lines will wrap at the viewport width.")),
                ( localize(
                254,
        ...
        'diffEditor.diffAlgorithm': {
            ...
            markdownEnumDescriptions: [
                ( localize(255, "Uses the legacy diffing algorithm.")),
                ( localize(256, "Uses the advanced diffing algorithm.")),
            ]
        },
        'diffEditor.hideUnchangedRegions.enabled': {
            type: 'boolean',
            default: diffEditorDefaultOptions.hideUnchangedRegions.enabled,
            markdownDescription: ( localize(257, "Controls whether the diff editor shows unchanged regions.")),
        },
        'diffEditor.hideUnchangedRegions.revealLineCount': {
            type: 'integer',
            default: diffEditorDefaultOptions.hideUnchangedRegions.revealLineCount,
            markdownDescription: ( localize(258, "Controls how many lines are used for unchanged regions.")),
            minimum: 1,
        },
        ...
        'diffEditor.experimental.showMoves': {
            ...
            markdownDescription: ( localize(261, "Controls whether the diff editor should show detected code moves."))
        },
