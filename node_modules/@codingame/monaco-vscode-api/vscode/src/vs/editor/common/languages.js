...
(function (CompletionItemKinds) {
    ...
    function toLabel(kind) {
        switch (kind) {
            case CompletionItemKind.Method: return localize(795, 'Method');
            case CompletionItemKind.Function: return localize(796, 'Function');
            case CompletionItemKind.Constructor: return localize(797, 'Constructor');
            case CompletionItemKind.Field: return localize(798, 'Field');
            case CompletionItemKind.Variable: return localize(799, 'Variable');
            case CompletionItemKind.Class: return localize(800, 'Class');
            case CompletionItemKind.Struct: return localize(801, 'Struct');
            case CompletionItemKind.Interface: return localize(802, 'Interface');
            case CompletionItemKind.Module: return localize(803, 'Module');
            case CompletionItemKind.Property: return localize(804, 'Property');
            case CompletionItemKind.Event: return localize(805, 'Event');
            case CompletionItemKind.Operator: return localize(806, 'Operator');
            case CompletionItemKind.Unit: return localize(807, 'Unit');
            case CompletionItemKind.Value: return localize(808, 'Value');
            case CompletionItemKind.Constant: return localize(809, 'Constant');
            case CompletionItemKind.Enum: return localize(810, 'Enum');
            case CompletionItemKind.EnumMember: return localize(811, 'Enum Member');
            case CompletionItemKind.Keyword: return localize(812, 'Keyword');
            case CompletionItemKind.Text: return localize(813, 'Text');
            case CompletionItemKind.Color: return localize(814, 'Color');
            case CompletionItemKind.File: return localize(815, 'File');
            case CompletionItemKind.Reference: return localize(816, 'Reference');
            case CompletionItemKind.Customcolor: return localize(817, 'Custom Color');
            case CompletionItemKind.Folder: return localize(818, 'Folder');
            case CompletionItemKind.TypeParameter: return localize(819, 'Type Parameter');
            case CompletionItemKind.User: return localize(820, 'User');
            case CompletionItemKind.Issue: return localize(821, 'Issue');
            case CompletionItemKind.Tool: return localize(822, 'Tool');
            case CompletionItemKind.Snippet: return localize(823, 'Snippet');
            default: return '';
        }
    }
...
const symbolKindNames = {
    [SymbolKind.Array]: ( localize(824, "array")),
    [SymbolKind.Boolean]: ( localize(825, "boolean")),
    [SymbolKind.Class]: ( localize(826, "class")),
    [SymbolKind.Constant]: ( localize(827, "constant")),
    [SymbolKind.Constructor]: ( localize(828, "constructor")),
    [SymbolKind.Enum]: ( localize(829, "enumeration")),
    [SymbolKind.EnumMember]: ( localize(830, "enumeration member")),
    [SymbolKind.Event]: ( localize(831, "event")),
    [SymbolKind.Field]: ( localize(832, "field")),
    [SymbolKind.File]: ( localize(833, "file")),
    [SymbolKind.Function]: ( localize(834, "function")),
    [SymbolKind.Interface]: ( localize(835, "interface")),
    [SymbolKind.Key]: ( localize(836, "key")),
    [SymbolKind.Method]: ( localize(837, "method")),
    [SymbolKind.Module]: ( localize(838, "module")),
    [SymbolKind.Namespace]: ( localize(839, "namespace")),
    [SymbolKind.Null]: ( localize(840, "null")),
    [SymbolKind.Number]: ( localize(841, "number")),
    [SymbolKind.Object]: ( localize(842, "object")),
    [SymbolKind.Operator]: ( localize(843, "operator")),
    [SymbolKind.Package]: ( localize(844, "package")),
    [SymbolKind.Property]: ( localize(845, "property")),
    [SymbolKind.String]: ( localize(846, "string")),
    [SymbolKind.Struct]: ( localize(847, "struct")),
    [SymbolKind.TypeParameter]: ( localize(848, "type parameter")),
    [SymbolKind.Variable]: ( localize(849, "variable")),
};
function getAriaLabelForSymbol(symbolName, kind) {
    return localize(850, '{0} ({1})', symbolName, symbolKindNames[kind]);
}
var SymbolTag;
(function (SymbolTag) {
