        ...
        super(EditorOption.hover, 'hover', defaults, {
            'editor.hover.enabled': {
                ...
                markdownEnumDescriptions: [
                    ( localize(313, "Hover is enabled.")),
                    ( localize(314, "Hover is disabled.")),
                    ( localize(
                    315,
                ...
                description: ( localize(316, "Controls whether the hover is shown."))
            },
            'editor.hover.delay': {
                type: 'number',
                ...
                minimum: 0,
                maximum: 10000,
                description: ( localize(317, "Controls the delay in milliseconds after which the hover is shown."))
            },
            'editor.hover.sticky': {
                type: 'boolean',
            ...
            'editor.hover.above': {
                ...
                description: ( localize(320, "Prefer showing hovers above the line, if there's space."))
            },
        });
    }
    validate(_input) {
    ...
    constructor() {
        ...
        super(EditorOption.lightbulb, 'lightbulb', defaults, {
            'editor.lightbulb.enabled': {
                ...
                default: defaults.enabled,
                enumDescriptions: [
                    ( localize(324, 'Disable the code action menu.')),
                    ( localize(325, 'Show the code action menu when the cursor is on lines with code.')),
                    ( localize(
                    326,
                    'Show the code action menu when the cursor is on lines with code or on empty lines.'
                )),
                ],
                description: ( localize(327, "Enables the Code Action lightbulb in the editor."))
            }
        });
    }
    validate(_input) {
    ...
    constructor() {
        ...
        super(EditorOption.stickyScroll, 'stickyScroll', defaults, {
            ...
            'editor.stickyScroll.maxLineCount': {
                ...
                minimum: 1,
                maximum: 20,
                description: ( localize(329, "Defines the maximum number of sticky lines to show."))
            },
    ...
    constructor() {
        ...
        super(EditorOption.inlayHints, 'inlayHints', defaults, {
            'editor.inlayHints.enabled': {
                type: 'string',
                default: defaults.enabled,
                description: ( localize(332, "Enables the inlay hints in the editor.")),
                enum: ['on', 'onUnlessPressed', 'offUnlessPressed', 'off'],
                markdownEnumDescriptions: [
                    ( localize(333, "Inlay hints are enabled")),
                    ( localize(
                    334,
                    ...
                    ( localize(336, "Inlay hints are disabled")),
                ],
            },
            ...
            'editor.inlayHints.padding': {
                ...
                description: ( localize(339, "Enables the padding around the inlay hints in the editor."))
            },
    ...
    constructor() {
        ...
        super(EditorOption.minimap, 'minimap', defaults, {
            'editor.minimap.enabled': {
                type: 'boolean',
                default: defaults.enabled,
                description: ( localize(342, "Controls whether the minimap is shown."))
            },
            'editor.minimap.autohide': {
                type: 'string',
                enum: ['none', 'mouseover', 'scroll'],
                enumDescriptions: [
                    ( localize(343, "The minimap is always shown.")),
                    ( localize(
                    344,
                    "The minimap is hidden when mouse is not over the minimap and shown when mouse is over the minimap."
                )),
                    ( localize(345, "The minimap is only shown when the editor is scrolled")),
                ],
                default: defaults.autohide,
                description: ( localize(346, "Controls whether the minimap is hidden automatically."))
            },
            'editor.minimap.size': {
                type: 'string',
                ...
                description: ( localize(350, "Controls the size of the minimap."))
            },
            'editor.minimap.side': {
                type: 'string',
                enum: ['left', 'right'],
                default: defaults.side,
                description: ( localize(351, "Controls the side where to render the minimap."))
            },
            'editor.minimap.showSlider': {
                type: 'string',
                enum: ['always', 'mouseover'],
                default: defaults.showSlider,
                description: ( localize(352, "Controls when the minimap slider is shown."))
            },
            'editor.minimap.scale': {
                ...
                maximum: 3,
                enum: [1, 2, 3],
                description: ( localize(353, "Scale of content drawn in the minimap: 1, 2 or 3."))
            },
            'editor.minimap.renderCharacters': {
                type: 'boolean',
                default: defaults.renderCharacters,
                description: ( localize(354, "Render the actual characters on a line as opposed to color blocks."))
            },
            ...
            'editor.minimap.sectionHeaderFontSize': {
                ...
                description: ( localize(359, "Controls the font size of section headers in the minimap."))
            },
    ...
    constructor() {
        ...
        const types = [
            { type: 'boolean' },
            {
                type: 'string',
                enum: ['on', 'inline', 'off'],
                enumDescriptions: [( localize(365, "Quick suggestions show inside the suggest widget")), ( localize(366, "Quick suggestions show as ghost text")), ( localize(367, "Quick suggestions are disabled"))]
            }
        ];
        super(EditorOption.quickSuggestions, 'quickSuggestions', defaults, {
            ...
            properties: {
                strings: {
                    ...
                    description: ( localize(368, "Enable quick suggestions inside strings."))
                },
                comments: {
                    anyOf: types,
                    default: defaults.comments,
                    description: ( localize(369, "Enable quick suggestions inside comments."))
                },
                other: {
                    anyOf: types,
                    default: defaults.other,
                    description: ( localize(370, "Enable quick suggestions outside of strings and comments."))
                },
            },
            default: defaults,
            markdownDescription: ( localize(
...
class EditorRenderLineNumbersOption extends BaseEditorOption {
    constructor() {
        super(EditorOption.lineNumbers, 'lineNumbers', { renderType: RenderLineNumbersType.On, renderFn: null }, {
            ...
            enumDescriptions: [
                ( localize(372, "Line numbers are not rendered.")),
                ( localize(373, "Line numbers are rendered as absolute number.")),
                ( localize(374, "Line numbers are rendered as distance in lines to cursor position.")),
                ( localize(375, "Line numbers are rendered every 10 lines."))
            ],
            default: 'on',
            description: ( localize(376, "Controls the display of line numbers."))
        });
    }
                ...
                anyOf: [
                    columnSchema,
                    {
                        ...
                        properties: {
                            ...
                            color: {
                                type: 'string',
                                description: ( localize(378, "Color of this editor ruler.")),
                                format: 'color-hex'
                            }
                        }
                    }
    ...
    constructor() {
        ...
        super(EditorOption.scrollbar, 'scrollbar', defaults, {
            'editor.scrollbar.vertical': {
                ...
                enumDescriptions: [
                    ( localize(380, "The vertical scrollbar will be visible only when necessary.")),
                    ( localize(381, "The vertical scrollbar will always be visible.")),
                    ( localize(382, "The vertical scrollbar will always be hidden.")),
                ],
                default: 'auto',
                description: ( localize(383, "Controls the visibility of the vertical scrollbar."))
            },
            'editor.scrollbar.horizontal': {
                type: 'string',
                enum: ['auto', 'visible', 'hidden'],
                enumDescriptions: [
                    ( localize(384, "The horizontal scrollbar will be visible only when necessary.")),
                    ( localize(385, "The horizontal scrollbar will always be visible.")),
                    ( localize(386, "The horizontal scrollbar will always be hidden.")),
                ],
                default: 'auto',
                description: ( localize(387, "Controls the visibility of the horizontal scrollbar."))
            },
            'editor.scrollbar.verticalScrollbarSize': {
                type: 'number',
                default: defaults.verticalScrollbarSize,
                description: ( localize(388, "The width of the vertical scrollbar."))
            },
            'editor.scrollbar.horizontalScrollbarSize': {
                type: 'number',
                default: defaults.horizontalScrollbarSize,
                description: ( localize(389, "The height of the horizontal scrollbar."))
            },
            'editor.scrollbar.scrollByPage': {
                type: 'boolean',
                default: defaults.scrollByPage,
                description: ( localize(390, "Controls whether clicks scroll by page or jump to click position."))
            },
    ...
    constructor() {
        ...
        super(EditorOption.unicodeHighlighting, 'unicodeHighlight', defaults, {
            ...
            [unicodeHighlightConfigKeys.allowedCharacters]: {
                ...
                description: ( localize(397, "Defines allowed characters that are not being highlighted.")),
        ...
        super(EditorOption.inlineSuggest, 'inlineSuggest', defaults, {
            ...
            'editor.inlineSuggest.showToolbar': {
                ...
                enumDescriptions: [
                    ...
                    ( localize(402, "Never show the inline suggestion toolbar.")),
                ],
                description: ( localize(403, "Controls when to show the inline suggestion toolbar.")),
            },
            ...
            'editor.inlineSuggest.fontFamily': {
                type: 'string',
                default: defaults.fontFamily,
                description: ( localize(412, "Controls the font family of the inline suggestions."))
            },
            ...
            'editor.inlineSuggest.edits.showLongDistanceHint': {
                ...
                description: ( localize(414, "Controls whether long distance inline suggestions are shown.")),
                tags: ['nextEditSuggestions', 'experimental']
            },
            'editor.inlineSuggest.edits.renderSideBySide': {
                type: 'string',
                default: defaults.edits.renderSideBySide,
                description: ( localize(415, "Controls whether larger suggestions can be shown side by side.")),
                enum: ['auto', 'never'],
                enumDescriptions: [
                    ( localize(
                    416,
    ...
    constructor() {
        ...
        super(EditorOption.guides, 'guides', defaults, {
            'editor.guides.bracketPairs': {
                ...
                enumDescriptions: [
                    ( localize(421, "Enables bracket pair guides.")),
                    ( localize(422, "Enables bracket pair guides only for the active bracket pair.")),
                    ( localize(423, "Disables bracket pair guides.")),
                ],
                default: defaults.bracketPairs,
                description: ( localize(424, "Controls whether bracket pair guides are enabled or not."))
            },
            'editor.guides.bracketPairsHorizontal': {
                ...
                enumDescriptions: [
                    ...
                    ( localize(426, "Enables horizontal guides only for the active bracket pair.")),
                    ( localize(427, "Disables horizontal bracket pair guides.")),
                ],
                default: defaults.bracketPairsHorizontal,
                description: ( localize(428, "Controls whether horizontal bracket pair guides are enabled or not."))
            },
            ...
            'editor.guides.indentation': {
                ...
                description: ( localize(430, "Controls whether the editor should render indent guides."))
            },
            'editor.guides.highlightActiveIndentation': {
                type: ['boolean', 'string'],
                enum: [true, 'always', false],
                enumDescriptions: [
                    ( localize(431, "Highlights the active indent guide.")),
                    ( localize(
                    432,
                    "Highlights the active indent guide even if bracket guides are highlighted."
                )),
                    ( localize(433, "Do not highlight the active indent guide.")),
                ],
    ...
    constructor() {
        ...
        super(EditorOption.suggest, 'suggest', defaults, {
            'editor.suggest.insertMode': {
                ...
                enum: ['insert', 'replace'],
                enumDescriptions: [
                    ( localize(435, "Insert suggestion without overwriting text right of the cursor.")),
                    ( localize(436, "Insert suggestion and overwrite text right of the cursor.")),
                ],
            ...
            'editor.suggest.selectionMode': {
                ...
                enumDescriptions: [
                    ...
                    ( localize(444, "Select a suggestion only when triggering IntelliSense as you type.")),
                ],
            ...
            'editor.suggest.snippetsPreventQuickSuggestions': {
                ...
                description: ( localize(446, "Controls whether an active snippet prevents quick suggestions."))
            },
            'editor.suggest.showIcons': {
                type: 'boolean',
                default: defaults.showIcons,
                description: ( localize(447, "Controls whether to show or hide icons in suggestions."))
            },
            ...
            'editor.suggest.preview': {
                ...
                description: ( localize(449, "Controls whether to preview the suggestion outcome in the editor."))
            },
            ...
            'editor.suggest.maxVisibleSuggestions': {
                type: 'number',
                deprecationMessage: ( localize(451, "This setting is deprecated. The suggest widget can now be resized.")),
            },
            ...
            'editor.suggest.showMethods': {
                type: 'boolean',
                default: true,
                markdownDescription: ( localize(453, "When enabled IntelliSense shows `method`-suggestions."))
            },
            'editor.suggest.showFunctions': {
                type: 'boolean',
                default: true,
                markdownDescription: ( localize(454, "When enabled IntelliSense shows `function`-suggestions."))
            },
            'editor.suggest.showConstructors': {
                type: 'boolean',
                default: true,
                markdownDescription: ( localize(455, "When enabled IntelliSense shows `constructor`-suggestions."))
            },
            'editor.suggest.showDeprecated': {
                type: 'boolean',
                default: true,
                markdownDescription: ( localize(456, "When enabled IntelliSense shows `deprecated`-suggestions."))
            },
            ...
            'editor.suggest.showFields': {
                type: 'boolean',
                default: true,
                markdownDescription: ( localize(458, "When enabled IntelliSense shows `field`-suggestions."))
            },
            'editor.suggest.showVariables': {
                type: 'boolean',
                default: true,
                markdownDescription: ( localize(459, "When enabled IntelliSense shows `variable`-suggestions."))
            },
            'editor.suggest.showClasses': {
                type: 'boolean',
                default: true,
                markdownDescription: ( localize(460, "When enabled IntelliSense shows `class`-suggestions."))
            },
            'editor.suggest.showStructs': {
                type: 'boolean',
                default: true,
                markdownDescription: ( localize(461, "When enabled IntelliSense shows `struct`-suggestions."))
            },
            'editor.suggest.showInterfaces': {
                type: 'boolean',
                default: true,
                markdownDescription: ( localize(462, "When enabled IntelliSense shows `interface`-suggestions."))
            },
            'editor.suggest.showModules': {
                type: 'boolean',
                default: true,
                markdownDescription: ( localize(463, "When enabled IntelliSense shows `module`-suggestions."))
            },
            'editor.suggest.showProperties': {
                type: 'boolean',
                default: true,
                markdownDescription: ( localize(464, "When enabled IntelliSense shows `property`-suggestions."))
            },
            'editor.suggest.showEvents': {
                type: 'boolean',
                default: true,
                markdownDescription: ( localize(465, "When enabled IntelliSense shows `event`-suggestions."))
            },
            'editor.suggest.showOperators': {
                type: 'boolean',
                default: true,
                markdownDescription: ( localize(466, "When enabled IntelliSense shows `operator`-suggestions."))
            },
            'editor.suggest.showUnits': {
                type: 'boolean',
                default: true,
                markdownDescription: ( localize(467, "When enabled IntelliSense shows `unit`-suggestions."))
            },
            'editor.suggest.showValues': {
                type: 'boolean',
                default: true,
                markdownDescription: ( localize(468, "When enabled IntelliSense shows `value`-suggestions."))
            },
            'editor.suggest.showConstants': {
                type: 'boolean',
                default: true,
                markdownDescription: ( localize(469, "When enabled IntelliSense shows `constant`-suggestions."))
            },
            'editor.suggest.showEnums': {
                type: 'boolean',
                default: true,
                markdownDescription: ( localize(470, "When enabled IntelliSense shows `enum`-suggestions."))
            },
            'editor.suggest.showEnumMembers': {
                type: 'boolean',
                default: true,
                markdownDescription: ( localize(471, "When enabled IntelliSense shows `enumMember`-suggestions."))
            },
            'editor.suggest.showKeywords': {
                type: 'boolean',
                default: true,
                markdownDescription: ( localize(472, "When enabled IntelliSense shows `keyword`-suggestions."))
            },
            'editor.suggest.showWords': {
                type: 'boolean',
                default: true,
                markdownDescription: ( localize(473, "When enabled IntelliSense shows `text`-suggestions."))
            },
            'editor.suggest.showColors': {
                type: 'boolean',
                default: true,
                markdownDescription: ( localize(474, "When enabled IntelliSense shows `color`-suggestions."))
            },
            'editor.suggest.showFiles': {
                type: 'boolean',
                default: true,
                markdownDescription: ( localize(475, "When enabled IntelliSense shows `file`-suggestions."))
            },
            'editor.suggest.showReferences': {
                type: 'boolean',
                default: true,
                markdownDescription: ( localize(476, "When enabled IntelliSense shows `reference`-suggestions."))
            },
            'editor.suggest.showCustomcolors': {
                type: 'boolean',
                default: true,
                markdownDescription: ( localize(477, "When enabled IntelliSense shows `customcolor`-suggestions."))
            },
            'editor.suggest.showFolders': {
                type: 'boolean',
                default: true,
                markdownDescription: ( localize(478, "When enabled IntelliSense shows `folder`-suggestions."))
            },
            'editor.suggest.showTypeParameters': {
                type: 'boolean',
                default: true,
                markdownDescription: ( localize(479, "When enabled IntelliSense shows `typeParameter`-suggestions."))
            },
            'editor.suggest.showSnippets': {
                type: 'boolean',
                default: true,
                markdownDescription: ( localize(480, "When enabled IntelliSense shows `snippet`-suggestions."))
            },
            'editor.suggest.showUsers': {
                type: 'boolean',
                default: true,
                markdownDescription: ( localize(481, "When enabled IntelliSense shows `user`-suggestions."))
            },
            'editor.suggest.showIssues': {
                type: 'boolean',
                default: true,
                markdownDescription: ( localize(482, "When enabled IntelliSense shows `issues`-suggestions."))
            }
        });
    }
    validate(_input) {
    ...
    constructor() {
        super(EditorOption.smartSelect, 'smartSelect', {
            ...
            'editor.smartSelect.selectLeadingAndTrailingWhitespace': {
                description: ( localize(483, "Whether leading and trailing whitespace should always be selected.")),
                default: true,
                type: 'boolean'
            },
    ...
    constructor() {
        super(EditorOption.wrappingIndent, 'wrappingIndent', WrappingIndent.Same, {
            'editor.wrappingIndent': {
                ...
                enumDescriptions: [
                    ( localize(486, "No indentation. Wrapped lines begin at column 1.")),
                    ( localize(487, "Wrapped lines get the same indentation as the parent.")),
                    ( localize(488, "Wrapped lines get +1 indentation toward the parent.")),
                    ( localize(489, "Wrapped lines get +2 indentation toward the parent.")),
                ],
                description: ( localize(490, "Controls the indentation of wrapped lines.")),
                default: 'same'
            }
        });
    }
    ...
    constructor() {
        ...
        super(EditorOption.pasteAs, 'pasteAs', defaults, {
            'editor.pasteAs.enabled': {
                type: 'boolean',
                default: defaults.enabled,
                markdownDescription: ( localize(495, "Controls whether you can paste content in different ways.")),
            },
...
const EditorOptions = {
    ...
    allowVariableFonts: register(( new EditorBooleanOption(EditorOption.allowVariableFonts, 'allowVariableFonts', true, {
        description: ( localize(504, "Controls whether to allow using variable fonts in the editor."))
    }))),
    ...
    ariaLabel: register(( new EditorStringOption(EditorOption.ariaLabel, 'ariaLabel', ( localize(506, "Editor content"))))),
    ...
    autoClosingQuotes: register(( new EditorStringEnumOption(
        ...
        ['always', 'languageDefined', 'beforeWhitespace', 'never'],
        {
            enumDescriptions: [
                '',
                ( localize(518, "Use language configurations to determine when to autoclose quotes.")),
                ( localize(519, "Autoclose quotes only when the cursor is to the left of whitespace.")),
                '',
            ],
            description: ( localize(
                520,
    ...
    autoIndent: register(( new EditorEnumOption(
        ...
        {
            enumDescriptions: [
                ( localize(521, "The editor will not insert indentation automatically.")),
                ( localize(522, "The editor will keep the current line's indentation.")),
                ( localize(
                523,
    ...
    autoSurround: register(( new EditorStringEnumOption(
        ...
        ['languageDefined', 'quotes', 'brackets', 'never'],
        {
            enumDescriptions: [
                ...
                ( localize(530, "Surround with quotes but not brackets.")),
                ( localize(531, "Surround with brackets but not quotes.")),
                ''
            ],
            description: ( localize(
                532,
    ...
    codeLens: register(( new EditorBooleanOption(EditorOption.codeLens, 'codeLens', true, { description: ( localize(534, "Controls whether the editor shows CodeLens.")) }))),
    codeLensFontFamily: register(( new EditorStringOption(
        EditorOption.codeLensFontFamily,
        'codeLensFontFamily',
        '',
        { description: ( localize(535, "Controls the font family for CodeLens.")) }
    ))),
    ...
    colorDecoratorActivatedOn: register(( new EditorStringEnumOption(
        ...
        ['clickAndHover', 'hover', 'click'],
        {
            enumDescriptions: [
                ...
                ( localize(539, "Make the color picker appear on hover of the color decorator")),
                ( localize(540, "Make the color picker appear on click of the color decorator"))
            ],
            description: ( localize(
                541,
    ...
    cursorBlinking: register(( new EditorEnumOption(
        ...
        { description: ( localize(545, "Control the cursor animation style.")) }
    ))),
    cursorSmoothCaretAnimation: register(( new EditorStringEnumOption(
        ...
        {
            enumDescriptions: [
                ( localize(546, "Smooth caret animation is disabled.")),
                ( localize(
                547,
                "Smooth caret animation is enabled only when the user moves the cursor with an explicit gesture."
            )),
                ( localize(548, "Smooth caret animation is always enabled."))
            ],
            description: ( localize(549, "Controls whether the smooth caret animation should be enabled."))
        }
    ))),
    cursorStyle: register(( new EditorEnumOption(
        ...
        { description: ( localize(550, "Controls the cursor style in insert input mode.")) }
    ))),
    overtypeCursorStyle: register(( new EditorEnumOption(
        ...
        ['line', 'block', 'underline', 'line-thin', 'block-outline', 'underline-thin'],
        cursorStyleFromString,
        { description: ( localize(551, "Controls the cursor style in overtype input mode.")) }
    ))),
    ...
    cursorSurroundingLinesStyle: register(( new EditorStringEnumOption(
        ...
        ['default', 'all'],
        {
            enumDescriptions: [
                ...
                ( localize(554, "`cursorSurroundingLines` is enforced always."))
            ],
            markdownDescription: ( localize(555, "Controls when `#editor.cursorSurroundingLines#` should be enforced."))
        }
    ))),
    ...
    experimentalGpuAcceleration: register(( new EditorStringEnumOption(
        ...
        ['off', 'on'],
        {
            tags: ['experimental'],
            enumDescriptions: [
                ( localize(561, "Use regular DOM-based rendering.")),
                ( localize(562, "Use GPU acceleration.")),
            ],
            description: ( localize(
                563,
    ...
    experimentalWhitespaceRendering: register(( new EditorStringEnumOption(
        ...
        {
            enumDescriptions: [
                ( localize(564, "Use a new rendering method with svgs.")),
                ( localize(565, "Use a new rendering method with font characters.")),
                ( localize(566, "Use the stable rendering method.")),
            ],
            description: ( localize(
                567,
    ...
    fastScrollSensitivity: register(( new EditorFloatOption(
        ...
        5,
        x => (x <= 0 ? 5 : x),
        { markdownDescription: ( localize(568, "Scrolling speed multiplier when pressing `Alt`.")) }
    ))),
    find: register(( new EditorFind())),
    fixedOverflowWidgets: register(( new EditorBooleanOption(EditorOption.fixedOverflowWidgets, 'fixedOverflowWidgets', false))),
    folding: register(( new EditorBooleanOption(EditorOption.folding, 'folding', true, { description: ( localize(569, "Controls whether the editor has code folding enabled.")) }))),
    foldingStrategy: register(( new EditorStringEnumOption(
        ...
        ['auto', 'indentation'],
        {
            enumDescriptions: [
                ...
                ( localize(571, "Use the indentation-based folding strategy.")),
            ],
            description: ( localize(572, "Controls the strategy for computing folding ranges."))
        }
    ))),
    foldingHighlight: register(( new EditorBooleanOption(
        ...
        'foldingHighlight',
        true,
        { description: ( localize(573, "Controls whether the editor should highlight folded ranges.")) }
    ))),
    foldingImportsByDefault: register(( new EditorBooleanOption(
        EditorOption.foldingImportsByDefault,
        'foldingImportsByDefault',
        false,
        { description: ( localize(574, "Controls whether the editor automatically collapses import ranges.")) }
    ))),
    ...
    fontFamily: register(( new EditorStringOption(
        ...
        { description: ( localize(577, "Controls the font family.")) }
    ))),
    ...
    hideCursorInOverviewRuler: register(( new EditorBooleanOption(
        ...
        false,
        { description: ( localize(581, "Controls whether the cursor should be hidden in the overview ruler.")) }
    ))),
    ...
    inertialScroll: register(( new EditorBooleanOption(
        ...
        'inertialScroll',
        false,
        { description: ( localize(582, "Make scrolling inertial - mostly useful with touchpad on linux.")) }
    ))),
    letterSpacing: register(( new EditorFloatOption(
        ...
        { description: ( localize(583, "Controls the letter spacing in pixels.")) }
    ))),
    ...
    matchBrackets: register(( new EditorStringEnumOption(
        ...
        'always',
        ['always', 'near', 'never'],
        { description: ( localize(586, "Highlight matching brackets.")) }
    ))),
    ...
    multiCursorMergeOverlapping: register(( new EditorBooleanOption(
        ...
        true,
        { description: ( localize(590, "Merge multiple cursors when they are overlapping.")) }
    ))),
    multiCursorModifier: register(( new EditorEnumOption(
        ...
        {
            markdownEnumDescriptions: [
                ( localize(591, "Maps to `Control` on Windows and Linux and to `Command` on macOS.")),
                ( localize(592, "Maps to `Alt` on Windows and Linux and to `Option` on macOS."))
            ],
            markdownDescription: ( localize(
                593,
    ...
    multiCursorPaste: register(( new EditorStringEnumOption(
        ...
        {
            markdownEnumDescriptions: [
                ( localize(595, "Each cursor pastes a single line of the text.")),
                ( localize(596, "Each cursor pastes the full text."))
            ],
            markdownDescription: ( localize(
                597,
    ...
    occurrencesHighlight: register(( new EditorStringEnumOption(
        ...
        {
            markdownEnumDescriptions: [
                ( localize(599, "Does not highlight occurrences.")),
                ( localize(600, "Highlights occurrences only in the current file.")),
                ( localize(601, "Experimental: Highlights occurrences across all valid open files."))
            ],
            markdownDescription: ( localize(
                602,
    ...
    overtypeOnPaste: register(( new EditorBooleanOption(
        ...
        'overtypeOnPaste',
        true,
        { description: ( localize(604, "Controls whether pasting should overtype.")) }
    ))),
    ...
    peekWidgetDefaultFocus: register(( new EditorStringEnumOption(
        ...
        {
            enumDescriptions: [
                ( localize(606, "Focus the tree when opening peek")),
                ( localize(607, "Focus the editor when opening peek"))
            ],
            description: ( localize(
                608,
    ...
    renameOnType: register(( new EditorBooleanOption(
        ...
        'renameOnType',
        false,
        { description: ( localize(611, "Controls whether the editor auto renames on type.")), markdownDeprecationMessage: ( localize(612, "Deprecated, use `#editor.linkedEditing#` instead.")) }
    ))),
    renderControlCharacters: register(( new EditorBooleanOption(
        EditorOption.renderControlCharacters,
        'renderControlCharacters',
        true,
        { description: ( localize(613, "Controls whether the editor should render control characters.")), restricted: true }
    ))),
    renderFinalNewline: register(( new EditorStringEnumOption(
        ...
        (isLinux ? 'dimmed' : 'on'),
        ['off', 'on', 'dimmed'],
        { description: ( localize(614, "Render last line number when the file ends with a newline.")) }
    ))),
    renderLineHighlight: register(( new EditorStringEnumOption(
        ...
        ['none', 'gutter', 'line', 'all'],
        {
            enumDescriptions: [
                ...
                '',
                '',
                ( localize(615, "Highlights both the gutter and the current line.")),
            ],
            description: ( localize(616, "Controls how the editor should render the current line highlight."))
        }
    ))),
    ...
    renderWhitespace: register(( new EditorStringEnumOption(
        ...
        ['none', 'boundary', 'selection', 'trailing', 'all'],
        {
            enumDescriptions: [
                ...
                ( localize(619, "Render whitespace characters only on selected text.")),
                ( localize(620, "Render only trailing whitespace characters.")),
                ''
            ],
            description: ( localize(621, "Controls how the editor should render whitespace characters."))
        }
    ))),
    ...
    roundedSelection: register(( new EditorBooleanOption(
        ...
        'roundedSelection',
        true,
        { description: ( localize(622, "Controls whether selections should have rounded corners.")) }
    ))),
    ...
    scrollBeyondLastLine: register(( new EditorBooleanOption(
        ...
        true,
        { description: ( localize(624, "Controls whether the editor will scroll beyond the last line.")) }
    ))),
    ...
    selectionClipboard: register(( new EditorBooleanOption(EditorOption.selectionClipboard, 'selectionClipboard', true, {
        description: ( localize(627, "Controls whether the Linux primary clipboard should be supported.")),
        included: isLinux
    }))),
    ...
    showFoldingControls: register(( new EditorStringEnumOption(
        ...
        {
            enumDescriptions: [
                ( localize(631, "Always show the folding controls.")),
                ( localize(632, "Never show the folding controls and reduce the gutter size.")),
                ( localize(633, "Only show the folding controls when the mouse is over the gutter.")),
            ],
            description: ( localize(634, "Controls when the folding controls on the gutter are shown."))
        }
    ))),
    showUnused: register(( new EditorBooleanOption(EditorOption.showUnused, 'showUnused', true, { description: ( localize(635, "Controls fading out of unused code.")) }))),
    showDeprecated: register(( new EditorBooleanOption(
        EditorOption.showDeprecated,
        'showDeprecated',
        true,
        { description: ( localize(636, "Controls strikethrough deprecated variables.")) }
    ))),
    ...
    snippetSuggestions: register(( new EditorStringEnumOption(
        ...
        {
            enumDescriptions: [
                ( localize(637, "Show snippet suggestions on top of other suggestions.")),
                ( localize(638, "Show snippet suggestions below other suggestions.")),
                ( localize(639, "Show snippets suggestions with other suggestions.")),
                ( localize(640, "Do not show snippet suggestions.")),
            ],
            description: ( localize(
                641,
    ...
    smoothScrolling: register(( new EditorBooleanOption(
        ...
        'smoothScrolling',
        false,
        { description: ( localize(642, "Controls whether the editor will scroll using an animation.")) }
    ))),
    ...
    suggestSelection: register(( new EditorStringEnumOption(
        ...
        {
            markdownEnumDescriptions: [
                ( localize(647, "Always select the first suggestion.")),
                ( localize(
                648,
    ...
    tabCompletion: register(( new EditorStringEnumOption(
        ...
        ['on', 'off', 'onlySnippets'],
        {
            enumDescriptions: [
                ...
                ( localize(652, "Disable tab completions.")),
                ( localize(
                653,
                "Tab complete snippets when their prefix match. Works best when 'quickSuggestions' aren't enabled."
            )),
            ],
            description: ( localize(654, "Enables tab completions."))
        }
    ))),
    ...
    unusualLineTerminators: register(( new EditorStringEnumOption(
        ...
        {
            enumDescriptions: [
                ( localize(656, "Unusual line terminators are automatically removed.")),
                ( localize(657, "Unusual line terminators are ignored.")),
                ( localize(658, "Unusual line terminators prompt to be removed.")),
            ],
            description: ( localize(659, "Remove unusual line terminators that might cause problems."))
        }
    ))),
    ...
    wordBreak: register(( new EditorStringEnumOption(EditorOption.wordBreak, 'wordBreak', 'normal', ['normal', 'keepAll'], {
        markdownEnumDescriptions: [
            ( localize(661, "Use the default line break rule.")),
            ( localize(
            662,
    ...
    wordWrap: register(( new EditorStringEnumOption(
        ...
        {
            markdownEnumDescriptions: [
                ( localize(665, "Lines will never wrap.")),
                ( localize(666, "Lines will wrap at the viewport width.")),
                ( localize(667, "Lines will wrap at `#editor.wordWrapColumn#`.")),
                ( localize(
                668,
                "Lines will wrap at the minimum of viewport and `#editor.wordWrapColumn#`."
            )),
            ],
            description: ( localize(669, "Controls how lines should wrap."))
        }
    ))),
    ...
    defaultColorDecorators: register(( new EditorStringEnumOption(
        ...
        ['auto', 'always', 'never'],
        {
            enumDescriptions: [
                ...
                ( localize(673, "Always show default color decorators.")),
                ( localize(674, "Never show default color decorators.")),
            ],
            description: ( localize(
                675,
