    ...
    replaceAll() {
        if (this._model) {
            if (this._editor.getModel()?.isTooLargeForHeapOperation()) {
                this._notificationService.warn(( localize(1037, "The file is too large to perform a replace all operation.")));
                return false;
            }
...
class StartFindWithArgsAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1040, "Find with Arguments")),
...
class StartFindWithSelectionAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1041, "Find with Selection")),
            precondition: undefined,
            kbOpts: {
                kbExpr: null,
                primary: 0,
...
const NextMatchFindAction = registerMultiEditorAction(( new MultiEditorAction({
    ...
    label: ( localize2(1042, "Find Next")),
    precondition: undefined,
    kbOpts: [{
...
const PreviousMatchFindAction = registerMultiEditorAction(( new MultiEditorAction({
    ...
    label: ( localize2(1043, "Find Previous")),
    precondition: undefined,
    kbOpts: [{
            kbExpr: EditorContextKeys.focus,
...
class MoveToMatchFindAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1044, "Go to Match...")),
    ...
    run(accessor, editor) {
        ...
        if (matchesCount < 1) {
            ...
            notificationService.notify({
                ...
                message: ( localize(1045, "No matches. Try searching for something else."))
            });
            return;
        }
...
class NextSelectionMatchFindAction extends SelectionMatchFindAction {
    constructor() {
        super({
            ...
            label: ( localize2(1048, "Find Next Selection")),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.focus,
...
class PreviousSelectionMatchFindAction extends SelectionMatchFindAction {
    constructor() {
        super({
            ...
            label: ( localize2(1049, "Find Previous Selection")),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.focus,
