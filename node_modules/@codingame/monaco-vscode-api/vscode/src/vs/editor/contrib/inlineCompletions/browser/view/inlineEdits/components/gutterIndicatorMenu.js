...
let GutterIndicatorMenuContent = class GutterIndicatorMenuContent {
    ...
    _createHoverContent() {
        ...
        const gotoAndAccept = option(createOptionArgs({
            id: 'gotoAndAccept',
            title: `${( localize(1312, "Go To"))} / ${( localize(1313, "Accept"))}`,
            icon: Codicon.check,
            commandId: inlineSuggestCommitId,
        }));
        const reject = option(createOptionArgs({
            id: 'reject',
            title: ( localize(1314, "Reject")),
            icon: Codicon.close,
        ...
        }))), { hoverDelegate: nativeHoverDelegate  }) : undefined;
        return hoverContent([
            title,
            gotoAndAccept,
            alternativeCommand,
