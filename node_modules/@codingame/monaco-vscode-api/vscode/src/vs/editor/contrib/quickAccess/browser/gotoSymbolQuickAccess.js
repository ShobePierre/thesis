...
let AbstractGotoSymbolQuickAccessProvider = class AbstractGotoSymbolQuickAccessProvider extends AbstractEditorNavigationQuickAccessProvider {
    ...
    doProvideWithoutEditorSymbols(context, model, picker, token) {
        ...
        this.provideLabelPick(picker, ( localize(1446, "The active text editor does not provide symbol information.")));
        (async () => {
            ...
            try {
                ...
                if (items.length > 0) {
                    ...
                    if (query.original.length > 0) {
                        this.provideLabelPick(picker, ( localize(1447, "No matching editor symbols")));
                    }
                    else {
                        this.provideLabelPick(picker, ( localize(1448, "No editor symbols")));
                    }
                }
            }
            finally {
    ...
    async doGetSymbolPicks(symbolsPromise, query, options, token, model) {
        ...
        if (openSideBySideDirection) {
            buttons = [{
                    ...
                    tooltip: openSideBySideDirection === 'right' ? ( localize(1449, "Open to the Side")) : ( localize(1450, "Open to the Bottom"))
                }];
        }
        ...
        if (filterBySymbolKind) {
            ...
            symbolPicks = [
                { label: ( localize(1451, "symbols ({0})", filteredSymbolPicks.length)), type: 'separator' },
...
const FALLBACK_NLS_SYMBOL_KIND = ( localize(1452, "properties ({0})"));
const NLS_SYMBOL_KIND_CACHE = {
    [SymbolKind.Method]: ( localize(1453, "methods ({0})")),
    [SymbolKind.Function]: ( localize(1454, "functions ({0})")),
    [SymbolKind.Constructor]: ( localize(1455, "constructors ({0})")),
    [SymbolKind.Variable]: ( localize(1456, "variables ({0})")),
    [SymbolKind.Class]: ( localize(1457, "classes ({0})")),
    [SymbolKind.Struct]: ( localize(1458, "structs ({0})")),
    [SymbolKind.Event]: ( localize(1459, "events ({0})")),
    [SymbolKind.Operator]: ( localize(1460, "operators ({0})")),
    [SymbolKind.Interface]: ( localize(1461, "interfaces ({0})")),
    [SymbolKind.Namespace]: ( localize(1462, "namespaces ({0})")),
    [SymbolKind.Package]: ( localize(1463, "packages ({0})")),
    [SymbolKind.TypeParameter]: ( localize(1464, "type parameters ({0})")),
    [SymbolKind.Module]: ( localize(1465, "modules ({0})")),
    [SymbolKind.Property]: ( localize(1452, "properties ({0})")),
    [SymbolKind.Enum]: ( localize(1466, "enumerations ({0})")),
    [SymbolKind.EnumMember]: ( localize(1467, "enumeration members ({0})")),
    [SymbolKind.String]: ( localize(1468, "strings ({0})")),
    [SymbolKind.File]: ( localize(1469, "files ({0})")),
    [SymbolKind.Array]: ( localize(1470, "arrays ({0})")),
    [SymbolKind.Number]: ( localize(1471, "numbers ({0})")),
    [SymbolKind.Boolean]: ( localize(1472, "booleans ({0})")),
    [SymbolKind.Object]: ( localize(1473, "objects ({0})")),
    [SymbolKind.Key]: ( localize(1474, "keys ({0})")),
    [SymbolKind.Field]: ( localize(1475, "fields ({0})")),
    [SymbolKind.Constant]: ( localize(1476, "constants ({0})"))
};
