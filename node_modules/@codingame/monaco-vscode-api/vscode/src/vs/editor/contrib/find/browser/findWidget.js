...
import { createElement, trackFocus, getTotalWidth, createTextNode, getDomNodePagePosition, getTopLeftOffset, getComputedStyle } from '../../../../base/browser/dom.js';
...
const findCollapsedIcon = registerIcon('find-collapsed', Codicon.chevronRight, ( localize(1052, 'Icon to indicate that the editor find widget is collapsed.')));
const findExpandedIcon = registerIcon('find-expanded', Codicon.chevronDown, ( localize(1053, 'Icon to indicate that the editor find widget is expanded.')));
const findSelectionIcon = registerIcon('find-selection', Codicon.selection, ( localize(1054, 'Icon for \'Find in Selection\' in the editor find widget.')));
const findReplaceIcon = registerIcon('find-replace', Codicon.replace, ( localize(1055, 'Icon for \'Replace\' in the editor find widget.')));
const findReplaceAllIcon = registerIcon('find-replace-all', Codicon.replaceAll, ( localize(1056, 'Icon for \'Replace All\' in the editor find widget.')));
const findPreviousMatchIcon = registerIcon('find-previous-match', Codicon.arrowUp, ( localize(1057, 'Icon for \'Find Previous\' in the editor find widget.')));
const findNextMatchIcon = registerIcon('find-next-match', Codicon.arrowDown, ( localize(1058, 'Icon for \'Find Next\' in the editor find widget.')));
const NLS_FIND_DIALOG_LABEL = ( localize(1059, "Find / Replace"));
const NLS_FIND_INPUT_LABEL = ( localize(1060, "Find"));
const NLS_FIND_INPUT_PLACEHOLDER = ( localize(1061, "Find"));
const NLS_PREVIOUS_MATCH_BTN_LABEL = ( localize(1062, "Previous Match"));
const NLS_NEXT_MATCH_BTN_LABEL = ( localize(1063, "Next Match"));
const NLS_TOGGLE_SELECTION_FIND_TITLE = ( localize(1064, "Find in Selection"));
const NLS_CLOSE_BTN_LABEL = ( localize(1065, "Close"));
const NLS_REPLACE_INPUT_LABEL = ( localize(1066, "Replace"));
const NLS_REPLACE_INPUT_PLACEHOLDER = ( localize(1067, "Replace"));
const NLS_REPLACE_BTN_LABEL = ( localize(1068, "Replace"));
const NLS_REPLACE_ALL_BTN_LABEL = ( localize(1069, "Replace All"));
const NLS_TOGGLE_REPLACE_MODE_BTN_LABEL = ( localize(1070, "Toggle Replace"));
...
const NLS_MATCHES_LOCATION = ( localize(1072, "{0} of {1}"));
const NLS_NO_RESULTS = ( localize(1073, "No results"));
...
class FindWidget extends Widget {
    ...
    _getAriaLabel(label, currentMatch, searchString) {
        if (label === NLS_NO_RESULTS) {
            return searchString === ''
                ? ( localize(1074, "{0} found", label))
                : ( localize(1075, "{0} found for '{1}'", label, searchString));
        }
        if (currentMatch) {
        ...
        return localize(1077, "{0} found for '{1}'", label, searchString);
    }
