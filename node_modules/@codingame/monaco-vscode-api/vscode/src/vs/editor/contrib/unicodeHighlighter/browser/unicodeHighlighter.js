...
const warningIcon = registerIcon('extensions-warning-message', Codicon.warning, ( localize(1629, 'Icon shown with a warning message in the extensions editor.')));
        ...
        this._updateState = (state) => {
            if (state && state.hasMore) {
                ...
                if (state.nonBasicAsciiCharacterCount >= max) {
                    data = {
                        message: ( localize(1630, 'This document contains many non-basic ASCII unicode characters')),
                        command: ( new DisableHighlightingOfNonBasicAsciiCharactersAction()),
                    };
                }
                else if (state.ambiguousCharacterCount >= max) {
                    data = {
                        message: ( localize(1631, 'This document contains many ambiguous unicode characters')),
                        command: ( new DisableHighlightingOfAmbiguousCharactersAction()),
                    };
                }
                else if (state.invisibleCharacterCount >= max) {
                    data = {
                        message: ( localize(1632, 'This document contains many invisible unicode characters')),
...
const configureUnicodeHighlightOptionsStr = ( localize(1633, 'Configure Unicode Highlight Options'));
        ...
        for (const d of lineDecorations) {
            ...
            switch (highlightInfo.reason.kind) {
                ...
                case UnicodeHighlighterReasonKind.Invisible:
                    reason = ( localize(1636, 'The character {0} is invisible.', codePointStr));
                    break;
                case UnicodeHighlighterReasonKind.NonBasicAscii:
                    reason = ( localize(1637, 'The character {0} is not a basic ASCII character.', codePointStr));
                    break;
            }
            ...
            const adjustSettings = ( localize(1638, 'Adjust settings'));
...
class DisableHighlightingInCommentsAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1639, "Disable highlighting of characters in comments")),
            precondition: undefined
        });
        this.shortLabel = ( localize(1640, 'Disable Highlight In Comments'));
    }
...
class DisableHighlightingInStringsAction extends EditorAction {
    ...
    constructor() {
        super({
            id: DisableHighlightingOfAmbiguousCharactersAction.ID,
            label: ( localize2(1641, "Disable highlighting of characters in strings")),
            precondition: undefined
        });
        this.shortLabel = ( localize(1642, 'Disable Highlight In Strings'));
    }
    async run(accessor, editor) {
        const configurationService = accessor.get(IConfigurationService);
        if (configurationService) {
...
class DisableHighlightingOfAmbiguousCharactersAction extends Action2 {
    ...
    constructor() {
        super({
            id: DisableHighlightingOfAmbiguousCharactersAction.ID,
            title: ( localize2(1643, "Disable highlighting of ambiguous characters")),
            precondition: undefined,
            f1: false,
        });
        this.shortLabel = ( localize(1644, 'Disable Ambiguous Highlight'));
    }
    async run(accessor, editor) {
        const configurationService = accessor.get(IConfigurationService);
        if (configurationService) {
...
class DisableHighlightingOfInvisibleCharactersAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(1645, "Disable highlighting of invisible characters")),
            precondition: undefined,
            f1: false,
        });
        this.shortLabel = ( localize(1646, 'Disable Invisible Highlight'));
    }
    async run(accessor, editor) {
        const configurationService = accessor.get(IConfigurationService);
        if (configurationService) {
...
class DisableHighlightingOfNonBasicAsciiCharactersAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(1647, "Disable highlighting of non basic ASCII characters")),
            precondition: undefined,
            f1: false,
        });
        this.shortLabel = ( localize(1648, 'Disable Non ASCII Highlight'));
    }
    async run(accessor, editor) {
        const configurationService = accessor.get(IConfigurationService);
        if (configurationService) {
...
class ShowExcludeOptions extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(1649, "Show Exclude Options")),
            precondition: undefined,
            f1: false,
        });
    }
