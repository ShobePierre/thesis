...
class IndentationToSpacesAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1242, "Convert Indentation to Spaces")),
            precondition: EditorContextKeys.writable,
            metadata: {
                description: ( localize2(1243, "Convert the tab indentation to spaces.")),
            }
        });
    }
    run(accessor, editor) {
...
class IndentationToTabsAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1244, "Convert Indentation to Tabs")),
            precondition: EditorContextKeys.writable,
            metadata: {
                description: ( localize2(1245, "Convert the spaces indentation to tabs.")),
            }
        });
    }
    run(accessor, editor) {
    ...
    run(accessor, editor) {
        ...
        const picks = ( [1, 2, 3, 4, 5, 6, 7, 8].map(n => ({
            ...
            description: (n === creationOpts.tabSize && n === modelOpts.tabSize
                ? ( localize(1246, "Configured Tab Size"))
                : n === creationOpts.tabSize
                    ? ( localize(1247, "Default Tab Size"))
                    : n === modelOpts.tabSize
                        ? ( localize(1248, "Current Tab Size"))
                        : undefined)
        })));
        const autoFocusIndex = Math.min(model.getOptions().tabSize - 1, 7);
        setTimeout(() => {
            quickInputService.pick(picks, { placeHolder: ( localize(1249, "Select Tab Size for Current File")), activeItem: picks[autoFocusIndex] }).then(pick => {
                if (pick) {
...
class IndentUsingTabs extends ChangeIndentationSizeAction {
    ...
    constructor() {
        super(false, false, {
            ...
            label: ( localize2(1250, "Indent Using Tabs")),
            precondition: undefined,
            metadata: {
                description: ( localize2(1251, "Use indentation with tabs.")),
            }
        });
    }
}
class IndentUsingSpaces extends ChangeIndentationSizeAction {
    ...
    constructor() {
        super(true, false, {
            ...
            label: ( localize2(1252, "Indent Using Spaces")),
            precondition: undefined,
            metadata: {
                description: ( localize2(1253, "Use indentation with spaces.")),
            }
        });
    }
}
class ChangeTabDisplaySize extends ChangeIndentationSizeAction {
    ...
    constructor() {
        super(true, true, {
            ...
            label: ( localize2(1254, "Change Tab Display Size")),
            precondition: undefined,
            metadata: {
                description: ( localize2(1255, "Change the space size equivalent of the tab.")),
            }
        });
    }
}
class DetectIndentation extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1256, "Detect Indentation from Content")),
            precondition: undefined,
            metadata: {
                description: ( localize2(1257, "Detect the indentation from content.")),
            }
        });
    }
    run(accessor, editor) {
...
class ReindentLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1258, "Reindent Lines")),
            precondition: EditorContextKeys.writable,
            metadata: {
                description: ( localize2(1259, "Reindent the lines of the editor.")),
            },
...
class ReindentSelectedLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1260, "Reindent Selected Lines")),
            precondition: EditorContextKeys.writable,
            metadata: {
                description: ( localize2(1261, "Reindent the selected lines of the editor.")),
            },
            canTriggerInlineEdits: true,
        });
    }
