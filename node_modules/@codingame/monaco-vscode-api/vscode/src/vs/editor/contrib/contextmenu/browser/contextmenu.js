...
let ContextMenuController = class ContextMenuController {
    ...
    _showScrollbarContextMenu(anchor) {
        ...
        actions.push(createAction({
            label: ( localize(999, "Render Characters")),
        ...
        actions.push(createEnumAction(( localize(1000, "Vertical size")), minimapOptions.enabled, 'editor.minimap.size', minimapOptions.size, [{
                label: ( localize(1001, "Proportional")),
                value: 'proportional'
            }, {
                label: ( localize(1002, "Fill")),
                value: 'fill'
            }, {
                label: ( localize(1003, "Fit")),
                value: 'fit'
            }]));
        actions.push(createEnumAction(( localize(1004, "Slider")), minimapOptions.enabled, 'editor.minimap.showSlider', minimapOptions.showSlider, [{
                label: ( localize(1005, "Mouse Over")),
                value: 'mouseover'
            }, {
                label: ( localize(1006, "Always")),
                value: 'always'
            }]));
        const useShadowDOM = this._editor.getOption(EditorOption.useShadowDOM) && !isIOS;
        this._contextMenuIsBeingShownCount++;
...
class ShowContextMenu extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1007, "Show Editor Context Menu")),
