...
import { createElement, ModifierKeyEmitter, n, $ } from '../../../../../../../base/browser/dom.js';
...
import { getOriginalBorderColor, getModifiedBorderColor, modifiedChangedTextOverlayColor, inlineEditIndicatorPrimaryForeground, inlineEditIndicatorPrimaryBackground, inlineEditIndicatorPrimaryBorder, observeColor, originalChangedTextOverlayColor } from '../theme.js';
        ...
        this._layout = derived(this, reader => {
            ...
            if (this._viewData.alternativeAction) {
                ...
                const occurrencesLabel = count !== undefined ? count === 1 ?
                    ( localize(1320, "{0} 1 occurrence", label)) :
                    ( localize(1321, "{0} {1} occurrences", label, count))
                    : label;
                const keybindingTooltip = ( localize(1322, "{0} show occurrences", '[shift]'));
                alternativeAction = {
