...
class TriggerSuggestAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1562, "Trigger Suggest")),
...
registerEditorAction(class extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1567, "Reset Suggest Widget Size")),
