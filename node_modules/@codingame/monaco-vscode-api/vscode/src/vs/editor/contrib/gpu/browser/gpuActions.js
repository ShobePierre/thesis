...
class DebugEditorGpuRendererAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1190, "Developer: Debug Editor GPU Renderer")),
    ...
    async run(accessor, editor) {
        ...
        const choice = await quickInputService.pick([
            {
                label: ( localize(1191, "Log Texture Atlas Stats")),
                id: 'logTextureAtlasStats',
            },
            {
                label: ( localize(1192, "Save Texture Atlas")),
                id: 'saveTextureAtlas',
            },
            {
                label: ( localize(1193, "Draw Glyph")),
                id: 'drawGlyph',
            },
        ], { canPickMany: false });
        if (!choice) {
