...
class ShowNextInlineSuggestionAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1270, "Show Next Inline Suggestion")),
...
class ShowPreviousInlineSuggestionAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1271, "Show Previous Inline Suggestion")),
            precondition: ( ContextKeyExpr.and(
                EditorContextKeys.writable,
                InlineCompletionContextKeys.inlineSuggestionVisible
            )),
...
class TriggerInlineSuggestionAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1272, "Trigger Inline Suggestion")),
            precondition: EditorContextKeys.writable,
            metadata: {
                description: ( localize(1273, "Triggers an inline suggestion in the editor.")),
                args: [{
                        name: 'args',
                        description: ( localize(1274, "Options for triggering inline suggestions.")),
                        isOptional: true,
        ...
        if (validatedArgs?.showNoResultNotification) {
            if (!controller?.model.get()?.state.get()) {
                notificationService.notify({
                    ...
                    message: ( localize(1275, "No inline suggestion is available."))
                });
            }
        }
    }
...
class AcceptNextWordOfInlineCompletion extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1276, "Accept Next Word Of Inline Suggestion")),
            precondition: ( ContextKeyExpr.and(
                EditorContextKeys.writable,
                InlineCompletionContextKeys.inlineSuggestionVisible
            )),
            ...
            menuOpts: [{
                    ...
                    title: ( localize(1277, 'Accept Word')),
                    group: 'primary',
                    order: 2,
                }],
        });
...
class AcceptNextLineOfInlineCompletion extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1278, "Accept Next Line Of Inline Suggestion")),
            precondition: ( ContextKeyExpr.and(
                EditorContextKeys.writable,
                InlineCompletionContextKeys.inlineSuggestionVisible
            )),
            ...
            menuOpts: [{
                    menuId: MenuId.InlineSuggestionToolbar,
                    title: ( localize(1279, 'Accept Line')),
                    group: 'secondary',
                    order: 2,
                }],
        });
...
class AcceptInlineCompletion extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1280, "Accept Inline Suggestion")),
...
class AcceptInlineCompletionAlternativeAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1282, "Accept Inline Suggestion Alternative Action")),
            precondition: ( ContextKeyExpr.and(
...
class JumpToNextInlineEdit extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1283, "Jump to next inline edit")),
            precondition: InlineCompletionContextKeys.inlineEditVisible,
            menuOpts: [{
                    menuId: MenuId.InlineEditsActions,
                    title: ( localize(1284, "Jump")),
                    group: 'primary',
                    order: 1,
...
class HideInlineCompletion extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1285, "Hide Inline Suggestion")),
            precondition: ( ContextKeyExpr.or(
                InlineCompletionContextKeys.inlineSuggestionVisible,
                InlineCompletionContextKeys.inlineEditVisible
            )),
...
class ToggleInlineCompletionShowCollapsed extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1287, "Toggle Inline Suggestions Show Collapsed")),
...
class ToggleAlwaysShowInlineSuggestionToolbar extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize(1288, "Always Show Toolbar")),
            f1: false,
...
class DevExtractReproSample extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize(1289, "Developer: Extract Inline Suggest State")),
