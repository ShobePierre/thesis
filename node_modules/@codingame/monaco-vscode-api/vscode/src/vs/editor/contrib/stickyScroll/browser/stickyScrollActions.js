...
class ToggleStickyScroll extends EditorAction2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(1542, "Toggle Editor Sticky Scroll")),
                mnemonicTitle: ( localize(1543, "&&Toggle Editor Sticky Scroll")),
            },
            metadata: {
            ...
            toggled: {
                ...
                title: ( localize(1545, "Sticky Scroll")),
                mnemonicTitle: ( localize(1546, "&&Sticky Scroll")),
            },
            menu: [
...
class FocusStickyScroll extends EditorAction2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(1547, "Focus Editor Sticky Scroll")),
                mnemonicTitle: ( localize(1548, "&&Focus Editor Sticky Scroll")),
            },
...
class SelectNextStickyScrollLine extends EditorAction2 {
    constructor() {
        super({
            ...
            title: ( localize2(1549, "Select the next editor sticky scroll line")),
...
class SelectPreviousStickyScrollLine extends EditorAction2 {
    constructor() {
        super({
            ...
            title: ( localize2(1550, "Select the previous sticky scroll line")),
            precondition: ( EditorContextKeys.stickyScrollFocused.isEqualTo(true)),
            keybinding: {
                weight,
...
class GoToStickyScrollLine extends EditorAction2 {
    constructor() {
        super({
            ...
            title: ( localize2(1551, "Go to the focused sticky scroll line")),
            precondition: ( EditorContextKeys.stickyScrollFocused.isEqualTo(true)),
            keybinding: {
                weight,
...
class SelectEditor extends EditorAction2 {
    constructor() {
        super({
            ...
            title: ( localize2(1552, "Select Editor")),
            precondition: ( EditorContextKeys.stickyScrollFocused.isEqualTo(true)),
            keybinding: {
                weight,
