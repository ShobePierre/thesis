...
class DefaultTextPasteOrDropEditProvider extends SimplePasteAndDropProvider {
    ...
    async getEdit(dataTransfer, _token) {
        ...
        return {
            ...
            title: ( localize(1023, "Insert Plain Text")),
            insertText,
            kind: this.kind,
        };
    }
    ...
    async getEdit(dataTransfer, token) {
        ...
        if (uriCount > 0) {
            label = entries.length > 1
                ? ( localize(1024, "Insert Uris"))
                : ( localize(1025, "Insert Uri"));
        }
        else {
            label = entries.length > 1
                ? ( localize(1026, "Insert Paths"))
                : ( localize(1027, "Insert Path"));
        }
        return {
    ...
    async getEdit(dataTransfer, token) {
        ...
        return {
            ...
            title: entries.length > 1
                ? ( localize(1028, "Insert Relative Paths"))
                : ( localize(1029, "Insert Relative Path")),
            kind: this.kind,
        };
    }
};
    ...
    async provideDocumentPasteEdits(_model, _ranges, dataTransfer, context, token) {
        ...
        return {
            ...
            edits: [{
                    ...
                    title: ( localize(1030, 'Insert HTML')),
                    kind: this.kind,
                }],
        };
    }
