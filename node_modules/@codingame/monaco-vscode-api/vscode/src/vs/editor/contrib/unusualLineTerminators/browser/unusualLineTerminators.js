    ...
    async _checkForUnusualLineTerminators() {
        ...
        try {
            ...
            result = await this._dialogService.confirm({
                title: ( localize(1653, "Unusual Line Terminators")),
                message: ( localize(1654, "Detected unusual line terminators")),
                detail: ( localize(
                    1655,
                ...
                primaryButton: ( localize(1656, "&&Remove Unusual Line Terminators")),
                cancelButton: ( localize(1657, "Ignore"))
            });
        }
        finally {
            this._isPresentingDialog = false;
