...
const Context = {
    ...
    HasFocusedSuggestion: ( new RawContextKey('suggestWidgetHasFocusedSuggestion', false, ( localize(1553, "Whether any suggestion is focused")))),
    DetailsVisible: ( new RawContextKey('suggestWidgetDetailsVisible', false, ( localize(1554, "Whether suggestion details are visible")))),
    MultipleSuggestions: ( new RawContextKey('suggestWidgetMultipleSuggestions', false, ( localize(1555, "Whether there are multiple suggestions to pick from")))),
    ...
    AcceptSuggestionsOnEnter: ( new RawContextKey('acceptSuggestionOnEnter', true, ( localize(1557, "Whether suggestions are inserted when pressing Enter")))),
    HasInsertAndReplaceRange: ( new RawContextKey('suggestionHasInsertAndReplaceRange', false, ( localize(1558, "Whether the current suggestion has insert and replace behaviour")))),
    InsertMode: ( new RawContextKey(
        'suggestionInsertMode',
        undefined,
        { type: 'string', description: ( localize(1559, "Whether the default behaviour is to insert or replace")) }
    )),
    CanResolve: ( new RawContextKey('suggestionCanResolve', false, ( localize(1560, "Whether the current suggestion supports to resolve further details")))),
};
