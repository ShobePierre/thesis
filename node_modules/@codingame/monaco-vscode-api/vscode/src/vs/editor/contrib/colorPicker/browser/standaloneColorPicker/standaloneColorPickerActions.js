...
class ShowOrFocusStandaloneColorPicker extends EditorAction2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(985, "Show or Focus Standalone Color Picker")),
                mnemonicTitle: ( localize(986, "&&Show or Focus Standalone Color Picker")),
            },
...
class HideStandaloneColorPicker extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(988, "Hide the Color Picker")),
            ...
            metadata: {
                description: ( localize2(989, "Hide the standalone color picker.")),
            }
        });
    }
...
class InsertColorWithStandaloneColorPicker extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(990, "Insert Color with Standalone Color Picker")),
            ...
            metadata: {
                description: ( localize2(991, "Insert hex/rgb/hsl colors with the focused standalone color picker.")),
            }
        });
    }
    run(_accessor, editor) {
