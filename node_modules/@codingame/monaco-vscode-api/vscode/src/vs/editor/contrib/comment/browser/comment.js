...
class ToggleCommentLineAction extends CommentLineAction {
    constructor() {
        super(Type.Toggle, {
            ...
            label: ( localize2(992, "Toggle Line Comment")),
            ...
            menuOpts: {
                ...
                group: '5_insert',
                title: ( localize(993, "&&Toggle Line Comment")),
                order: 1
            },
...
class AddLineCommentAction extends CommentLineAction {
    constructor() {
        super(Type.ForceAdd, {
            ...
            label: ( localize2(994, "Add Line Comment")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class RemoveLineCommentAction extends CommentLineAction {
    constructor() {
        super(Type.ForceRemove, {
            ...
            label: ( localize2(995, "Remove Line Comment")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class BlockCommentAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(996, "Toggle Block Comment")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarEditMenu,
                group: '5_insert',
                title: ( localize(997, "Toggle &&Block Comment")),
                order: 2
            },
            canTriggerInlineEdits: true,
        });
