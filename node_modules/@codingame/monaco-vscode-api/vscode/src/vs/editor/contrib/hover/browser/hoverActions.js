...
class ShowOrFocusHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1201, "Show or Focus Hover")),
            metadata: {
                        ...
                        schema: {
                            ...
                            properties: {
                                'focus': {
                                    ...
                                    enumDescriptions: [
                                        ( localize(1203, 'The hover will not automatically take focus.')),
                                        ( localize(1204, 'The hover will take focus only if it is already visible.')),
                                        ( localize(1205, 'The hover will automatically take focus when it appears.')),
                                    ],
...
class ShowDefinitionPreviewHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1206, "Show Definition Preview Hover")),
            precondition: undefined,
            metadata: {
                description: ( localize2(1207, 'Show the definition preview hover in the editor.')),
            },
        });
    }
    run(accessor, editor) {
...
class HideContentHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1208, "Hide Hover")),
...
class ScrollUpHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1209, "Scroll Up Hover")),
            ...
            metadata: {
                description: ( localize2(1210, 'Scroll up the editor hover.'))
            },
        });
    }
    run(accessor, editor) {
...
class ScrollDownHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1211, "Scroll Down Hover")),
            precondition: EditorContextKeys.hoverFocused,
            kbOpts: {
                kbExpr: EditorContextKeys.hoverFocused,
            ...
            metadata: {
                description: ( localize2(1212, 'Scroll down the editor hover.')),
            },
        });
    }
    run(accessor, editor) {
...
class ScrollLeftHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1213, "Scroll Left Hover")),
            precondition: EditorContextKeys.hoverFocused,
            kbOpts: {
                kbExpr: EditorContextKeys.hoverFocused,
            ...
            metadata: {
                description: ( localize2(1214, 'Scroll left the editor hover.')),
            },
        });
    }
    run(accessor, editor) {
...
class ScrollRightHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1215, "Scroll Right Hover")),
            precondition: EditorContextKeys.hoverFocused,
            kbOpts: {
                kbExpr: EditorContextKeys.hoverFocused,
            ...
            metadata: {
                description: ( localize2(1216, 'Scroll right the editor hover.'))
            },
        });
    }
    run(accessor, editor) {
...
class PageUpHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1217, "Page Up Hover")),
            precondition: EditorContextKeys.hoverFocused,
            kbOpts: {
                kbExpr: EditorContextKeys.hoverFocused,
            ...
            metadata: {
                description: ( localize2(1218, 'Page up the editor hover.')),
            },
        });
    }
    run(accessor, editor) {
...
class PageDownHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1219, "Page Down Hover")),
            precondition: EditorContextKeys.hoverFocused,
            kbOpts: {
                kbExpr: EditorContextKeys.hoverFocused,
            ...
            metadata: {
                description: ( localize2(1220, 'Page down the editor hover.')),
            },
        });
    }
    run(accessor, editor) {
...
class GoToTopHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1221, "Go To Top Hover")),
            precondition: EditorContextKeys.hoverFocused,
            kbOpts: {
                kbExpr: EditorContextKeys.hoverFocused,
            ...
            metadata: {
                description: ( localize2(1222, 'Go to the top of the editor hover.')),
            },
        });
    }
    run(accessor, editor) {
...
class GoToBottomHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1223, "Go To Bottom Hover")),
            precondition: EditorContextKeys.hoverFocused,
            kbOpts: {
                kbExpr: EditorContextKeys.hoverFocused,
                primary: KeyCode.End,
            ...
            metadata: {
                description: ( localize2(1224, 'Go to the bottom of the editor hover.'))
            },
        });
    }
    run(accessor, editor) {
