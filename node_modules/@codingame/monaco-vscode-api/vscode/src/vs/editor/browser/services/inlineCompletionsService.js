...
const InlineCompletionsSnoozing = ( new RawContextKey('inlineCompletions.snoozed', false, ( localize(145, "Whether inline completions are currently snoozed"))));
...
class SnoozeInlineCompletion extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(146, "Snooze Inline Suggestions")),
    ...
    async getDurationFromUser(quickInputService, storageService) {
        ...
        const picked = await quickInputService.pick(items, {
            placeHolder: ( localize(147, "Select snooze duration for Inline Suggestions")),
...
class CancelSnoozeInlineCompletion extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(148, "Cancel Snooze Inline Suggestions")),
