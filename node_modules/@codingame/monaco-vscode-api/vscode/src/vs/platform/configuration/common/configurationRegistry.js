...
class ConfigurationRegistry extends Disposable {
    constructor() {
        ...
        this.defaultLanguageConfigurationOverridesNode = {
            id: 'defaultOverrides',
            title: ( localize(1761, "Default Language Configuration Overrides")),
            properties: {}
        };
    ...
    updateOverridePropertyPatternKey() {
        for (const overrideIdentifier of ( this.overrideIdentifiers.values())) {
            ...
            const resourceLanguagePropertiesSchema = {
                type: 'object',
                description: ( localize(1763, "Configure editor settings to be overridden for a language.")),
                errorMessage: ( localize(1764, "This setting does not support per-language configuration.")),
                $ref: resourceLanguageSettingsSchemaId,
            };
...
function validateProperty(property, schema, extensionId) {
    if (!property.trim()) {
        return localize(1765, "Cannot register an empty property");
    }
