...
registerColor('actionBar.toggledBackground', inputActiveOptionBackground, ( localize(1743, 'Background color for toggled action items in action bar.')));
const ActionWidgetContextKeys = {
    Visible: ( new RawContextKey('codeActionMenuVisible', false, ( localize(1744, "Whether the action widget list is visible"))))
};
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(1745, "Hide action widget")),
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(1746, "Select previous action")),
            precondition: ActionWidgetContextKeys.Visible,
            keybinding: {
                weight,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(1747, "Select next action")),
            precondition: ActionWidgetContextKeys.Visible,
            keybinding: {
                weight,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(1748, "Accept selected action")),
            precondition: ActionWidgetContextKeys.Visible,
            keybinding: {
                weight,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(1749, "Preview selected action")),
            precondition: ActionWidgetContextKeys.Visible,
            keybinding: {
                weight,
