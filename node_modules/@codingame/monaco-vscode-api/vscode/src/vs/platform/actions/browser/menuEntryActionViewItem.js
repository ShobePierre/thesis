...
let MenuEntryActionViewItem = class MenuEntryActionViewItem extends ActionViewItem {
    ...
    getTooltip() {
        ...
        let title = keybindingLabel
            ? ( localize(1752, "{0} ({1})", tooltip, keybindingLabel))
            : tooltip;
        if (!this._wantsAltCommand && this._menuItemAction.alt?.enabled) {
            ...
            const altTitleSection = altKeybindingLabel
                ? ( localize(1752, "{0} ({1})", altTooltip, altKeybindingLabel))
                : altTooltip;
            title = ( localize(
                1753,
                "{0}\n[{1}] {2}",
    ...
    updateLabel() {
        ...
        if (this.label) {
            ...
            if (this._options?.conversational) {
                this.label.textContent = ( localize(1754, '{1} to {0}', this._action.label, kb2));
            }
            else {
                this.label.textContent = ( localize(1755, '{0} ({1})', this._action.label, kb2));
            }
        }
    }
...
let SubmenuEntrySelectActionViewItem = class SubmenuEntrySelectActionViewItem extends SelectActionViewItem {
    constructor(action, contextViewService, configurationService) {
        super(null, action, ( action.actions.map(
