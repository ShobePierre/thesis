...
const ExtensionsLocalizedLabel = ( localize2(1822, "Extensions"));
const PreferencesLocalizedLabel = ( localize2(1823, 'Preferences'));
...
( Registry.as(Extensions.Configuration))
    ...
    id: 'extensions',
    order: 30,
    title: ( localize(1824, "Extensions")),
    type: 'object',
    properties: {
        [AllowedExtensionsConfigKey]: {
            ...
            defaultSnippets: [{
                    body: {},
                    description: ( localize(1826, "No extensions are allowed.")),
                }, {
                    body: {
                        '*': true
                    },
                    description: ( localize(1827, "All extensions are allowed.")),
                }],
            ...
            patternProperties: {
                    ...
                    anyOf: [
                        {
                            ...
                            description: ( localize(1829, "Allow or disallow the extension.")),
                            enumDescriptions: [
                                ( localize(1830, "Extension is allowed.")),
                                ( localize(1831, "Extension is not allowed.")),
                                ( localize(1832, "Allow only stable versions of the extension.")),
                            ],
                        },
                        {
                            type: 'array',
                ...
                '([a-z0-9A-Z][a-z0-9-A-Z]*)$': {
                    type: ['boolean', 'string'],
                    enum: [true, false, 'stable'],
                    description: ( localize(1834, "Allow or disallow all extensions from the publisher.")),
                    enumDescriptions: [
                        ( localize(1835, "All extensions from the publisher are allowed.")),
                        ( localize(1836, "All extensions from the publisher are not allowed.")),
                        ( localize(1837, "Allow only stable versions of the extensions from the publisher.")),
                    ],
                },
                '\\*': {
                    type: 'boolean',
                    enum: [true, false],
                    description: ( localize(1838, "Allow or disallow all extensions.")),
                    enumDescriptions: [
                        ( localize(1839, "Allow all extensions.")),
                        ( localize(1840, "Disallow all extensions."))
                    ],
                }
            }
        }
...
export { AllowedExtensionsConfigKey, DISABLED_EXTENSIONS_STORAGE_PATH, ENABLED_EXTENSIONS_STORAGE_PATH, EXTENSION_IDENTIFIER_PATTERN, EXTENSION_IDENTIFIER_REGEX, EXTENSION_INSTALL_DEP_PACK_CONTEXT, EXTENSION_INSTALL_SKIP_PUBLISHER_TRUST_CONTEXT, EXTENSION_INSTALL_SKIP_WALKTHROUGH_CONTEXT, EXTENSION_INSTALL_SOURCE_CONTEXT, ExtensionGalleryError, ExtensionGalleryErrorCode, ExtensionInstallSource, ExtensionManagementError, ExtensionManagementErrorCode, ExtensionRequestsTimeoutConfigKey, ExtensionSignatureVerificationCode, ExtensionsLocalizedLabel, FilterType, InstallOperation, PreferencesLocalizedLabel, SortBy, SortOrder, StatisticType, TargetPlatformToString, VerifyExtensionSignatureConfigKey, WEB_EXTENSION_TAG, computeSize, getTargetPlatform, isIExtensionIdentifier, isNotWebExtensionInWebTargetPlatform, isTargetPlatformCompatible, shouldRequireRepositorySignatureFor, toTargetPlatform };
