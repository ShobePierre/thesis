...
function registerConfiguration() {
    ...
    configurationRegistry.registerConfiguration({
        id: 'settingsSync',
        order: 30,
        title: ( localize(2444, "Settings Sync")),
        type: 'object',
        properties: {
            [CONFIG_SYNC_KEYBINDINGS_PER_PLATFORM]: {
                type: 'boolean',
                description: ( localize(2445, "Synchronize keybindings for each platform.")),
                default: true,
            ...
            'settingsSync.ignoredExtensions': {
                ...
                items: [{
                        ...
                        errorMessage: ( localize(2447, "Expected format '${publisher}.${name}'. Example: 'vscode.csharp'."))
                    }],
                'default': [],
                'scope': ConfigurationScope.APPLICATION,
                uniqueItems: true,
            ...
            'settingsSync.ignoredSettings': {
                'type': 'array',
                description: ( localize(2448, "Configure settings to be ignored while synchronizing.")),
                'default': [],
                'scope': ConfigurationScope.APPLICATION,
...
const ALL_SYNC_RESOURCES = [SyncResource.Settings, SyncResource.Keybindings, SyncResource.Snippets, SyncResource.Prompts, SyncResource.Tasks, SyncResource.Extensions, SyncResource.GlobalState, SyncResource.Profiles, SyncResource.Mcp];
