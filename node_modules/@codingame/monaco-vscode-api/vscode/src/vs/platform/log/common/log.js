...
function LogLevelToLocalizedString(logLevel) {
    switch (logLevel) {
        case LogLevel.Trace: return { original: 'Trace', value: ( localize(1979, "Trace")) };
        case LogLevel.Debug: return { original: 'Debug', value: ( localize(1980, "Debug")) };
        case LogLevel.Info: return { original: 'Info', value: ( localize(1981, "Info")) };
        case LogLevel.Warning: return { original: 'Warning', value: ( localize(1982, "Warning")) };
        case LogLevel.Error: return { original: 'Error', value: ( localize(1983, "Error")) };
        case LogLevel.Off: return { original: 'Off', value: ( localize(1984, "Off")) };
    }
}
...
export { AbstractLogger, AbstractLoggerService, AbstractMessageLogger, CONTEXT_LOG_LEVEL, ConsoleLogger, DEFAULT_LOG_LEVEL, LogLevel, LogLevelToLocalizedString, LogLevelToString, MultiplexLogger, NullLogService, NullLogger, NullLoggerService, canLog, getLogLevel, isLogLevel, log, parseLogLevel };
