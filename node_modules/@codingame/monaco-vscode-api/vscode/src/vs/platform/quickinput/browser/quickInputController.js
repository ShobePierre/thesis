...
let QuickInputController = class QuickInputController extends Disposable {
    ...
    getUI(showInActiveContainer) {
        ...
        const checkAll = this._register(( new TriStateCheckbox(( localize(2023, "Toggle all checkboxes")), false, { ...defaultCheckboxStyles, size: 15 })));
        ...
        const visibleCount = this._register(( new CountBadge(visibleCountContainer, { countFormat: ( localize(2024, "{0} Results")) }, this.styles.countBadge)));
        const countContainer = append(filterContainer, $('.quick-input-count'));
        countContainer.setAttribute('aria-live', 'polite');
        const count = this._register(( new CountBadge(countContainer, { countFormat: ( localize(2025, "{0} Selected")) }, this.styles.countBadge)));
    ...
    show(controller) {
        ...
        backButton.tooltip = backKeybindingLabel ? ( localize(2028, "Back ({0})", backKeybindingLabel)) : ( localize(2029, "Back"));
