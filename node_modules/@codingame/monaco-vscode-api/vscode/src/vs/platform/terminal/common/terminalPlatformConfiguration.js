...
const terminalProfileBaseProperties = {
    args: {
        description: ( localize(2077, 'An optional set of arguments to run the shell executable with.')),
        type: 'array',
        items: {
            type: 'string'
        }
    ...
    icon: {
        description: ( localize(2078, 'A codicon ID to associate with the terminal icon.')),
        ...terminalIconSchema
    },
    color: {
        description: ( localize(2079, 'A theme color ID to associate with the terminal icon.')),
        ...terminalColorSchema
    },
    env: {
...
const terminalAutomationProfileSchema = {
    ...
    properties: {
        path: {
            description: ( localize(2083, 'A path to a shell executable.')),
            type: ['string'],
            items: {
                type: 'string'
            }
...
const terminalPlatformConfiguration = {
    id: 'terminal',
    order: 100,
    title: ( localize(2085, "Integrated Terminal")),
    type: 'object',
    properties: {
            ...
            additionalProperties: {
                'anyOf': [
                    ...
                    },
                    {
                        ...
                        properties: {
                            extensionIdentifier: {
                                description: ( localize(2090, 'The extension that contributed this profile.')),
                                type: 'string'
                            },
                            id: {
                                description: ( localize(2091, 'The id of the extension terminal')),
                                type: 'string'
                            },
                            title: {
                                description: ( localize(2092, 'The name of the extension terminal')),
                                type: 'string'
                            },
                            ...terminalProfileBaseProperties
                        }
                ...
                'anyOf': [
                    {
                        ...
                        properties: {
                            extensionIdentifier: {
                                description: ( localize(2093, 'The extension that contributed this profile.')),
                                type: 'string'
                            },
                            id: {
                                description: ( localize(2094, 'The id of the extension terminal')),
                                type: 'string'
                            },
                            title: {
                                description: ( localize(2095, 'The name of the extension terminal')),
                                type: 'string'
                            },
                            ...terminalProfileBaseProperties
                        }
                ...
                'anyOf': [
                    {
                        ...
                        properties: {
                            extensionIdentifier: {
                                description: ( localize(2096, 'The extension that contributed this profile.')),
                                type: 'string'
                            },
                            id: {
                                description: ( localize(2097, 'The id of the extension terminal')),
                                type: 'string'
                            },
                            title: {
                                description: ( localize(2098, 'The name of the extension terminal')),
                                type: 'string'
                            },
                            ...terminalProfileBaseProperties
                        }
        ...
        [TerminalSettingId.ShowLinkHover]: {
            scope: ConfigurationScope.APPLICATION,
            description: ( localize(2102, "Whether to show hovers for links in the terminal output.")),
            type: 'boolean',
            default: true
        },
    ...
    defaultProfilesConfiguration = {
        ...
        properties: {
            [TerminalSettingId.DefaultProfileLinux]: {
                restricted: true,
                markdownDescription: ( localize(2104, "The default terminal profile on Linux.")),
                type: ['string', 'null'],
                default: null,
            ...
            [TerminalSettingId.DefaultProfileMacOs]: {
                restricted: true,
                markdownDescription: ( localize(2105, "The default terminal profile on macOS.")),
                type: ['string', 'null'],
                default: null,
            ...
            [TerminalSettingId.DefaultProfileWindows]: {
                restricted: true,
                markdownDescription: ( localize(2106, "The default terminal profile on Windows.")),
                type: ['string', 'null'],
                default: null,
