        ...
        },
        {
            ...
            properties: {
                ...
                'http.proxySupport': {
                    ...
                    enumDescriptions: [
                        ( localize(2045, "Disable proxy support for extensions.")),
                        ( localize(2046, "Enable proxy support for extensions.")),
                        ( localize(
                        2047,
                        "Enable proxy support for extensions, fall back to request options, when no proxy found."
                    )),
                        ( localize(2048, "Enable proxy support for extensions, override request options.")),
                    ],
                    default: 'override',
                    markdownDescription: ( localize(
                        2049,
