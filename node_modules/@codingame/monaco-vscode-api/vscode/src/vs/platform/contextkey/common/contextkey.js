...
const errorEmptyString = ( localize(1770, "Empty context key expression"));
...
const errorNoInAfterNot = ( localize(1772, "'in' after 'not'."));
const errorClosingParenthesis = ( localize(1773, "closing parenthesis ')'"));
const errorUnexpectedToken = ( localize(1774, "Unexpected token"));
const hintUnexpectedToken = ( localize(1775, "Did you forget to put && or || before the token?"));
const errorUnexpectedEOF = ( localize(1776, "Unexpected end of expression"));
const hintUnexpectedEOF = ( localize(1777, "Did you forget to put a context key?"));
class Parser {
    ...
    _errExpectedButGot(expected, got, additionalInfo) {
        const message = ( localize(1778, "Expected: {0}\nReceived: '{1}'.", expected, Scanner.getLexeme(got)));
        ...
        if (parser.lexingErrors.length > 0) {
            return (parser.lexingErrors.map((se) => ({
                errorMessage: se.additionalInfo ?
                    ( localize(1779, "Unexpected token. Hint: {0}", se.additionalInfo)) :
                    ( localize(1780, "Unexpected token.")),
                offset: se.offset,
