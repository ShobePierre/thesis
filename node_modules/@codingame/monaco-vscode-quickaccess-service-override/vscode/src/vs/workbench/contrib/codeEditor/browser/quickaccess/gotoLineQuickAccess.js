...
class GotoLineAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(6163, 'Go to Line/Column...')),
            f1: true,
            keybinding: {
...
( Registry.as(Extensions.Quickaccess)).registerQuickAccessProvider({
    ...
    helpEntries: [{ description: ( localize(6165, "Go to Line/Column")), commandId: GotoLineAction.ID }]
});
class GotoOffsetAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(6166, 'Go to Offset...')),
            f1: true
        });
    }
    async run(accessor) {
...
( Registry.as(Extensions.Quickaccess)).registerQuickAccessProvider({
    ...
    helpEntries: [{ description: ( localize(6167, "Go to Offset")), commandId: GotoOffsetAction.ID }]
});
