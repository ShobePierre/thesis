...
quickAccessRegistry.registerQuickAccessProvider({
    ...
    helpEntries: [{
            description: ( localize(10171, "Show all Quick Access Providers")),
            commandCenterOrder: 70,
            commandCenterLabel: ( localize(10172, 'More'))
        }]
});
quickAccessRegistry.registerQuickAccessProvider({
    ...
    placeholder: ( localize(10173, "Type the name of a view, output channel or terminal to open.")),
    helpEntries: [{ description: ( localize(10174, "Open View")), commandId: OpenViewPickerAction.ID }]
});
quickAccessRegistry.registerQuickAccessProvider({
    ctor: CommandsQuickAccessProvider,
    prefix: CommandsQuickAccessProvider.PREFIX,
    contextKey: 'inCommandsPicker',
    placeholder: ( localize(10175, "Type the name of a command to run.")),
    helpEntries: [{ description: ( localize(10176, "Show and Run Commands")), commandId: ShowAllCommandsAction.ID, commandCenterOrder: 20 }]
});
MenuRegistry.appendMenuItem(MenuId.MenubarViewMenu, {
    group: '1_open',
    command: {
        id: ShowAllCommandsAction.ID,
        title: ( localize(10177, "&&Command Palette..."))
    },
    order: 1
});
MenuRegistry.appendMenuItem(MenuId.MenubarHelpMenu, {
    ...
    command: {
        id: ShowAllCommandsAction.ID,
        title: ( localize(10178, "Show All Commands"))
    },
    order: 2
});
MenuRegistry.appendMenuItem(MenuId.MenubarViewMenu, {
    ...
    command: {
        ...
        title: ( localize(10179, "&&Open View..."))
    },
    order: 2
});
MenuRegistry.appendMenuItem(MenuId.MenubarGoMenu, {
    ...
    command: {
        ...
        title: ( localize(10180, "Go to &&Line/Column..."))
    },
    order: 1
});
MenuRegistry.appendMenuItem(MenuId.GlobalActivity, {
    ...
    command: {
        id: ShowAllCommandsAction.ID,
        title: ( localize(10181, "Command Palette..."))
    },
    order: 1
});
