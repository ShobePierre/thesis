...
let ViewQuickAccessProvider = class ViewQuickAccessProvider extends PickerQuickAccessProvider {
    ...
    constructor(viewDescriptorService, viewsService, outputService, terminalService, terminalGroupService, debugService, paneCompositeService, contextKeyService) {
        super(ViewQuickAccessProvider_1.PREFIX, {
            noResultsPick: {
                label: ( localize(10182, "No matching views")),
                containerLabel: ''
            }
        });
    ...
    doGetViewPickItems() {
        ...
        addPaneComposites(ViewContainerLocation.Sidebar, ( localize(10183, "Side Bar")));
        addPaneComposites(ViewContainerLocation.Panel, ( localize(10184, "Panel")));
        addPaneComposites(ViewContainerLocation.AuxiliaryBar, ( localize(10185, "Secondary Side Bar")));
        ...
        this.terminalGroupService.groups.forEach((group, groupIndex) => {
            group.terminalInstances.forEach((terminal, terminalIndex) => {
                ...
                viewEntries.push({
                    label,
                    containerLabel: ( localize(10187, "Terminal")),
                    accept: async () => {
        ...
        this.debugService.getModel().getSessions(true).filter(s => s.hasSeparateRepl()).forEach((session, _) => {
            ...
            viewEntries.push({
                label,
                containerLabel: ( localize(10188, "Debug Console")),
                accept: async () => {
        ...
        for (const channel of channels) {
            viewEntries.push({
                label: channel.label,
                containerLabel: ( localize(10189, "Output")),
...
class OpenViewPickerAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(10190, 'Open View')),
...
class QuickAccessViewPickerAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(10191, 'Quick Open View')),
            category: Categories.View,
            f1: false,
            keybinding: {
