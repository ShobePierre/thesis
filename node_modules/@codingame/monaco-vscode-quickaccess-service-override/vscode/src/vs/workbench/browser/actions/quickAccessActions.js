...
import { QuickInputHideReason, ItemActivation } from '@codingame/monaco-vscode-api/vscode/vs/platform/quickinput/common/quickInput';
import { IQuickInputService } from '@codingame/monaco-vscode-api/vscode/vs/platform/quickinput/common/quickInput.service';
import { IKeybindingService } from '@codingame/monaco-vscode-api/vscode/vs/platform/keybinding/common/keybinding.service';
import { CommandsRegistry } from '@codingame/monaco-vscode-api/vscode/vs/platform/commands/common/commands';
import { inQuickPickContext, defaultQuickAccessContext, getQuickNavigateHandler } from '@codingame/monaco-vscode-api/vscode/vs/workbench/browser/quickaccess';
...
registerAction2(class QuickAccessAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2890, "Go to File...")),
            metadata: {
...
registerAction2(class QuickAccessAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(2891, "Quick Open")),
            icon: Codicon.search,
            menu: {
...
class QuickAccessNavigateNextAction extends BaseQuickAccessNavigateAction {
    constructor() {
        super('workbench.action.quickOpenNavigateNext', ( localize2(2892, 'Navigate Next in Quick Open')), true, true);
    }
}
class QuickAccessNavigatePreviousAction extends BaseQuickAccessNavigateAction {
    constructor() {
        super('workbench.action.quickOpenNavigatePrevious', ( localize2(2893, 'Navigate Previous in Quick Open')), false, true);
    }
}
class QuickAccessSelectNextAction extends BaseQuickAccessNavigateAction {
    constructor() {
        super('workbench.action.quickOpenSelectNext', ( localize2(2894, 'Select Next in Quick Open')), true, false, {
            weight: KeybindingWeight.WorkbenchContrib + 50,
            when: inQuickPickContext,
            primary: 0,
...
class QuickAccessSelectPreviousAction extends BaseQuickAccessNavigateAction {
    constructor() {
        super('workbench.action.quickOpenSelectPrevious', ( localize2(2895, 'Select Previous in Quick Open')), false, false, {
            weight: KeybindingWeight.WorkbenchContrib + 50,
            when: inQuickPickContext,
            primary: 0,
