...
let MainThreadWorkspace = class MainThreadWorkspace {
    ...
    getStatusMessage(extensionName, addCount, removeCount) {
        ...
        if (wantsToAdd && !wantsToDelete) {
            if (addCount === 1) {
                message = ( localize(2540, "Extension '{0}' added 1 folder to the workspace", extensionName));
            }
            else {
                message = ( localize(
                    2541,
            ...
            if (removeCount === 1) {
                message = ( localize(2542, "Extension '{0}' removed 1 folder from the workspace", extensionName));
            }
            else {
                message = ( localize(
                    2543,
            ...
            message = ( localize(2544, "Extension '{0}' changed folders of the workspace", extensionName));
        }
        return message;
    }
