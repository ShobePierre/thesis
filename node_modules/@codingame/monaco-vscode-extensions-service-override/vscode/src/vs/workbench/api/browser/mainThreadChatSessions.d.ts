...
import { IChatAgentRequest } from "@codingame/monaco-vscode-api/vscode/vs/workbench/contrib/chat/common/chatAgents";
import { IChatContentInlineReference, IChatProgress } from "@codingame/monaco-vscode-api/vscode/vs/workbench/contrib/chat/common/chatService";
...
export declare class MainThreadChatSessions extends Disposable implements MainThreadChatSessionsShape {
    ...
    private _provideNewChatSessionItem;
