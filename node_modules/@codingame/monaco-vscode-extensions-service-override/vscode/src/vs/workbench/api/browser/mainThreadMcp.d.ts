...
import { IMcpAuthenticationDetails, IMcpAuthenticationOptions, MainThreadMcpShape } from "@codingame/monaco-vscode-api/vscode/vs/workbench/api/common/extHost.protocol";
