    ...
    async _handleMissingInstalledDependency(extension, missingInstalledDependency) {
        ...
        if (this._extensionEnablementService.isEnabled(missingInstalledDependency)) {
            this._notificationService.notify({
                ...
                actions: {
                    primary: [toAction({ id: 'reload', label: ( localize(2486, "Reload Window")), run: () => this._hostService.reload() })]
                }
            });
        }
        else {
            ...
            if (enablementState === EnablementState.DisabledByVirtualWorkspace) {
                ...
                this._notificationService.notify({
                    ...
                    actions: {
                        primary: [toAction({ id: 'manageWorkspaceTrust', label: ( localize(2489, "Manage Workspace Trust")), run: () => this._commandService.executeCommand('workbench.trust.manage') })]
                    }
                });
            }
                ...
                this._notificationService.notify({
                    ...
                    actions: {
                        primary: [toAction({
                                id: 'enable', label: ( localize(2491, "Enable and Reload")), enabled: true,
        ...
        if (dependencyExtension) {
            this._notificationService.notify({
                ...
                actions: {
                    primary: [toAction({
                            id: 'install',
                            label: ( localize(2494, "Install and Reload")),
