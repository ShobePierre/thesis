    ...
    toggleStatusbarItem(active) {
        if (active) {
            if (!this.statusBarEntry.value) {
                const text = ( localize(10621, 'Scrolling Locked'));
                const tooltip = ( localize(10622, 'Lock Scrolling Enabled'));
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    id: 'workbench.action.toggleLockedScrolling',
                    title: {
                        ...( localize2(10623, "Toggle Locked Scrolling Across Editors")),
                        mnemonicTitle: ( localize(10624, "Locked Scrolling")),
                    },
                    category: Categories.View,
                    f1: true,
                    metadata: {
                        description: ( localize(10625, "Synchronize Scrolling Editors")),
                    }
                });
            }
            run() {
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    title: {
                        ...( localize2(10626, "Hold Locked Scrolling Across Editors")),
                        mnemonicTitle: ( localize(10627, "Locked Scrolling")),
                    },
                    category: Categories.View,
                });
            }
