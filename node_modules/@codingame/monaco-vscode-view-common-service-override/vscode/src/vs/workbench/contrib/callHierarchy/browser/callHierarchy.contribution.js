...
const _ctxHasCallHierarchyProvider = ( new RawContextKey('editorHasCallHierarchyProvider', false, ( localize(4524, 'Whether a call hierarchy provider is available'))));
const _ctxCallHierarchyVisible = ( new RawContextKey('callHierarchyVisible', false, ( localize(4525, 'Whether call hierarchy peek is currently showing'))));
const _ctxCallHierarchyDirection = ( new RawContextKey(
    'callHierarchyDirection',
    undefined,
    { type: 'string', description: ( localize(4526, 'Whether call hierarchy shows incoming or outgoing calls')) }
));
    ...
    _showCallHierarchyWidget(position, direction, model, cts) {
        ...
        model.then(model => {
            ...
            if (model) {
                ...
                this._widget.showMessage(( localize(4527, "No results")));
            }
        }).catch(err => {
            ...
            this._widget.showMessage(( localize(4528, "Failed to show call hierarchy")));
        });
    }
    showOutgoingCalls() {
...
registerAction2(class PeekCallHierarchyAction extends EditorAction2 {
    constructor() {
        super({
            ...
            title: ( localize2(4529, 'Peek Call Hierarchy')),
            menu: {
...
registerAction2(class extends EditorAction2 {
    constructor() {
        super({
            ...
            title: ( localize2(4530, 'Show Incoming Calls')),
            icon: registerIcon('callhierarchy-incoming', Codicon.callIncoming, ( localize(4531, 'Icon for incoming calls in the call hierarchy view.'))),
...
registerAction2(class extends EditorAction2 {
    constructor() {
        super({
            ...
            title: ( localize2(4532, 'Show Outgoing Calls')),
            icon: registerIcon('callhierarchy-outgoing', Codicon.callOutgoing, ( localize(4533, 'Icon for outgoing calls in the call hierarchy view.'))),
...
registerAction2(class extends EditorAction2 {
    constructor() {
        super({
            ...
            title: ( localize2(4534, 'Refocus Call Hierarchy')),
