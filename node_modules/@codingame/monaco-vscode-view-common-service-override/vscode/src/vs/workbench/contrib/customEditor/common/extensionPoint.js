...
const customEditorsContributionSchema = {
    ...
    properties: {
        ...
        [Fields.selector]: {
            type: 'array',
            description: ( localize(6412, 'Set of globs that the custom editor is enabled for.')),
            items: {
                type: 'object',
                defaultSnippets: [{
                        body: {
                ...
                properties: {
                    filenamePattern: {
                        type: 'string',
                        description: ( localize(6413, 'Glob that the custom editor is enabled for.')),
                    },
                }
            }
        },
...
const customEditorsExtensionPoint = ExtensionsRegistry.registerExtensionPoint({
    ...
    jsonSchema: {
        description: ( localize(6417, 'Contributed custom editors.')),
        type: 'array',
        defaultSnippets: [{
                body: [{
                        [Fields.viewType]: '$1',
...
class CustomEditorsDataRenderer extends Disposable {
    ...
    render(manifest) {
        ...
        const headers = [
            ( localize(6418, "View Type")),
            ( localize(6419, "Priority")),
            ( localize(6420, "Filename Pattern")),
        ];
...
( Registry.as(Extensions.ExtensionFeaturesRegistry)).registerExtensionFeature({
    id: 'customEditors',
    label: ( localize(6421, "Custom Editors")),
    access: {
        canToggle: false
    },
