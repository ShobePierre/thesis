...
const configureSettingsLabel = ( localize(8491, "Configure"));
...
class ColorDecorationAccessor {
    constructor() {
        ...
        this.name = ( localize(8492, 'Color Decorator Status'));
        this.label = ( localize(8493, 'Color decorators'));
        this.source = ( localize(8494, 'Color Decorators'));
...
class FoldingRangeAccessor {
    constructor() {
        ...
        this.name = ( localize(8495, 'Folding Status'));
        this.label = ( localize(8496, 'Folding ranges'));
        this.source = ( localize(8497, 'Folding'));
    ...
    updateStatusItem(info) {
        ...
        if (info && info.limited !== false) {
            const status = {
                ...
                detail: ( localize(8498, 'only {0} shown for performance reasons', info.limited)),
