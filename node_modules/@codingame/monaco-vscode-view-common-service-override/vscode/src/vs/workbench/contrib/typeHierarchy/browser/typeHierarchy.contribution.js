...
const _ctxHasTypeHierarchyProvider = ( new RawContextKey('editorHasTypeHierarchyProvider', false, ( localize(12788, 'Whether a type hierarchy provider is available'))));
const _ctxTypeHierarchyVisible = ( new RawContextKey('typeHierarchyVisible', false, ( localize(12789, 'Whether type hierarchy peek is currently showing'))));
const _ctxTypeHierarchyDirection = ( new RawContextKey(
    'typeHierarchyDirection',
    undefined,
    { type: 'string', description: ( localize(12790, 'whether type hierarchy shows super types or subtypes')) }
));
    ...
    _showTypeHierarchyWidget(position, direction, model, cts) {
        ...
        model.then(model => {
            ...
            if (model) {
                ...
                this._widget.showMessage(( localize(12791, "No results")));
            }
        }).catch(err => {
            ...
            this._widget.showMessage(( localize(12792, "Failed to show type hierarchy")));
        });
    }
...
registerAction2(class PeekTypeHierarchyAction extends EditorAction2 {
    constructor() {
        super({
            ...
            title: ( localize2(12793, 'Peek Type Hierarchy')),
            menu: {
...
registerAction2(class extends EditorAction2 {
    constructor() {
        super({
            ...
            title: ( localize2(12794, 'Show Supertypes')),
...
registerAction2(class extends EditorAction2 {
    constructor() {
        super({
            ...
            title: ( localize2(12795, 'Show Subtypes')),
...
registerAction2(class extends EditorAction2 {
    constructor() {
        super({
            ...
            title: ( localize2(12796, 'Refocus Type Hierarchy')),
