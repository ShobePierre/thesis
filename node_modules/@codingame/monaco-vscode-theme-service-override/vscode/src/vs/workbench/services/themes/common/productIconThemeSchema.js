...
const schema = {
    ...
    properties: {
        fonts: {
            ...
            items: {
                ...
                properties: {
                    id: {
                        type: 'string',
                        description: ( localize(14368, 'The ID of the font.')),
                        pattern: fontIdRegex.source,
                        patternErrorMessage: fontIdErrorMessage
                    },
                    src: {
                        type: 'array',
                        description: ( localize(14369, 'The location of the font.')),
                        items: {
                            type: 'object',
                            properties: {
                                path: {
                                    type: 'string',
                                    description: ( localize(14370, 'The font path, relative to the current product icon theme file.')),
                                },
                                format: {
                                    type: 'string',
                                    description: ( localize(14371, 'The format of the font.')),
        ...
        iconDefinitions: {
            description: ( localize(14374, 'Association of icon name to a font character.')),
            $ref: iconsSchemaId
        }
    }
};
