...
function registerColorThemeExtensionPoint() {
    return ExtensionsRegistry.registerExtensionPoint({
        ...
        jsonSchema: {
            description: ( localize(14407, 'Contributes textmate color themes.')),
            type: 'array',
            items: {
                type: 'object',
                ...
                properties: {
                    id: {
                        description: ( localize(14408, 'Id of the color theme as used in the user settings.')),
                        type: 'string'
                    },
                    label: {
                        description: ( localize(14409, 'Label of the color theme as shown in the UI.')),
                        type: 'string'
                    },
                    uiTheme: {
...
function registerFileIconThemeExtensionPoint() {
    return ExtensionsRegistry.registerExtensionPoint({
        ...
        jsonSchema: {
            description: ( localize(14412, 'Contributes file icon themes.')),
            type: 'array',
            items: {
                type: 'object',
                ...
                properties: {
                    id: {
                        description: ( localize(14413, 'Id of the file icon theme as used in the user settings.')),
                        type: 'string'
                    },
                    label: {
                        description: ( localize(14414, 'Label of the file icon theme as shown in the UI.')),
                        type: 'string'
                    },
                    path: {
                        description: ( localize(
...
function registerProductIconThemeExtensionPoint() {
    return ExtensionsRegistry.registerExtensionPoint({
        ...
        jsonSchema: {
            description: ( localize(14416, 'Contributes product icon themes.')),
            type: 'array',
            items: {
                type: 'object',
                ...
                properties: {
                    id: {
                        description: ( localize(14417, 'Id of the product icon theme as used in the user settings.')),
                        type: 'string'
                    },
                    label: {
                        description: ( localize(14418, 'Label of the product icon theme as shown in the UI.')),
                        type: 'string'
                    },
                    path: {
                        description: ( localize(
...
class ThemeRegistry {
    ...
    onThemes(extensionData, extensionLocation, themeContributions, resultingThemes = [], log) {
        if (!Array.isArray(themeContributions)) {
            log?.error(( localize(14424, "Extension point `{0}` must be an array.", this.themesExtPoint.name)));
