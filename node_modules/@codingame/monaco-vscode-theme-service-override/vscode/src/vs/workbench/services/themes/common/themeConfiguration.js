...
const colorThemeSettingSchema = {
    ...
    errorMessage: ( localize(14376, "Theme is unknown or not installed.")),
};
...
const colorCustomizationsSchema = {
    type: 'object',
    description: ( localize(14382, "Overrides colors from the currently selected color theme.")),
...
const fileIconThemeSettingSchema = {
    ...
    enum: [null],
    enumItemLabels: [( localize(14384, 'None'))],
    enumDescriptions: [( localize(14385, 'No file icons'))],
    errorMessage: ( localize(14386, "File icon theme is unknown or not installed."))
};
const productIconThemeSettingSchema = {
    type: ['string', 'null'],
    default: ThemeSettingDefaults.PRODUCT_ICON_THEME,
    description: ( localize(14387, "Specifies the product icon theme used.")),
    enum: [ThemeSettingDefaults.PRODUCT_ICON_THEME],
    enumItemLabels: [( localize(14388, 'Default'))],
    enumDescriptions: [( localize(14389, 'Default'))],
    errorMessage: ( localize(14390, "Product icon theme is unknown or not installed."))
};
...
const tokenColorSchema = {
    type: 'object',
    properties: {
        comments: tokenGroupSettings(( localize(14392, "Sets the colors and styles for comments"))),
        strings: tokenGroupSettings(( localize(14393, "Sets the colors and styles for strings literals."))),
        keywords: tokenGroupSettings(( localize(14394, "Sets the colors and styles for keywords."))),
        numbers: tokenGroupSettings(( localize(14395, "Sets the colors and styles for number literals."))),
        types: tokenGroupSettings(( localize(14396, "Sets the colors and styles for type declarations and references."))),
        ...
        textMateRules: {
            description: ( localize(14399, 'Sets colors and styles using textmate theming rules (advanced).')),
            $ref: textmateColorsSchemaId
        },
        semanticHighlighting: {
            description: ( localize(14400, 'Whether semantic highlighting should be enabled for this theme.')),
...
const semanticTokenColorSchema = {
    ...
    properties: {
        ...
        rules: {
            ...
            description: ( localize(14405, 'Semantic token styling rules for this theme.')),
