...
import { Barrier, Queue, Promises, Delayer, Throttler } from '@codingame/monaco-vscode-api/vscode/vs/base/common/async';
...
import { ConfigurationModel, mergeChanges, ConfigurationChangeEvent } from '@codingame/monaco-vscode-api/vscode/vs/platform/configuration/common/configurationModels';
import { isConfigurationOverrides, isConfigurationUpdateOverrides, ConfigurationTarget, ConfigurationTargetToString } from '@codingame/monaco-vscode-api/vscode/vs/platform/configuration/common/configuration';
...
import { distinct, delta, equals as equals$1 } from '@codingame/monaco-vscode-api/vscode/vs/base/common/arrays';
...
import { NullPolicyService } from '@codingame/monaco-vscode-api/vscode/vs/platform/policy/common/policy';
...
let RegisterConfigurationSchemasContribution = class RegisterConfigurationSchemasContribution extends Disposable {
    ...
    registerConfigurationSchemas() {
        ...
        const configDefaultsSchema = {
            type: 'object',
            description: ( localize(13700, 'Contribute defaults for configurations')),
...
configurationRegistry.registerConfiguration({
    ...
    properties: {
        [APPLY_ALL_PROFILES_SETTING]: {
            'type': 'array',
            description: ( localize(13701, "Configure settings to be applied for all profiles.")),
            'default': [],
