...
import { JSONEditingErrorCode } from '@codingame/monaco-vscode-api/vscode/vs/workbench/services/configuration/common/jsonEditing';
...
import { rewriteWorkspaceFileForNewLocation } from '@codingame/monaco-vscode-api/vscode/vs/platform/workspaces/common/workspaces';
...
let AbstractWorkspaceEditingService = class AbstractWorkspaceEditingService extends Disposable {
    ...
    async pickNewWorkspacePath() {
        ...
        let workspacePath = await this.fileDialogService.showSaveDialog({
            saveLabel: ( localize(14601, "Save")),
            title: ( localize(14602, "Save Workspace")),
    ...
    askToOpenWorkspaceConfigurationFile(message) {
        this.notificationService.prompt(Severity.Error, message, [{
                label: ( localize(14604, "Open Workspace Configuration")),
