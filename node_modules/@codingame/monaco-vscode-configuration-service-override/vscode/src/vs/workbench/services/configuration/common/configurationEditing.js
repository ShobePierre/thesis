...
let ConfigurationEditing = class ConfigurationEditing {
    ...
    onInvalidConfigurationError(error, operation) {
        const openStandAloneConfigurationActionLabel = operation.workspaceStandAloneConfigurationKey === TASKS_CONFIGURATION_KEY ? ( localize(13703, "Open Tasks Configuration"))
            : operation.workspaceStandAloneConfigurationKey === LAUNCH_CONFIGURATION_KEY ? ( localize(13704, "Open Launch Configuration"))
                : operation.workspaceStandAloneConfigurationKey === MCP_CONFIGURATION_KEY ? ( localize(13705, "Open MCP Configuration"))
                    : null;
        if (openStandAloneConfigurationActionLabel) {
            ...
            this.notificationService.prompt(Severity.Error, error.message, [{
                    label: ( localize(13706, "Open Settings")),
    ...
    onConfigurationFileDirtyError(error, operation, scopes) {
        ...
        if (openStandAloneConfigurationActionLabel) {
            this.notificationService.prompt(Severity.Error, error.message, [{
                    label: ( localize(13707, "Save and Retry")),
                    run: () => {
    ...
    stringifyTarget(target) {
        switch (target) {
            case EditableConfigurationTarget.USER_LOCAL:
                return localize(13740, "User Settings");
            case EditableConfigurationTarget.USER_REMOTE:
                return localize(13741, "Remote User Settings");
            case EditableConfigurationTarget.WORKSPACE:
                return localize(13742, "Workspace Settings");
            case EditableConfigurationTarget.WORKSPACE_FOLDER:
                return localize(13743, "Folder Settings");
            default:
                return '';
        }
    }
