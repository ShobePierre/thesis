...
import { isVirtualWorkspace } from '@codingame/monaco-vscode-api/vscode/vs/platform/workspace/common/virtualWorkspace';
        ...
        if (workspaces.length === 1) {
            ...
            this.notificationService.prompt(Severity.Info, ( localize(
                ...
                'https://go.microsoft.com/fwlink/?linkid=2025315'
                    ...
                    label: ( localize(13524, "Open Workspace")),
            ...
            this.notificationService.prompt(Severity.Info, ( localize(
                ...
                'https://go.microsoft.com/fwlink/?linkid=2025315'
                    ...
                    label: ( localize(13526, "Select Workspace")),
                    run: () => {
                        this.quickInputService.pick(( workspaces.map(workspace => ({ label: workspace }))), { placeHolder: ( localize(13527, "Select a workspace to open")) }).then(pick => {
                            if (pick) {
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(13524, "Open Workspace")),
            f1: false,
            menu: {
    ...
    async run(accessor, uri) {
        ...
        if (contextService.getWorkbenchState() === WorkbenchState.WORKSPACE) {
            ...
            if (workspaceConfiguration && isEqual(workspaceConfiguration, uri)) {
                notificationService.info(( localize(13528, "This workspace is already open.")));
                return;
            }
        }
