    ...
    getProvider(accessor) {
        ...
        function getProvider() {
            ...
            function getContentForNotification() {
                ...
                return withSeverityPrefix(notification.source ? ( localize(3497, '{0} Source: {1}', message, notification.source)) : message, notification.severity);
            }
...
function getActionsFromNotification(notification, accessibilitySignalService) {
    ...
    if (actions) {
        actions.push({
            id: 'clearNotification', label: ( localize(3498, "Clear Notification")), tooltip: ( localize(3498, "Clear Notification")), run: () => {
                notification.close();
