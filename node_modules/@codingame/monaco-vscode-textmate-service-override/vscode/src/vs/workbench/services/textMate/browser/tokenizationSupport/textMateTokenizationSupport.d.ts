...
import { EncodedTokenizationResult, IBackgroundTokenizationStore, IBackgroundTokenizer, IState, ITokenizationSupport, TokenizationResult } from "@codingame/monaco-vscode-api/vscode/vs/editor/common/languages";
