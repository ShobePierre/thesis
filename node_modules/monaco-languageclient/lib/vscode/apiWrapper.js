...
import { ExtensionHostKind, getBuiltinExtensions, registerExtension } from '@codingame/monaco-vscode-api/extensions';
...
import { ConsoleLogger, encodeStringOrUrlToDataUrl } from 'monaco-languageclient/common';
...
export class MonacoVscodeApiWrapper {
     ...
     */
    async initAllServices(performServiceConsistencyChecks) {
    ...
    initExtension(extensionConfig, extensionIds) {
        if (!extensionIds.includes(`${extensionConfig.config.publisher}.${extensionConfig.config.name}`)) {
