...
function DashboardPage() {
  ...
  const boxes = [
    ...
    },
    {
      ...
      details:
        "DIY Activity allows you to build, test, and share interactive projects with classmates.",
      hoverText: "Create your own DIY activities!",
      hoverGif: experiment,
    },
  ];
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-b from-[#cfe3fa] via-[#e6f0ff] to-white select-none">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-grow flex flex-col items-center justify-center text-center p-6 transition-all duration-300 md:ml-72">
          {message && (
